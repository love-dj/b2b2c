...
<Script type="text/javascript" src="<?php echo STATIC_SITE_URL;?>/js/flea/slider.js" charset="utf-8"></Script>

<script charset="utf-8" type="text/javascript" src="<?php echo STATIC_SITE_URL;?>/js/flea/jquery.jqzoom.js" ></script>
<script charset="utf-8" type="text/javascript" src="<?php echo STATIC_SITE_URL;?>/js/flea/goodsinfo.js"></script> 
<script type="text/javascript" src="<?php echo STATIC_SITE_URL;?>/js/flea/dialog.js" id="wt_dialog" charset="utf-8"></script>
<link type="text/css" rel="stylesheet" href="<?php echo STATIC_SITE_URL;?>/js/flea/dialog.css">
<script>
function collect_flea(fav_id){
    var url = 'index.php?w=member_flea&t=addfavorites';
...
function collect_goods(fav_id){
    var url = 'index.php?w=member&t=addfavorites';
    $.getJSON(url, {'fav_id':fav_id}, function(data){
        if (data.done)
        {
            alert(data.msg);
...
<div class="wth-breadcrumb-box">
    <div class="wth-breadcrumb wrapper"><i class="icon-home"></i>
            <span><a href="<?php echo BASE_SITE_URL;?>/index.php?w=flea">闲置首页</a></span><span class="arrow">&gt;</span>
				<span><a href="<?php echo BASE_SITE_URL;?>/index.php?w=flea_class">全部闲置</a></span><span class="arrow">&gt;</span>
                <span><?php echo $output['goods_title'];?></span>
          </div>
  </div>
<div class="wrapper">
  <div class="flea_info_main">
    <div class="content_780 fn-left" style="position: relative;" wt_type="jqzoom_relative">
   ...
   <span><a href="#" class="blue" onclick="javascrit:collect_flea(<?php echo $output['goods']['goods_id'];?>);return false;"><?php echo $lang['flea_goods_collect_goods'];?></a></span>    </div>  
      ...
      <div class="ware_info">
        ...
        <ul class="item_info">
          ...
          <li><em><?php echo $lang['flea_transfer_area'];?>：</em> <a class="orange" href="index.php?w=flea_class&area_input=<?php echo $output['goods']['flea_area_id']?>"><?php echo $output['goods']['flea_area_name']?></a></li>
          <li class="rank_new">
            ...
            <span class="tb-tips">
               ...
               <a class="ico3" style="text-decoration:none; cursor:pointer;" wt_type="dialog" dialog_id="friend_add" dialog_title="<?php echo $lang['flea_oldnew_choose'];?>" uri="index.php?w=flea_class&t=quality_inner" dialog_width="400">
		  ...
		  ?>
          <a class="blue" href="index.php?w=flea_class&key_input=<?php echo urlencode($val); ?>" target="_blank"><?php echo $val?></a>
          <?php }?>
          <?php }?>
          </li>
        </ul>
        <div id="contact" class="grey-box">
          <div class="bd">
            <ul class="fn-clear">
              ...
              <li><?php echo $lang['flea_contact_tel'];?>： <img style="vertical-align: middle;" src="<?php echo STATIC_SITE_URL;?>/pnum.php?pnum=<?php echo $output['goods']['flea_pphone']?>"></li>
            </ul>
    ...
    <div class="content_208 fn-right">
      ...
      <p><?php echo $lang['flea_store_owner'];?>:<?php echo $output['flea_member_info']['member_name'];?><a href="<?php echo MEMBER_SITE_URL;?>/index.php?w=member_message&t=sendmsg&member_id=<?php echo $output['flea_member_info']['member_id'];?>" target=_blank><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/flea/web_mail.gif"></a></p>
    </div>
        ...
        <div class="flea_goods">
           <div class="pic">
             <span class="thumb size60">
               <i></i>
               <a title="<?php echo $val['goods_name']?>" href="<?php echo BASE_SITE_URL;?>/index.php?w=flea_goods&type=goods&goods_id=<?php echo $val['goods_id']?>"><img height="60" width="60" src="<?php echo $val['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$val['member_id'].DS.$val['goods_image'] : SHOP_TEMPLATES_URL.'/images/member/default_image.png';?>" onload="javascript:DrawImage(this,60,60);"></a>
             </span>
           </div>
           <dl>
             <dt><a href="index.php?w=flea_goods&type=goods&goods_id=<?php echo $val['goods_id']?>"><?php echo $val['goods_name'];?></a></dt>
             <dd><?php echo $lang['currency'];?><a href="index.php?w=flea_goods&type=goods&goods_id=<?php echo $val['goods_id']?>"><?php echo $val['goods_store_price'];?></a></dd>
           </dl>
        </div>
        <?php }?>
        <?php }?>
...
<div class="Menubox">
<ul>
<li id="one1" onclick="setTab('one',1,3)" class="hover"><?php echo $lang['flea_goods_content'];?></li>
...
<div><?php echo $output['goods']['goods_body'];?></div>
  ...
  <div id="comments-content">
     ...
     <input type="hidden" name="w" value="flea_goods">
     <input type="hidden" name="t" value="save_consult">
     ...
     <input type="hidden" value="" name="type_name">
       ...
       <div class="comment-w"><a href="#" onclick="save_consult1()"><?php echo $lang['flea_index_commit'];?></a></div>
       </form>
       <script type="text/javascript">
...
<div id="con_one_2" style="display:none">
  <div id="comments-content">
     ...
     <input type="hidden" value="" name="type_name">
       <div class="comment-user"><img src="<?php echo getMemberAvatar($output['member_info']['member_avatar']); ?>"></div>
       <div class="comment-add"><textarea name="content" type="text"></textarea></div>
       <div class="comment-w"><a href="#" onclick="save_consult2()"><?php echo $lang['flea_index_commit'];?></a></div>
       </form>
       <script type="text/javascript">
    ...
    <li>
      <div class="pic"> 
        <span class="thumb size160">
          <i></i>
          <a title="<?php echo $val3['goods_name'] ?>" href="index.php?w=flea_goods&type=goods&goods_id=<?php echo $val3['goods_id']?>"><img height="160" width="160" onload="javascript:DrawImage(this,160,160);" src="<?php echo $val3['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$val3['member_id'].DS.$val3['goods_image'] : SHOP_TEMPLATES_URL.'/images/member/default_image.png';?>"></a>
        </span>
      </div>
      <h3><a href="index.php?w=flea_goods&type=goods&goods_id=<?php echo $val3['goods_id']?>"><?php echo $val3['goods_name']?></a></h3>
      ...
      <ul id="slider_high">
        ...
        <?php if(!empty($output['goods_commend']) && is_array($output['goods_commend'])){?>
            ...
            <span class="thumb size76">
              <i></i>
              <a href="index.php?w=flea_goods&type=goods&goods_id=<?php echo $comment_goods['goods_id'];?>">
