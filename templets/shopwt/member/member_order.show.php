...
<div class="wtm-oredr-show">
  <div class="wtm-order-info">
    <div class="wtm-order-details">
      ...
      <div class="content">
        <dl>
          <dt><?php echo $lang['member_show_order_receiver'].$lang['wt_colon'];?></dt>
        ...
        <dl>
          <dt><?php echo $lang['member_show_order_buyer_message'].$lang['wt_colon'];?></dt>
          ...
          <dd><?php echo $output['order_info']['order_sn']; ?><a href="javascript:void(0);">更多<i class="icon-angle-down"></i>
            <div class="more"><span class="arrow"></span>
              <ul>
                ...
                <li><?php echo $lang['member_order_pay_method'].$lang['wt_colon'];?><span><?php echo $output['order_info']['payment_name']; ?>
                ...
                <li><?php echo $lang['member_show_order_pay_time'].$lang['wt_colon'];?><span>
        ...
        <dl>
          <dt><?php echo $lang['member_show_order_seller_info'].$lang['wt_colon'];?></dt>
          <dd><?php echo $output['order_info']['extend_store']['store_name']; ?><a href="javascript:void(0);">更多<i class="icon-angle-down"></i>
            <div class="more"><span class="arrow"></span>
              <ul>
                <li><?php echo $lang['member_address_location'].$lang['wt_colon'];?><span><?php echo $output['order_info']['extend_store']['area_info'].'&nbsp;'.$output['order_info']['extend_store']['store_address']; ?></span></li>
            ...
            <div class="msg"> <span member_id="<?php echo $output['order_info']['extend_store']['member_id'];?>"></span>
              ...
              <a target="_blank" href="http://amos.im.alisoft.com/msg.aw?v=2&uid=<?php echo $output['order_info']['extend_store']['store_ww'];?>&site=cntaobao&s=2&charset=<?php echo CHARSET;?>"><img border="0" src="http://amos.alicdn.com/online.aw?v=2&uid=<?php echo $output['order_info']['extend_store']['store_ww'];?>&site=cntaobao&s=2&charset=<?php echo CHARSET;?>" alt="Wang Wang" style=" vertical-align: middle;" /></a>
              <?php }?>
            </div>
          </dd>
        </dl>
    ...
    <div class="wtm-order-condition">
      ...
      <ul>
        ...
        <li>1. 您尚未对该订单进行支付，请<a href="index.php?w=buy&t=pay&pay_sn=<?php echo $output['order_info']['pay_sn'];?>" class="wtbtn-mini wtbtn-bittersweet"><i></i>支付订单</a>以确保商家及时发货。</li>
        <li>2. 如果您不想购买此订单的商品，请选择<a href="#order-step" class="wtbtn-mini">取消订单</a>操作。</li>
    ...
    <div class="wtm-order-condition">
      ...
      <ul>
        ...
        <li>3. 如果您不想购买此订单的商品，请选择<a href="#order-step" class="wtbtn-mini">取消订单</a>操作。</li>
        <?php } else { ?>
        ...
        <li>3. 如果您想取消购买，请与商家沟通后对订单进行<a class="wtbtn-mini" href="#order-step">申请退款</a>操作。</li>
        <?php } ?>
        <?php } ?>
      </ul>
    </div>
    ...
    <div class="wtm-order-condition">
      ...
      <ul>
        ...
        <li>2. 如果您已收到货，且对商品满意，您可以<a href="#order-step" class="wtbtn-mini wtbtn-mint">确认收货</a>完成交易。</li>
        <li>3. 系统将于
    ...
    <div class="wtm-order-condition">
      ...
      <ul>
        ...
        <li>2. 将感兴趣的<a href="index.php?w=member_favorite_goods&t=fglist" class="wtbtn-mini">收藏商品</a>加入购物车进行购买。</li>
        <li>3. 看一看<a href="<?php echo urlShop('show_store','index',array('store_id'=>$output['order_info']['store_id']), $output['order_info']['extend_store']['store_domain']);?>" class="wtbtn-mini">该店铺</a>中有什么新商品上架。</li>
      </ul>
    </div>
    <?php } else { ?>
    <div class="wtm-order-condition">
      ...
      <ul>
        ...
        <li>3. 交易已完成，你可以对购买的商品及商家的服务进行<a href="#order-step" class="wtbtn-mini wtbtn-aqua">评价</a>及晒单。</li>
        <?php } ?>
      </ul>
    </div>
    <?php } ?>
  ...
  <div id="order-step" class="wtm-order-step">
  ...
  <div class="wtm-order-contnet">
    <table class="wtm-default-table order">
      ...
      <tbody>
        ...
        <tr>
          <th colspan="7" style="border-right: none;"> <div class="order-deliver"><span>物流公司： <a target="_blank" href="<?php echo $output['order_info']['express_info']['e_url'];?>"><?php echo $output['order_info']['express_info']['e_name'];?></a></span><span> <?php echo $lang['member_show_order_shipping_no'].$lang['wt_colon'];?> <?php echo $output['order_info']['shipping_code'];?> </span><span><a href="javascript:void(0);" id="show_shipping">物流跟踪<i class="icon-angle-down"></i>
              <div class="more"><span class="arrow"></span>
                <ul id="shipping_ul">
                  <li>加载中...</li>
                </ul>
        ...
        <tr class="bd-line">
          <td>&nbsp;</td>
          <td class="w70"><div class="wtm-goods-thumb"><a target="_blank" href="<?php echo $goods['goods_url']; ?>"><img src="<?php echo $goods['image_60_url']; ?>" onMouseOver="toolTip('<img src=<?php echo $goods['image_240_url']; ?>>')" onMouseOut="toolTip()" /></a></div></td>
          <td class="tl"><dl class="goods-name">
              ...
              <dd>退款单号：<a target="_blank" href="index.php?w=member_refund&t=view&refund_id=<?php echo $output['refund_all']['refund_id'];?>"><?php echo $output['refund_all']['refund_sn'];?></a></dd>
              <?php }else if($goods['extend_refund']['refund_type'] == 1) {?>
              <dd>退款单号：<a target="_blank" href="index.php?w=member_refund&t=view&refund_id=<?php echo $goods['extend_refund']['refund_id'];?>"><?php echo $goods['extend_refund']['refund_sn'];?></a></dd>
              <?php }else if($goods['extend_refund']['refund_type'] == 2) {?>
              <dd>退货单号：<a target="_blank" href="index.php?w=member_return&t=view&return_id=<?php echo $goods['extend_refund']['refund_id'];?>"><?php echo $goods['extend_refund']['refund_sn'];?></a></dd>
              <?php } ?>
            </dl></td>
          <td></td>
          <td class="tl refund"><?php echo wtPriceFormat($goods['goods_price']); ?>
            <p class="green">
          ...
          <td><!-- 退款 -->
            ...
            <p><a href="index.php?w=member_refund&t=add_refund&order_id=<?php echo $output['order_info']['order_id']; ?>&goods_id=<?php echo $goods['rec_id']; ?>">退款/退货</a></p>
            <?php }?>

            <!-- 投诉 -->
            
            <?php if ($output['order_info']['if_complain']){ ?>
            <p><a href="index.php?w=member_complain&t=complain_new&order_id=<?php echo $output['order_info']['order_id']; ?>&goods_id=<?php echo $goods['rec_id']; ?>">交易投诉</a></p>
            <?php } ?></td>
          ...
          <td rowspan="<?php echo $output['order_info']['goods_count'];?>"><?php if ($output['order_info']['if_lock']) { ?>
            ...
            <p><a href="javascript:void(0)" wt_type="sharegoods" data-param='{"gid":"<?php echo $output['order_info']['extend_order_goods'][0]['goods_id'];?>"}'>分享商品</a></p>
            <?php } ?></td>
          <?php } ?>
          <!-- E 合并TD --> 
        </tr>
        ...
        <tr class="bd-line">
          <td>&nbsp;</td>
          <td colspan="7" class="tl"><div class="wtm-goods-gift"><strong>赠品：</strong>
              <ul>
        ...
        <tr>
          <td colspan="20"><dl class="freight">
              <dd>
                ...
                <?php echo $lang['member_show_order_tp_fee'].$lang['wt_colon'];?><span><?php echo $lang['currency'];?><?php echo $output['order_info']['shipping_fee']; ?></span>
                <?php if ($output['order_info']['shipping_name'] != ''){echo '('.$output['order_info']['shipping_name'].')';};?>
                <?php }else{?>
                <?php echo $lang['wt_common_shipping_free'];?>
                <?php }?>
				<b><?php echo $output['order_info']['points_number'];?></b> 积分抵
              <b><?php echo $output['order_info']['points_money'];?></b> 元
              </dd>
            </dl>
            <dl class="sum">
              <dd><?php echo $lang['member_order_sum'].$lang['wt_colon'];?><em><?php echo $output['order_info']['order_amount']; ?></em>元</dd>
            </dl></td>
        </tr>
      </tfoot>
    </table>
...
$(function(){
    $('#show_shipping').on('hover',function(){
    	$.getJSON('index.php?w=member_order&t=get_express&e_code=<?php echo $output['order_info']['express_info']['e_code']?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&c=<?php echo random(7);?>',function(data){
    		if(data){
    			data = data.join('<br/>');
