<div class="eject_con">
  ...
  <form id="post_form" method="post" action="index.php?w=store_lib_goods&t=edit_goods&gc_id=<?php echo $output['goods']['gc_id']; ?>&goods_id=<?php echo $output['goods']['goods_id']; ?>">
    <input type="hidden" name="form_submit" value="ok" />
    <dl>
      <dt><i class="required">*</i>商品价格<?php echo $lang['wt_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>市场价格<?php echo $lang['wt_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>商品库存<?php echo $lang['wt_colon'];?></dt>
      <dd>
    ...
    <div class="bottom">
        <label class="submit-border"><input type="submit" class="submit" value="<?php echo $lang['wt_ok'];?>" /></label>
    </div>
  </form>
</div>
