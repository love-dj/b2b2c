...
<div class="sns-main-all">
  ...
  <div class="shoplist-module" id="shoplist-module">
      ...
      <li class="shop-item" id="recordone_<?php echo $v['share_id']; ?>">
        <dl>
          <dt>
            ...
            <?php if ($output['relation'] == 3){?>
            <div class="set-btn fr" wt_type="privacydiv"><a href="javascript:void(0)" wt_type="formprivacybtn"><i></i><?php echo $lang['sns_setting'];?></a>
            <ul class="set-menu" wt_type="privacytab" style="display: none;">
              <li wt_type="privacyoption" data-param='{"sid":"<?php echo $v['share_id'];?>","v":"0","t":"store"}'><span class="<?php echo $v['share_privacy']==0?'selected':'';?>"><?php echo $lang['sns_open'];?></span></li>
              <li wt_type="privacyoption" data-param='{"sid":"<?php echo $v['share_id'];?>","v":"1","t":"store"}'><span class="<?php echo $v['share_privacy']==1?'selected':'';?>"><?php echo $lang['sns_friend'];?></span></li>
              <li wt_type="privacyoption" data-param='{"sid":"<?php echo $v['share_id'];?>","v":"2","t":"store"}'><span class="<?php echo $v['share_privacy']==2?'selected':'';?>"><?php echo $lang['sns_privacy'];?></span></li>
              <li wt_type="storedelbtn" data-param='{"sid":"<?php echo $v['share_id'];?>"}'><span class="del"><a href="javascript:void(0);"><?php echo $lang['wt_delete'];?></a></span></li>
            </ul></div>
            <?php }?>
          </dt>
          <dd><i class="pngFix"></i>
    ...
    <?php } else{?>
    <?php if ($output['relation'] == 3){?>
    <div class="sns-norecord"><i class="store-ico pngFix"></i><span><?php echo $lang['sns_sharestore_nohave_self_1'];?><a href="index.php?w=member_favorite_store&t=fslist" target="_blank"><?php echo $lang['sns_sharestore_nohave_self_2'];?></a><?php echo $lang['sns_sharestore_nohave_self_3'];?></span></div>
    <?php }else {?>
...
$(function(){
	...
	$('#snssharestore').click(function(){
	    ajax_form("sharestore", '<?php echo $lang['sns_sharestore'];?>', '<?php echo BASE_SITE_URL.DS;?>index.php?w=member_snsindex&t=sharestore', 480);
	    return false;
	});
});
</script>
