  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        <li><a href="index.php?w=store_joinin&t=edit_info"><?php echo '入驻首页';?></a></li>
  ...
  <table class="flex-table">
    <thead>
      <tr>
        ...
        <th width="80" align="center"><?php echo $lang['wt_sort'];?></th>
    ...
    <tbody>
      ...
      <tr data-id="<?php echo $val['help_id'];?>">
        ...
        <td class="handle-s"><a class="btn blue" href="index.php?w=store_joinin&t=edit_help&help_id=<?php echo $val['help_id'];?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['wt_edit'];?></a></td>
