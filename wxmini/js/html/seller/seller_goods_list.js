...
$(function() {
            ...
            success: function(e) { 
                if (e.datas && e.datas == 1) {
                    $.sDialog({
						...
						content: "操作成功",
						okFn: function() {
							window.location.href = WapSiteUrl + "/html/seller/store_goods_list.html";
						}
					})
                } else {
                    $.sDialog({
    ...
    function s(r) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?w=seller_goods&t=goods_show",
            data: {
                commonids: new Array(r),
                key: e
            },
    ...
    function c() {
        ...
        location.href = WapSiteUrl + "/html/member/order_delivery.html?order_id=" + e
    }
