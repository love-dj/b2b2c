...
function zsc_show(id){
	...
	if(zsc_class!='add'){
		...
		var url = "index.php?w=seller_wechat&t=addkeyword_ajax&kid="+zsc_id;
		//var url = "/biz.php?ctl=wechat&w=addkeyword_ajax&kid="+zsc_id;
		$.post(url,null,function(data){
			//$.each(data,function(i,v){
				...
				zsc_html = "<div class=\"edit-info\">"+
						   ...
						   "<img id=\"zsc_imgs0\" src=\"/shop/static/keyword/images/bigimg.jpg\" width=\"295\" height=\"126\"/>"+
						   "<span id=\"zsc_titles0\">标题</span>"+
						   "<b class=\"modify\"><img id=\"zsc_simg0\""+
						   " src=\"/shop/static/keyword/images/t-modify.png\" onclick=\"zsc_editimg(0)\"/></b>"+
						   ...
						   "<img src=\"/shop/static/keyword/images/keywords_28.jpg\" class=\"add1\" "+
						   "style=\"cursor:pointer;\" onclick=\"zsc_addimg(1)\" />"+
						   "</div>"+
						   "</div>"+
						   "<div class=\"tuwen_right\">"+
						   "<img src=\"/shop/static/keyword/images/keywords_15.jpg\">"+
						   "<p>"+
						   "<br />"+
						   ...
						   "</p>"+
						   "<img src=\"/shop/static/keyword/images/keywords_19.jpg\">"+ 
						   "</div>"+
						   "<div style=\" padding-top:45px; clear:both;\">"+
...
function zsc_addimg(num){
	if($('.simgcon').length<9){
		...
		var zsc_html = "<a href=\"javascript:;\" class=\"simgcon\" id=\"zsc_imgs"+num+"\">"+
					   "<span>标题</span>"+
					   "<img src=\"/shop/static/keyword/images/smallimg.jpg\" id=\"zsc_simg"+num+"\" />"+
					   "<b class=\"smodify\"><img src=\"/shop/static/keyword/images/t-modify.png\" onclick=\"zsc_editimg("+num+")\" />"+
					   "<img src=\"/shop/static/keyword/images/t-del.png\" onclick=\"zsc_delimg("+num+")\" /></b>"+
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		if(count==0){
			//var url = "/biz.php?ctl=wechat&w=keyword_index&t=add";
			var url = "index.php?w=seller_wechat&t=keyword_index&opt=add";
			...
			//var url = "/biz.php?ctl=wechat&w=keyword_index&t=update";
			var url = "index.php?w=seller_wechat&t=keyword_index&opt=update";
			var kid = $('#zsc_iid').val();
...
function zscdel(num){
	...
	var url = "index.php?w=seller_wechat&t=keyword_index&opt=del";
	//var url = "/biz.php?ctl=wechat&w=keyword_index&t=del";
	...
	$("input[name='"+file_id+"']").bind("change",function(){			
		...
		$(obj).parent().find(".fileuploading").addClass("show");
		  $.ajaxFileUpload
		   (
			   {
				    //url:APP_ROOT+'/index.php?ctl=avatar&w=upload&uid='+uid,
					url:"index.php?w=seller_wechat&t=upload_fm",
					//url:APP_ROOT+'/biz.php?ctl=wechat&w=upload_fm',
				    secureuri:false,
