	...
	public function indexWt() {
        ...
        foreach ($order_list as $key => $order_info) {
        	...
        	foreach ($order_info['extend_order_goods'] as $value) {
				...
				$value['goods_all_price'] = wtPriceFormat($value['goods_num'] * $value['goods_price']);
			...
			//优惠金额
		    $order_info['sale_amount'] = $order_info['goods_total_price'] - $order_info['goods_amount'];
