...
function update_flex(){
	$('.wtap-stat-general-single').load('index.php?w=stat_trade&t=get_plat_predeposit&'+$("#formSearch").serialize(),
		function(){
			$('.timer').each(count);
     	});
	$('#container').load('index.php?w=stat_trade&t=get_predeposit_highcharts&'+$("#formSearch").serialize());
    $("#flexigrid").flexigrid({
        url: 'index.php?w=stat_trade&t=get_predeposit_xml&'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?w=stat_trade&t=predeposit';
