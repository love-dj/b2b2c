 ...
 */
		...
		'store_goods_import_title_csv'		=> '导入程序默认从第二行执行导入，请保留CSV文件第一行的标题行，最大'.ini_get('upload_max_filesize').'',
...
3.如果CSV文件超过'.ini_get('upload_max_filesize').'请通过excel软件编辑拆成多个文件进行导入4444。<br/>
4.每个商品最多支持导入5张图片。',
...
/*淘宝文件导入*/
		...
		'store_goods_index_batch_upload'	 => '批量上传',
