<div class="goods-gallery add-step2"> <a class="sample_demo" id="select_s" href="index.php?w=store_album&t=pic_list&item=des" style="display:none;"><?php echo $lang['wt_submit'];?></a>
