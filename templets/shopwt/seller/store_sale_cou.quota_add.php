...
<div class="wtsc-form-default">
  <form id="add_form" action="index.php?w=store_sale_cou&t=cou_quota_add_save" method="post">
    <dl>
      ...
      <dd>
        ...
        <p class="hint">每月(30天)您需要支付<?php echo $output['setting_config']['sale_cou_price'].$lang['wt_yuan'];?></p>
...
$(document).ready(function(){
    ...
    $("#add_form").validate({
        ...
        submitHandler:function(form){
            var unit_price = <?php echo $output['setting_config']['sale_cou_price'];?>;
