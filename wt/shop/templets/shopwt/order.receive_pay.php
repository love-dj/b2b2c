...
<div class="page">
  ...
  <form method="post" name="form1" id="form1" action="index.php?w=<?php echo $_GET['w'];?>&t=change_state&state_type=receive_pay&order_id=<?php echo intval($_GET['order_id']);?>">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt"><?php echo wtPriceFormat($output['order_info']['order_amount']);?>
        </dd>
      </dl>
      ...
      <dl class="row">
        ...
        <?php foreach ($output['order_info']['book_list'] as $book_info) { ?>
            <?php echo $book_info['book_step'];?>，
                                ...
                                支付充值卡：<?php echo wtPriceFormat($book_info['book_rcb_amount']);?>，
                                支付预存款：<?php echo wtPriceFormat($book_info['book_pd_amount']);?>，
...
$(function(){
	...
	$("#form1").validate({
        ...
        messages : {
        	payment_time : {
                required : '<i class="fa fa-exclamation-bbs"></i>请填写付款准确时间'
            },
            payment_code : {
