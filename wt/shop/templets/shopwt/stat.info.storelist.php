...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?w=stat_store&t=get_store_xml&provid=<?php echo $_GET['provid'];?>&scid=<?php echo $_GET['scid'];?>&c=<?php echo $_GET['c'];?>',
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?w=stat_store&t=showstore&exporttype=excel&provid=<?php echo $_GET['provid'];?>&scid=<?php echo $_GET['scid'];?>&c=<?php echo $_GET['c'];?>';
