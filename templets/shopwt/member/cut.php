...
<div class="eject_con">
  <div id="warning"></div>
  <form action="index.php?w=cut&t=pic_cut" id="form_cut" method="post">
    ...
    <div class="pic-cut-100">
      ...
      <div class="cut-btn">
        <input class="submit"  type="button" id="pic_submit" value="<?php echo $lang['wt_submit'];?>">
      </div>
    </div>
  </form>
</div>
...
$(function(){
    ...
    $('#pic_submit').click(function(){
		...
		$.post('index.php?w=cut&t=pic_cut',d,function(data){
			call_back(data);
