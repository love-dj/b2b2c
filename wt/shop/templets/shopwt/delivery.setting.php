...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        <li><a href="<?php echo urlAdminShop('delivery', 'index');?>"><?php echo $lang['wt_manage'];?></a></li>
  ...
  <form id="setting_form" method="post" action="<?php echo urlAdminShop('delivery', 'save_setting');?>">
    ...
    <div class="wtap-form-default">
      <dl class="row">
        <dt class="tit"><label for="sale_booth_price"><em>*</em>物流自提服务站是否开启</label></dt>
        ...
        <dd class="opt">
          ...
          <p class="notic">现在去设置物流自提服务站使用的快递公司，<a onclick="window.parent.openItem('shop|express');" href="JavaScript:void(0);" class="wtap-btn"><i class="fa fa-truck"></i>
快递公司</a></p>
        </dd></dl>
        
      <div class="bot"><a href="JavaScript:void(0);" class="wtap-btn-big wtap-btn-green" id="submitBtn"><?php echo $lang['wt_submit'];?></a></div></div>
  </form>
</div>
<script>
$(function(){
