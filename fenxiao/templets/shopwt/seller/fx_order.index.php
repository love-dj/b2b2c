...
<table class="wtsc-default-table order">
  ...
  <tbody>
    ...
    <tr>
      <th colspan="20"><span class="ml10">订单编号<?php echo $lang['wt_colon'];?><em><?php echo $order['order_sn']; ?></em></span>
        <span>下单时间<?php echo $lang['wt_colon'];?><em class="goods-time"><?php echo $order['add_time_text']; ?></em></span>
        <span>结算状态<?php echo $lang['wt_colon'];?><em class="goods-time"><?php echo $order['fx_pay_state_text']; ?></em></span>
        <span>结算时间<?php echo $lang['wt_colon'];?><em class="goods-time"><?php echo $order['fx_pay_time']; ?></em></span>
         </th>
    </tr>
    <?php $i = 0;?>
    ...
    <tr>
      ...
      <td><?php echo $goods['fx_member_name']; ?></td>
      <!-- S 合并TD -->
      <?php if (($order['goods_count'] > 1 && $k ==0) || ($order['goods_count']) == 1){ ?>
      <td class="bdl" rowspan="<?php echo $order['goods_count'];?>" style="width:110px"><p class="wtsc-order-amount"><?php echo $order['fx_order_amount']; ?></p>
      ...
      <td class="bdl" rowspan="<?php echo $order['goods_count'];?>"><p class="wtsc-order-amount" style="width:90px"><?php echo $order['fx_commis_amount']; ?></p>
        </td>
