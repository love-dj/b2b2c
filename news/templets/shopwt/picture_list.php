...
<div class="warp-all picture-box-b">
  <div class="sitenav-bar">
    <div class="sitenav"><?php echo $lang['current_location'];?><?php echo $lang['wt_colon'];?> <a href="<?php echo NEWS_SITE_URL;?>"><?php echo $lang['news_site_name'];?></a> > <a href="<?php echo NEWS_SITE_URL.DS.'index.php?w=picture&t=picture_list';?>"><?php echo $lang['news_picture'];?></a> <?php echo empty($_GET['class_id'])?'':' > '.$output['picture_class_list'][$_GET['class_id']]['class_name'];?></div>
  </div>
  <div class="mainbox">
    <div class="picture-info"><?php echo $lang['news_picture_search1'];?><?php echo $lang['wt_colon'];?><em><?php echo intval($output['total_num']);?></em>&nbsp;<?php echo $lang['news_picture_search2'];?></div>
    ...
    <ul class="picture-list">
      ...
      <li>
        ...
        <div class="thumb"> <a href="<?php echo getNEWSPictureUrl($value['picture_id']);?>" target="_blank"><img src="<?php echo getNEWSArticleImageUrl($value['picture_attachment_path'], $value['picture_image']);?>" alt="<?php echo $value['picture_title'];?>" class="t-img"/></a></span> </div>
