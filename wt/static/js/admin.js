$(function() {
    ...
    $(".cb-enable").click(function(){
        ...
        $('.cb-midable',parent).removeClass('selected');
        $('.cb-midable2',parent).removeClass('selected');
        $(this).addClass('selected');
        $('.checkbox',parent).attr('checked', true);
    });
    $(".cb-midable").click(function(){
        var parent = $(this).parents('.onoff');
    ...
    /* BACK TO TOP */
		...
		$('#searchBarOpen').click(function() {
            $('.wtap-search-ban-s').animate({'right': '-40px'},200,
            function() {
                $('.wtap-search-bar').animate({'right': '0'},300);
            });
        });
        $('#searchBarClose').click(function() {
            $('.wtap-search-bar').animate({'right': '-240px'}, 300,
            function() {
                $('.wtap-search-ban-s').animate({'right': '0'},  200);
            });            
        });
		// 搜索项目过多时出现滚动条
