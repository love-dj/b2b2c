  ...
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        ...
        <li><a href="javascript:;" class="current"><span><?php echo $lang['wt_add'];?></span></a></li>
      </ul>
	  </div>
  </div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="vatop rowform"><input name="dourl" type="text" id="dourl" class="txt" />
            <span style="color:#999;padding:5px 0;">程序必须放在跟目录 /system/task 目录中，因此填写文件名即可</span></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="vatop rowform onoff"><label for="islock_enable" class="cb-enable selected" title="<?php echo $lang['wt_yes'];?>"><span><?php echo $lang['wt_yes'];?></span></label>
            <label for="islock_disabled" class="cb-disable" title="<?php echo $lang['wt_no'];?>"><span><?php echo $lang['wt_no'];?></span></label>
