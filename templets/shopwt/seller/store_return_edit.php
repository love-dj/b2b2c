  ...
  <div class="wtsc-flow-container">
    ...
    <div id="saleRefundReturn">
      ...
      <div class="wtsc-form-default">
        ...
        <form id="post_form" method="post" action="index.php?w=store_return&t=edit&return_id=<?php echo $output['return']['refund_id']; ?>">
          <input type="hidden" name="form_submit" value="ok" />
          <h3>商家处理意见</h3>
          <dl>
            <dt><i class="required">*</i><?php echo $lang['return_seller_confirm'].$lang['wt_colon'];?></dt>
            <dd>
              <div>
                <label class="mr20">
          ...
          <dl>
            <dt><i class="required">*</i><?php echo $lang['return_message'].$lang['wt_colon'];?></dt>
            <dd>
