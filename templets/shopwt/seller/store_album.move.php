<div class="eject_con">
  ...
  <form id="category_form" method="post" target="_parent" onsubmit="ajaxpost('category_form','','','onerror')" action="index.php?w=store_album&t=album_pic_move">
    <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="id" value="<?php echo $output['id']?>" />
    <dl>
      <dt><?php echo $lang['album_plist_move_album_change'].$lang['wt_colon'];?></dt>
      <dd>
