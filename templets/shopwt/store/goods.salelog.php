...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mt10">
  ...
  <tbody>
    ...
    <tr>
      <td><a href="index.php?w=member_snshome&mid=<?php echo $sale['buyer_id'];?>" target="_blank" data-param="{'id':<?php echo $sale['buyer_id'];?>}" wttype="mcard"><?php echo $sale['buyer_name'];?></a></td>
      <td><em class="price"><i style="color:red;"><?php echo $lang['currency'].wtPriceFormat($sale['goods_price']);?></i></em></td>
      <td><?php echo (isset($sale['goods_type']) ? $output['order_type'][$sale['goods_type']] : $output['order_vr_type'][$sale['order_sale_type']]);?></td>
  ...
  <tbody>
    <tr>
      <td colspan="10" class="wts-norecord"><?php echo $lang['no_record'];?></td>
    </tr>
  </tbody>
  <?php }?>
</table>
