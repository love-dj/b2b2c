...
<div class="robbuy-gallery" wttype="store_sns_album"> <a class="sample_demo" id="select_s" href="index.php?w=store_album&t=pic_list&item=store_sns_normal" style="display:none;"><?php echo $lang['wt_submit'];?></a>
...
$(document).ready(function(){
	/* 从图片空间选择图片 */
	$('div[wttype="store_sns_album"]').find('.demo').unbind().ajaxContent({
