...
<div class="index_block goods-list">
  ...
  <div wttype="item_content" class="content">
    ...
    <div wttype="item_image" class="item">
      <div class="goods-pic"><img wttype="goods_image" src="<?php echo getNEWSArticleImageUrl($item_value['article_attachment_path'], $item_value['article_image']['name']);?>" alt=""></div>
      <div class="goods-name" wttype="goods_name"><?php echo $item_value['article_title'];?></div>
      <div class="goods-price" wttype="goods_price"><?php echo $item_value['article_abstract'];?></div>
      <?php if($item_edit_flag) { ?>
      <input wttype="goods_id" name="item_data[item][]" type="hidden" value="<?php echo $item_value['article_id'];?>">
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#btn_mb_special_goods_search').on('click', function() {
            var url = '<?php echo urlShop('mb_store_decoration', 'gg_list');?>';
