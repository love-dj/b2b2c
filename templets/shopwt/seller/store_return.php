...
<form method="get" action="index.php">
  <input type="hidden" name="w" value="store_return" />
...
<table class="wtsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line" >
        ...
        <dd><?php echo $lang['refund_order_ordersn'].$lang['wt_colon'];?><a href="index.php?w=store_order&t=show_order&order_id=<?php echo $val['order_id']; ?>" target="_blank"><?php echo $val['order_sn'];?></a></dd>
        <dd><?php echo $lang['return_order_returnsn'].$lang['wt_colon'];?><?php echo $val['refund_sn']; ?></dd></dl></td>
      ...
      <td class="nscs-table-handle">
        ...
        <span><a href="index.php?w=store_return&t=edit&return_id=<?php echo $val['refund_id']; ?>" class="btn-bluejeans"><i class="icon-edit"></i><p>处理</p></a></span>
        <?php } else { ?>
       <span> <a href="index.php?w=store_return&t=view&return_id=<?php echo $val['refund_id']; ?>" class="btn-bittersweet"><i class="icon-eye-open"></i><p><?php echo $lang['wt_view'];?></p></a></span>
        <?php } ?>
        <?php if ($val['seller_state'] == 2 && $val['return_type'] == 2 && $val['goods_state'] == 2) { ?>
        <span><a href="javascript:void(0)" class="btn-mint" wt_type="dialog" dialog_title="<?php echo $lang['wt_edit'];?>" dialog_id="return_order" dialog_width="480" uri="index.php?w=store_return&t=receive&return_id=<?php echo $val['refund_id']; ?>"><i class="icon-check-sign"></i><p><?php echo '收货';?></p></a></span>
        <?php } ?>
        </td>
    </tr>
    <?php } ?>
...
<script src="<?php echo STATIC_SITE_URL;?>/js/jquery-ui/i18n/zh-CN.js" charset="utf-8"></script>
<script>
	$(function(){
