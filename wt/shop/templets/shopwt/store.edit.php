...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=store&t=store" title="返回<?php echo $lang['manage'];?>列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['wt_store_manage'];?> - 编辑会员“<?php echo $output['joinin_detail']['member_name'];?>”的店铺信息</h3>
...
<?php if(!($output['store_zizhi'])){?>
    <form id="joinin_form" enctype="multipart/form-data" method="post" action="index.php?w=store&t=edit_save_joinin" style="display:none;">
      <input type="hidden" name="form_submit" value="ok" />
      ...
      <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
        ...
        <tbody>
          ...
          <tr>
            <th>营业执照<br />
              电子版：</th>
            <td colspan="20"><a wttype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_licence_number_elc']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_licence_number_elc']);?>" alt="" /> </a>
      ...
      <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
        ...
        <tbody>
          ...
          <tr>
            <th>组织机构代码证<br/>
              电子版：</th>
            <td colspan="20"><a wttype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['organization_code_electronic']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['organization_code_electronic']);?>" alt="" /> </a>
      ...
      <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
        ...
        <tbody>
          <tr>
            <th>一般纳税人证明：</th>
            <td colspan="20"><a wttype="nyroModal" href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['general_taxpayer']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['general_taxpayer']);?>" alt="" /> </a>
        ...
        <tbody>
         ...
         <!-- <tr>
          ...
          <!--<tr>
            <th>开户银行许可证<br/>
              电子版：</th>
            <td colspan="20"><a wttype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['bank_licence_electronic']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['bank_licence_electronic']);?>" alt="" /> </a>
      ...
      <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
        ...
        <tbody>
          ...
          <tr>
            <th>税务登记证号<br />
              电子版：</th>
            <td><a wttype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['tax_registration_certif_elc']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['tax_registration_certif_elc']);?>" alt="" /> </a>
              <input type="file" name="tax_registration_certif_elc"></td>
          </tr>
        </tbody>
      </table>
      <div><a id="btn_fail" class="wtap-btn-big wtap-btn-green" href="JavaScript:void(0);"><?php echo $lang['wt_submit'];?></a></div>
    </form>
<?php }else { ?>
  <form id="joinin_form" enctype="multipart/form-data" method="post" action="index.php?w=store&t=edit_save_joinin" style="display:none;">
    <input type="hidden" name="form_submit" value="ok" />
    ...
    <tbody>
	  ...
	  <th>身份证正面<br/>          电子版：</th>
        <td colspan="20">
          <a wttype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_licence_number_electronic']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['organization_code_electronic']);?>" alt="" /> </a>
      ...
      <tr>
        <th>身份证反面<br/>          电子版：</th>
        <td colspan="20">
          <a wttype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['general_taxpayer']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['general_taxpayer']);?>" alt="" /> </a>
	  ...
	  <tr>
        <th>手持身份证<br />五官照片：</th>
        <td colspan="20">
          <a wttype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_licence_number_elc']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_licence_number_elc']);?>" alt="" /> </a>
  ...
  <div><a id="btn_fail" class="btn" href="JavaScript:void(0);"><span><?php echo $lang['wt_submit'];?></span></a></div>
</form>
<?php }?>
  </div>
</div>
...
$(function(){
    $("#store_region").wt_region();
    $("#company_address").wt_region();
    $("#business_licence_address").wt_region();
    $("#bank_address").wt_region();
    $("#settlement_bank_address").wt_region();
    $('#end_time').datepicker();
    ...
    $('#store_form').validate({
        ...
        messages : {
            store_name: {
                required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['please_input_store_name'];?>',
                remote   : '<i class="fa fa-exclamation-bbs"></i>店铺名称已存在'
            }
        }
    });

    $('div[wttype="editStoreContent"] > .title').find('li').click(function(){
        $(this).children().addClass('current').end().siblings().children().removeClass('current');
        var _index = $(this).index();
        var _form = $('div[wttype="editStoreContent"]').find('form');
        _form.hide();
