...
<div class="wrap">
  ...
  <div class="alert alert-success">
    ...
    <ul>
      ...
      <li>3. 如果您的邮箱已失效，可以 <a href="index.php?w=member_security&t=auth&type=modify_mobile">手机验证</a> 后通过接收手机短信完成验证。</li>
      <li>4. 如果您的手机已失效，可以 <a href="index.php?w=member_security&t=auth&type=modify_email">邮箱验证</a> 后通过接收邮件完成验证。</li>
    </ul>
  </div>
