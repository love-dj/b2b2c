...
<div id="member_center_box" class="wtm-index-container">
  <div class="user-account">
    ...
    <dl class="account04">
      <a href="<?php echo urlMember('member_coupon');?>">
      <dt>平台优惠券</dt>
      <dd class="icon"></dd>
      <dd class="value"><em><?php echo $output['member_info']['coupon_count']?$output['member_info']['coupon_count']:0;?></em>个</dd>
      </a>
    </dl>
    <dl class="account05">
  ...
  <table class="wtm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="w150 tl">&yen; <?php echo wtPriceFormat($val['consume_amount'])?></td>
