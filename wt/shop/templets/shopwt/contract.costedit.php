...
$(function(){
    ...
    $('#cost_form').validate({
        ...
        messages : {
            operatetype :{
                required : '<i class="fa fa-exclamation-bbs"></i>请选择增减类型'
            },
            price :{
                required : '<i class="fa fa-exclamation-bbs"></i>金额不能为空且为大于0数字',
                number : '<i class="fa fa-exclamation-bbs"></i>金额不能为空且为大于0数字',
                min : '<i class="fa fa-exclamation-bbs"></i>金额不能为空且为大于0数字'
            },
            clog_desc : {
                required : '<i class="fa fa-exclamation-bbs"></i>原因描述必填且小于200个字符',
                rangelength:'<i class="fa fa-exclamation-bbs"></i>原因描述必填且小于200个字符'
            }
        }
    });
