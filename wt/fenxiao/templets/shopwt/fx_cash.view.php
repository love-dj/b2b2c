<?php defined('ShopWT') or exit('Access Denied By ShopWT');?>
  <div class="wtap-form-default">
    ...
    <div class="bot" id="submit-holder"> <a class="wtap-btn-big wtap-btn-green" href="javascript:if (confirm('付款后不能取消，确认要付款吗？')){window.location.href='index.php?w=fx_cash&t=cash_pay&id=<?php echo $output['info']['tradc_id']; ?>';}else{}">付款</a></div>
  <?php } ?>
  </div>