...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=show&t=ap_manage" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['show_index_manage'];?> - <?php echo $lang['ap_change'];?> “<?php echo $output['ap_list'][0]['ap_name'];?>”</h3>
  ...
  <form id="link_form" enctype="multipart/form-data" method="post" name="form1">
    ...
    <div class="wtap-form-default">
				 	...
				 	case '0':
				        if($v['ap_display'] == '1'){
				 		...
				 		echo "<dl class='row'>
								...
								<dd class='opt'>
									<ul class='nofloat'>
										<li><input type='radio' name='ap_display' id='ap_display_1' value='1' ".$display_state1."><label for='ap_display_1'>".$lang['ap_allow_mul_show']."</label></li>
										<li><input type='radio' name='ap_display' id='ap_display_2' value='2' ".$display_state2."><label for='ap_display_2'>".$lang['ap_allow_one_show']."</label></li>
									</ul>
									<p class='notic'></p>
								</dd>
						</dl>";
				 		echo "<dl class='row' id='show_pic'>
								<dt class='tit'>
									<label>".$lang['ap_default_pic_upload']."</label>
								</dt>
								<dd class='opt'>
								<div class='input-file-show'><span class='show'> <a class='nyroModal' rel='gal' href='".UPLOAD_SITE_URL."/".ATTACH_SHOW."/".$v['default_content']."'> <i class='fa fa-picture-o' onMouseOver=\"toolTip('<img src=".UPLOAD_SITE_URL."/".ATTACH_SHOW."/".$v['default_content'].">')\" onMouseOut='toolTip()'></i></a></span><span class='type-file-box'>
            <input type='file' class='type-file-file' id='change_default_pic' name='default_pic' size='30' hidefocus='true'  wt_type='change_default_pic' title='点击前方预览图可查看大图，点击按钮选择文件并提交表单后上传生效'>
            </span></div>
          <span class='err'></span>
          <p class='notic'>".$lang['ap_show_defaultpic_when_nothing'].",".$lang['show_edit_support']."gif,jpg,jpeg,png</p>
								</dd>
							</dl>";
				 		break;
				 		case '1':
				        if($v['ap_display'] == '1'){
				 		...
				 		echo "<dl class='row'>
								...
								<dd class='opt'>
									...
									<span class='err'></span>
									<p class='notic'>".$lang['show_byte']."</p>
								</dd>
							</dl> ";
				 		echo "<dl class='row'>
								<dt class='tit'>
								...
								<dd class='opt'>
									<ul class='nofloat'>
										<li><input type='radio' name='ap_display' value='1' id='ap_display_1' ".$display_state1."><label for='ap_display_1'>".$lang['ap_allow_mul_show']."</label></li>
										<li><input type='radio' name='ap_display' id='ap_display_2' value='2' ".$display_state2."><label for='ap_display_2'>".$lang['ap_allow_one_show']."</label></li>
									</ul>
								</dd>
							</dl> ";
				 		...
				 		echo "<dl class='row'>
								...
								<dd class='opt'>
									<ul class='nofloat'>
										<li><input type='radio' id='ap_display_1' name='ap_display' value='1' ".$display_state1."><label for='ap_display_1'>".$lang['ap_allow_mul_show']."</label></li>
										<li><input type='radio' id='ap_display_2' name='ap_display' value='2' ".$display_state2."><label for='ap_display_2'>".$lang['ap_allow_one_show']."</label></li></ul>						
									<p class='notic'></p>
								</dd>
							</dl> ";
				 		echo "<dl id='show_pic' >
      ...
      <?php }?>
      <div class="bot"><a href="JavaScript:void(0);" class="wtap-btn-big wtap-btn-green" id="submitBtn" onclick="document.form1.submit()"><?php echo $lang['show_change'];?></a></div>
    </div>
  </form>
</div>
