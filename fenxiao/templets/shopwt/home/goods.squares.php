<link href="<?php echo FENXIAO_STATIC_SITE_URL;?>/font/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <?php foreach($output['goods_list'] as $value){?>
    	<li>
            ...
            <div class="d_list_goods_name">
                ...
                <div><span class="fl"><b><?php echo wtPriceFormatForList($value['goods_price']);?></b></span><span class="fr d_index_gray9">销量：<i class="d_index_gray6"><?php echo $value['sale_count'];?></i></span></div>
                <div><span class="fl d_index_orange">佣金比例：<b><?php echo $value['fx_commis_rate'];?>%</b></span><span class="fr d_index_gray9">佣金：<i class="d_index_gray6"><?php echo wtPriceFormatForList($value['goods_price']*$value['fx_commis_rate']*1.0/100);?></i></span></div>
            </div>
            </a>
            <div class="d_list_shop_name">
            	<a href="index.php?w=store&store_id=<?php echo $value['store_id'];?>"><img src="<?php echo FENXIAO_TEMPLATES_URL;?>/images/fx-store.png" class="fl" alt="<?php echo $value['store_name'];?>"/><span class="fl"><?php echo $value['store_name'];?></span></a>
            </div>
...
<div class="cd-popup1 cd-popup-box">
	<div class="cd-popup-container1">
        ...
        <div class="share">
            <div class="sharebord">
                <div class="item">
                    <input type="text" id="link1" readonly="readonly"><button class="clip_button">复制链接</button>
                </div>
            </div>
        </div>
        <div class="clear"></div>
...
<div class="cd-popup2 cd-popup-box">
   <div class="cd-popup-container2">
       ...
       <div id="fx_info2"></div>
        ...
        <h4 class="fl w-45">打开手机浏览器或微信扫描二维码后可将商品分享至微信好友及朋友圈</h4>
        </div>
        <a href="#0" class="cd-popup-close"><i class="icon-close" aria-hidden="true"></i>&nbsp;关闭</a>
    </div>
</div>
