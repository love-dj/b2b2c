  ...
  <form id="membertag_form" method="post" enctype="multipart/form-data">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="mtag_recommend1" class="cb-enable"><?php echo $lang['wt_yes'];?></label>
            <label for="mtag_recommend0" class="cb-disable selected"><?php echo $lang['wt_no'];?></label>
	...
	$('#membertag_form').validate({
        ...
        messages : {
        	membertag_name : {
                ...
                maxlength: '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['sns_member_tag_maxlength_error'];?>'
            },
            membertag_sort : {
