...
<div class="page">
  ...
  <br/>
  <form id="add_form" method="post" action="index.php?w=inform&t=inform_subject_save">
...
$(document).ready(function(){
	...
	$("#add_form").validate({
        ...
        messages : {
      		inform_subject_content: {
       			required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['inform_subject_add_null'];?>',
       			maxlength: '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['inform_subject_add_null'];?>'
	    	}
        }
	});
});
