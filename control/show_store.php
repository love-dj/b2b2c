...
class show_storeControl extends BaseStoreControl {
    ...
    public function indexWt(){
        if(!$this->store_decoration_only) {
            ...
            $fieldstr = "goods_id,goods_commonid,goods_name,goods_jingle,store_id,store_name,goods_price,goods_sale_price,goods_marketprice,goods_storage,goods_image,goods_freight,goods_salenum,color_id,evaluation_good_star,evaluation_count,goods_sale_type";
            //得到最新12个商品列表
    ...
    public function show_articleWt() {
        //判断是否为导航页面
     ...
     * ajax获取动态数量
     */
    function ajax_store_trend_countWt(){
     ...
     * ajax 店铺流量统计入库
     */
    public function ajax_flowstat_recordWt(){
        ...
        if ($_GET['w_param'] == 'goods' && $_GET['t_param'] == 'index'){//统计商品页面流量
        ...
        if ($_GET['w_param'] == 'goods' && $_GET['t_param'] == 'index'){//已经存在数据则更新
            if ($goods_exist){
    ...
    private function _getGoodsList($condition, $order = 'goods_id desc') {
        ...
        $fieldstr = "goods_id,goods_commonid,goods_name,goods_jingle,store_id,store_name,goods_price,goods_costprice,goods_sale_price,goods_marketprice,goods_storage,goods_image,goods_freight,goods_salenum,color_id,evaluation_good_star,evaluation_count,goods_sale_type,is_independent_bonus,level_commission";
        //得到最新12个商品列表
        $count = $model_goods->getGoodsOnlineCount($condition,"distinct goods_commonid");
