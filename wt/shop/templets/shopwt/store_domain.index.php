  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        <li><a href="index.php?w=domain&t=store_domain_setting"><?php echo $lang['wt_config'];?></a></li>
        <li><a href="JavaScript:void(0);" class="current"><?php echo $lang['wt_domain_shop'];?></a></li>
      </ul>
    </div>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?w=domain&t=get_xml',
        colModel : [
