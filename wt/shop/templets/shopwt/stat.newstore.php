...
<div class="page">
  ...
  <table class="flex-table">
    ...
    <tbody id="datatable">
      ...
      <tr>
        ...
        <td class="handle-s"><a href="index.php?w=stat_store&t=showstore&type=newbyday&c=<?php echo $v['seartime'];?>&scid=<?php echo $_REQUEST['search_sclass'];?>" class="btn green"><i class="fa fa-list-alt"></i>查看</a></td>
  ...
  <div class="wtap-search-bar">
    ...
    <input type="hidden" name="t" value="newstore" />
