...
<div class="wtd-login-title">
  <h1>物流自提点</h1>
  <h4>欢迎使用物流自提服务点，快捷又方便</h4>
</div>
<div class="wtd-login-form">
  <form id="delivery_login" method="post" action="<?php echo DELIVERY_SITE_URL;?>/index.php?w=login">
  ...
  <a href="index.php?w=joinin" class="register">加盟自提点</a> </div>
