...
<div class="wtm-flow-box">
  <div id="wtmInformFlow" class="wtm-flow-container">
    ...
    <div class="wtm-default-form">
      ...
      <dl>
        <dt>回复内容<?php echo $lang['wt_colon'];?></dt>
        <dd>
          <?php echo $output['consult_info']['mc_reply'];?>
        </dd>
      </dl>
      <?php }?>
      <div class="bottom"><a href="javascript:history.go(-1);" class="wtbtn ml10">返回列表</a></div>
    </div>
  </div>
