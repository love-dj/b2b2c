        ...
        <dd class="opt sale-box">
          ...
          <dl sale_id="<?php echo $key;?>">
            <dt class="title">
              ...
              <a href="JavaScript:del_sale_list(<?php echo $key;?>);" class="wtap-btn-mini del"><i class="fa fa-trash"></i>删除</a><a href="JavaScript:show_sale_dialog(<?php echo $key;?>);" class="wtap-btn-mini edit"><i class="fa fa-pencil-square-o"></i><?php echo $lang['wt_edit'];?></a> </dt>
            <dd>
              <ul>
          ...
          <div class="add-sale"><a class="wtap-btn" href="JavaScript:add_sale_list();"><?php echo $lang['page_config_add_recommend'];?></a><?php echo $lang['page_config_sale_max'];?></div>
        </dd>
      </dl>
      <div class="bot"><a href="index.php?w=page_config&t=html_update&web_id=<?php echo $output['code_sale_list']['web_id'];?>" class="wtap-btn-big wtap-btn-green"><?php echo $lang['page_config_web_html'];?></a></div>
    </div>
  </form>
</div>
...
<div id="sale_list_dialog" style="display:none;">
  <div class="s-tips"><i></i><?php echo $lang['page_config_goods_list_tips'];?></div>
  <?php if (is_array($output['code_sale_list']['code_info']) && !empty($output['code_sale_list']['code_info'])) { ?>
  <?php foreach ($output['code_sale_list']['code_info'] as $key => $val) { ?>
  <div class="wtap-form-default" select_sale_id="<?php echo $key;?>">
    <dl class="row">
  ...
  <div class="wtap-form-all" select_sale_id="<?php echo $key;?>">
    <dl class="row">
        ...
        <div class="search-bar" id="gcategory">
          <label>排序
            <select name="goods_order" id="goods_order">
              <option value="goods_salenum" selected><?php echo $lang['page_config_goods_order_sale'];?></option>
              <option value="goods_click" ><?php echo $lang['page_config_goods_order_click'];?></option>
              <option value="evaluation_count" ><?php echo $lang['page_config_goods_order_comment'];?></option>
              <option value="goods_collect" ><?php echo $lang['page_config_goods_order_collect'];?></option>
            </select>
          </label>
          分类
          ...
          <a href="JavaScript:void(0);" onclick="get_goods_list();" class="wtap-btn"><?php echo $lang['wt_query'];?></a></div>
      </dd>
    </dl>
    <div id="show_sale_goods_list"></div>
  </div>
  <div class="bot"><a href="JavaScript:void(0);" onclick="update_sale();" class="wtap-btn-big wtap-btn-green"><span><?php echo $lang['page_config_save'];?></span></a></div>
</div>
