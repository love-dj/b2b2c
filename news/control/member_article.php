...
class member_articleControl extends NEWSMemberControl{
    ...
    private function get_article_list($condition = array()) {
        ...
        Tpl::showpage('member_article_list', 'news_member_layout');
    }
     ...
     * 移到回收站
     */
    public function article_publishWt() {
     ...
     * 移到回收站
     */
    public function article_recycleWt() {
     ...
     * 移到草稿箱
     */
    public function article_draftWt() {
     ...
     * 删除
     */
    public function article_dropWt() {
        $article_id = intval($_GET['article_id']);
