  ...
  <div class="wtap-order-flow">
    <ol class="num5">
      <li  id="state_new" class="">
        ...
        <i class="fa fa-arrow-bbs-right"></i> </li>
...
$(document).ready(function(){
  ...
  <div class="wtap-order-details">
    ...
    <div class="tabs-panels">
      <div class="misc-info">
        <dl>
          <dt><?php echo $lang['order_shop_name'];?><?php echo $lang['wt_colon'];?></dt>
          ...
          <dt><?php echo $lang['order_state'];?><?php echo $lang['wt_colon'];?></dt>
          <dd><?php echo $output['order_info']['order_state_text'];?></dd>
          <dt>订单号<?php echo $lang['wt_colon'];?></dt>
          <dd><a href="index.php?w=order&t=show_order&order_id=<?php echo $output['order_info']['order_id'];?>"> <?php echo $output['order_info']['order_sn'];?></a></dd>
          <dt><?php echo $lang['order_datetime'];?><?php echo $lang['wt_colon'];?></dt>
          <dd><?php echo date('Y-m-d H:i:s',$output['order_info']['add_time']);?>
          <dt><?php echo $lang['order_price'];?><?php echo $lang['wt_colon'];?></dt>
          ...
          <dt><?php echo $lang['order_voucher_price'];?><?php echo $lang['wt_colon'];?></dt>
          <dd><?php echo $lang['currency'].$output['order_info']['voucher_price'].'.00';?>
          <dt><?php echo $lang['order_voucher_sn'];?><?php echo $lang['wt_colon'];?></dt>
  ...
  <div class="wtap-form-default">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_state'];?><?php echo $lang['wt_colon'];?></dt>
      <dd class="opt"><?php echo $output['complain_info']['complain_state_text'];?></dd>
    </dl>
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_subject_content'];?><?php echo $lang['wt_colon'];?></dt>
      <dd class="opt"><?php echo $output['complain_info']['complain_subject_content'];?></dd>
    </dl>
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_accuser'];?><?php echo $lang['wt_colon'];?></dt>
      <dd class="opt"><?php echo $output['complain_info']['accuser_name'];?></dd>
    </dl>
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_evidence'];?><?php echo $lang['wt_colon'];?></dt>
      <dd class="opt">
        <?php
                        if(empty($output['complain_info']['complain_pic1'])&&empty($output['complain_info']['complain_pic2'])&&empty($output['complain_info']['complain_pic3'])) {
                            ...
                            $pic_link = 'index.php?w=show_pics&type=complain&pics=';
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_datetime'];?><?php echo $lang['wt_colon'];?></dt>
  ...
  <div class="wtap-form-default">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_accused'];?><?php echo $lang['wt_colon'];?></dt>
      <dd class="opt"><?php echo $output['complain_info']['accused_name'];?></dd>
    </dl>
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_appeal_evidence'];?><?php echo $lang['wt_colon'];?></dt>
      <dd class="opt">
      <?php
    ...
    <dl class="row">
      <dt class="tit"> <?php echo $lang['complain_appeal_datetime'];?><?php echo $lang['wt_colon'];?></dt>
      <dd class="opt"><?php echo date('Y-m-d H:i:s',$output['complain_info']['appeal_datetime']);?></dd>
    </dl>
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_appeal_content'];?><?php echo $lang['wt_colon'];?></dt>
  ...
  <div class="wtap-form-default">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['talk_list'];?><?php echo $lang['wt_colon'];?></dt>
      <dd class="opt">
    ...
    <dl cass="row">
      <dt class="tit"><?php echo $lang['talk_send'];?><?php echo $lang['wt_colon'];?></dt>
      <dd class="opt">
        <textarea id="complain_talk" class="tarea"></textarea>
        <div>
        <a href="JavaScript:void(0);" id="btn_refresh" class="wtap-btn"><?php echo $lang['talk_refresh'];?></a><a href="JavaScript:void(0);" id="btn_publish" class="wtap-btn"><?php echo $lang['talk_send'];?></a>
        </div>
        </dd>
    </dl>
    <?php } ?>
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?w=complain&t=get_complain_talk',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'index.php?w=complain&t=publish_complain_talk',
                cache:false,
...
function forbit_talk(talk_id) {
        $.ajax({
            type:'POST',
                url:'index.php?w=complain&t=forbit_talk',
                cache:false,
  ...
  <div class="wtap-form-default">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['final_handle_message'];?><?php echo $lang['wt_colon'];?></dt>
      <dd class="opt"><?php echo $output['complain_info']['final_handle_message'];?></dd>
    </dl>
    <dl>
      <dt class="tit"><?php echo $lang['final_handle_datetime'];?><?php echo $lang['wt_colon'];?></dt>
      <dd class="opt"><?php echo date('Y-m-d H:i:s',$output['complain_info']['final_handle_datetime']);?></dd>
    </dl>
    <div class="bot"><a href="JavaScript:void(0);" class="wtap-btn-big wtap-btn-green" onclick="history.go(-1)"><?php echo $lang['wt_back'];?></a></div>
  </div>
  <?php } ?>
  <?php if(intval($output['complain_info']['complain_state']) !== 99) { ?>
  <div class="wtap-form-default">
    ...
    <dl class="row" id="close_complain">
      ...
      <form method='post' id="verify_form" action="index.php?w=complain&t=complain_verify">
          ...
          <a id="verify_button" class="wtap-btn-big wtap-btn-green" href="javascript:void(0)"><span><?php echo $lang['complain_text_verify'];?></span></a>
          <?php } ?>
          <?php if(intval($output['complain_info']['complain_state']) !== 99) { ?>
          <a id="close_button" class="wtap-btn-big wtap-btn-green" href="javascript:void(0)"><span><?php echo $lang['complain_text_close'];?></span></a>
          <?php } ?>
          <a href="JavaScript:void(0);" class="wtap-btn-big wtap-btn-green" onclick="history.go(-1)"><span><?php echo $lang['wt_back'];?></span></a>
        </form></div></dd>
    </dl>
    <form method='post' id="close_form" action="index.php?w=complain&t=complain_close">
      ...
      <dd class="opt">
        ...
        <div class="bot complain_dialog"><a id="btn_handle_submit" class="wtap-btn-big wtap-btn-green" href="javascript:void(0)"><?php echo $lang['wt_submit'];?></a> <a id="btn_close_cancel" class="wtap-btn-big wtap-btn-green" href="javascript:void(0)"><?php echo $lang['wt_cancel'];?></a></div>
    </form>
  </div>
  <?php } ?>
</div>
