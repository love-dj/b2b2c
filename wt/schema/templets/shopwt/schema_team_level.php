...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <div class="subject">
                <h3><?php echo $lang['nc_schema_team_level'];?></h3>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(function(){
        $("#flexigrid").flexigrid({
            url: 'index.php?act=schema_team_level&op=get_xml',
            colModel : [
                ...
                {display: '等级名称', name : 'level_name', width : 200, sortable : true, align: 'center'},
                {display: '奖金比例', name : 'layer_one', width : 300, sortable : true, align: 'center'},
    ...
    function fg_operation(name, bDiv) {
        if (name == 'add') {
            window.location.href = 'index.php?act=schema_team_level&op=add_level';
        } else if (name == 'del') {
    ...
    function fg_delete(id) {
        ...
        location.href = 'index.php?act=schema_team_level&op=del_level&del_id='+id;
    }
</script>