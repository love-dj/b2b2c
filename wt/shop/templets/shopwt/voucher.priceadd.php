...
<div class="page">
  ...
  <form id="add_form" method="post" action="index.php?w=voucher&t=<?php echo $output['menu_key']; ?>">
...
$(function(){
	...
	$("#add_form").validate({
        ...
        messages : {
      		voucher_price_describe: {
       			required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_voucher_price_describe_error'];?>',
       			maxlength: '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_voucher_price_describe_lengtherror'];?>'
	    	},
	    	voucher_price: {
                required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_voucher_price_error'];?>',
                digits : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_voucher_price_error'];?>',
                min : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_voucher_price_error'];?>'
		    },
		    voucher_points: {
		    	digits : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_voucher_price_points_error'];?>'
            }
        }
	});
});
