...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=goods_class&t=goods_class" title="返回商品分类列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['goods_class_index_class'];?> - <?php echo $lang['wt_new'];?></h3>
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <p class="notic"><?php echo $lang['goods_class_add_type_desc_one'];?><a onclick="window.parent.openItem('shop|type')" href="JavaScript:void(0);" class="wtap-btn mr5 ml5"><?php echo $lang['wt_type_manage'];?></a><?php echo $lang['goods_class_add_type_desc_two'];?></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <label>
            ...
            <input type="checkbox" class="checkbox" name="is_show" id="is_show" value="1" >
