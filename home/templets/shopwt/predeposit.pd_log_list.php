...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a class="wtbtn wtbtn-bittersweet" title="在线充值" href="index.php?w=predeposit&t=recharge_add" style="right: 207px;"><i class="icon-shield"></i>在线充值</a> 
    ...
    <a class="wtbtn wtbtn-bluejeansjeans" href="index.php?w=predeposit&t=rechargecard_add"><i class="icon-shield"></i>充值卡充值</a> 
  </div>
  <div class="alert">
    <span class="mr30">
      <?php echo $lang['predeposit_pricetype_available'].$lang['wt_colon']; ?>
      <strong class="mr5 red" style="font-size: 18px;">
        <?php echo $output['member_info']['available_predeposit']; ?>
      </strong>
      <?php echo $lang['currency_zh'];?>
    </span>
    <span>
      <?php echo $lang['predeposit_pricetype_freeze'].$lang['wt_colon']; ?>
      <strong class="mr5 blue" style="font-size: 18px;">
        <?php echo $output['member_info']['freeze_predeposit']; ?>
      </strong>
      <?php echo $lang['currency_zh'];?>
    </span>
  </div>
