...
<div class="wtsc-form-default" wttype="normal" style=" display: none;">
  <form method="post" action="index.php?w=store_sns&t=store_sns_save" id="normal_form">
    <input type="hidden" name="type" value="2" />
    <dl>
      <dt><?php echo $lang['store_sns_image'].$lang['wt_colon'];?></dt>
      <dd>
        <div class="wtsc-upload-thumb store-sns-pic">
          <p><img wttype="normal_img" src="<?php echo SHOP_TEMPLATES_URL?>/images/member/default_image.png"/></p>
        ...
        <div class="handle">
          <div class="wtsc-upload-btn"> <a href="javascript:void(0);"><span>
            ...
            <a class="wtbtn mt5" wttype="get_img" href="index.php?w=store_album&t=pic_list&item=store_sns_normal"><i class="icon-picture"></i>从图片空间选择</a> <a href="javascript:void(0);" wttype="del_img" class="wtbtn ml5 mt5" style="display: none;"><i class="icon-bbs-arrow-up"></i>关闭相册</a></div>
...
<div class="wtsc-form-default" wttype="recommend" style="display: none;">
  ...
  <form method="post" action="index.php?w=store_sns&t=store_sns_save" id="recommend_form">
...
<div class="wtsc-form-default" wttype="hotsell" style="display: none;" >
  <form method="post" action="index.php?w=store_sns&t=store_sns_save" id="hotsell_form">
...
<div class="wtsc-form-default" wttype="new" style="display: none;" >
  <form method="post" action="index.php?w=store_sns&t=store_sns_save" id="new_form">
...
$(function(){
	...
	$('#normal_file').unbind().live('change', function(){
		$('img[wttype="normal_img"]').attr('src',SHOP_TEMPLATES_URL+"/images/loading.gif");

		$.ajaxFileUpload
		(
			{
				url:'index.php?w=store_sns&t=image_upload',
				secureuri:false,
