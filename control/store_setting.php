...
class store_settingControl extends BaseSellerControl {
     ...
     * @return
     */
    public function store_settingWt(){
        /**
         * 实例化模型
         */
        ...
        if (chksubmit()){
			...
			$PhpQRCode->set('date',WAP_SITE_URL . '/html/store.html?store_id='.$store_id);
            		$PhpQRCode->set('pngTempName', $store_id . '_store.png');
            		$PhpQRCode->init();

            $model_class->editStore($param, array('store_id' => $store_id));
            showDialog(Language::get('wt_common_save_succ'),'index.php?w=store_setting&t=store_setting','succ');
        }
        /**
         * 实例化店铺等级模型
         */
    ...
    public function store_slideWt() {
        ...
        if ($_POST['form_submit'] == 'ok'){
            ...
            showDialog(Language::get('wt_common_save_succ'),'index.php?w=store_setting&t=store_slide','succ');
        }
     ...
     * 店铺幻灯片ajax上传
     */
    public function silde_image_uploadWt(){
        $upload = new UploadFile();
    ...
    public function dorp_imgWt(){
        ...
        echo json_encode(array('succeed'=>Language::get('wt_common_save_succ','UTF-8')));die;
    }
    ...
    public function store_mobileWt()
    {
        ...
        if (chksubmit()) {
            ...
            showDialog('保存成功', 'index.php?w=store_setting&t=store_mobile', 'succ');
        }
    ...
    private function profile_menu($menu_key='') {
        ...
        $menu_array = array(
            1=>array('menu_key'=>'store_setting','menu_name'=>Language::get('wt_member_path_store_config'),'menu_url'=>'index.php?w=store_setting&t=store_setting'),
            4=>array('menu_key'=>'store_slide','menu_name'=>Language::get('wt_member_path_store_slide'),'menu_url'=>'index.php?w=store_setting&t=store_slide'),
            5=>array('menu_key'=>'store_theme','menu_name'=>'店铺主题','menu_url'=>'index.php?w=store_setting&t=theme'),

            7 => array(
                'menu_key' => 'store_mobile',
                'menu_name' => '手机店铺设置',
                'menu_url' => 'index.php?w=store_setting&t=store_mobile',
            ),
        );
