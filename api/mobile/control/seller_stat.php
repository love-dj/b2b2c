...
class seller_statControl extends mobileSellerControl {
    ...
    public function ordersamountWt() {
        $this->ordersstat('ordersamount');
    }
    public function ordersnumWt() {
     ...
     * 客单价统计
     */
    public function perguestpriceWt(){
        $model_stat = Model('stat');
        $where = array();
        $where['store_id'] = $this->store_info['store_id'];
        $where['order_isvalid'] = 1;//计入统计的有效订单
    ...
    public function goodsamountWt() {
        $this->goodssales('goodsamount');
    }
    public function goodsnumWt() {
    ...
    public function areasalesamountWt() {
        $this->areasales('ordersamount');
    }
    public function areasalesnumWt() {
        $this->areasales('ordersnum');
    }
    public function areamembernumWt() {
