...
<div class="wrap">
  ...
  <div class="wtm-bind">
    ...
    <div class="relieve">
      <form method="post" id="editbind_form" name="editbind_form" action="index.php?w=member_bind&t=weixinunbind">
    ...
    <div class="revise wtm-default-form ">
      <form method="post" id="editpw_form" name="editpw_form" action="index.php?w=member_bind&t=weixinunbind">
        <input type='hidden' id="is_editpw" name="is_editpw" value='yes'/>
        <dl>
          <dt>新密码<?php echo $lang['wt_colon']; ?></dt>
          <dd>
        ...
        <dl>
          <dt>确认密码<?php echo $lang['wt_colon']; ?></dt>
          <dd>
