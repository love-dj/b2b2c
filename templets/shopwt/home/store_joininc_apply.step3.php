...
<div id="apply_store_info" class="apply-store-info">
  ...
  <form id="form_store_info" action="index.php?w=store_joininc&t=step4" method="post" >
...
$(document).ready(function(){
    ...
    $('#btn_add_category').on('click', function() {
        ...
        if(validation) {
            ...
            tr_category += '<td><a wttype="btn_drop_category" href="javascript:;">删除</a></td>';
    ...
    $('#table_category').on('click', '[wttype="btn_drop_category"]', function() {
