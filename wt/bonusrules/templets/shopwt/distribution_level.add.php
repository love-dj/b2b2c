	...
	<form id="level_form" action="" name="form1" enctype="multipart/form-data" method="post">
		...
		<div class="wtap-form-default">			
			...
			<dl class="row">
				...
				<dd class="opt">
					<input type="text" value="" name="layer_one" id="layer_one" class="s-input-txt"> %
					<span class="err"></span>
					<p class="notic"></p>
				</dd>
			</dl>
			<dl class="row">
				...
				<dd class="opt">
					<input type="text" value="" name="layer_two" id="layer_two" class="s-input-txt"> %
					<span class="err"></span>
					<p class="notic"></p>
				</dd>
			</dl>
			<dl class="row">
				...
				<dd class="opt">
					<input type="text" value="" name="layer_three" id="layer_three" class="s-input-txt"> %
					<span class="err"></span>
					<p class="notic"></p>
				</dd>
			</dl>
			<dl class="row">
				...
				<dd class="opt">
					<input type="text" value="" name="level_people" id="level_people" class="s-input-txt">
					<span class="err"></span>
					<p class="notic"></p>
				</dd>
			</dl>
			...
			<dl class="row">
				...
				<dd class="opt">
					<div class="col-xs-12 col-sm-9 col-md-10">
						...
						<div class="input-group row" style="margin-bottom:5px;">
							<label class="radio-inline col-xs-12 col-sm-6">
								<input type="checkbox" name="upgrade_type[]" value="order_money">
								团队分销订单金额满&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
