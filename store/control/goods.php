...
class goodsControl extends BaseChainCenterControl{
    ...
    public function set_stockWt() {
        ...
        $goods_content = $model_goods->getGeneralGoodsOnlineList(array('goods_commonid' => $common_id), 'goods_id,goods_spec,goods_serial,goods_price');
