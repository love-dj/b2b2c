...
<div class="wrap">
  <form id="voucher_list_form" method="get">
    <table class="wtm-search-table">
      <input type="hidden" id='w' name='w' value='fx_order' />
  ...
  <table class="wtm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="goods-price">
          <?php echo wtPriceFormatForList($val['goods_pay_price']);?>
        </td>
        <td class="goods-name">
        ...
        <td class="goods-price"><?php echo wtPriceFormatForList($val['goods_pay_price']*$val['fx_commis_rate']*0.01);?></td>
