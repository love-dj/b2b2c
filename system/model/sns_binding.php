...
class sns_bindingModel extends Model{
    ...
    public function getApps(){
        $app_arr = array();
        $app_arr['qqweibo'] = array('name'=>Language::get('wt_shareset_qqweibo'),'url'=>"http://t.qq.com",'applyurl'=>'http://dev.t.qq.com');
        $app_arr['sinaweibo'] = array('name'=>Language::get('wt_shareset_sinaweibo'),'url'=>"http://www.weibo.com",'applyurl'=>'http://open.weibo.com/developers');
        return $app_arr;
    }
    /**
    ...
    public function addQQWeiboPic($bindinfo,$params){
        ...
        include_once(BASE_API_PATH.DS.'sns'.DS.'qqweibo'.DS.'tencent.php');
