  ...
  <div class="wtm-flow-container">
    ...
    <div id="saleRefund" show_id="1">
      ...
      <div class="wtm-default-form">
        <form id="post_form1" enctype="multipart/form-data" method="post" action="index.php?w=member_refund&t=add_refund&order_id=<?php echo $output['order']['order_id']; ?>&goods_id=<?php echo $output['goods']['rec_id']; ?>">
          ...
          <div class="bottom">
            ...
            <a href="javascript:history.go(-1);" class="wtbtn ml10">取消并返回</a> </div>
        </form>
      </div>
    </div>
    <div id="saleRefundReturn" show_id="2" style="display: none;">
      ...
      <div class=" wtm-default-form">
        <div id="warning"></div>
        <form id="post_form2" method="post" enctype="multipart/form-data" action="index.php?w=member_refund&t=add_refund&order_id=<?php echo $output['order']['order_id']; ?>&goods_id=<?php echo $output['goods']['rec_id']; ?>">
          <input type="hidden" name="form_submit" value="ok" />
          ...
          <dl>
            <dt><i class="required">*</i><?php echo $lang['refund_order_refund'].$lang['wt_colon'];?></dt>
            <dd>
          ...
          <dl>
            <dt><i class="required">*</i><?php echo $lang['return_order_return'].$lang['wt_colon'];?></dt>
            <dd>
