...
<script>
var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var SITEURL = '<?php echo BASE_SITE_URL;?>';var MEMBER_SITE_URL = '<?php echo MEMBER_SITE_URL;?>';var STATIC_SITE_URL = '<?php echo STATIC_SITE_URL;?>';var SHOP_TEMPLATES_URL = '<?php echo SHOP_TEMPLATES_URL;?>';var SHOP_TEMPLATES_URL = '<?php echo SHOP_TEMPLATES_URL;?>';</script>
  ...
  <div class="wrapper">
    ...
    <nav class="wtsc-nav">
      ...
      <dl class="<?php echo $output['current_menu']['model'] == $key?'current':'';?>">
        <dt><a href="<?php echo $key != 'fenxiao' ? '':FENXIAO_SITE_URL.'/';?>index.php?w=<?php echo $menu_value['child'][key($menu_value['child'])]['w'];?>&t=<?php echo $menu_value['child'][key($menu_value['child'])]['t'];?>"><?php echo $menu_value['name'];?></a></dt>
        <dd>
          <ul>
            <?php if(!empty($menu_value['child']) && is_array($menu_value['child'])) {?>
            <?php foreach($menu_value['child'] as $submenu_value) {?>
            <li> <a href="<?php echo $key != 'fenxiao' ? '':FENXIAO_SITE_URL.'/';?>index.php?w=<?php echo $submenu_value['w'];?>&t=<?php echo $submenu_value['t'];?>"> <?php echo $submenu_value['name'];?> </a> </li>
            <?php } ?>
            <?php } ?>
          </ul>
        </dd>
      ...
      <div class="column-menu">
        <ul id="seller_center_left_menu">
          ...
          <li <?php echo $_GET['w'] == 'seller_center'?"id='quicklink_".$submenu_value['w']."'":'';?>class="<?php echo $submenu_value['w'] == $_GET['w']?'current':'';?>"> 
            <a href="<?php echo strpos($submenu_value['w'],'store_fx_')===0 ? FENXIAO_SITE_URL.'/':'';?>index.php?w=<?php echo $submenu_value['w'];?>&t=<?php echo $submenu_value['t'];?>"> <?php echo $submenu_value['name'];?> </a> </li>
          <?php } ?>
          <?php } else { ?>
