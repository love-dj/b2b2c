...
function copyToClipBoard(id){
    ...
    {
        ajax_form('copy_rec', '<?php echo $lang['rec_ps_code'];?>', 'index.php?w=show&t=rec_code&rec_id='+id);
    }
}
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?w=show&t=get_xml',
        colModel : [
        ...
        title: '推广展位列表',
        onSuccess : function(){
        	$('a[wttype="jscode"]').click(function(){
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?w=show&t=rec_add';
    }else if (name == 'delete') { 
...
function fg_delete(id) {
	...
	$.ajax({
        type: "GET",
        dataType: "json",
        url: 'index.php?w=show&t=rec_del',
        data: "rec_id="+id,
