...
<?php if ($output['store_info']) { ?>
      <a class="back" href="index.php?w=sale_booth&t=booth_quota_list" title="返回套餐列表">
        <i class="fa fa-arrow-bbs-o-left"></i>
      </a>
      <div class="subject">
        <h3><?php echo $lang['wt_sale_booth']; ?> - 查看/管理店铺“<?php echo $output['store_info']['store_name']; ?>”参与活动的商品</h3>
...
<?php } else { ?>
      ...
      <ul class="tab-base wt-row">
        ...
        <li><a href="<?php echo urlAdminShop('sale_booth', 'booth_setting');?>"><?php echo $lang['wt_config'];?></a></li>
      </ul>
<?php } ?>
    </div>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?w=sale_booth&t=goods_list_xml&store_id=<?php echo $output['store_id']; ?>',
        colModel: [
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    var href = '<?php echo urlAdminShop('sale_booth', 'del_goods', array(
                        'goods_id' => '__IDS__',
