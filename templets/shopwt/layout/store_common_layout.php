  ...
  <header class="wt-head wrapper">
    ...
    <div class="search-m" id="search">
        <form class="search-form" method="get" action="<?php echo BASE_SITE_URL.'/';?>index.php" name="formSearch" id="formSearch">
          ...
          <a href="javascript:void(0)" class="search-btn-all" wttype="search_in_shop"><span>搜全站</span></a><a href="javascript:void(0)" class="search-btn-store" wttype="search_in_store"><span>搜店内</span></a>
        </form>
      </div>
