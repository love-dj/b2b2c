  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        ...
        <li><a href="index.php?w=store_joinin&t=help_list"><?php echo '入驻指南';?></a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="input-file-show">
            ...
            </span></div> <a href="JavaScript:void(0);" class="wtap-btn" onclick="clear_pic(<?php echo $i;?>)"><i class="fa fa-trash"></i>
删除</a>
          <p class="notic"></p>
        </dd>
      </dl>
