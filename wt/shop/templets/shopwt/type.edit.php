...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=type&t=type" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['wt_type_manage'];?> - <?php echo $lang['wt_edit'];?>“<?php echo $output['type_info']['type_name'];?>”</h3>
  ...
  <form id="type_form" method="post">
    ...
    <div class="wtap-form-default">
        ...
        <dd class="opt">
          ...
          <div id="spec_div" class="scrollbar-box">
            <div class="wtap-type-spec-list">
              <input type="hidden" value="" name="spec[form_submit]" wt_type="submit_value" />
              ...
              <dl>
                ...
                <dd>
                  ...
                  <label>
                    <input class="checkitem" wt_type="change_default_spec_value" type="checkbox" <?php if(in_array($v['sp_id'], $output['spec_related'])){ echo 'checked="checked"';}?> value="<?php echo $v['sp_id'];?>" name="spec_id[]">
        ...
        <dd class="opt">
          ...
          <div id="brand_div" class="scrollbar-box">
            <div class="wtap-type-spec-list">
              ...
              <input type="hidden" value="" name="brand[form_submit]" wt_type="submit_value" />
      ...
      <dl class="row">
        <dt class="tit"><?php echo $lang['type_add_attr_add'].$lang['wt_colon'];?></dt>
        <dd class="opt">
          <ul class="wtap-ajax-add" id="ul_attr">
            ...
            <li>
              <input type="hidden" value="" name="at_value[<?php echo $aval['attr_id'];?>][form_submit]" wt_type="submit_value" />
              <input type="hidden" value="<?php echo $aval['attr_id'];?>" name="at_value[<?php echo $aval['attr_id'];?>][a_id]" wt_type='ajax_attr_id' />
              <label>删
              ...
              <label><a href="javascript:void(0);" onclick="ajax_form('attr_deit', '编辑属性', '<?php echo urlAdminShop('type', 'attr_edit', array('attr_id' => $aval['attr_id']));?>', 640)" class="wtap-btn"><?php echo $lang['wt_edit'];?></a></label>
            </li>
            <?php }?>
            <?php }?>
            <a id="add_type" class="wtap-btn" href="JavaScript:void(0);"><i class="fa fa-plus"></i><?php echo $lang['type_add_attr_add_one'];?></a>
          </ul>
...
$(function(){
    ...
    $('input[wt_type="change_default_spec_value"]').click(function(){
        $(this).parents('div:first').find("input[wt_type='submit_value']").val('ok');
    });
