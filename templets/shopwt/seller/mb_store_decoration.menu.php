...
<div class="wtsc-form-default">
  <form method="post" action="index.php?w=mb_store_decoration&t=decoration_menu" enctype="multipart/form-data" id="my_store_form">
    <input type="hidden" name="form_submit" value="ok" />
    <dl>
      <dt>启用手机店铺底部菜单装修<?php echo $lang['wt_colon'];?></dt>
      <dd>
