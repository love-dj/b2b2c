  ...
  <div class="topbar wrapper">
    ...
    <div class="right-menu">
      <dl>
        ...
        <dd>
          <ul>
			 <li><a href="<?php echo urlFenxiao('search','index');?>">分销商品</a></li>
			 <li><a href="<?php echo urlFenxiao('store','index');?>">分销店铺</a></li>
			 <li><a href="<?php echo urlFenxiao('fx_goods','index');?>">我的分销</a></li>
			 <li><a href="<?php echo urlFenxiao('fx_order','index');?>">我的订单</a></li>
			 <li><a href="<?php echo urlFenxiao('fx_bill','index');?>">分销结算</a></li>
          </ul>
        </dd>
      </dl>
      <dl>
