...
class member_goodsbrowseControl extends mobileMemberControl {
    ...
    public function browse_listWt(){
        ...
        if ($goodsid_arr){
            $goods_list_tmp = Model('goods')->getGoodsList(array('goods_id' => array('in', $goodsid_arr)), 'goods_id, goods_name, goods_sale_price,goods_sale_type, goods_marketprice, goods_image, store_id, gc_id, gc_id_1, gc_id_2, gc_id_3');
            $goods_list = array();
