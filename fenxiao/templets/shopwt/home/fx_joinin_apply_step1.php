...
<div id="apply_company_info" class="apply-company-info">
  ...
  <form id="form_company_info" action="index.php?w=fx_join&t=step2" method="post">
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <?php if($output['member_info']['member_email_bind'] == 0){?>
              <a href="<?php echo urlMember('member_security','auth',array('type'=>'modify_email'));?>" target="_blank" class="go-to fl" title="邮箱验证"><i class="icon-envelope-o" aria-hidden="true"></i>&nbsp;去验证</a>
            <?php }?>  
        ...
        <tr>
          ...
          <td>
            ...
            <?php if($output['member_info']['member_mobile_bind'] == 0){?>
              <a href="<?php echo urlMember('member_security','auth',array('type'=>'modify_mobile'));?>" target="_blank" class="go-to fl" title="手机验证"><i class="icon-tablet" aria-hidden="true"></i>&nbsp;去验证</a>
            <?php }?>  
        ...
        <tr>
          <th>结算账户类型：</th>
           <td>
            <input type="radio" name="bill_type_code" value="bank" checked="checked"><img src="<?php echo FENXIAO_TEMPLATES_URL;?>/images/fx-upay.jpg" width="auto" height="24" alt=""/>&nbsp;银行支付
            &nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="bill_type_code" value="alipay"><img src="<?php echo FENXIAO_TEMPLATES_URL;?>/images/fx-alipay.jpg" width="auto" height="24" alt=""/>&nbsp;支付宝支付
          </td>
        </tr>
        <tr>
          <th><i>*</i>收款人：</th>
        ...
        <tr>
          ...
          <td><input  type="text" id="captcha" name="captcha" class="text w80" size="10"  />
            <span>
              <img src="index.php?w=vercode&t=makecode&type=30x92&wthash=<?php echo getwthash();?>" name="codeimage" id="codeimage"/> <a class="makecode" href="javascript:void(0)" onclick="javascript:document.getElementById('codeimage').src='index.php?w=vercode&t=makecode&type=30x92&wthash=<?php echo getwthash();?>&c=' + Math.random();">更换验证码</a>
            </span></td>
        </tr>
      </tbody>
    </table>
