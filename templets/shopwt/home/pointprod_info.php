...
<div class="wtp-container">
  <div class="wtp-detail">
    <div class="wtp-gift-picture"><a href="<?php echo $output['prodinfo']['pgoods_image_max']; ?>"><img src="<?php echo $output['prodinfo']['pgoods_image_max']; ?>"></a></div>
    <div class="wtp-share">
    ...
    <div class="wtp-gift-summary">
      ...
      <div class="wtp-meta">
        <dl>
          <dt>原&nbsp;&nbsp;价：</dt>
          <dd class="cost-price"><strong><?php echo $lang['currency'].wtPriceFormat($output['prodinfo']['pgoods_price']); ?></strong></dd>
        </dl>
        <dl>
          <dt>所需积分：</dt>
        ...
        <dl>
          <dt><?php echo $lang['pointprod_info_goods_limittime'].$lang['wt_colon']; ?></dt>
          <dd>
      ...
      <div class="wtp-key">
        <dl>
          <dt class="mt5"><?php echo $lang['pointprod_info_goods_exchangenum'].$lang['wt_colon']; ?></dt>
          <dd class="wtp-figure-input">
            <input name="exnum" type="text" class="text w30" id="exnum" value='1' size="4"/>
            <span>（<?php echo $lang['pointprod_info_goods_lastnum'].$lang['wt_colon']; ?><?php echo $output['prodinfo']['pgoods_storage']; ?>
      ...
      <div class="wts-btn">
        ...
        <a class="no-buynow"><i class="icon-shopping-cart"></i><?php echo $lang['pointprod_willbe']; ?></a>
        <?php }elseif ($output['prodinfo']['ex_state'] == 'end') {?>
        <a class="no-buynow"><i class="icon-shopping-cart"></i><?php echo $lang['pointprod_exchange_end']; ?></a>
        <?php }else{?>
        <a class="buynow" onclick="return add_to_cart();"><i class="icon-shopping-cart"></i><?php echo $lang['pointprod_exchange']; ?></a>
        <?php }?>
      </div>
    </div>
    <div style=" position: absolute; z-index: 1; top: -1px; right: -1px;">
      <div class="wtp-info">
        ...
        <div class="content">
          <dl>
            <dt><?php echo $lang['pointprod_info_goods_serial'].$lang['wt_colon']; ?></dt>
  ...
  <div class="wtp-goods-box">
    <div class="wtp-sidebar">
      <div class="wtp-sidebar-container">
    ...
    <div class="wtp-goods-main">
      <div class="tabbar">
        <div class="wtp-goods-title-nav">
          <ul id="categorymenu">
            <li class="current"> <a id="tabGoodsIntro" href="#content"><?php echo $lang['pointprod_info_goods_description']; ?></a> </li>
          </ul>
        </div>
      </div>
      <div class="wtp-goods-content-content"><?php echo $output['prodinfo']['pgoods_body']; ?></div>
    </div>
  </div>
</div>
 ...
 function copy_url()
 {
	 ...
	 if(window.clipboardData)
	    ...
	    else if (window.netscape)
	    {
	        ...
	        if (!trans){return;}
	        // specificeer wat voor soort data we t willen halen; text in dit geval
	        trans.addDataFlavor('text/unicode');
	        // om de data uit de transferable te halen hebben we 2 nieuwe objecten
	        // nodig om het in t te slaan
	        var str = new Object();
	        var len = new Object();
...
function add_to_cart()
{
	...
	if(checkresult == false){
		...
		$.getJSON('<?php echo BASE_SITE_URL; ?>/index.php?w=pointcart&t=add&pgid=<?php echo $output['prodinfo']['pgoods_id']; ?>&quantity='+quantity, function(result){
	        if(result.done){
	        	window.location.href = '<?php echo BASE_SITE_URL; ?>/index.php?w=pointcart';
	        } else {
		        if(result.url){
