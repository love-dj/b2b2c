  ...
  <table class="search-form">
    <tbody>
      <tr>
        ...
        <td class="tc w70"><a href="index.php?w=store_sale_cou&t=cou_sku&cou_id=<?php echo $output['cou_id']; ?>" wttype="search_a" class="wts-btn"><i class="icon-search"></i><?php echo $lang['wt_search'];?></a></td>
        <td class="w10"></td>
      </tr>
    </tbody>
  </table>
...
?>
      <li wttype="<?php echo $val['goods_id'];?>">
        ...
        <div data-cou-sku-switch-enabled="<?php echo $val['goods_id']; ?>">
          <a href="javascript:;" class="wtbtn-mini wtbtn-mint" onclick="cou_sku_add_callback('<?php echo $val['goods_id']; ?>');"><i class="icon-plus"></i>设置为活动商品</a>
        </div>
      </li>
      <?php }?>
    </ul>
