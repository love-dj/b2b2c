...
<div class="brandWrap clearfix"> <a class="brandDesc f-fl" href="<?php echo urlShop('brand', 'list', array('brand'=>$brand['brand_id']));?>" target="_blank" style="top: 0px;"> <img class="brandLogo" data-url="<?php echo brandImage($brand['brand_pic']);?>"  rel='lazy' src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" title="<?php echo $brand['brand_name'];?>" alt="<?php echo $brand['brand_name'];?>">
