...
<div class="breadcrumb"><span class="icon-home"></span><span><a href="<?php echo BASE_SITE_URL;?>">首页</a></span> <span class="arrow">></span> <span>分销员认证申请</span> </div>
<div class="main">
  <div class="sidebar">
    <div class="title">
      <h3>分销员认证申请</h3>
    ...
    <div class="content">
      ...
      <?php if(C('fenxiao_check') == 1 || $output['member_info']['fx_state'] == 1){?>
      <dl>
  ...
  <div class="right-box">
    ...
    <div class="joinin-concrete">
      <?php require('fx_joinin_apply_'.$output['sub_step'].'.php'); ?>
    </div>
  </div>
</div>
