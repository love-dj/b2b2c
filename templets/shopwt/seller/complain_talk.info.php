...
<?php } ?>
<form action="index.php?w=store_complain&t=apply_handle" method="post" id="handle_form">
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?w=store_complain&t=get_complain_talk',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'index.php?w=store_complain&t=publish_complain_talk',
                cache:false,
