...
<div class="tabmenu">
  ...
  <a href="<?php echo urlShop('store_order_vr', 'exchange');?>" class="wtbtn wtbtn-bittersweet"><i class="icon-edit"></i>兑换兑换码</a> </div>
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    <input type="hidden" name="w" value="store_order_vr" />
  ...
  <tbody>
    ...
    <tr>
      <th colspan="20"><span class="ml10"><?php echo $lang['store_order_order_sn'].$lang['wt_colon'];?><em><?php echo $order['order_sn']; ?></em>
        ...
        <?php }?>
        </span> <span><?php echo $lang['store_order_add_time'].$lang['wt_colon'];?><em class="goods-time"><?php echo date("Y-m-d H:i:s",$order['add_time']); ?></em></span> </th>
    </tr>
    <tr>
      <td class="bdl"></td>
      <td class="w70"><div class="wtsc-goods-thumb"><a href="<?php echo urlShop('goods','index',array('goods_id'=>$order['goods_id']));?>" target="_blank"><img src="<?php echo thumb($order,60);?>" onMouseOver="toolTip('<img src=<?php echo thumb($order,240);?>>')" onMouseOut="toolTip()"/></a></div></td>
      ...
      <td><p><?php echo wtPriceFormat($order['goods_price']); ?></p>
        <?php if ($order['order_sale_type'] == 1) { ?>
      ...
      <td class="bdl"><p class="wtsc-order-amount"><?php echo $order['order_amount']; ?></p>
