$(function(){
    ...
    /* 批量操作按钮 */
    $('a[wt_type="batchbutton"]').click(function(){
        /* 是否有选择 */
    ...
    $('span[wt_type="order_by"]').each(function(){
    ...
    $('span[wt_type="order_by"]').click(function(){
