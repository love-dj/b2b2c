...
class member_informationControl extends BaseMemberControl {
    ...
    public function memberWt() {
        ...
        if (chksubmit()){
            ...
            $message = $update? $lang['wt_common_save_succ'] : $lang['wt_common_save_fail'];
        ...
        Tpl::output('menu_sign_url','index.php?w=member_information&t=member');
    ...
    public function moreWt(){
        ...
        if(chksubmit()){
            ...
            showDialog(Language::get('wt_common_op_succ'),'','succ');
        }
...
public function uploadWt() {
		if (!chksubmit()){
			redirect('index.php?w=member_information&t=avatar');
		}
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'member':
                $menu_array = array(
                1=>array('menu_key'=>'member',  'menu_name'=>Language::get('home_member_base_infomation'),'menu_url'=>'index.php?w=member_information&t=member'),
                2=>array('menu_key'=>'more',    'menu_name'=>Language::get('home_member_more'),'menu_url'=>'index.php?w=member_information&t=more'),
                5=>array('menu_key'=>'avatar',  'menu_name'=>Language::get('home_member_modify_avatar'),'menu_url'=>'index.php?w=member_information&t=avatar'));
                break;
        }
