        ...
        <div id="searchCon" class="content">
          <div class="layout-box">
            <dl>
              <dt>抢购名称</dt>
              <dd>
                <input type="text" name="robbuy_name" class="s-input-txt" placeholder="请输入抢购名称关键字" />
              </dd>
            </dl>
            <dl>
              <dt>商品名称</dt>
            ...
            <dl>
              ...
              <dd>
                <select name="state" class="s-select">
                    <?php foreach ((array) $output['robbuy_state_array'] as $sk => $sv) { ?>
...
<script>
$(function(){
    var flexUrl = 'index.php?w=robbuy&t=robbuy_list_xml';
    ...
    $("#flexigrid").flexigrid({
        ...
        colModel: [
            ...
            {display: '抢购名称', name: 'robbuy_name', width: 400, sortable: false, align: 'left'},
            ...
            {display: '抢购图片', name: 'robbuy_image', width: 60, sortable: false, align: 'center'},
            ...
            {display: '抢购状态', name: 'robbuy_state_text', width: 80, sortable: false, align: 'center'}
        ],
        searchitems: [
            {display: '抢购名称', name: 'robbuy_name', isdefault: true},
