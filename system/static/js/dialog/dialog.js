...
DialogManager = {
    ...
    /* 加载对话框样式 */
    'loadStyle'     :function(){
        var _wt_dialog_path = $('#wt_dialog').attr('src');
        var _path    = _wt_dialog_path.split('/');
        var _dialog_css = _path.slice(0, _path.length - 1).join('/') + '/dialog.css';
        $('#wt_dialog').after('<link href="' + _dialog_css + '" rel="stylesheet" type="text/css" />');
    }
};
ScreenLocker = {
    'style'     : {
...
/*common2.2.js*/
DIALOGIMGDIR  = SITEURL+"/"+'static/js/dialog/images/dialog';
