...
<div class="eject_con">
  <div id="warning"></div>
  <form method="post" id="order_cancel_form" onsubmit="ajaxpost('order_cancel_form', '', '', 'onerror');return false;" action="index.php?w=store_order_vr&t=change_state&state_type=order_cancel&order_id=<?php echo $output['order_id']; ?>">
    ...
    <dl>
      <dt><?php echo $lang['store_order_cancel_reason'].$lang['wt_colon'];?></dt>
      <dd>
        <ul class="checked">
          <li>
