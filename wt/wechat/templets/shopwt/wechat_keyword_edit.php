...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title"><a class="back" href="index.php?w=keyword" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
			<div class="subject">
				<h3>
					<?php echo $lang['wt_wechat_keywords'];?> - 编辑
				</h3>
				<h5>设置关键词</h5>
			</div>
		</div>
  ...
  <input type="hidden" name="materialid" id="materialid" value="<?php echo $output['reply_info']['reply_materialid'];?>" />
	<div class="wtap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
         <input class="input-txt" name="keywords" id="keywords" value="<?php echo trim($output['reply_info']['reply_keywords'],'|');?>" type="text">
      ...
      <dl class="row msgtype_0" <?php echo $output['reply_info']['reply_msgtype']==1 ? ' style="display:none"' : '';?>>
        <dt class="tit">
	...
	<dl class="row msgtype_1" <?php echo $output['reply_info']['reply_msgtype']==0 ? ' style="display:none"' : '';?>>
        <dt class="tit">
