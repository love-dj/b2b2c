...
<div class="news-sns">
  <div class="news-sns-left">
    <div class="news-sns-tabmene">
      <ul>
        ...
        <li><a href="<?php echo urlShop('store_snshome', 'index', array('sid' => $output['store_info']['store_id'], 'type' => 'sale'));?>" <?php if($_GET['type'] == 'sale'){?>class="selected"<?php }?>><?php echo $lang['store_sns_sales_sale'];?><i></i></a></li>
              ...
              <div id="forward_<?php echo $val['strace_id'];?>" style="display:none;">
                <div class="forward-widget">
                  <div class="forward-edit">
                    <form id="forwardform_<?php echo $val['strace_id'];?>" method="post" action="index.php?w=store_snshome&t=addforward">
                      ...
                      <div class="forward-add">
                        ...
                        <!-- 防止点击Enter键提交 -->
                        <div class="w"> <span class="skin-blue"><span class="btn"><a href="javascript:void(0);" wt_type="s_forwardbtn" data-param='{"txtid":"<?php echo $val['strace_id'];?>"}'><?php echo $lang['sns_forward'];?></a></span></span> <span id="forwardcharcount<?php echo $val['strace_id'];?>" style="float:right;"></span> <a class="face" wt_type="smiliesbtn" data-param='{"txtid":"forward<?php echo $val['strace_id'];?>"}' href="javascript:void(0);" ><?php echo $lang['sns_smiles'];?></a> </div>
                      </div>
                    </form>
                  </div>
  ...
  <div class="news-sns-right">
    <div class="news-sns-right-container">
      <div class="news-store-pic"><a><img src="<?php echo getStoreLogo($output['store_info']['store_avatar']);?>" alt="<?php echo $output['store_info']['store_name'];?>" title="<?php echo $output['store_info']['store_name'];?>" /></a></div>
      <dl class="news-store-info">
        <dt><?php echo $output['store_info']['store_name']; ?></dt>
        <dd>已收藏：<em wttype="store_collect"><?php echo $output['store_info']['store_collect']?></em></dd>
      </dl>
      <div class="news-store-favorites"><a href="javascript:collect_store('<?php echo $output['store_info']['store_id'];?>','count','store_collect')" ><i class="icon-plus"></i>收藏店铺</a></div>
    </div>
    <div class="news-sns-right-container">
      <?php if (!empty($output['favorites_list'])) {?>
      <div class="title">最新收藏用户</div>
      <div class="news-favorites-user">
        <ul>
