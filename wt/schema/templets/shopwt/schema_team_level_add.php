...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title"><a class="back" href="index.php?act=level&op=index" title="返回团队等级列表"><i class="fa fa-arrow-circle-o-left"></i></a>
			<div class="subject">
				<h3>团队等级 - <?php echo $lang['nc_new'];?></h3>
				<h5>新增团队等级</h5>
			</div>
		</div>
	</div>
					...
					<div class="col-xs-12 col-sm-9 col-md-10">
						<div class="input-group row" style="padding-buttom:50px;">
							<label class="radio-inline col-xs-12 col-sm-6">
								<input type="checkbox" name="upgrade_type[first_cost_count]" value="1">
								一级客户消费满
						...
						<div class="input-group row">
							<label class="radio-inline col-xs-12 col-sm-6">
								<input type="checkbox" name="upgrade_type[fans_count]" value="1">
								粉丝人数满
								<input type="text" name="upgrade_value[fans_count]" value="">
								<span>人</span>
							</label>
							<label class="radio-inline col-xs-12 col-sm-6" style="margin-left:50px;">
								<input type="checkbox" name="upgrade_type[first_fans_count]" value="1">
								一级粉丝人数满
								<input type="text" name="upgrade_value[first_fans_count]" value="">
								<span>人</span>
							</label>
						</div>
						...
						<div class="input-group row">
							<label class="radio-inline col-xs-12 col-sm-6">
								<input type="checkbox" name="upgrade_type[fans_order_count]" value="1">
								粉丝分销商人数满
								<input type="text" name="upgrade_value[fans_order_count]" value="">
								<span>人</span>
							</label>
							<label class="radio-inline col-xs-12 col-sm-6" style="margin-left:50px;">
								<input type="checkbox" name="upgrade_type[first_fans_order_count]" value="1">
								一级粉丝分销商人数满
								<input type="text" name="upgrade_value[first_fans_order_count]" value="">
								<span>人</span>
							</label>
						</div>
