  ...
  <form id="goods_class_form" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label><?php echo $lang['wt_display'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="gc_show1" class="cb-enable selected"><span><?php echo $lang['wt_yes'];?></span></label>
            <label for="gc_show0" class="cb-disable"><span><?php echo $lang['wt_no'];?></span></label>
        ...
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="gc_index_show1" class="cb-enable selected"><span><?php echo $lang['wt_yes'];?></span></label>
            <label for="gc_index_show0" class="cb-disable"><span><?php echo $lang['wt_no'];?></span></label>
        ...
        <tr>
          <td colspan="2" class="required"><label><?php echo $lang['wt_sort'];?>:</label></td>
        </tr>
        <tr class="noborder">
