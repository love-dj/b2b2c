...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=goods_class&t=goods_class&gc_id=<?php echo $output['class_array']['gc_parent_id']?>" title="返回商品分类列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['goods_class_index_class'];?> - <?php echo $lang['wt_edit'];?>“<?php echo $output['class_array']['gc_name'];?>”</h3>
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <p class="notic mb10"><?php echo $lang['goods_class_add_type_desc_one'];?><a onclick="window.parent.openItem('shop|type')" href="JavaScript:void(0);" class="wtap-btn mr5 ml5"><?php echo $lang['wt_type_manage'];?></a><?php echo $lang['goods_class_add_type_desc_two'];?></p>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <label>
            ...
            <input type="checkbox" class="checkbox" name="is_show" id="is_show" value="1" <?php if ($output['class_array']['is_show'] == 1) {?>checked<?php }?>>

            隐藏</label>

          <p class="notic mb10">勾选前台隐藏后，该分类及子分类在前台导航不显示。</p>
	...
	$('#goods_class_form').validate({
        ...
        rules : {
            gc_name : {
                required : true,
                remote   : {
                url :'index.php?w=goods_class&t=ajax&branch=check_class_name',
                type:'get',
                data:{
                    gc_name : function(){
                        return $('#gc_name').val();
        ...
        messages : {
             gc_name : {
                required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['goods_class_add_name_null'];?>',
                remote   : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['goods_class_add_name_exists'];?>'
            },
            commis_rate : {
            	required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['goods_class_add_commis_rate_error'];?>',
                maxlength :'<i class="fa fa-exclamation-bbs"></i><?php echo $lang['goods_class_add_commis_rate_error'];?>',
                minlength :'<i class="fa fa-exclamation-bbs"></i><?php echo $lang['goods_class_add_commis_rate_error'];?>',
                digits :'<i class="fa fa-exclamation-bbs"></i><?php echo $lang['goods_class_add_commis_rate_error'];?>'
            },
            gc_sort  : {
                number   : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['goods_class_add_sort_int'];?>'
            }
        }
    });
