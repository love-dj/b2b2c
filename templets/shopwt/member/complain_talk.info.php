...
<h3><?php echo $lang['talk_detail'];?></h3>
  <dl>
    <dt><?php echo $lang['talk_list'].$lang['wt_colon'];?></dt>
    <dd>
      <div id="div_talk" class="wtm-complain-talk"> </div>
    </dd>
  </dl>
  <?php if(intval($output['complain_info']['complain_state']) <= 40) { ?>
  <dl>
    <dt><?php echo $lang['talk_send'].$lang['wt_colon'];?></dt>
    <dd>
  ...
  <form action="index.php?w=member_complain&t=apply_handle" method="post" id="handle_form">
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?w=member_complain&t=get_complain_talk',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'index.php?w=member_complain&t=publish_complain_talk',
                cache:false,
