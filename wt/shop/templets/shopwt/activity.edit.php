...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=activity&t=activity" title="返回<?php echo $lang['wt_manage'];?>列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="activity_sort"><em>*</em><?php echo $lang['wt_sort'];?></label>
        </dt>
        <dd class="opt">
...
$(document).ready(function(){
	...
	$("#add_form").validate({
        ...
        messages : {
	    	...
	    	activity_start_date: {
	    		required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['activity_new_startdate_null'];?>'
	    	},
	    	activity_end_date: {
	    		required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['activity_new_enddate_null'];?>'
	    	},
	    	activity_sort: {
