...
class order_callControl extends BaseSellerControl {
	...
	public function getajaxorderWt()
	{
		$model_order = Model('order');
        $condition = array();
        $condition['store_id'] = $_SESSION['store_id'];
	...
	private function _order_cancel($order_info, $post) {
	    ...
	    if(!chksubmit()) {
            ...
            exit();
	         ...
	         return $handle_order->changeOrderStateCancel($order_info,'seller',$_SESSION['member_name'], $msg);
	     }
	}
	...
	private function _order_ship_price($order_info, $post) {
	    ...
	    if(!chksubmit()) {
            ...
            return $handle_order->changeOrderShipPrice($order_info,'seller',$_SESSION['member_name'],$post['shipping_fee']);           
        }
    ...
    private function profile_menu($menu_type='',$menu_key='') {
        ...
        switch ($menu_type) {
        	case 'list':
            $menu_array = array(
            array('menu_key'=>'order_call',		'menu_name'=>Language::get('wt_member_path_all_order'),	'menu_url'=>'index.php?w=order_call'),
            );
            break;
        }
