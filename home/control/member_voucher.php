...
class member_voucherControl extends BaseMemberControl
{
     ...
     * 通过卡密绑定代金券
     */
    public function voucher_bindingWt()
    {
        if (chksubmit(false, true)) {
            ...
            if ($result) {
                ...
                showDialog('代金券领取成功', 'index.php?w=member_voucher&t=voucher_list', 'succ');
            } else {
    ...
    private function profile_menu($menu_key = '')
    {
        $menu_array = array(
            1 => array(
                ...
                'menu_name' => Language::get('wt_myvoucher'),
                'menu_url' => 'index.php?w=member_voucher&t=voucher_list'
            ),
            2 => array(
                'menu_key' => 'voucher_binding',
                'menu_name' => '领取代金券',
                'menu_url' => 'index.php?w=member_voucher&t=voucher_binding'
            )
        );
