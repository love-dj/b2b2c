...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="<?php echo urlAdminShop('robbuy', 'price_list'); ?>" title="返回列表">
  ...
  <form id="add_form" method="post" action="index.php?w=robbuy&t=price_save">
...
$(document).ready(function(){
	...
	$('#add_form').validate({
        ...
        messages : {
            range_name : {
                required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['range_name_error'];?>'
            },
            range_start : {
                required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['range_start_error'];?>',
                digits : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['range_start_error'];?>'
            },
            range_end : {
                required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['range_end_error'];?>',
                digits : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['range_end_error'];?>'
            }
        }
    });
});
