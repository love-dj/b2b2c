      ...
      <div class="quick-thread">
        <div class="base-tab-menu">
          <ul class="base-tab-nav">
            <li class="selected"><a href="javascript:void(0);"><?php echo $lang['bbs_new_theme'];?></a></li>
            <li><a href="index.php?w=theme&t=new_theme&sp=1&c_id=<?php echo $output['c_id'];?>"><?php echo $lang['bbs_new_poll'];?></a></li>
          </ul>
        </div>
