 ...
 <style media="print">
	...
	<?php foreach ($output['order_list'] as $item_k =>$item_v){?>
	  <div id="print_container" style="width:58mm;">
		...
		<!--<tr>
		<td>配送方式：<?php echo $item_v['delivery_name'];?></td>
		</tr>-->
		<tr>
		<td>收款方式：<?php echo $item_v['payment_name'];?></td>
		</tr>
		...
		<tr>
		<td style="width:8mm;text-align:center"><?php echo $k+1;?></td>
		<td style="width:35mm;"><?php echo $goods['goods_name'];?></td>
		<td style="width:10mm; text-align:center"><?php echo $goods['goods_num'];?></td>
		<td style="width:15mm;"><?php echo $goods['goods_price'];?></td>
		</tr>
		<?php } ?>
		</table>
		</td>
		...
		<td><strong>总计：<?php echo $item_v['goods_total_price'];?>元</strong></td>
		</tr>
		<?php } ?>
		</table>
		</div>
