  ...
  <div class="homepage-focus" id="homepageFocusTab">
    <div class="title">
      ...
      <ul class="tab-base wt-row">
        ...
        <li><a href="JavaScript:void(0);" form="upload_show_form">广告联动组图</a></li>
      </ul>
    </div>
    <form id="upload_category_form" class="tab-content" name="upload_category_form">
      ...
      <div class="wtap-form-default">
        <dl class="row">
          ...
          <dd class="opt">
            <div class="wtap-channel-category">
              ...
              <dl select_class_id="<?php echo $val['gc_parent']['gc_id'];?>">
                ...
                <a href="javascript:void(0);" class="wtap-btn-mini upload-pic" title="上传分类图片"><i id="form_<?php echo $val['gc_parent']['gc_id'];?>" class="fa fa-upload"></i></a>
                <a href="javascript:void(0);" class="wtap-btn-mini del" onclick="del_gc_parent(<?php echo $val['gc_parent']['gc_id'];?>);" title="删除该分类块"><i class="fa fa-trash"></i></a>
                </dt>
                <dd>
      ...
      <div class="wtap-form-default">
        <div class="bot"><a href="JavaScript:void(0);" onclick="update_channel_category();" class="wtap-btn-big wtap-btn-green"><span>保存</span></a> <a href="index.php?w=web_channel&t=html_update&web_id=<?php echo $output['code_channel_slide']['web_id'];?>" class="wtap-btn-big wtap-btn-green"><span>更新模块内容</span></a> <span class="web-save-succ" style="display:none;"><?php echo $lang['wt_common_save_succ'];?></span> </div>
      </div>
    </form>
    <form id="upload_category" enctype="multipart/form-data" method="post" style="display:none;" action="index.php?w=web_channel&t=upload_gc_pic" target="upload_">
    ...
    <form id="upload_slide_form" class="tab-content" name="upload_slide_form" enctype="multipart/form-data" method="post" action="index.php?w=web_channel&t=channel_slide" target="upload_pic" style="display:none;">
      ...
      <div class="wtap-form-default">
        <dl class="row">
          ...
          <dd class="opt">
            <div class="full-screen-slides">
              <ul>
                ...
                <li slide_id="<?php echo $val['pic_id'];?>" title="可上下拖拽更改显示顺序">
                  <div class="title">
                    <h4></h4>
                    <a class="wtap-btn-mini del" href="JavaScript:del_slide(<?php echo $val['pic_id'];?>);"><i class="fa fa-trash"></i>删除</a></div>
            ...
            <div class="mt20"><a class="wtap-btn" href="JavaScript:add_slide();"><?php echo '图片调用';?></a> </div>
          </dd>
        </dl>
      </div>
      <div id="upload_slide" class="wtap-form-default" style="display:none; overflow: visible;">
        <div class="title">
          <h3>新增/选中区域内容设置详情</h3>
        </div>
      ...
      <div class="wtap-form-default">
        <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_slide_form').submit();" class="wtap-btn-big wtap-btn-green"><span>保存</span></a> <a href="index.php?w=web_channel&t=html_update&web_id=<?php echo $output['code_channel_slide']['web_id'];?>" class="wtap-btn-big wtap-btn-green"><span>更新模块内容</span></a> <span class="web-save-succ" style="display:none;"><?php echo $lang['wt_common_save_succ'];?></span> </div>
      </div>
    </form>
    <form id="upload_show_form" class="tab-content" name="upload_show_form" enctype="multipart/form-data" method="post" action="index.php?w=web_channel&t=channel_show" target="upload_pic" style="display:none;">
      <input type="hidden" name="form_submit" value="ok" />
      <input type="hidden" name="web_id" value="<?php echo $output['code_channel_show']['web_id'];?>">
      <input type="hidden" name="code_id" value="<?php echo $output['code_channel_show']['code_id'];?>">
      <div class="wtap-form-default">
        <dl class="row">
          <dt class="tit">广告联动组图预览</dt>
          <dd class="opt focus-trigeminy">
            <?php if (is_array($output['code_channel_show']['code_info']) && !empty($output['code_channel_show']['code_info'])) { ?>
            <?php foreach ($output['code_channel_show']['code_info'] as $key => $val) { ?>
            <div focus_id="<?php echo $key;?>" class="focus-trigeminy-group" title="<?php echo '可上下拖拽更改图片组显示顺序';?>">
              <div class="title">
                <h4></h4>
                <a class="wtap-btn-mini del" href="JavaScript:del_show(<?php echo $key;?>);"><i class="fa fa-trash"></i>删除</a></div>
              <ul>
                <?php foreach($val['pic_list'] as $k => $v) { ?>
                <li pic_id="<?php echo $k;?>" onclick="select_show(<?php echo $key;?>,this);" title="<?php echo '可左右拖拽更改图片排列顺序';?>">
                  <div class="focus-thumb"><img title="<?php echo $v['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$v['pic_img'];?>"/></div>
                  <input name="channel_show[<?php echo $key;?>][pic_list][<?php echo $v['pic_id'];?>][pic_id]" value="<?php echo $v['pic_id'];?>" type="hidden">
                  <input name="channel_show[<?php echo $key;?>][pic_list][<?php echo $v['pic_id'];?>][pic_name]" value="<?php echo $v['pic_name'];?>" type="hidden">
                  <input name="channel_show[<?php echo $key;?>][pic_list][<?php echo $v['pic_id'];?>][pic_url]" value="<?php echo $v['pic_url'];?>" type="hidden">
                  <input name="channel_show[<?php echo $key;?>][pic_list][<?php echo $v['pic_id'];?>][pic_img]" value="<?php echo $v['pic_img'];?>" type="hidden">
                </li>
                <?php } ?>
              </ul>
            </div>
            ...
            <div class="mt20"> <a class="wtap-btn" href="JavaScript:add_show();"><?php echo '图片组';?></a> </div>
          </dd>
        </dl>
      </div>
      <div id="upload_show" class="wtap-form-default" style="display:none;">
        <div class="title">
          <h3>新增/选中区域内容设置详情</h3>
        </div>
        <dl class="row">
      ...
      <div class="wtap-form-default">
        <div class="bot"> <a href="JavaScript:void(0);" onclick="$('#upload_show_form').submit();" class="wtap-btn-big wtap-btn-green"><span>保存</span></a> <a href="index.php?w=web_channel&t=html_update&web_id=<?php echo $output['code_channel_slide']['web_id'];?>" class="wtap-btn-big wtap-btn-green"><span>更新模块内容</span></a> <span class="web-save-succ" style="display:none;"><?php echo $lang['wt_common_save_succ'];?></span> </div>
      </div>
    </form>
  </div>
</div>
...
<script src="<?php echo ADMIN_STATIC_URL;?>/js/channel_tp.js"></script>
