...
.goods-guess-like .goods-content { width: 200px; margin: 5px auto 15px auto;}
.goods-guess-like .goods-content dt { line-height: 18px; height: 36px; overflow: hidden;}
.goods-guess-like .goods-content dd { font: bold 12px/20px Verdana; color: #C00;}
.goods-guess-like .goods-content dd em { font-size: 14px; font-weight: 600; margin: 0 4px;}
.goods-guess-like .goods-sale { font: 700 12px/15px "microsoft yahei"; color: #FFF; background: url(<?php echo SHOP_TEMPLATES_URL;?>/images/wt_bg_img.png) no-repeat 0 -21px; text-align: center; width: 30px; height: 30px; padding: 6px 5px 15px 9px; position: absolute; z-index: 2; top: 5px; right: 10px;}
    ...
    <ul id="mycarousel" class="jcarousel-skin-tango">
      ...
      <li>
        ...
        <dl class="goods-content">
          ...
          <dd>
            <div>￥<em><?php echo wtPriceFormat($v['goods_sale_price']);?></em></div>
          </dd>
        </dl>
      </li>
      <?php } ?>
