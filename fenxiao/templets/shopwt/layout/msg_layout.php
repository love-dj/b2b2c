...
<script>var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var SITEURL = '<?php echo FENXIAO_SITE_URL;?>';var FENXIAO_STATIC_SITE_URL = '<?php echo FENXIAO_STATIC_SITE_URL;?>';var STATIC_SITE_URL = '<?php echo STATIC_SITE_URL;?>';var FENXIAO_TEMPLATES_URL = '<?php echo FENXIAO_TEMPLATES_URL;?>';</script>
...
<div class="header-box"><header class="wt-head wrapper">
  <h1 class="site-logo"><a href="<?php echo FENXIAO_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$output['setting_config']['site_logo']; ?>" class="pngFix"></a></h1></header></div>
<div class="msg">
