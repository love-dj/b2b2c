...
$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php?w=member_order_vr&t=order_info',{key:key,order_id:order_id}, function(result) {
    	...
    	$(".wtm-vr-order-codes ul li img").each(function(){
    	    var code_img = $(this);
        ...
        $.getJSON(ApiUrl + '/index.php?w=goods&t=store_o2o_addr', {store_id:result.datas.order_info.store_id},function(result){
        	if (result.datas.error) {
        		return ;
        	}
    ...
    function cancelOrderId(order_id) {
        $.ajax({
            type:"post",
            url:ApiUrl+"/index.php?w=member_order_vr&t=order_cancel",
    ...
    function toSend(){
    	...
    	$.ajax({
            type:"post",
            url:ApiUrl+"/index.php?w=member_order_vr&t=resend",
    ...
    function evaluationOrder() {
        ...
        location.href = WapSiteUrl + '/html/member/member_vr_evaluation.html?order_id=' + orderId;
