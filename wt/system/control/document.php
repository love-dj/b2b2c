...
class documentControl extends SystemControl{
        ...
        if(chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    $url = array(
                        array(
                            'url'=>'index.php?w=document&t=document',
                            'msg'=>$lang['document_edit_back_to_list']
                        ),
                        array(
                            'url'=>'index.php?w=document&t=edit&doc_id='.intval($_POST['doc_id']),
                            'msg'=>$lang['document_edit_again']
                        ),
                    );
                    $this->log(L('wt_edit,document_index_document').'[ID:'.$_POST['doc_id'].']',1);
     ...
     * 系统文章图片上传
     */
    public function document_pic_uploadWt(){
        /**
         * 上传图片
         */
