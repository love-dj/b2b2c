...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['show_index_manage'];?></h3>
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['show_help2'];?></li>
    </ul>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?w=show&t=get_ap_xml',
        colModel : [
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?w=show&t=ap_add';
    }else if (name == 'delete') { 
...
{
   ajax_form('copy_show', '<?php echo $lang['ap_get_js'];?>', 'index.php?w=show&t=ap_copy&id='+id);
}
</script> 
