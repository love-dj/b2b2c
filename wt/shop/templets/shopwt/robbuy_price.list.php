...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['robbuy_price_range_help1'];?></li>
    </ul>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?w=robbuy&t=price_list_xml',
        colModel: [
        ...
        buttons: [
            {
                ...
                title: '添加一条新数据到列表',
                onpress: function() {
                    location.href = 'index.php?w=robbuy&t=price_add';
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    location.href = 'index.php?w=robbuy&t=price_drop&range_id=' + ids.join(',');
                }
            }
        ],
        usepager: false,
