...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title"><a class="back" href="index.php?w=express&t=index" title="返回快递公司列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
            <div class="subject">
                <h3><?php echo $lang['wt_edit'];?>快递公司 - “<?php echo $output['express_array']['e_name'];?>”</h3>
                <h5>编辑快递公司</h5>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
		...
		e_code_kdniao : {
            ...
            messages : {
                e_name : {
                    required : '<i class="fa fa-exclamation-bbs"></i>快递公司名称不能为空'
                },
                e_code : {
                    required : '<i class="fa fa-exclamation-bbs"></i>快递公司编号不能为空'
                },
		e_code_kdniao : {
                    required : '<i class="fa fa-exclamation-bbs"></i>快递鸟快递公司代码'
                },
                e_letter  : {
                    required   : '<i class="fa fa-exclamation-bbs"></i>快递公司首字母不能为空'
                }
            }
        });
    });
