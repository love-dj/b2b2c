...
<script>
$(function(){
	$('.head-my-menu .my-cart').append('<div class="addcart-goods-num"><?php echo $output['cart_list']['cart_goods_num'];?></div>');
...
<div class="btn-box">
<?php if ($output['cart_list']['list']) { ?>
<div wtType="rtoolbar_total_price" class="total-price">共计金额：<em class="goods-price">&yen;<?php echo $output['cart_list']['cart_all_price'];?></em></div>
<a href="javascript:void(0);" onclick="javascript:window.location.href='<?php echo BASE_SITE_URL;?>/index.php?w=cart'">结算购物车中的商品</a>
<?php } ?>