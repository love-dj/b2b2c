...
<div class="wrapper mt10">
  ...
  <div class="left"></div>
    ...
    <ul class="mjs-info">
      ...
      <li> <span class="sale-rule">单笔订单消费满<em><?php echo $lang['currency'].wtPriceFormat($value['price']);?></em>
        <?php if(!empty($value['discount'])) { ?>
        ， 立减现金<em><?php echo $lang['currency'].wtPriceFormat($value['discount']);?></em>
        <?php } ?>
      ...
      <ul>
        ...
        <li>
          <dl>
            ...
            <dd class="goods-content"><span class="price"><?php echo $lang['currency'];?> <?php echo wtPriceFormat($value['goods_sale_price']);?> </span><span class="goods-sold"><?php echo $lang['wt_sell_out'];?><strong><?php echo $value['goods_salenum'];?></strong> <?php echo $lang['wt_jian'];?></span></dd>
