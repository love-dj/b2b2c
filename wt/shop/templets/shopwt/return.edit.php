...
<div class="page">
  ...
  <form id="post_form" method="post" action="index.php?w=return&t=edit&return_id=<?php echo $output['return']['refund_id']; ?>">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt"><?php echo wtPriceFormat($output['return']['refund_amount']); ?> 
            <span id="pay_amount">
      ...
      <dl class="row">
        ...
        <dd class="opt"><?php echo wtPriceFormat($output['order']['pay_amount']);?></dd>
          ...
          <dl class="row">
            <dt class="tit"></dt>
            <dd class="opt">
                <a href="<?php echo ADMIN_SITE_URL;?>/index.php?w=refund&t=alipay&refund_id=<?php echo $output['return']['refund_id']; ?>" target="_blank">支付宝退款</a>  
...
$(function(){
	...
	$("#wxpayBtn").click(function(){
	    var ajaxurl = "<?php echo ADMIN_SITE_URL;?>/index.php?w=refund&t=wxpay&refund_id=<?php echo $output['return']['refund_id']; ?>";
		show_msg(ajaxurl);
	});
	$("#alipayBtn").click(function(){
	    var ajaxurl = "<?php echo ADMIN_SITE_URL;?>/index.php?w=refund&t=get_detail&refund_id=<?php echo $output['return']['refund_id']; ?>";
		show_msg(ajaxurl);
	});
    $('#post_form').validate({
