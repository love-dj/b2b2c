<div class="page">
	 ...
	 <div class="fixed-bar">
      ...
      <div class="subject">
        <h3><?php echo $lang['wechat_url_manage'];?> - 编辑</h3>
        <h5>设置自定义url</h5>
      </div>
    </div>
  </div>
  ...
  <div class="wtap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
		   <input id="name" name="name" value="<?php echo $output['url_info']['url_name']?>" class="input-txt" type="text">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
        ...
        <dd class="opt">
		    <input id="urllink" name="urllink" value="<?php echo $output['url_info']['url_link']?>" class="input-txt" type="text">
          <span class="err"></span>
