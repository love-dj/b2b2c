...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['wt_domain_manage'];?></h3>
        <h5><?php echo $lang['wt_domain_manage_subhead'];?></h5>
      </div>
      <ul class="tab-base wt-row">
        <li><a href="JavaScript:void(0);" class="current"><?php echo $lang['wt_config'];?></a></li>
        <li><a href="index.php?w=domain&t=store_domain_list"><?php echo $lang['wt_domain_shop'];?></a></li>
      </ul>
    </div>
  </div>
  <form method="post" id="settingForm" name="settingForm">
    ...
    <div class="wtap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
          <label for="enabled_subdomain1" class="cb-enable <?php if($output['list_setting']['enabled_subdomain'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['wt_yes'];?>"><?php echo $lang['wt_yes'];?></label>
          <label for="enabled_subdomain0" class="cb-disable <?php if($output['list_setting']['enabled_subdomain'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['wt_no'];?>"><?php echo $lang['wt_no'];?></label>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="subdomain_edit1" class="cb-enable <?php if($output['list_setting']['subdomain_edit'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['wt_yes'];?>"><?php echo $lang['wt_yes'];?></label>
            <label for="subdomain_edit0" class="cb-disable <?php if($output['list_setting']['subdomain_edit'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['wt_no'];?>"><?php echo $lang['wt_no'];?></label>
...
$(document).ready(function(){
	...
	$("#settingForm").validate({
        ...
        messages : {
            subdomain_times  : {
                required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['domain_times_null'];?>',
                digits   : '<?php echo $lang['domain_times_digits'];?>',
                min    :'<?php echo $lang['domain_times_min'];?>'
            },
            subdomain_length  : {
                required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['domain_length_tips'];?>',
