...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['wt_news_picture_manage'];?></h3>
        <h5><?php echo $lang['wt_news_picture_manage_subhead'];?></h5>
      </div>
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['news_picture_list_tip2'];?></li>
...
<div id="dialog_verify" style="display:none;">
  <form id="verify_form" method='post' action="index.php?w=news_picture&t=news_picture_verify">
...
$(function(){
    ...
    $('input[name="verify_state"]').click(function() {
        if ($(this).val() == 1) {
            $('tr[wttype="reason"]').hide();
        } else {
            $('tr[wttype="reason"]').show();
        }
    });
    ...
    var flexUrl = 'index.php?w=news_picture&t=news_picture_list_xml&picture_state=<?php echo $output['currentState']; ?>';
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    location.href = 'index.php?w=news_picture&t=news_picture_drop&picture_id=__IDS__'.replace('__IDS__', ids.join(','));
                }
            }
        ],
        searchitems: [
...
$("a[data-j='drop']").live('click', function() {
    ...
    location.href = 'index.php?w=news_picture&t=news_picture_drop&picture_id='+id;
});
...
$("a[data-j='callback']").live('click', function() {
    ...
    var id = $(this).parents('tr[data-id]').attr('data-id');
    location.href = 'index.php?w=news_picture&t=news_picture_callback&picture_id=' + id;
});
...
$("a[data-j='picture_commend_flag'],a[data-j='picture_comment_flag']").live('click', function() {
    ...
    var id = $(this).parents('tr[data-id]').attr('data-id');
    $.get('index.php?w=news_picture&t=ajax', {
        column: column,
        id: id,
        value: value
    }, function(d) {
...
$("span[data-live-inline-edit]").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.getJSON('index.php?w=news_picture&t=update_' + column, {
