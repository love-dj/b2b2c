...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=show&t=ap_manage" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['show_index_manage'];?> - <?php echo $lang['ap_add'];?></h3>
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <select name="ap_class" id="ap_class">
            <option value="0"><?php echo $lang['show_pic'];?></option>
            <option value="1"><?php echo $lang['show_word'];?></option>
        ...
        <dd class="opt">
          <ul class="nofloat">
            <li>
              ...
              <label><?php echo $lang['ap_allow_mul_show'];?></label>
            </li>
            <li>
              <input type="radio" name="ap_display" value="2" checked="checked">
              <label><?php echo $lang['ap_allow_one_show'];?></label>
            </li>
          </ul>
      ...
      <dl class="row" id="ap_width_media">
        ...
        <dd class="opt">
          ...
          <span class="err"></span>
          <p class="notic"><?php echo $lang['show_pix'];?></p>
        </dd>
      </dl>
      <dl class="row" id="ap_width_word">
        ...
        <dd class="opt">
          ...
          <span class="err"></span>
          <p class="notic"><?php echo $lang['show_byte'];?></p>
        </dd>
      </dl>
      ...
      <dl class="row" id="default_pic">
        ...
        <div class="type-file-box">
          <div class="input-file-show"><span class="type-file-box">
            <input type="file" class="type-file-file" id="change_default_pic" name="default_pic" size="30" hidefocus="true"  wt_type="change_default_pic" title="点击按钮选择文件并提交表单后上传生效">
            </span></div></div>
          <span class="err"></span>
          <p class="notic"><?php echo $lang['ap_show_defaultpic_when_nothing']; ?>,<?php echo $lang['show_edit_support'];?>gif,jpg,jpeg,png</p>
        </dd>
      </dl>
...
$(document).ready(function(){
	...
	$('#link_form').validate({
        ...
        messages : {
        	ap_name : {
                required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['ap_can_not_null']; ?>'
            },
            ap_width_media	:{
            	required   : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['ap_input_digits_pixel']; ?>',
            	digits	:'<i class="fa fa-exclamation-bbs"></i><?php echo $lang['ap_input_digits_pixel'];?>',
            	min	:'<i class="fa fa-exclamation-bbs"></i><?php echo $lang['ap_input_digits_pixel'];?>'
            },
            ap_height	:{
            	required   : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['ap_input_digits_pixel']; ?>',
            	digits	:'<i class="fa fa-exclamation-bbs"></i><?php echo $lang['ap_input_digits_pixel'];?>',
            ...
            default_word	:{
            	required   : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['ap_default_word_can_not_null']; ?>'
            },
            default_pic: {
        		required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['default_pic_can_not_null'];?>',
