...
<div class="tabmenu">
  ...
  <div class="text-intro"> <?php echo $lang['store_activity_theme'].$lang['wt_colon'];//'活动主题';?> <?php echo $output['activity_info']['activity_title'];?></div>
</div>
<form method="GET">
  <input type="hidden" name="w" value="store"/>
  <input type="hidden" name="t" value="activity_apply"/>
  ...
  <table class="wtsc-default-table" >
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td><div class="pic-thumb"><a href="index.php?w=goods&goods_id=<?php echo $v['goods_id']; ?>" target="_blank"><img src="<?php echo cthumb($v['goods_image'], 60,$_SESSION['store_id']);?>"></a></div></td>
  ...
  <div class="div-goods-select">
    <form method="GET">
      <input type="hidden" name="w" value="store_activity"/>
      <input type="hidden" name="t" value="activity_apply"/>
    ...
    <form method="POST" id="apply_form" onsubmit="ajaxpost('apply_form','','','onerror');" action="index.php?w=store_activity&t=activity_apply_save">
      <input type="hidden" name="activity_id" value="<?php echo $_GET['activity_id'];?>"/>
        ...
        <ul class="goods-list">
          ...
          <li>
            ...
            <dl class="goods-content">
              ...
              <dd>销售价格：￥<?php echo wtPriceFormat($goods['goods_price']);?></dd>
            </dl>
          </li>
          <?php }?>
          <div class="clear"></div>
