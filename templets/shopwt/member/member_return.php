...
<div class="wrap">
  ...
  <form method="get" action="index.php">
    <table class="wtm-search-table">
      <input type="hidden" name="w" value="member_return" />
  ...
  <table class="wtm-default-table order">
    ...
    <tbody>
      ...
      <tr>
        <th colspan="20"> <span class="fl ml10"><?php echo $lang['return_order_returnsn'].$lang['wt_colon'];?><?php echo $val['refund_sn']; ?></span><span><?php echo $lang['refund_buyer_add_time'].$lang['wt_colon'];?><?php echo date("Y-m-d H:i:s",$val['add_time']);?></span>
          <!-- store_name -->
      ...
      <tr>
        ...
        <td class="tl"><dl class="goods-name">
            ...
            <dd><?php echo $lang['refund_order_ordersn'].$lang['wt_colon'];?><a href="index.php?w=member_order&t=show_order&order_id=<?php echo $val['order_id']; ?>" target="_blank"><?php echo $val['order_sn'];?></a></dd>
          </dl></td>
        ...
        <td class="bdr"><?php if($val['seller_state'] == 2 && $val['return_type'] == 2 && $val['goods_state'] == 1) { ?>
          <p><a href="index.php?w=member_return&t=ship&return_id=<?php echo $val['refund_id']; ?>" class="wtbtn">退货</a></p>
          <?php } else { ?>
          <a href="index.php?w=member_return&t=view&return_id=<?php echo $val['refund_id']; ?>" class="wtbtn">查看</a>
          <?php } ?>
          <?php if($val['seller_state'] == 2 && $val['return_type'] == 2 && $val['goods_state'] == 3) { ?>
          <p><a href="javascript:void(0)" class="wtbtn wtbtn-bittersweet" wt_type="dialog" dialog_title="延迟时间" dialog_id="return_delay" dialog_width="480"
        	    uri="index.php?w=member_return&t=delay&return_id=<?php echo $val['refund_id']; ?>"> 延时 </a></p>
          <?php } ?></td>
      </tr>
      <?php } ?>
      <?php } else { ?>
