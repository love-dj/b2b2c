<?php defined('ShopWT') or exit('Access Denied By ShopWT');?>
  <form method="get" id="formSearch">
    <table class="search-form">
      <input type="hidden" id='w' name='w' value='store_vr_bill' />
...
<table class="wtsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><?php echo wtPriceFormat($code_info['pay_price']);?></td>
        <td><?php echo wtPriceFormat($code_info['pay_price'] * $code_info['commis_rate']/100);?></td>
        <td>
       	<a target="_blank" href="index.php?w=store_order_vr&t=show_order&order_id=<?php echo $code_info['order_id'];?>"><?php echo $lang['wt_view'];?></a>
        </td>
      </tr>
      <?php } ?>
      <?php } else { ?>
