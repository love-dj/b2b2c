...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=store_joinin&t=help_list" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3>商家入驻 - <?php echo $lang['wt_edit'];?>“<?php echo $output['help']['help_title']?>”</h3>
...
$(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?w=store_joinin&t=upload_pic&item_id=<?php echo $output['help']['help_id']?>',
...
function del_file_upload(file_id){
    ...
    $.getJSON('index.php?w=store_joinin&t=del_pic&file_id=' + file_id, function(result){
        if(result){
            $('#pic_' + file_id).remove();
        }
    });
