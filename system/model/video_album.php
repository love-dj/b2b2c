...
class video_albumModel extends Model{
    ...
    public function addClass($input){
        if(is_array($input) && !empty($input)){
            return Db::insert('video_album_class',$input);
        }else{
            return false;
        }
    }
    ...
    public function updateClass($input,$id){
        if(is_array($input) && !empty($input)){
            return Db::update('video_album_class',$input," video_class_id='$id' ");
        }else{
            return false;
        }
    }
    ...
    public function updateVideo($input,$condition){
        if(is_array($input) && !empty($input)){
            return Db::update('video_album',$input,$this->getCondition($condition));
        }else{
            return false;
        }
    }
    ...
    public function delClass($id){
        if(!empty($id)) {
            return Db::delete('video_album_class'," video_class_id ='".$id."' ");
        }else{
            return false;
        }
    }
    ...
    public function delVideo($id, $store_id){
        ...
        if(!empty($id)) {
            return Db::delete('video_album','video_id in('.$id.')');
        }else{
            return false;
        }
    }
    ...
    public function getOneClass($param){
        if(is_array($param) && !empty($param)) {
            return Db::getRow(array_merge(array('table'=>'video_album_class'),$param));
        }else{
            return false;
        }
    }
    ...
    public function getOneVideoById($param){
        if(is_array($param) && !empty($param)) {
            return Db::getRow(array_merge(array('table'=>'video_album'),$param));
        }else{
            return false;
        }
    }
