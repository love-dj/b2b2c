...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=goods_class&t=goods_class&gc_id=<?php echo $output['parent_id']?>" title="返回上级分类列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?w=goods_class&t=goods_class_add&gc_parent_id=<?php echo $output['gc_id']?>';
    }
    if (name == 'del') {
