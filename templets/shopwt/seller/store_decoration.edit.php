...
<div class="wtsc-path"><i class="icon-desktop"></i>商家管理中心<i class="icon-angle-right"></i>店铺<i class="icon-angle-right"></i>店铺装修<i class="icon-angle-right"></i>页面设计</div>
<div class="wtsc-decoration-box">
  <div class="wtsc-decoration-menu" id="waypoints">
  ...
  <div id="store_decoration_content" style="<?php echo $output['decoration_background_style'];?>">
    <div id="decoration_banner" class="wtsl-nav"> </div>
    <div id="decoration_nav" class="wtsl-nav">
      <div class="wts-nav">
        <ul>
    ...
    <div id="dialog_edit_head_tabs_1">
      ...
      <dl>
        ...
        <dd>
          ...
          <p> <a id="btn_default_nav_style" class="wtbtn-mini" href="javascript:void(0);"><i class="icon-refresh"></i>恢复默认</a> </p>
...
<div id="dialog_select_module" class="dialog-decoration-module" style="display:none;">
  <ul>
    <li><a wttype="btn_show_module_dialog" data-module-type="slide" href="javascript:void(0);"><i class="slide"></i>
      <dl>
        <dt>图片和幻灯</dt>
        <dd>添加图片和可切换幻灯</dd>
      </dl>
      </a></li>
    <li><a wttype="btn_show_module_dialog" data-module-type="hot_area" href="javascript:void(0);"><i class="hotarea"></i>
      <dl>
        <dt>图片热点</dt>
        <dd>添加图片并设置热点区域链接</dd>
      </dl>
      </a></li>
    <li> <a wttype="btn_show_module_dialog" data-module-type="goods" href="javascript:void(0);"><i class="goods"></i>
      <dl>
        <dt>店铺商品</dt>
        <dd>选择添加店铺内的在售商品</dd>
      </dl>
      </a> </li>
    <li> <a wttype="btn_show_module_dialog" data-module-type="html" href="javascript:void(0);"><i class="html"></i>
      <dl>
        <dt>自定义</dt>
...
<div id="dialog_module_slide" class="eject_con dialog-decoration-edit" style="display:none;">
  ...
  <dl class="display-set">
    ...
    <dd><span>全屏显示
      ...
      <p><a id="btn_add_slide_image" class="wtbtn mt5" href="javascript:void(0);"><i class="icon-plus"></i>添加图片</a></p>
    </dd>
  </dl>
    ...
    <form action="">
      <dl>
        ...
        <dd>
          ...
          <div class="wtsc-upload-btn"> <a href="javascript:void(0);"> <span>
            <input type="file" hidefocus="true" size="1" class="input-file" name="file" id="file"  wttype="btn_module_slide_upload"/>
            </span>
            <p><i class="icon-upload-alt"></i>图片上传</p>
            </a> </div>
      ...
      <dl>
        ...
        <dd>
          ...
          <p class="mt5"><a id="btn_save_add_slide_image" class="wtbtn wtbtn-aqua" href="javascript:void(0);">添加</a> <a id="btn_cancel_add_slide_image" class="wtbtn wtbtn-bittersweet" href="javascript:void(0);">取消</a></p>
        </dd>
      </dl>
    </form>
  </div>
...
<div id="dialog_module_hot_area" class="eject_con dialog-decoration-edit" style="display:none;">
  ...
  <form action="">
    <dl>
      ...
      <dd>
        <div class="wtsc-upload-btn"> <a href="javascript:void(0);"> <span>
          <input type="file" hidefocus="true" size="1" class="input-file" name="file" id="file"  wttype="btn_module_hot_area_upload"/>
          </span>
          <p><i class="icon-upload-alt"></i>图片上传</p>
          </a> </div>
  ...
  <dl>
    ...
    <dd>
      ...
      <a id="btn_module_hot_area_add" class="wtbtn ml5" href="javascript:void(0);"><i class="icon-anchor"></i>添加网址</a>
...
<div id="dialog_module_goods" class="eject_con dialog-decoration-edit" style="display:none;">
  ...
  <div class="decoration-search-goods">
    <div class="search-bar">输入商品关键字：
      ...
      <a id="btn_module_goods_search" class="wtbtn" href="javascript:void(0);">搜索</a><span class="ml10 orange">小提示： 留空搜索显示店铺全部在售商品，每页显示10个。</span></div>
...
<a wttype="btn_del_slide_image" href="javascript:void(0);" title="删除">X</a>
</li>
</script> 
<!-- 热点块控制模板 --> 
...
<i></i>
<p>热点区域<%=index%></p>
<p><a wttype="btn_module_hot_area_select" data-hot-area-position="<%=position%>" class="wtbtn-mini wtbtn-aqua" href="javascript:void(0);">选择</a>
<a data-index="<%=index%>" wttype="btn_module_hot_area_del" class="wtbtn-mini wtbtn-grapefruit" href="javascript:void(0);">删除</a></p>
</li>
</script> 
<!-- 热点块标识模板 --> 
...
<script type="text/javascript" src="<?php echo STATIC_SITE_URL;?>/js/decoration/store_decoration.js" charset="utf-8"></script> 
