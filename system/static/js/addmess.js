...
$(function(){
	...
	check_tuwen(1);
	//var url = "/biz.php?ctl=wechat&w=showmess";
	var url = "index.php?w=seller_wechat&t=showmess";
...
function zsc_editimg(num){
	...
	if(0==zsc_count){
		$('#zsc_titles').val($('#zsc_titles0').html());
		$('#zsc_urls').val($('#zsc_urls0').val());
		if('/shop/static/keyword/images/bigimg.jpg'==$('#zsc_imgs0').attr('src')){
			$('#zsc_imgurls').val();
		}else{
		...
		if('/shop/static/keyword/images/smallimg.jpg'!=ssurl){
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		//var url = "/biz.php?ctl=wechat&w=addmess";
		var url = "index.php?w=seller_wechat&t=addmess";
