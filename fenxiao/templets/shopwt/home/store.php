    ...
    <div class="detail-shop-info">
        ...
        <ul class="fl">
            <li>
                ...
                <span>电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：<?php echo $output['store_info']['store_phone'];?></span>
            </li>
            <li>
    ...
    <div class="detail-shop-data">
        <div class="fl">
            ...
            <div class="data-number">
                <span>30天推广量</span> <span><b class="d_index_orange" id="myTargetElement-promote"><?php echo $output['fx_count']?></b>&nbsp;件</span>
            </div>
            <div class="data-number">
        ...
        <div class="chat fr">
            <div class="chat-nav">
                <a href="javascript:void(0);" class="commission-btn" title="支付佣金"><i class="icon-cny" aria-hidden="true"></i>&nbsp;支付佣金</a>
                <a href="javascript:void(0);" class="promote-btn" title="推广量"><i class="icon-line-chart" aria-hidden="true"></i>&nbsp;推广量</a>
            </div>
...
<div class="d_index">
    <h1 class="p-goods">
        <img src="<?php echo FENXIAO_TEMPLATES_URL;?>/images/fx-iext.jpg" alt="" class="fl" height="19" width="19"><span class="fl">&nbsp;&nbsp;推广商品</span>
    </h1>
    <?php if(!empty($output['goods_list']) && is_array($output['goods_list'])){?>
    <ul class="d_list">
    <?php foreach($output['goods_list'] as $value){?>
        <li>
            <a href="<?php echo urlShop('fx_goods','goods_detail',array('goods_id'=> $value['goods_commonid']));?>">
                ...
                <div class="d_list_goods_name">
                    ...
                    <div>
                        <span class="fl"><b><?php echo wtPriceFormatForList($value['goods_price']);?></b></span><span class="fr d_index_gray9">销量：<i class="d_index_gray6"><?php echo $value['sale_count'];?></i></span>
                    </div>
                    <div>
                        <span class="fl d_index_orange">佣金比例：<b><?php echo $value['fx_commis_rate'];?>%</b></span><span class="fr d_index_gray9">佣金：<i class="d_index_gray6"><?php echo wtPriceFormatForList($value['goods_price']*$value['fx_commis_rate']*1.0/100);?></i></span>
                    </div>
                </div>
            </a>
            <div class="add-cart checkbox">
                <a href="javascript:void(0);" data-gid="<?php echo $value['goods_commonid']?>" class="cd-popup-trigger1"><i class="icon-share-alt" aria-hidden="true"></i>&nbsp;立即推广</a>
                <a href="javascript:void(0);" data-gid="<?php echo $value['goods_commonid']?>" class="cd-popup-trigger2"><i class="icon-qrcode" aria-hidden="true"></i>&nbsp;获取二维码</a>
            </div>
        </li>
    <?php }?>    
    </ul>
...
<script src="<?php echo FENXIAO_STATIC_SITE_URL; ?>/js/countUp.min.js"></script>
<script src="<?php echo FENXIAO_STATIC_SITE_URL; ?>/js/Chart.min.js"></script>
...
<script type="text/javascript">
    ...
    var demo_promote = new CountUp("myTargetElement-promote", 0, <?php echo $output['fx_count']?>, 0, 2, options);
...
<script>
    $(function () {
        //推广量统计
        var commission_data = <?php echo $output['fx_info']?>;
        var commission_opt ={
            scaleOverride : true,
            scaleSteps : 5,
            scaleStepWidth : <?php echo $output['fx_opt']?>,
            scaleStartValue : 0
          };
