;(function($){
    ...
    $(".submit").click(function(){
        if($.sValid()){
            ...
            $.ajax({
                url: ApiUrl + "/index.php?w=seller_apply&t=do_apply",
                type: 'POST',
                dataType: 'json',
...
;(function($){
    ...
    $('input[name="paying_money_certificate"]').fileupload({
        dataType: 'json',
        url: ApiUrl + '/index.php?w=seller_apply&t=ajax_upload_image',
    ...
    $('#btn_select_category').on('click', function() {
        $(".gc-wrap-pre").remove();
        $.ajax({
            url: ApiUrl + "/index.php?w=seller_apply&t=get_goods_category",
            type: 'POST',
            dataType: 'json',
            data: {client: Client},
            success: function(result){
