...
class seoModel extends Model{
     ...
     *
     */
    public function showwap(){
        $this->seo['title'] = preg_replace("/{.*}/siU",'',$this->seo['title']);
        $this->seo['keywords'] = preg_replace("/{.*}/siU",'',$this->seo['keywords']);
        $this->seo['description'] = preg_replace("/{.*}/siU",'',$this->seo['description']);
        $seo['html_title'] = C('site_name');
        $seo['seo_keywords'] = $this->seo['keywords'] ? $this->seo['keywords'] : C('site_name');
        $seo['seo_description'] = $this->seo['description'] ? $this->seo['description'] : C('site_name');
        return $seo;
