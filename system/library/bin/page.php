...
class Page{
        ...
        switch ($this->style) {
            ...
            case '6':
                ...
                if ($this->getNowPage() <= 1){
                    ...
                    $html_page .= '<li><a class="demo" href="'. $this->setFenxiaoPseudoStaticPageUrl($this->getNowPage()-1) .'">'.$this->left_inside_a_html.$this->pre_page.$this->right_inside_a_html.'</a></li>';
                }
                if ($this->getNowPage() == $this->getTotalPage() || $this->getTotalPage() == 0){
                    $html_page .= '<li>'.$this->left_inside_a_html.$this->next_page.$this->right_inside_a_html.'</li>';
                }else {
                    $html_page .= '<li><a class="demo" href="'. $this->setFenxiaoPseudoStaticPageUrl($this->getNowPage()+1) .'">'.$this->left_inside_a_html.$this->next_page.$this->right_inside_a_html.'</a></li>';
                }
                $html_page .= '</ul>';
                break;
            case '7':
                ...
                if ($this->getNowPage() <= 1){
                    ...
                    $html_page .= '<li><a class="demo" href="'. $this->setFenxiaoPseudoStaticPageUrl('1') .'">'.$this->left_inside_a_html.$this->pre_home.$this->right_inside_a_html.'</a></li>';
                    $html_page .= '<li><a class="demo" href="'. $this->setFenxiaoPseudoStaticPageUrl($this->getNowPage()-1) .'">'.$this->left_inside_a_html.$this->pre_page.$this->right_inside_a_html.'</a></li>';
                }
                $html_page .= $this->getNowBar();
                if ($this->getNowPage() == $this->getTotalPage() || $this->getTotalPage() == 0){
                    ...
                    $html_page .= '<li><a class="demo" href="'. $this->setFenxiaoPseudoStaticPageUrl($this->getNowPage()+1) .'">'.$this->left_inside_a_html.$this->next_page.$this->right_inside_a_html.'</a></li>';
                    $html_page .= '<li><a class="demo" href="'. $this->setFenxiaoPseudoStaticPageUrl($this->getTotalPage()) .'">'.$this->left_inside_a_html.$this->pre_last.$this->right_inside_a_html.'</a></li>';
                }
                $html_page .= '</ul>';
                break;
            default:
    ...
    private function setShopPseudoStaticPageUrl($page){
        $param = $_GET;
        $w = $param['w'] == '' ? 'index' : $param['w'];
        unset($param['w']);
        $t = $param['t'] == '' ? 'index' : $param['t'];
        unset($param['t']);
        $param[$this->page_name] = $page;
        return urlShop($w, $t, $param);
    }
    private function setFenxiaoPseudoStaticPageUrl($page){
        $param = $_GET;
        $w = $param['w'] == '' ? 'index' : $param['w'];
        unset($param['w']);
        $t = $param['t'] == '' ? 'index' : $param['t'];
