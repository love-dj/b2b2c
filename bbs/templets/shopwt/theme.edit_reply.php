...
<div class="group warp-all">
  ...
  <div class="theme-editor">
    <form method="post" id="reply_form1" action="<?php echo BBS_SITE_URL;?>/index.php?w=theme&t=edit_reply&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['reply_info']['theme_id'];?>&r_id=<?php echo $output['reply_info']['reply_id'];?>">
      ...
      <div class="quick-thread">
        <div class="quick-thread-box">
          ...
          <div class="bottom"> <a class="submit-btn" wttype="reply_submit" href="Javascript: void(0)"><?php echo $lang['wt_edit_reply'];?></a> <a class="cancel-btn" href="Javascript:history.go(-1);" wttype="theme_cancle"><?php echo $lang['wt_cancel'];?></a>
            <div id="warning"></div>
          </div>
        </div>
      </div>
