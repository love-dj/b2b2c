...
<form id="pricerangeform" method="post" action="index.php" target="_self" onsubmit="return checksubmit();">
	<input type="hidden" name="w" value="statistics_general" />
    <input type="hidden" name="t" value="pricesetting" />
    <input type="hidden" value="ok" name="form_submit">
    <table id="pricerang_table" class="wtsc-default-table">
      <thead>
        <tr>
        ...
        <tr>
          <td colspan="20">
            <a id="addrow" href="javascript:void(0);" class="wtbtn-mini"><span>增加一行</span></a>
          </td>
        </tr>
      </thead>
      <tbody>
    	...
    	<tr id="row_<?php echo $k; ?>">
    		...
    		<td class="nscs-table-handle">
    			<span><a class="btn-grapefruit" href="JavaScript:void(0);" onclick="delrow(<?php echo $k;?>);"><i class="icon-trash"></i><p><?php echo $lang['wt_del']; ?></p></a></span>
    		</td>
    	</tr>
    	<?php } } else { ?>
    	<tr id="row_0">
    		...
    		<td class="nscs-table-handle">
    			<span><a class="btn-grapefruit" href="JavaScript:void(0);" onclick="delrow(0);"><i class="icon-trash"></i><p><?php echo $lang['wt_del']; ?></p></a></span>
    		</td>
    	</tr>
    	<?php } ?>
      </tbody>
...
$(function(){
	...
	$('#addrow').click(function(){
		...
		html += '<td class="nscs-table-handle"><span><a class="btn-grapefruit" href="JavaScript:void(0);" onclick="delrow('+i+');"><i class="icon-trash"></i><p><?php echo $lang['wt_del']; ?></p></a></span></td>';
