...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=inform&t=inform_list" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
  ...
  <form id="handle_form" method="post"  action="index.php?w=inform&t=inform_handle" name="form1">
    ...
    <div class="bot"><a href="JavaScript:void(0);" class="wtap-btn-big wtap-btn-green" id="btn_handle_submit"><?php echo $lang['wt_submit'];?></a></div>
    </dl>
  </form>
</div>
