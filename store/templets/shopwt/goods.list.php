...
<form method="get" action="index.php">
  <table class="search-form">
    <input type="hidden" name="w" value="goods" />
...
<table class="wtsc-default-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="nscs-table-handle"><span><a href="javascript:void(0);" class="btn-bluejeans" wttype="set_stock" data-commonid="<?php echo $val['goods_commonid'];?>"><i class="icon-foursquare"></i>
        <p>设置库存</p>
        </a></span></td>
    </tr>
...
$(function(){
    $('a[wttype="set_stock"]').click(function(){
