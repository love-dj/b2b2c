...
<form id="pay_form" method="post" enctype="multipart/form-data" action="index.php?w=store_contract&t=applypay">
	<input type="hidden" id="w" name="w" value="store_contract"/>
	<input type="hidden" id="t" name="t" value="applypay"/>
	...
	<dl>
		...
		<dd>
			<div class="wtsc-upload-thumb voucher-pic">
				<p>
	...
	<dl>
		...
		<dd>
			<div id="costimg_preview" class="wtsc-upload-thumb voucher-pic">
				<p><i class="icon-picture"></i></p>
			</div>
			<div class="wtsc-upload-btn">
				<a href="javascript:void(0);">
					<span><input type="file" hidefocus="true" size="1" class="input-file" name="costimg" id="costimg" wt_type="costimg"/></span>
	...
	<div class="bottom">
		<label class="submit-border">
			<a id='submitbtn' class="submit" href="javascript:void(0);"><?php echo $lang['wt_submit'];?></a>
		</label>
	</div>
</form>
</div>
