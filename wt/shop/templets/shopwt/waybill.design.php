...
<div class="page"> 
  ...
  <div class="wtap-form-default">
    <dl class="row">
      ...
      <dd class="opt">
        <form id="design_form" action="<?php echo urlAdminShop('waybill', 'waybill_design_save');?>" method="post">
          ...
          <ul id="waybill_item_list" class="wt-row wtap-waybill-list">
            ...
            <li>
              ...
              <i wttype="btn_item_edit" data-item-name="<?php echo $key;?>" title="微调" class="fa fa-pencil-square-o"></i>
    ...
    <div class="bot"><a id="submit" href="javascript:;" class="wtap-btn-big wtap-btn-green"><?php echo $lang['wt_submit'];?></a></div>
  </div>
</div>
<div id="dialog_item_edit" style="display:none;">
  ...
  <div class="wtap-form-default">
    ...
    <div class="bot"><a id="btn_dialog_submit" href="javascript:;" class="wtap-btn-big wtap-btn-green">确定调整</a> <a id="btn_dialog_cancel" href="javascript:;" class="wtap-btn-big wtap-btn-orange ml20">取消微调</a> </div>
  </div>
</div>
...
$(document).ready(function() {
    ...
    //微调弹出窗口
    $('[wttype="btn_item_edit"]').on('click', function() {
        ...
        $('#dialog_item_edit').wt_show_dialog({title:'微调'});
    });
