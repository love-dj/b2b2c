...
<div class="news-content mt10">
  <form id="add_form" method="post" action="index.php?w=publish&t=publish_article_save">
    ...
    <div class="news-publish-content" id="main-list-bar">
      <div class="news-publish-sidebar" id="main-nav">
        ...
        <div class="upload-images-box">
          ...
          <!-- <div id="btn_image_list_up" class="up-btn" title="<?php echo $lang['news_text_up'];?>"><i></i><?php echo $lang['news_text_up'];?></div>-->
          <div class="upload-img-list" id="art-upload-scrollbar">
            <ul id="article_image_list" class="article-image-list" style="position:relative;">
              ...
              <li><div class="picture"><a href="Javascript: void(0);"><img alt="" src="<?php echo getNEWSArticleImageUrl($output['article_detail']['article_attachment_path'], serialize($value), 'max');?>"></a></div>
                <div class="handle"><a wttype="btn_insert_article_image"><?php echo $lang['news_text_insert'];?></a><a image_name="<?php echo $key;?>" wttype="btn_set_article_image"><?php echo $lang['news_cover'];?></a> <a image_name="<?php echo $key;?>" wttype="btn_drop_article_image"><?php echo $lang['news_delete'];?></a></div>
          ...
          <!-- <div id="btn_image_list_down" class="down-btn" title="<?php echo $lang['news_text_down'];?>"/> 
          <i></i><?php echo $lang['news_text_down'];?></div>-->
      </div>
    </div>
    <table class="news-publish-table">
      <tbody>
        <tr>
          <th><?php echo $lang['news_article_class'];?></th>
          ...
          <td rowspan="3" align="center" valign="middle" class="w200">
              ...
              <img alt="" src="<?php echo getNEWSArticleImageUrl($output['article_detail']['article_attachment_path'],$output['article_detail']['article_image'], 'list');?>">
              <?php } ?>
              </div>
              <p class="edit-cover-text"><?php echo $lang['news_cover'];?></p>
            <input id="article_image" name="article_image" type="hidden" value="<?php if(!empty($output['article_detail'])) echo getNEWSImageName($output['article_detail']['article_image']);?>" /></td>
        </tr>
        <tr>
        ...
        <tr>
          <th><?php echo $lang['news_article_content'];?><?php echo $lang['wt_colon'];?></th>
          <td colspan="2"><?php showEditor('article_content',$output['article_detail']['article_content'],'900px','400px','visibility:hidden;',"true",$output['editor_multimedia'],'true','simple');?></td>
        </tr>
        <tr>
          <th><?php echo $lang['news_text_publisher'];?><?php echo $lang['wt_colon'];?></th>
        ...
        <tr>
          <th><?php echo $lang['news_publish_time'];?><?php echo $lang['wt_colon'];?></th>
        ...
        <tr>
          <th><?php echo $lang['news_article_orgin'];?><?php echo $lang['wt_colon'];?></th>
          <td colspan="3"><input id="article_origin" class="text w100" name="article_origin" type="text" value="<?php if(!empty($output['article_detail'])) echo $output['article_detail']['article_origin'];?>"/>
            <span><?php echo $lang['news_article_orgin_address'];?><?php echo $lang['wt_colon'];?></span>
            ...
            <div class="hint"><?php echo $lang['news_article_orgin_explain'];?></div></td>
        </tr>
        <tr>
          <th><?php echo $lang['news_article_goods'];?><?php echo $lang['wt_colon'];?></th>
          <td colspan="2">
            <ul id="article_goods_list" class="article-goods-list">
              ...
              <li wttype="btn_goods_select">
                <dl>
                  <dt class="name"> <a target="_blank" href="<?php echo $value['url'];?>"><?php echo $value['title'];?></a> </dt>
                  <dd wttype="btn_goods_select" class="image"> <img src="<?php echo $value['image'];?>" title="<?php echo $value['title'];?>"> </dd>
                  <dd class="price"><?php echo $lang['news_price'];?><?php echo $lang['wt_colon'];?><em><?php echo $value['price'];?></em></dd>
                </dl>
                <i><?php echo $lang['news_article_goods_delete_explain'];?></i>
            ...
            <p>
              ...
              <label for="goods_search_type_url"><?php echo $lang['news_goods_link'];?></label>
              <input id="goods_search_type_title" value="goods_name" name="goods_search_type" type="radio" />
              <label for="goods_search_type_title"><?php echo $lang['news_goods_name'];?></label>
            </p>
            <input id="goods_search_keyword" class="text w380" name="goods_search_keyword" type="text" />
            <input id="btn_goods_search" class="btn-type-s" type="button" value="<?php echo $lang['news_text_add'];?>" />
            <div id="div_goods_select"> </div>
            <div class="hint"><?php echo $lang['news_goods_explain'];?></div></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <div class="hint"><?php echo $lang['news_keyword_expalin'];?></div>
          </td>
        </tr>
        <tr>
          <th><?php echo $lang['news_other_article'];?><?php echo $lang['wt_colon'];?></th>
          <td colspan="2"><input id="article_link" name="article_link" type="hidden" value="<?php if(!empty($output['article_detail'])) echo $output['article_detail']['article_link'];?>"/>
            <ul id="article_link_list" class="article-link-list">
              ...
              <li article_id="<?php echo $value['article_id'];?>" wttype="btn_article_select"><a target="_blank" href="<?php echo getNEWSArticleUrl($value['article_id']);?>"> <?php echo $value['article_title'];?> </a> <i><?php echo $lang['news_article_article_delete_explain'];?></i> </li>
              <?php } ?>
              <?php } ?>
            </ul>
            ...
            <p>
              ...
              <label for="article_search_type_id"><?php echo $lang['news_article_id'];?></label>
              <input id="article_search_type_title" name="article_search_type" value="article_keyword" type="radio" />
              <label for="article_search_type_title"><?php echo $lang['news_article_title'];?></label>
            </p>
            <input id="article_search_keyword" class="text w380" name="article_search_keyword" type="text" />
            <input id="btn_article_search"  class="btn-type-s" type="button" value="<?php echo $lang['news_text_search'];?>" />
            <div id="div_article_select"> </div>
            <div class="hint"><?php echo $lang['news_article_expalin'];?></div></td>
        </tr>
      </tbody>
      <tfoot>
        <tr>
          <td colspan="20"><a id="btn_draft" class="btn-draft" href="javascript:void(0);"><?php echo $lang['news_article_save_draft'];?></a> <a id="btn_publish" class="btn-publish" href="javascript:void(0);"><?php echo $lang['news_text_publish'];?></a></td>
        </tr>
      </tfoot>
    </table>
  </form>
...
<script type="text/javascript" src="<?php echo NEWS_STATIC_SITE_URL;?>/js/waypoints.js"></script> 
<script type="text/javascript" src="<?php echo NEWS_STATIC_SITE_URL;?>/js/news_article_publish.js"></script>
...
<script type="text/javascript">
 $(document).ready(function(){
    ...
    //摘要计数
    $("#article_abstract").wt_text_count({max:140});
