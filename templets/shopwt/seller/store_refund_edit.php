...
<div class="wtsc-flow-box">
  <div class="wtsc-flow-container">
    ...
    <div class="wtsc-form-default">
      ...
      <dl>
        <dt><?php echo $lang['refund_buyer_message'].$lang['wt_colon'];?></dt>
        <dd> <?php echo $output['refund']['reason_info']; ?> </dd>
      </dl>
      <dl>
        <dt><?php echo $lang['refund_order_refund'].$lang['wt_colon'];?></dt>
      ...
      <dl>
        ...
        <dd>
          ...
          <ul class="wtsc-evidence-pic">
            <?php foreach ($output['pic_list'] as $key => $val) { ?>
            <?php if(!empty($val)){ ?>
            <li><a href="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_PATH.'/refund/'.$val;?>" wttype="nyroModal" rel="gal" target="_blank"> <img class="show_image" src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_PATH.'/refund/'.$val;?>"></a></li>
            <?php } ?>
            <?php } ?>
          </ul>
          <?php } ?>
      ...
      <form id="post_form" method="post" action="index.php?w=store_refund&t=edit&refund_id=<?php echo $output['refund']['refund_id']; ?>">
        <input type="hidden" name="form_submit" value="ok" />
        <h3>商家处理意见</h3>
        <dl>
          <dt><i class="required">*</i><?php echo $lang['refund_seller_confirm'].$lang['wt_colon'];?></dt>
          <dd>
            <label class="mr20">
        ...
        <dl>
          <dt><i class="required">*</i><?php echo $lang['refund_message'].$lang['wt_colon'];?></dt>
          <dd>
        ...
        <div class="bottom">
          <label class="submit-border">
            <a class="submit" id="confirm_button"><?php echo $lang['wt_ok'];?></a>
          </label>
          <label class="submit-border">
