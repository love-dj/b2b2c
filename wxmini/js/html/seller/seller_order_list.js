...
$(function() {
    ...
    function t() {
        ...
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?w=seller_order&t=order_list&page=" + page + "&curpage=" + curpage,
            data: {
                key: e,
                state_type: t,
                order_key: r
    ...
    function i(orderid,price) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?w=seller_order&t=order_spay_price",
            data: {
                order_id: orderid,
				order_fee:price,
                key: e
    ...
    function n() {
        ...
        $.sDialog({
			...
			okFn:function(){
						...
						$.ajax({
							type: "post",
							url: ApiUrl + "/index.php?w=seller_order&t=order_deliver_send",
							data: {
