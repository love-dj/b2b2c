...
<div class="wts-store-map-content">
  <div class="wts-store-map-baidu" id="baidu_map" style="width:<?php echo $_GET['w']; ?>px;height:<?php echo $_GET['h']; ?>px;"></div>
  <div class="wts-store-map-info">
