...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=navigation&t=navigation" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['navigation_index_nav'];?> - <?php echo $lang['wt_new'];?></h3>
  ...
  <form id="navigation_form" method="post">
    ...
    <div class="wtap-form-default">
	  ...
	  <input type="radio" value="3" name="nav_location">
          <label><?php echo $lang['navigation_index_hidden'];?></label>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="nav_new_open1" class="cb-enable selected" ><?php echo $lang['wt_yes'];?></label>
            <label for="nav_new_open0" class="cb-disable" ><?php echo $lang['wt_no'];?></label>
