  ...
  <table class="wtm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td class="tc"></td>
        <td class="link2 tl">
        <a <?php if($v['article_url']!=''){?>target="_blank"<?php }?> href="<?php if($v['article_url']!='')echo $v['article_url'];else echo urlShop('article', 'show', array('article_id'=>$v['article_id']));?>"><?php echo $v['article_title']?></a>
        </td>
