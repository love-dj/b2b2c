$(function (){
    ...
    html += '<a href="' + WapSiteUrl + '/news/index.html" class="gotop">资讯</a>' + "</div>" + '<!--<div class="copyright">' + 'Copyright&nbsp;&copy;&nbsp;2018-2020 <a href="javascript:void(0);">http://www.longbasz.com</a>版权所有' + "</div>--></div>";
	if (cart_count > 0) {
