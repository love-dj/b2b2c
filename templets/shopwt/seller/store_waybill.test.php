...
.print-btn i { background: url(<?php echo SHOP_TEMPLATES_URL?>/images/seller/wtsc_bg_img.png)scroll no-repeat 0 -460px; vertical-align: middle; display: inline-block; width: 32px; height: 32px;}
...
.print-btn:hover a, .print-box .print-btn a:hover { color: #FFF;  text-decoration:none;}
