...
<div class="wrap">
  ...
  <div class="wtm-favorite-store-more">
    ...
    <div class="item-list">
      <div class="store-info">
        ...
        <dl>
          ...
          <dd><?php echo $lang['favorite_message'].$lang['wt_colon'];?><span member_id="<?php echo $output['store_info']['member_id'];?>"></span>
      ...
      <div class="show-tab" data-sid="<?php echo $output['store_info']['store_id'];?>">
        ...
        <a href="<?php if ($output['count']['sale'] == 0) {?>javascript:;<?php } else { echo urlShop('member_favorite_store', 'more', array('store_id' => $output['store_info']['store_id'], 'sign' => 'sale')) ;}?>" class="<?php if ($_GET['sign'] == 'sale') {?>current<?php }?> <?php if ($output['count']['sale'] == 0) {?>disabled<?php }?>">优惠促销</a>
