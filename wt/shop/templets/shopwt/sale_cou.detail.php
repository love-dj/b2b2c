    ...
    <dd class="opt">
      <div class="rule-goods-list">
        <ul>
          ...
          <li title="<?php echo $g['goods_name']; ?>"> <img alt="" src="<?php echo cthumb($g['goods_image'], 60); ?>" style="width:30px;" /><a target="_blank" href="<?php echo urlShop('goods', 'index', array('goods_id' => $sku, )); ?>"><?php echo $g['goods_name']; ?> </a> <span>商品价：<em> ￥<?php echo $g['goods_sale_price']; ?></em></span>
            <?php } ?>
          </li>
        </ul>
      </div>
