        ...
        <dd class="opt nobg nopd nobd nobs">
          <div class="wtap-account-container">
            ...
            <ul class="wtap-account-container-list">
              ...
              <li>
                <label>
                  <input type="checkbox" class="checkbox" name="cache[]" value="show" >
                  <?php echo $lang['cache_cls_show'];?></label>
              </li>
              <li>
                <label>
                  <input type="checkbox" class="checkbox" name="cache[]" id="robbuy_price" value="robbuy_price" >
                  抢购价格区间</label>
              </li>
              <li>
                <label>
              ...
              <li>
                <label>
                  <input type="checkbox" class="checkbox" name="cache[]" id="bbs_level" value="bbs_level" >
                  <?php echo $lang['cache_cls_bbs_level']?></label>
              </li>
              <li>
                <label>
              ...
              <li>
                <label>
                  <input type="checkbox" class="checkbox" name="cache[]" id="fx_index" value="fx_index" >
                  分销首页管理</label>
              </li>
            </ul>
          </div>
