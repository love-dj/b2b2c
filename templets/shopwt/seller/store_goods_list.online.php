...
<div class="tabmenu">
  <?php include template('layout/submenu');?>
    <a title="批量生成商品二维码" class="wtbtn wtbtn-aqua" href="index.php?w=store_goods_online&amp;t=maker_qrcode" style="right:100px" onclick="return confirm('全部生成二维码可能超时失败，确定要生成吗？');">生成所有商品二维码</a>
  <a href="<?php echo urlShop('store_goods_add');?>" class="wtbtn wtbtn-mint" title="<?php echo $lang['store_goods_index_add_goods'];?>"> <?php echo $lang['store_goods_index_add_goods'];?></a> </div>
<form method="get" action="index.php">
  <table class="search-form">
    <input type="hidden" name="w" value="store_goods_online" />
  ...
  <thead>
    ...
    <tr>
      ...
      <td colspan="20"><label for="all" ><?php echo $lang['wt_select_all'];?></label>
        <a href="javascript:void(0);" class="wtbtn-mini" wt_type="batchbutton" uri="<?php echo urlShop('store_goods_online', 'drop_goods');?>" name="commonid" confirm="<?php echo $lang['wt_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['wt_del'];?></a> <a href="javascript:void(0);" class="wtbtn-mini" wt_type="batchbutton" uri="<?php echo urlShop('store_goods_online', 'goods_unshow');?>" name="commonid"><i class="icon-level-down"></i><?php echo $lang['store_goods_index_unshow'];?></a> <a href="javascript:void(0);" class="wtbtn-mini" wttype="batch" data-param="{url:'<?php echo urlShop('store_goods_online', 'edit_jingle');?>', sign:'jingle'}"><i></i>设置广告词</a> <a href="javascript:void(0);" class="wtbtn-mini" wttype="batch" data-param="{url:'<?php echo urlShop('store_goods_online', 'edit_plate');?>', sign:'plate'}"><i></i>设置关联版式</a> <a href="javascript:void(0);" class="wtbtn-mini" wt_type="batchbutton" uri="<?php echo urlShop('store_goods_online', 'edit_qrcode');?>" name="commonid" confirm="你确定要更新嘛？">更新二维码</a></td>
    </tr>
    <?php } ?>
  </thead>
  <tbody>
    ...
    <tr>
      <td class="trigger"><i class="tip icon-plus-sign" wttype="ajaxGoodsList" data-comminid="<?php echo $val['goods_commonid'];?>" title="点击展开查看此商品全部规格；规格值过多时请横向拖动区域内的滚动条进行浏览。"></i></td>
      ...
      <td class="tl"><dl class="goods-name">
          ...
          <dd class="serve"> <span class="<?php if ($val['goods_commend'] == 1) { echo 'open';}?>" title="店铺推荐商品"><i class="commend">荐</i></span> <span class="<?php if ($val['mobile_body'] != '') { echo 'open';}?>" title="手机端商品详情"><i class="icon-tablet"></i></span> <span class="" title="商品页面二维码"><i class="icon-qrcode"></i>
            ...
            <?php if ($val['is_fcode'] ==1) {?>
            <span><a class="wtbtn-mini wtbtn-grapefruit" href="<?php echo urlShop('store_goods_online', 'download_f_code_excel', array('commonid' => $val['goods_commonid']));?>">下载F码</a></span>
            <?php }?>
          </dd>
        </dl></td>
    ...
    <tr style="display:none;">
      <td colspan="20"><div class="wtsc-goods-sku ps-container"></div></td>
    </tr>
    <?php } ?>
    <?php } else { ?>
    <tr>
  ...
  <tfoot>
    ...
    <tr>
      ...
      <th colspan="10"><label for="all2"><?php echo $lang['wt_select_all'];?></label>
        <a href="javascript:void(0);" wt_type="batchbutton" uri="<?php echo urlShop('store_goods_online', 'drop_goods');?>" name="commonid" confirm="<?php echo $lang['wt_ensure_del'];?>" class="wtbtn-mini"><i class="icon-trash"></i><?php echo $lang['wt_del'];?></a> <a href="javascript:void(0);" wt_type="batchbutton" uri="<?php echo urlShop('store_goods_online', 'goods_unshow');?>" name="commonid" class="wtbtn-mini"><i class="icon-level-down"></i><?php echo $lang['store_goods_index_unshow'];?></a> <a href="javascript:void(0);" class="wtbtn-mini" wttype="batch" data-param="{url:'<?php echo urlShop('store_goods_online', 'edit_jingle');?>', sign:'jingle'}"><i></i>设置广告词</a> <a href="javascript:void(0);" class="wtbtn-mini" wttype="batch" data-param="{url:'<?php echo urlShop('store_goods_online', 'edit_plate');?>', sign:'plate'}"><i></i>设置关联版式</a> </th>
    </tr>
    <tr>
...
<script src="<?php echo STATIC_SITE_URL;?>/js/store_goods_list.js"></script> 
<script>
$(function(){
    //Ajax提示
    $('.tip').poshytip({
