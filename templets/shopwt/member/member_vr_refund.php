...
<div class="wrap">
  ...
  <form method="get" action="index.php">
    <input type="hidden" name="w" value="member_vr_refund" />
  ...
  <table class="wtm-default-table order">
    ...
    <tbody>
      ...
      <tr>
        <th colspan="20"> <span class="ml10"><?php echo $lang['refund_order_refundsn'].$lang['wt_colon'];?><?php echo $val['refund_sn']; ?></span><span><?php echo $lang['refund_buyer_add_time'].$lang['wt_colon'];?><?php echo date("Y-m-d H:i:s",$val['add_time']);?></span>
      ...
      <tr class="bd-line" >
        ...
        <td class="tl"><dl class="goods-name">
            ...
            <dd><?php echo $lang['refund_order_ordersn'].$lang['wt_colon'];?><a href="index.php?w=member_order_vr&t=show_order&order_id=<?php echo $val['order_id']; ?>" target="_blank"><?php echo $val['order_sn'];?></a></dd>
          </dl></td>
        <td><?php echo $val['refund_amount'];?></td>
        <td><?php echo $output['admin_array'][$val['admin_state']]; ?></td>
        <td class="bdr"><a href="index.php?w=member_vr_refund&t=view&refund_id=<?php echo $val['refund_id']; ?>" class="wtbtn"><?php echo $lang['wt_view'];?> </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <tfoot>
