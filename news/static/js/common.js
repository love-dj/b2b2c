 ...
 */
(function($) {
    $.fn.wt_text_count = function(options,submit_function) {
        var settings = $.extend({}, {max: 140}, options);
        return this.each(function() {
            $(this).after('<span wt_type="commend_count"></div>');
            var message_item = $(this).next("[wt_type='commend_count']");
 ...
 */
;(function($) {
    $.fn.wt_gallery = function(options) {
