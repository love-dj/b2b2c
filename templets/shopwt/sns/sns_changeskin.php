...
<div class="sns-skin-button"><a href="javascript:void(0);" wttype="skin_save" class="save"><?php echo $lang['wt_common_button_save'];?></a><a href="javascript:void(0);" onclick="DialogManager.close('change_skin');" class="close"><?php echo $lang['wt_cancel'];?></a></div>
...
$(function(){
	...
	$('a[wttype="skin_save"]').click(function(){
		$.get("index.php?w=sns_setting&t=skin_save&skin="+default_skin, function(data){
