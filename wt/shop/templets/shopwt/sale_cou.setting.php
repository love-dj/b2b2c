...
<div class="page">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?w=sale_cou&t=cou_setting_save">
    ...
    <div class="wtap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" id="sale_cou_price" name="sale_cou_price" value="<?php echo $output['setting']['sale_cou_price'];?>" class="input-txt">
          <span class="err"></span>
...
$(function(){
    ...
    $("#add_form").validate({
        ...
        messages : {
            sale_cou_price: {
                required : '<i class="fa fa-exclamation-bbs"></i>请输入价格',
                digits : '<i class="fa fa-exclamation-bbs"></i>请输入数字',
                min : '<i class="fa fa-exclamation-bbs"></i>请输入大于或等于0的数字'
            }
        }
    });
});
