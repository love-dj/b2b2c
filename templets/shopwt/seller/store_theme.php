...
<div class="wtsc-store-templet">
  <dl class="current-style">
    <dt class="templet-thumb"><img src="<?php echo $output['curr_theme']['curr_image'];?>" id="current_theme_img" /></dt>
    <dd><?php echo $lang['store_theme_tpl_name'];?><?php echo $lang['wt_colon'];?><strong id="current_template"><?php echo $output['curr_theme']['curr_name'];?></strong></dd>
    <dd><?php echo $lang['store_theme_style_name'];?><?php echo $lang['wt_colon'];?><strong id="current_style"><?php echo $output['curr_theme']['curr_truename'];?></strong></dd>
    <dd><?php echo $lang['store_create_store_name'];?><?php echo $lang['wt_colon'];?><strong><?php echo $output['store_info']['store_name'];?></strong></dd>
    <dd><a href="<?php echo urlShop('show_store', 'index', array('store_id' => $output['store_info']['store_id']));?>" class="wtbtn"><?php echo $lang['store_theme_homepage'];?></a></dd>
  </dl>
    ...
    <ul>
      ...
      <li>
        <dl>
          ...
          <dd><?php echo $lang['store_theme_tpl_name1'];?><?php echo $lang['wt_colon'];?><?php echo $theme['name'];?></dd>
          <dd><?php echo $lang['store_theme_style_name1'];?><?php echo $lang['wt_colon'];?><?php echo $theme['truename'];?></dd>
          <dd class="btn"> <a href="javascript:use_theme('<?php echo $theme['name'];?>','<?php echo $theme['truename'];?>');" class="wtbtn"><i class="icon-cogs"></i><?php echo $lang['store_theme_use'];?></a> <a href="javascript:preview_theme('<?php echo $theme['name'];?>');" class="wtbtn"><i class="icon-zoom-in"></i><?php echo $lang['store_theme_preview'];?></a> </dd>
        </dl>
      </li>
      <?php }?>
    </ul>
...
function use_theme(style,truename){
    ajaxget('index.php?w=store_setting&t=set_theme&style_name=' + style);
}
</script>
