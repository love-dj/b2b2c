...
<div class="wth-container wrapper">
    <div class="wtp-voucher w400 mt20 mb20">
      ...
      <div class="button"><a href="javascript:void(0);" id="getvoucherbtn" data-param='{"tid":"<?php echo $output['template_info']['voucher_t_id'];?>"}' class="wtbtn wtbtn-grapefruit">确认领取</a></div>
    </div>
</div>
<script type="text/javascript">
$(document).ready(function(){
	$("#getvoucherbtn").click(function(){
		ajaxget('index.php?w=voucher&t=getvouchersave&tid=<?php echo $output['template_info']['voucher_t_id'];?>');
	});
});
</script>