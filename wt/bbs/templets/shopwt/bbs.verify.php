...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        <li><a href="index.php?w=bbs_manage&t=bbs_list"><?php echo $lang['wt_manage'];?></a></li>
        <li><a href="javascript:void(0);" class="current"><?php echo $lang['bbs_wait_verify'];?></a></li>
      </ul>
    </div>
  </div>
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['bbs_verify_prompts_one'];?></li>
      <li><?php echo $lang['bbs_verify_prompts_two'];?></li>
    </ul>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?w=bbs_manage&t=get_xml&type=verify',
        colModel : [
