...
class goods_video_albumControl extends SystemControl{
    ...
    public function get_xmlWt() {
        ...
        foreach ($album_list as $value) {
            $param = array();
            $operation = "<a class='btn green' href='index.php?w=goods_video_album&t=video_list&video_class_id=".$value['video_class_id']."'><i class='fa fa-list-alt'></i>查看</a>";
            if ($value['store_id']) $operation = "<a class='btn red' href='javascript:void(0);' onclick='fg_del(". $value['video_class_id'] .")'><i class='fa fa-trash-o'></i>删除</a><a class='btn green' href='index.php?w=goods_video_album&t=video_list&video_class_id=".$value['video_class_id']."'><i class='fa fa-list-alt'></i>查看</a>";
     ...
     * 删除视频
     */
    public function video_class_delWt(){
     ...
     *
     */
    public function del_album_videoWt(){
     ...
     *
     */
    public function del_more_videoWt(){
        $model= Model();
