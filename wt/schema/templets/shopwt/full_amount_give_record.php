...
<div class="page" style="margin-bottom:30px; ">
  <div class="fixed-bar">
    <div class="item-title">
        ...
        <div class="container">
            <form style="display: inline-block;" method="post" action="index.php?act=full_amount_give_record">
                ...
                <a href="index.php?act=full_amount_give_record&op=export_full_give_record&member_keyword=<?php echo $_POST['member_keyword'] ;?>&start_time=<?php echo $_POST['start_time'] ;?>&end_time=<?php echo $_POST['end_time'] ;?>" style="margin-left: 46px;border: 1px solid;padding: 3px;cursor: pointer">导出EXCEL</a>
            </form>
...
<div>
    <table>
        <tr class="tr" style="background-color:#cccccc38">
            ...
            <th style="width: 400px;">本期赠送金额(元)</th>
...
<!--            <th>操作</th>-->
        ...
        <?php foreach($output['list'] as $k=>$value){?>
            <tr class="td">
                ...
                <td>
                    营业额/利润:&nbsp;<?php echo $value['platform_money'].'元' ; ?><br/>
                    分配比例:&nbsp;<?php echo $value['platform_give_rate'].'%' ; ?><br/>
                    总权益:&nbsp;<?php echo $value['total_money'].'元' ; ?><br/>
                    权益单价:&nbsp;<?php echo $value['unit_price'].'元/个' ; ?><br/>
                    剩余权益:&nbsp;<?php echo $value['rest_money'].'元' ; ?><br/>
                    权益总个数:&nbsp;<?php echo $value['total_dot'].'个' ; ?><br/>
                </td>
               <!-- <td>
