...
<div class="page">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?w=sale_pingou&t=pingou_setting_save">
    ...
    <div class="wtap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" id="sale_pingou_price" name="sale_pingou_price" value="<?php echo $output['setting']['sale_pingou_price'];?>" class="input-txt">
          <span class="err"></span>
          <p class="notic">购买拼团活动所需费用，购买后商家可以在所购买周期内发布拼团促销活动</p>
...
$(document).ready(function(){
	...
	$("#add_form").validate({
        ...
        messages : {
      		sale_pingou_price: {
       			required : '<i class="fa fa-exclamation-circle"></i>不能为空，且必须为大于0的正整数',
       			digits : '<i class="fa fa-exclamation-circle"></i>不能为空，且必须为大于0的正整数',
                min : '<i class="fa fa-exclamation-circle"></i>不能为空，且必须为大于0的正整数'
            }
        }
	});
});
