      ...
      <dl class="row">
        ...
        <dd class="opt">
          <table border="1" cellpadding="3" cellspacing="3" bordercolor="#CCC">
            <tbody>
              <tr>
                <td bgcolor="#EFF8F8"><?php echo $lang['wt_sort'];?></td>
          ...
          <p class="notic"><a href="<?php echo STATIC_SITE_URL;?>/examples/goods_class.csv" class="wtap-btn"><?php echo $lang['goods_class_import_example_tip'];?></a></p>
        </dd>
      </dl>
      <div class="bot"><a href="JavaScript:document.form1.submit();" class="wtap-btn-big wtap-btn-green"><?php echo $lang['goods_class_import_import'];?></a></div>
    </div>
  </form>
</div>
