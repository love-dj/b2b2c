...
<ul class="goods-list">
  ...
  <li>
    ...
    <a wttype="btn_add_xianshi_goods" data-storage="<?php echo $val['goods_storage'];?>" data-goods-id="<?php echo $val['goods_id'];?>" data-goods-name="<?php echo $val['goods_name'];?>" data-goods-img="<?php echo thumb($val, 240);?>" data-goods-price="<?php echo $val['goods_price'];?>" href="javascript:void(0);" class="wtbtn-mini">选择商品/修改折扣价</a> </li>
  <?php } ?>
</ul>
