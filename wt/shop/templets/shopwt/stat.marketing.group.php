...
function update_flex(){
	//加载统计列表
    $("#glist").flexigrid({
        url: 'index.php?w=stat_marketing&t=get_grouplist_xml&'+$("#formSearch").serialize(),
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
            {display: '抢购名称', name : 'robbuy_name', width : 150, sortable : false, align: 'left'},
            ...
            {display: '抢购状态', name : 'robbuy_state_text',  width : 60, sortable : true, align: 'center'},
            ...
            {display: '折扣', name : 'robbuy_rebate', width : 50, sortable : false, align: 'center'},
            {display: '抢购价', name : 'robbuy_price',  width : 60, sortable : true, align: 'center'},
    ...
    $("#flexigrid").flexigrid({
        url: 'index.php?w=stat_marketing&t=get_groupgoods_xml&'+$("#formSearch").serialize(),
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
...
$(function () {
	...
	$('#wtsubmit').click(function(){
	    $("#glist").flexOptions({url: 'index.php?w=stat_marketing&t=get_grouplist_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
	    $("#flexigrid").flexOptions({url: 'index.php?w=stat_marketing&t=get_groupgoods_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
	    update_flex();
    });
});
function fg_operation(name, bDiv){
    var stat_url = 'index.php?w=stat_marketing&t=groupgoods';
