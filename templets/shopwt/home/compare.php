...
<div class="wth-container mt10 mb10">
  <div class="wth-compare-title">基本信息对比</div>
  <?php if($output['compare_list']){ ?>
  <table class="wth-compare-table">
  ...
  <div class="wth-compare-bottom"> <a href="javascript:void(0);" wt_type="comparediff" data-param='{"type":"light"}'><i class="icon-indent-right"></i>高亮显示不同项</a> <a href="javascript:void(0);" wt_type="comparediff" data-param='{"type":"cancel"}' style="display: none;"><i class="icon-indent-left"></i>取消高亮不同项</a> <a href="javascript:void(0);" wt_type="comparesame" data-param='{"type":"hide"}'><i class="icon-resize-small"></i>隐藏相同项</a> <a href="javascript:void(0);" wt_type="comparesame" data-param='{"type":"show"}' style="display: none;"><i class="icon-resize-full"></i>显示相同项</a> <a href="javascript:void(0);" class="delall" onclick="javascript:delCompare('all','info');"><i class="icon-remove-sign"></i>清空对比栏</a></div>
  <?php } else {?>
  <table class="wth-compare-table">
    <tbody>
      <tr>
        <td class="wth-compare-null"><p> <i class="icon-search"></i>对比栏暂无对比商品，先添加对比商品再来进行详细比较吧！</p></td>
      </tr>
    </tbody>
  </table>
  <?php } ?>
...
<script type="text/javascript">
      ...
      $(document).ready(function(){
            $(".wth-compare-table tr td").mouseover(function(){
      ...
      $(document).ready(function(){
            $(".wth-compare-table tr td").mouseout(function(){
...
$(function(){
	//高亮显示和取消高亮不同项
	$("[wt_type='comparediff']").click(function(){
		//处理参数
		var data_str = '';
		eval('data_str =' + $(this).attr('data-param'));
		var type = data_str.type;
		$("[wt_type='comparediff']").show();
		$(this).hide();
	...
	//隐藏和显示相同项
	$("[wt_type='comparesame']").click(function(){
		//处理参数
		var data_str = '';
		eval('data_str =' + $(this).attr('data-param'));
		var type = data_str.type;
		$("[wt_type='comparesame']").show();
		$(this).hide();
		$("[name='isdiff[]']").each(function(){
			var itemval = $(this).val();
			if(itemval){
