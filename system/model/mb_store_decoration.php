...
class mb_store_decorationModel extends Model {
    ...
    public function __construct(){
        parent::__construct('mb_store_decoration');
    }
    ...
    public function getStoreDecorationList($condition) {
        $list = $this->table('mb_store_decoration')->where($condition)->select();
        return $list;
    }
    ...
    public function getStoreDecorationInfo($condition, $store_id = null) {
        $info = $this->table('mb_store_decoration')->where($condition)->find();
    ...
    public function getStoreDecorationInfoDetail($decoration_id, $store_id) {
        ...
        $mb_store_decoration_info = $this->getStoreDecorationInfo($condition);

        if(!empty($mb_store_decoration_info)) {
            $data = array();

            //处理装修背景设置
            $decoration_setting = array();
            if(empty($mb_store_decoration_info['decoration_setting'])) {
                ...
                $setting = unserialize($mb_store_decoration_info['decoration_setting']);
            ...
            //处理导航条样式
            $data['decoration_nav'] = unserialize($mb_store_decoration_info['decoration_nav']);

            //处理banner
            $decoration_banner = unserialize($mb_store_decoration_info['decoration_banner']);
    ...
    public function addStoreDecoration($param){
        return $this->table('mb_store_decoration')->insert($param);
    }
    ...
    public function editStoreDecoration($update, $condition){
        return $this->table('mb_store_decoration')->where($condition)->update($update);
    }
    ...
    public function getStoreDecorationBlockList($condition) {
        $list = $this->table('mb_store_decoration_block')->where($condition)->order('block_sort asc')->select();
    ...
    public function getStoreDecorationBlockInfo($condition, $store_id = null) {
        $info = $this->table('mb_store_decoration_block')->where($condition)->find();
    ...
    public function addStoreDecorationBlock($param){
        return $this->table('mb_store_decoration_block')->insert($param);
    }
    ...
    public function editStoreDecorationBlock($update, $condition){
        return $this->table('mb_store_decoration_block')->where($condition)->update($update);
    }
    ...
    public function delStoreDecorationBlock($condition){
        return $this->table('mb_store_decoration_block')->where($condition)->delete();
    }
