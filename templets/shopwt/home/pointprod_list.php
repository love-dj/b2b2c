      ...
      <dl class="searchbox">
        ...
        <dd><!-- 高级搜索start -->
          <ul>
            ...
            <?php } else { ?>
            <li wt_type="search_orderby" data-param='{"orderval":"default"}' style="cursor: pointer;">默认排序</li>
            <?php }?>
            <!-- 默认排序e --> 
            ...
            <li class="selected" wt_type="search_orderby" data-param='{"orderval":"stimeasc"}'>上架时间<em class="desc"></em></li>
            <?php } elseif ($_GET['orderby'] == 'stimeasc') {//升序选中 ?>
            <li class="selected" wt_type="search_orderby" data-param='{"orderval":"stimedesc"}'>上架时间<em class="asc"></em></li>
            <?php } else {//未选中?>
            <li wt_type="search_orderby" data-param='{"orderval":"stimedesc"}'>上架时间<em class="desc"></em></li>
            <?php } ?>
            <!-- 上架时间e --> 
            <li>&nbsp;</li>
            <!-- 会员等级s -->
            ...
            <li>所需积分：
              ...
              <a href="javascript:searchpointprod();" class="wtbtn">搜索</a> </li>
            <!-- 所需积分e -->
            <li>&nbsp;</li>
            <?php if($_SESSION['is_login'] == '1'){ ?>
            <li>
...
function searchpointprod(){
	var url = 'index.php?w=pointprod&t=index';
