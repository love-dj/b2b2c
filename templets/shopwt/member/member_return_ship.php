...
<form id="post_form" method="post" action="index.php?w=member_return&t=ship&return_id=<?php echo $output['return']['refund_id']; ?>">
  <input type="hidden" name="form_submit" value="ok" />
  <h3>请填写退货发货信息</h3>
  <dl>
    <dt><?php echo '物流公司'.$lang['wt_colon'];?></dt>
    <dd>
  ...
  <dl>
    <dt><i class="required">*</i><?php echo '物流单号'.$lang['wt_colon'];?></dt>
    <dd>
  ...
  <div class="bottom">
    <label class="submit-border">
      ...
      <a href="javascript:history.go(-1);" class="wtbtn ml10"><i class="icon-reply"></i>返回列表</a>
  </div>
</form>
