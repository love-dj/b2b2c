...
<form method="get" action="index.php" target="_self">
	<input type="hidden" name="w" value="statistics_sale" />
    <input type="hidden" name="t" value="area" />
  <table class="search-form">
    <tr>
    	<td class="tr">
    		<div class="fr">
    			<label class="submit-border"><input type="submit" class="submit" value="<?php echo $lang['wt_common_search'];?>" /></label>
    		</div>
    		<div class="fr">
...
<div id="stat_tabs" class="ui-tabs" style="min-height:500px;padding-top:10px;">
	<div class="tabmenu">
      	<ul class="tab pngFix">
      		<li><a href="#membernum_div" wt_type="showdata" data-param='{"type":"membernum"}'>下单会员数</a></li>
    ...
    <!-- 下单会员数 -->
    <div id="membernum_div" wt_type="datacontainer" class="tc">
    ...
    <!-- 下单金额 -->
    <div id="orderamount_div" wt_type="datacontainer" class="tc" style="display:none;">
        <?php if($output['stat_json_map']){ ?>
    	<div class="stat-map-color">高&nbsp;&nbsp;<span style="background-color: #fd0b07;">&nbsp;</span><span style="background-color: #ff9191;">&nbsp;</span><span style="background-color: #f7ba17;">&nbsp;</span><span style="background-color: #fef406;">&nbsp;</span><span style="background-color: #25aae2;">&nbsp;</span>&nbsp;&nbsp;低
    		<p>备注：按照排名由高到低显示：排名第1、2、3名为第一阶梯；排名第4、5、6名为第二阶梯；排名第7、8、9为第三阶梯；排名第10、11、12为第四阶梯；其余为第五阶梯。</p>
    	</div>
    ...
    <!-- 下单量 -->
    <div id="ordernum_div" wt_type="datacontainer" class="tc" style="display:none;">
    	<?php if($output['stat_json_map']){ ?>
    	<div class="stat-map-color">高&nbsp;&nbsp;<span style="background-color: #fd0b07;">&nbsp;</span><span style="background-color: #ff9191;">&nbsp;</span><span style="background-color: #f7ba17;">&nbsp;</span><span style="background-color: #fef406;">&nbsp;</span><span style="background-color: #25aae2;">&nbsp;</span>&nbsp;&nbsp;低
    		<p>备注：按照排名由高到低显示：排名第1、2、3名为第一阶梯；排名第4、5、6名为第二阶梯；排名第7、8、9为第三阶梯；排名第10、11、12为第四阶梯；其余为第五阶梯。</p>
    	</div>
...
<script type="text/javascript" src="<?php echo SHOP_TEMPLATES_URL; ?>/js/ui.core.js"></script>
<script type="text/javascript" src="<?php echo SHOP_TEMPLATES_URL; ?>/js/ui.tabs.js"></script>
<script type="text/javascript" src="<?php echo STATIC_SITE_URL;?>/js/statistics.js"></script>
<script type="text/javascript" src="<?php echo STATIC_SITE_URL;?>/highcharts/highcharts.js"></script>

<link rel="stylesheet" type="text/css" href="<?php echo STATIC_SITE_URL;?>/js/map/jquery.vector-map.css"/>
<script type="text/javascript" src="<?php echo STATIC_SITE_URL;?>/js/map/jquery.vector-map.js"></script>
<script type="text/javascript" src="<?php echo STATIC_SITE_URL;?>/js/map/china-zh.js"></script>
...
$(function(){
	...
	$("[name='searchweek_month']").change(function(){
		...
		$.getJSON('index.php?w=index&t=getweekofmonth',{y:year,m:month},function(data){
	        if(data != null){
