...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=goods_class&t=goodsclass_list" title="返回分类列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['wt_what_goods_class'];?> - 新增/编辑说说看分类<?php if(isset($output['class_info']['class_name'])) echo $output['class_info']['class_name'];?></h3>
        <h5><?php echo $lang['wt_what_goods_class_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?w=goods_class&t=goodsclass_save">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="class_parent_id"><?php echo $lang['what_parent_class'];?></label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row class_keyword">
        <dt class="tit">
          <label for="class_sort"><em>*</em><?php echo $lang['what_class_keyword'];?></label>
        </dt>
        <dd class="opt">
