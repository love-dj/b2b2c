...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=page_config&t=page_config" title="返回板块区列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        ...
        <div class="home-templates-board-layout style-<?php echo $output['web_array']['style_name'];?>">
          <div class="left">
            ...
            <dl>
              <dt>
                <h4>切换广告图片</h4>
                <a href="JavaScript:show_dialog('upload_adv');"><?php echo $lang['wt_edit'];?></a></dt>
              <dd class="adv-pic">
            ...
            <div>
              ...
              <dl recommend_id="<?php echo $key;?>">
                <dt>
                  ...
                  <a href="JavaScript:del_recommend(<?php echo $key;?>);"><i class="fa fa-trash"></i><?php echo $lang['wt_del'];?></a> <a href="JavaScript:show_recommend_dialog(<?php echo $key;?>);"><i class="fa fa-shopping-cart"></i><?php echo '商品块';?></a> 
              ...
              <?php } ?>
              <?php } ?>
              <div class="add-tab" id="btn_add_list"><a href="JavaScript:add_recommend();"><i class="icon-plus-sign-alt"></i><?php echo $lang['page_config_add_recommend'];?></a>(最多9个)</div>
            </div>
          </div>
...
<div id="upload_tit_dialog" style="display:none;">
  <div class="s-tips"><i class="fa fa-lightbulb-o"></i><?php echo $lang['page_config_prompt_tit'];?></div>
...
<div id="category_list_dialog" style="display:none;">
  <div class="s-tips"><i class="fa fa-lightbulb-o"></i><?php echo $lang['page_config_category_tips'];?></div>
...
<div id="upload_act_dialog" class="upload_act_dialog" style="display:none;">
  <div class="s-tips"><i class="fa fa-lightbulb-o"></i><?php echo $lang['page_config_prompt_act'];?></div>
  <form id="upload_act_form" name="upload_act_form" enctype="multipart/form-data" method="post" action="index.php?w=page_config&t=upload_pic" target="upload_pic">
    ...
    <input type="hidden" name="w[pic]" value="<?php echo $output['code_act']['code_info']['pic'];?>">
    <input type="hidden" name="w[type]" value="pic">
    <div class="wtap-form-default" id="upload_act_type_pic" <?php if($output['code_act']['code_info']['type'] == 'adv') { ?>style="display:none;"<?php } ?>>
      <dl class="row">
        <dt class="tit"><?php echo '活动名称';?></dt>
        <dd class="opt">
          <input class="input-txt" type="text" name="w[title]" value="<?php echo $output['code_act']['code_info']['title'];?>">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input name="w[url]" value="<?php echo !empty($output['code_act']['code_info']['url']) ? $output['code_act']['code_info']['url']:BASE_SITE_URL;?>" class="input-txt" type="text">
...
<div id="recommend_pic2_dialog" style="display:none;">
  ...
  <form id="recommend_pic2_form" name="recommend_pic2_form" enctype="multipart/form-data" method="post" action="index.php?w=page_config&t=recommend_pic2" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="web_id" value="<?php echo $output['code_recommend_list']['web_id'];?>">
    <input type="hidden" name="code_id" value="<?php echo $output['code_recommend_list']['code_id'];?>">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input class="input-txt" type="text" name="pic_list2[pic_url]" value="<?php echo BASE_SITE_URL;?>">
        </dd>
      </dl>
      <dl class="row">
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#recommend_pic2_form').submit();" class="wtap-btn-big wtap-btn-green"><span><?php echo $lang['page_config_save'];?></span></a></div>
    </div>
  </form>
</div>
<!-- 品牌模块 -->
...
<div id="upload_adv_dialog" class="upload_adv_dialog" style="display:none;">
  ...
  <form id="upload_adv_form" name="upload_adv_form" enctype="multipart/form-data" method="post" action="index.php?w=page_config&t=slide_adv" target="upload_pic">
    ...
    <div class="wtap-form-all">
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <a class="wtap-btn" href="JavaScript:add_slide_adv();"><i class="fa fa-plus"></i><?php echo '新增图片';?>&nbsp;(最多5个)</a>
          <span id="adv_slide_succ" class="web-save-succ" style="display:none;"><?php echo $lang['wt_common_save_succ'];?></span></dd>
      </dl>
    </div>
    <div id="upload_slide_adv" class="wtap-form-default" style="display:none;">
      <dl class="row">
        <dt class="tit"><?php echo '文字标题';?></dt>
        <dd class="opt">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <p class="notic"><?php echo $lang['page_config_adv_url_tips'];?></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit"><?php echo $lang['page_config_upload_adv_pic'].$lang['wt_colon'];?></dt>
        <dd class="opt">
          <div class="input-file-show"><span class="type-file-box">
            <input type='text' name='textfield' id='textfield1' class='type-file-text' />
            <input type='button' name='button' id='button1' value='选择上传...' class='type-file-button' />
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_adv_form').submit();" class="wtap-btn-big wtap-btn-green"><?php echo $lang['page_config_save'];?></a></div>
    </div>
  </form>
</div>
<!-- 商品推荐切换广告图片 -->
<div id="recommend_adv_dialog" class="recommend_adv_dialog" style="display:none;">
  ...
  <form id="recommend_adv_form" name="recommend_adv_form" enctype="multipart/form-data" method="post" action="index.php?w=page_config&t=recommend_slide" target="upload_pic">
    <input type="hidden" name="web_id" value="<?php echo $output['code_recommend_list']['web_id'];?>">
    <input type="hidden" name="code_id" value="<?php echo $output['code_recommend_list']['code_id'];?>">
    <input type="hidden" name="key_id" value="">
    <input type="hidden" name="pic_id" value="">
    <div class="wtap-form-all">
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <a class="wtap-btn" href="JavaScript:add_recommend_slide();"><i class="fa fa-plus"></i>新增图片&nbsp;(最多5个)</a>
          <span id="recommend_slide_succ" class="web-save-succ" style="display:none;"><?php echo $lang['wt_common_save_succ'];?></span></dd>
      </dl>
    </div>
    <div id="recommend_slide_adv" class="wtap-form-default" style="display:none;">
      <dl class="row">
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#recommend_adv_form').submit();" class="wtap-btn-big wtap-btn-green"><?php echo $lang['page_config_save'];?></a>
        </div>
    </div>
  </form>
</div>
...
<script src="<?php echo ADMIN_STATIC_URL?>/js/web_index_fl.js"></script>
