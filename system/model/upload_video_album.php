...
class upload_video_albumModel extends Model {
    ...
    public function add($param){
        ...
        if (is_array($param)){
            $result = Db::insert('video_album',$param);
            return $result;
        }else {
            return false;
        }
    ...
    public function updates($param){
        ...
        if (is_array($param)){
            ...
            $result = Db::update('video_album',$tmp,$where);
            return $result;
        }else {
            return false;
        }
    ...
    public function updatebywhere($param,$conditionarr){
        ...
        if (is_array($param)){
            ...
            $result = Db::update('video_album',$tmp,$condition_str);
            return $result;
        }else {
            return false;
        }
    ...
    public function del($id){
        if (intval($id) > 0){
            ...
            $result = Db::delete('video_album',$where);
            return $result;
        }else {
            return false;
        }
    ...
    public function dropUploadById($id){
        ...
        $result = Db::delete('video_album',$condition_str);
        return $result;
    }
