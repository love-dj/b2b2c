 ...
 <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3>计划任务</h3>
        <h5>计划触发相关设置</h5>
      </div> <ul class="tab-base wt-row"><li><a class="current"><span><?php echo $lang['wt_list'];?></span></a></li><li><a href="index.php?w=task&t=add"><span><?php echo $lang['wt_add'];?></span></a></li></ul>    </div>
  </div>
  <div class="explanation" id="explanation">
    <div class="title" id="checkZoom"><i class="fa fa-bell-o"></i>
      <h4 title="提示相关设置操作时应注意的要点"><?php echo $lang['wt_prompts'];?></h4>
  ...
  <table class="flex-table">
    <thead>
      <tr>
        ...
        <th width="120" class="handle" align="center"><?php echo $lang['wt_handle'];?></th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle"><a class="btn blue" href="?w=task&t=edit&id=<?php echo $v['id']; ?>'><?php echo $lang['wt_edit'];?></a>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['wt_edit'];?></a>
        <a href="javascript:;" onClick="(window.confirm('你确实要删除这个任务么！') ? location='?w=task&t=del&id=<?php echo $v['id']; ?>' : '')" class="btn red"><i class="fa fa-trash-o"></i><?php echo $lang['wt_del'];?></a>
        </td>
        <td><?php echo $v['id']; ?></td>
...
$(function(){
	$('.flex-table').flexigrid({
		...
		title: '<?php echo $lang['wt_list'];?>',// 表格标题
		reload: false,// 不使用刷新
