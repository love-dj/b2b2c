      ...
      <dl class="row">
        ...
        <dd class="opt">
          <ul class="wt-row">
            ...
            <li>
              <div class="grade-template-thumb"> <a class="nyroModal" rel="gal" href="<?php echo BASE_SITE_URL;?>/templets/<?php echo TPL_SHOP_NAME;?>/store/style/<?php echo $v;?>/screenshot.jpg"><img src="<?php echo BASE_SITE_URL;?>/templets/<?php echo TPL_SHOP_NAME;?>/store/style/<?php echo $v;?>/images/preview.jpg" ></a>
                <?php if ($v == 'default'){?>
