...
class store_waybillControl extends BaseSellerControl{
     ...
     * 模板管理
     */
    public function waybill_manageWt() {
     ...
     * 绑定运单打印模板
     */
    public function waybill_bindWt() {
     ...
     * 绑定运单打印模板保存
     */
    public function waybill_bind_saveWt() {
     ...
     * 解绑运单打印模板
     */
    public function waybill_unbindWt() {
     ...
     * 运单模板设置
     */
    public function waybill_settingWt() {
     ...
     * 运单模板设置保存
     */
    public function waybill_setting_saveWt() {
        $store_waybill_id = intval($_POST['store_waybill_id']);
        ...
        if($result) {
            showDialog(L('wt_common_save_succ'), urlShop('store_waybill', 'waybill_manage'), 'succ');
        } else {
     ...
     * 运单打印测试
     */
    public function waybill_testWt() {
        $model_waybill = Model('waybill');
     ...
     * 设置默认打印模板
     */
    public function waybill_set_defaultWt() {
        $store_waybill_id = intval($_POST['store_waybill_id']);
        ...
        if($result) {
            ...
            showMessage(L('wt_common_save_fail'), '', '', 'error');
        }
    }
     ...
     * 模板列表
     */
    public function waybill_listWt() {
        $model_waybill = Model('waybill');
     ...
     * 保存运单模板
     */
    public function waybill_saveWt() {
        $model_waybill = Model('waybill');
        $result = $model_waybill->saveWaybill($_POST, $_SESSION['store_id']);

        if($result) {
            showDialog(L('wt_common_save_succ'), urlShop('store_waybill', 'waybill_list'), 'succ');
        } else {
            showDialog(L('wt_common_save_fail'), urlShop('store_waybill', 'waybill_list'));
        }
    }
     ...
     * 编辑运单模板
     */
    public function waybill_editWt() {
        $model_express = Model('express');
        $model_waybill = Model('waybill');
     ...
     * 设计运单模板
     */
    public function waybill_designWt() {
        $model_waybill = Model('waybill');
     ...
     * 设计运单模板保存
     */
    public function waybill_design_saveWt() {
        $model_waybill = Model('waybill');
