...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['wt_news_special_manage'];?></h3>
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['news_special_list_tip1'];?></li>
...
function update_flex(){
    $("#flexigrid").flexigrid({
        url: 'index.php?w=news_special&t=news_special_xml',
        colModel : [
...
function fg_operation_del(special_id){
    if (confirm('确定删除？')) {
        window.location.href = 'index.php?w=news_special&t=news_special_drop&special_id='+special_id;
    }
}
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?w=news_special&t=news_special_add';
    }
}
</script>