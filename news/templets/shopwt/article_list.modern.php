...
<div class="sitenav-bar">
  ...
  <div class="browse-list-modern"><a href="index.php?w=article&t=article_list&class_id=<?php echo $_GET['class_id'];?>" title="<?php echo $lang['news_classical'];?>">&nbsp;</a><span title="<?php echo $lang['news_modern'];?>"><?php echo $lang['news_modern'];?></span></span></div>
</div>
  ...
  <div class="modern-box">
    ...
    <div class="modern-list">
      ...
      <div class="modern-list-tag block-style-two">
        ...
        <?php $article_url = getNEWSArticleUrl($output['article_list'][$i]['article_id']);?>
        <div class="modern-list-item">
          <div class="article-cover">
            <?php if(!empty($output['article_list'][$i]['article_image'])) { ?>
            <a href="<?php echo $article_url;?>" target="_blank"> <img class="image_lazy_load" data-src="<?php echo getNEWSArticleImageUrl($output['article_list'][$i]['article_attachment_path'], $output['article_list'][$i]['article_image'], 'list');?>" src="<?php echo getLoadingImage();?>" alt="" /> </a>
            <?php } ?>
            <h3 class="article-title"><?php echo $output['article_list'][$i]['article_title'];?> </h3>
          </div>
          <div class="article-sub"><span class="date"><?php echo date('Y-m-d',$output['article_list'][$i]['article_publish_time']);?></span><span class="PV" title="<?php echo $lang['news_text_view_count'];?>"><i></i><?php echo $output['article_list'][$i]['article_click'];?></span></div>
          <div class="article-preface"><?php echo $output['article_list'][$i]['article_abstract'];?><a href="<?php echo $article_url;?>" target="_blank"><?php echo $lang['news_read_more'];?></a></div>
