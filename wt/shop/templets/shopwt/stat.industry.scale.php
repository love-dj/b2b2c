...
<div class="page">
  ...
  <div class="wtap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      ...
      <input type="hidden" name="t" value="scale" />
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('index.php?w=stat_industry&t=scale_list&stattype='+type+'&c=<?php echo $output['searchtime'];?>&choose_gcid='+choose_gcid);
}
</script>