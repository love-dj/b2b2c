...
<div class="wtsc-form-default">
  <form id="add_form" action="index.php?w=store_sale_mansong&t=mansong_quota_add_save" method="post">
    <dl>
      <dt><i class="required">*</i><?php echo $lang['mansong_quota_add_quantity'].$lang['wt_colon'];?></dt>
      <dd>
        ...
        <p class="hint"><?php echo $lang['mansong_price_explain2'].$output['setting_config']['sale_mansong_price'].$lang['wt_yuan'];?></p>
    ...
    $("#add_form").validate({
        errorPlacement: function(error, element){
     	...
     	submitHandler:function(form){
            var unit_price = <?php echo $output['setting_config']['sale_mansong_price'];?>;
            var quantity = $("#mansong_quota_quantity").val();
            var price = unit_price * quantity;
             showDialog('<?php echo $lang['mansong_quota_add_confirm'];?>'+price+'<?php echo $lang['wt_yuan'];?>', 'confirm', '', function(){ajaxpost('add_form', '', '', 'onerror');});
    	},
        rules : {
