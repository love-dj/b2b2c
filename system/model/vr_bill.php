...
class vr_billModel extends Model {
    ...
    public function getOrderStatisList($condition = array(), $fields = '*', $pagesize = null, $order = '', $limit = null) {
        return $this->table('order_vr_statis')->where($condition)->field($fields)->order($order)->page($pagesize)->limit($limit)->select();
    }
    ...
    public function getOrderStatisInfo($condition = array(), $fields = '*',$order = null) {
        return $this->table('order_vr_statis')->where($condition)->field($fields)->order($order)->find();
    }
    ...
    public function getOrderBillList($condition = array(), $fields = '*', $pagesize = null, $order = '', $limit = null) {
        return $this->table('order_vr_bill')->where($condition)->field($fields)->order($order)->limit($limit)->page($pagesize)->select();
    }
    ...
    public function getOrderBillInfo($condition = array(), $fields = '*') {
        return $this->table('order_vr_bill')->where($condition)->field($fields)->find();
    }
    ...
    public function getOrderBillCount($condition) {
        return $this->table('order_vr_bill')->where($condition)->count();
    }

    public function addOrderStatis($data) {
        return $this->table('order_vr_statis')->insert($data);
    }

    public function addOrderBill($data) {
        return $this->table('order_vr_bill')->insert($data);
    }

    public function editOrderBill($data, $condition = array()) {
        return $this->table('order_vr_bill')->where($condition)->update($data);
    }
}
