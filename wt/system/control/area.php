...
class areaControl extends SystemControl{
    ...
    public function get_xmlWt() {
        ...
        foreach ($list as $k => $info) {
            ...
            $operation_detail .= "<li><a href=\"index.php?w=area&t=edit&area_id={$info['area_id']}\">编辑地区</a></li>";
            if ($info['area_deep'] <= 3) {
                $operation_detail .= "<li><a href=\"index.php?w=area&t=add&parent_id={$info['area_id']}\">新增下级</a></li>";
    ...
    public function saveWt() {
        ...
        if ($result) {
            showMessage('操作成功',$_GET['area_id'] ? 'index.php?w=area' : '');
        } else {
