...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=fx_member" title="返回<?php echo $lang['pending'];?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      ...
      <?php if(intval($output['member_info']['fx_state']) == 2){?>
      <tr>
        <th>当前佣金：</th>
        <td><?php echo $output['member_info']['trad_amount'];?></td>
        <th>冻结金额：</th>
        <td><?php echo $output['member_info']['freeze_fx_trad'];?></td>
        <th>可提现金额：</th>
        <td><?php echo $output['member_info']['available_fx_trad'];?></td>
      </tr>
      <?php }?>
    </tbody>
  </table>
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      <tr>
        ...
        <td><?php echo getFenxiaoBillName($output['member_info']['bill_type_code']);?></td>
      </tr>
      <tr>
        <th>收款人姓名:</th>
  ...
  <form id="form_store_verify" action="index.php?w=fx_member&t=auth" method="post">
    ...
    <?php if(in_array(intval($output['member_info']['fx_state']), array(1, 3))) { ?>
    <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
      <tbody>
        <tr>
          <th>审核意见：</th>
    ...
    <div class="bottom">
      <a id="btn_pass" class="wtap-btn-big wtap-btn-green mr10" href="JavaScript:void(0);">通过</a>
      <a id="btn_fail" class="wtap-btn-big wtap-btn-red" href="JavaScript:void(0);">拒绝</a> 
    </div>
    <?php } ?>
  </form>
</div>
