...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>商品分类</h3>
      <ul class="tab-base">
        <li><a href="index.php?w=flea_class&t=goods_class"><span>管理</span></a></li>
  ...
  <form id="goods_class_form" name="goodsClassForm" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="gc_show1" class="cb-enable <?php if($output['class_array']['gc_show'] == '1'){ ?>selected<?php }?>"><span><?php echo $lang['wt_yes'];?></span></label>
            <label for="gc_show0" class="cb-disable <?php if($output['class_array']['gc_show'] == '0'){ ?>selected<?php }?>"><span><?php echo $lang['wt_no'];?></span></label>
        ...
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="gc_index_show1" class="cb-enable <?php if($output['class_array']['gc_index_show'] == '1'){ ?>selected<?php }?>"><span><?php echo $lang['wt_yes'];?></span></label>
            <label for="gc_index_show0" class="cb-disable <?php if($output['class_array']['gc_index_show'] == '0'){ ?>selected<?php }?>"><span><?php echo $lang['wt_no'];?></span></label>
        ...
        <tr>
          <td colspan="2" class="required"><label for="gc_sort"><?php echo $lang['wt_sort'];?>:</label></td>
        </tr>
        <tr class="noborder">
      ...
      <tfoot>
        <tr class="tfoot"><td colspan="15" ><a href="JavaScript:void(0);" class="btn" id="submitBtn"><span><?php echo $lang['wt_submit'];?></span></a></td>
        </tr>
      </tfoot>
    </table>
  </form>
	...
	$('#goods_class_form').validate({
        ...
        rules : {
            gc_name : {
                required : true,
                remote   : {                
                url :'index.php?w=flea_class&t=ajax&branch=check_class_name',
                type:'get',
                data:{
                    gc_name : function(){
                        return $('#gc_name').val();
