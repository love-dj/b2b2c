...
<div class="page">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?w=sale_mansong&t=mansong_setting_save">
    ...
    <div class="wtap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" id="sale_mansong_price" name="sale_mansong_price" value="<?php echo $output['setting']['sale_mansong_price'];?>" class="input-txt">
          <span class="err"></span>
...
$(document).ready(function(){
	...
	$("#add_form").validate({
        ...
        messages : {
      		sale_mansong_price: {
       			required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['mansong_price_error'];?>',
       			digits : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['mansong_price_error'];?>',
                min : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['mansong_price_error'];?>'
            }
        }
	});
});
