...
$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php?w=member_refund&t=refund_form',{key:key,order_id:getQueryString('order_id'),order_goods_id:getQueryString('order_goods_id')}, function(result) {
        ...
        $('input[name="refund_pic"]').ajaxUploadImage({
            url : ApiUrl + "/index.php?w=member_refund&t=upload_pic",
            data:{key:key},
        ...
        $('.btn-l').click(function(){
            ...
            $.ajax({
                type:'post',
                url:ApiUrl+'/index.php?w=member_refund&t=refund_post',
                data:param,
                dataType:'json',
                async:false,
                success:function(result){
                    ...
                    window.location.href = WapSiteUrl + '/html/member/member_refund.html';
                }
            });
        });
    });
