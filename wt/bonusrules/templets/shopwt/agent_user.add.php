...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title"><a class="back" href="index.php?w=agent_user&t=index" title="返回代理列表"><i class="fa fa-arrow-circle-o-left"></i></a>
			<div class="subject">
				<h3>新增区域代理</h3>
				<h5>新增商城区域代理会员</h5>
			</div>
...
<script type="text/javascript">
    ...
    $('#user_search').on('click',function(){
    	...
    	if(user_key.length > 0){
    	    $('#show_recommend_goods_list').load('index.php?w=agent_user&t=get_userlist&user_key='+user_key);
    	}else{
    		alert('请输入搜索关键词');
    	}
    });
