...
//         Tpl::output('help_list',$help_list);
        ...
        if (!checkPlatformStore()) {
            if (C('robbuy_allow') == 1){
                // 抢购套餐
                $groupquota_info = Model('robbuy_quota')->getRobbuyQuotaCurrent($_SESSION['store_id']);
        ...
        Tpl::output('article_list_seller',$article_list);
