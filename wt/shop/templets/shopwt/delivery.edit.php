...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminShop('delivery', 'index');?>" title="返回<?php echo $lang['wt_manage'];?>列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
  ...
  <form id="delivery_form" method="post" action="<?php echo urlAdminShop('delivery', 'save_edit');?>">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row" style="display: none;" wttype="fail_reason">
        <dt class="tit">
...
$(function(){
    ...
    $('input[name="dstate"]').change(function(){
        ...
        if (_val == 20) {
            $('[wttype="fail_reason"]').show();
        } else {
            $('[wttype="fail_reason"]').hide();
        }
    });
});
</script> 
