...
<script type="text/javascript" src="<?php echo ADMIN_STATIC_URL;?>/js/dialog/dialog.js" id="wt_dialog" charset="utf-8"></script>
...
<script type="text/javascript" src="<?php echo ADMIN_STATIC_URL;?>/js/jquery.bgColorSelector.js"></script>
<script type="text/javascript" src="<?php echo ADMIN_STATIC_URL;?>/js/admincp.js"></script>
...
$(function(){
	...
	function ajaxFileUpload()
	{
		...
		(
			{
				url:'<?php echo ADMIN_SITE_URL?>/index.php?w=common&t=pic_upload&type=admin_avatar&form_submit=ok&uploadpath=<?php echo ATTACH_ADMIN_AVATAR;?>',
				secureuri:false,
				fileElementId:'_pic',
				dataType: 'json',
				...
				{
					if (data.status == 1){
						ajax_form('cutpic','<?php echo $lang['wt_cut'];?>','<?php echo ADMIN_SITE_URL?>/index.php?w=common&t=pic_cut&type=admin_avatar&x=100&y=100&resize=1&ratio=1&url='+data.url,690);
					}else{
						alert(data.msg);
					}
...
<div class="admiwtp-header">
  ...
  <div class="admiwtp-name">
    <h2><?php echo $output['html_title'];?><br>平台系统管理中心</h2>
  </div>
  ...
  <div class="admiwtp-header-r">
    <div class="manager">
      ...
      <img alt="" wttype="admin_avatar" src="<?php if (cookie('admin_avatar') != '') { echo UPLOAD_SITE_URL . '/' . ATTACH_ADMIN_AVATAR . '/' . cookie('admin_avatar'); } else {echo ADMIN_TEMPLATES_URL.'/images/login/admin.png';}?>"> </span><i class="arrow" id="admin-manager-btn" title="显示快捷管理菜单"></i>
      <div class="manager-menu">
        ...
        <ul class="wt-row" wttype="quick_link">
    ...
    <ul class="operate wt-row">
      <li style="display: none !important;" wttype="pending_matters"><a class="toast show-option" href="javascript:void(0);" onclick="$.cookie('commonPendingMatters', 0, {expires : -1});ajax_form('pending_matters', '待处理事项', '<?php echo urlAdmin('common', 'pending_matters');?>', '480');" title="查看待处理事项">&nbsp;<em>0</em></a></li>
      <li><a class="time" href="<?php echo ADMIN_SITE_URL?>/system/index.php?w=setting&t=exetarget" target="workspace"  title="手动计划任务触发">&nbsp;</a></li>
      <li><a class="sitemap show-option" wttype="map_on" href="javascript:void(0);" title="查看全部管理菜单">&nbsp;</a></li>
      ...
      <li><a class="login-out show-option" href="index.php?w=index&t=logout" title="安全退出管理中心">&nbsp;</a></li>
    </ul>
  </div>
  <div class="clear"></div>
</div>
<div class="admiwtp-container unfold">
  <div class="admiwtp-container-left">
    ...
    <!-- <div class="about" title="关于系统" onclick="ajax_form('about', '', '<?php echo urlAdmin('aboutus');?>', 640);"><i class="fa fa-copyright"></i><span>longbasz.com</span></div> -->
  </div>
