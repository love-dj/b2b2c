 ...
 */
		...
		'inform_pic_error' => '图片只能是jpg/jpeg/gif/png格式',
		'inform_handling' => '该商品已经被举报请等待处理',
		'inform_type_null' => '举报类型不存在请联系平台管理员',
		'inform_subject_null' => '举报主题不存在请联系平台管理员',
		'inform_subject_select' => '请选择举报主题',
		'inform_success' => '举报成功请等待处理',
		'inform_fail' => '举报失败请联系管理员',
		'inform_cancel_confirm' => '确认取消该举报?',
		'inform_cancel_success' => '举报取消成功',
		'inform_cancel_fail' => '举报取消失败',
		'goods_null' => '商品不存在',
