...
.dialog-share .jcarousel-item a .extra { line-height: 20px; filter:progid:DXImageTransform.Microsoft.gradient(enabled='true',startColorstr='#BFE4393C', endColorstr='#BFE4393C');background:rgba(217,54,0,0.75); color: #FFF; display: none; width: 90px; height: 20px; position: absolute; z-index: 1; bottom: 0; left: 0;}
...
<div class="dialog-share">
  <form method="post" action="index.php?w=member_snsindex&t=sharestore&<?php if($_GET['irefresh'] == 1){?>irefresh=1<?php }?>" id="sharestore_form">
    ...
    <div class="share-content">
      ...
      <!-- 验证码 -->
      <div id="ss_seccode" class="seccode"><?php echo $lang['wt_checkcode'].$lang['wt_colon']; ?>
    ...
    <!-- 防止点击Enter键提交 -->
    <div class="bottom">
      <input name="<?php echo $lang['wt_snsshare'];?>" type="button" class="button" value="<?php echo $lang['wt_snsshare'];?>" id="weibobtn_store" />
	...
	$("#weibobtn_store").click(function(){
		if($("#sharestore_form").valid()){
			...
			if(cookienum >= max_recordnum && $("#ss_seccode").css('display') == 'none'){
				...
				$("#ss_seccode").find("[name='codeimage']").attr('src','index.php?w=vercode&type=30x92&c=' + Math.random());
