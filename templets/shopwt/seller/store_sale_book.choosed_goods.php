...
<div class="eject_con">
  ...
  <?php if ($output['error'] == '') {?>
  <form id="choosed_goods_form" action="<?php echo urlShop('store_sale_book', 'choosed_goods');?>" method="post" >
    ...
    <div class="selected-goods-content">
      ...
      <dl class="goods-content">
        ...
        <dd>销售价格：<strong class="red"><?php echo $lang['currency']; ?><?php echo wtPriceFormat($output['goods_content']['goods_price']);?></strong></dd>
...
$(function(){
    ...
    $("#choosed_goods_form").validate({
        ...
        rules : {
            total_payment: {
                required : true,
                max : <?php echo $output['goods_content']['goods_price'];?>,
                min : 0.01
            },
            down_payment: {
                required : true,
