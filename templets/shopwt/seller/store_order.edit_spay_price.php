...
<?php if ($output['order_info']) {?>
  ...
  <form id="changeform" method="post" action="index.php?w=store_order&t=change_state&state_type=spay_price&order_id=<?php echo $output['order_info']['order_id']; ?>">
    ...
    <dl>
      <dt><?php echo '订单金额'.$lang['wt_colon'];?></dt>
      <dd>
    ...
    <dl class="bottom">
      <dt>&nbsp;</dt>
      <dd>
        <input type="submit" class="submit" id="confirm_button" value="<?php echo $lang['wt_ok'];?>" />
      </dd>
    </dl>
  </form>
<?php } else { ?>
