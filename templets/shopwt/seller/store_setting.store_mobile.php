...
<div class="wtsc-form-default">
  <form method="post" action="index.php?w=store_setting&t=store_mobile" enctype="multipart/form-data" id="my_store_form">
    <input type="hidden" name="form_submit" value="ok" />
    <dl>
      <dt>页头背景图<?php echo $lang['wt_colon']; ?></dt>
      <dd class="mb-sliders">
    ...
    <dl>
      <dt>轮播<?php echo $lang['wt_colon']; ?></dt>
      <dd>
...
$(function() {
    ...
    $('input.input-file').change(function() {
        ...
        $.ajaxFileUpload({
            url: 'index.php?w=store_setting&t=store_mb_sliders',
            secureuri: false,
            fileElementId: id,
            dataType: 'json',
            data: {id: id},
    ...
    $("a[data-slider-drop]").click(function() {
        ...
        $.getJSON('index.php?w=store_setting&t=store_mb_sliders_drop', {id: id}, function(d) {
            if (!d.success) {
                alert(d.error);
                return;
            }
