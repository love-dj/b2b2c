$(function() { 
    ...
    $.ajax({
        type: "post",
        url: ApiUrl + "/index.php?w=seller_address&t=address_info",
        data: {
            key: e,
            address_id: a
        },
    ...
    $(".btn").click(function() {
        if ($.sValid()) {
            ...
            var n = $("#area_info").val();
            var o = $("#is_default").prop("checked") ? 1 : 0;
            $.ajax({
                type: "post",
                url: ApiUrl + "/index.php?w=seller_address&t=address_add",
                data: {
                    key: e,
                    seller_name: r,
                    telphone: d,
                ...
                success: function(a) {
                   if (a.code==200) {
						$.sDialog({
							...
							cancelBtn: true,
							okFn: function() {
								 location.href = WapSiteUrl + "/html/seller/seller_address_list.html"
							}
						 })
