...
<div class="wtm-flow-box" id="wtmComplainFlow">
  <div class="wtm-flow-container">
    ...
    <div class="wtm-default-form">
      <form action="index.php?w=member_complain&t=complain_save" method="post" id="add_form" enctype="multipart/form-data">
        ...
        <dl>
          <dt><?php echo $lang['complain_subject_select'].$lang['wt_colon'];?></dt>
          <dd>
        ...
        <dl>
          <dt><?php echo $lang['complain_evidence_upload'].$lang['wt_colon'];?></dt>
          <dd>
            <p>
        ...
        <div class="bottom">
          <label class="submit-border"><input id="submit_button" type="button" class="submit" value="<?php echo $lang['complain_text_submit'];?>" ></label>
                <a href="javascript:history.go(-1);" class="wtbtn ml10">取消并返回</a>
        </div>
      </form>
    </div>
  </div>
