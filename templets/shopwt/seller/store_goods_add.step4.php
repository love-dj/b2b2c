...
<ul class="add-goods-step">
  ...
  <li><i class="icon icon-camera-retro "></i>
    ...
    <h2>上传商品图片</h2>
    <i class="arrow icon-angle-right"></i> </li>
  <li class="current"><i class="icon icon-ok-bbs"></i>
    <h6>STEP.4</h6>
    <h2>商品发布成功</h2>
  </li>
</ul>
<div class="alert alert-block hr32">
  <h2><i class="icon-ok-bbs mr10"></i><?php echo $lang['store_goods_step3_goods_release_success'];?>&nbsp;&nbsp;<?php if (C('goods_verify')) {?>等待管理员审核商品！<?php }?></h2>
  <div class="hr16"></div>
  <div>
    <?php if ($output['allow_gift']) {?>
    <a class="wtbtn wtbtn-mint ml30" href="<?php echo urlShop('store_goods_online', 'add_gift', array('commonid' => $_GET['commonid'], 'ref_url' => urlShop('store_goods_online', 'index')));?>"><i class="icon-gift"></i>为该商品添加赠品捆绑</a>
    <?php }?>
  </div>
  <div class="hr16"></div>
  <strong>
    <a class="ml30" target="_blank" href="<?php echo urlShop('goods', 'index', array('goods_id'=>$output['goods_id']));?>"><?php echo $lang['store_goods_step3_viewed_product'];?>&gt;&gt;</a>
  ...
  <ul class="ml30">
    ...
    <li>2. <?php echo $lang['store_goods_step3_access'];?> &quot; <?php echo $lang['wt_seller'];?>&quot; <?php echo $lang['store_goods_step3_manage'];?> &quot;<a href="<?php echo urlShop('store_goods_online', 'index');?>"><?php echo $lang['wt_member_path_goods_list'];?></a>&quot;</li>
