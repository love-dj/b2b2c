...
$(function(){
    ...
    function initPage(){
        ...
        hasMore = false;
        var type = $('#filtrate_ul').find('.selected').find('a').attr('data-state');
        var goods_name = $('#goods_name').val();
        $.ajax({
            type:'post',
            url:ApiUrl+"/index.php?w=seller_goods&t=goods_offline&page="+page+"&curpage="+curpage,
            data:{key:key, type:type, goods_name : goods_name},
            dataType:'json',
    ...
    function cancelOrderId(order_id) {
        $.ajax({
            type:"post",
            url:ApiUrl+"/index.php?w=seller_order&t=order_cancel",
