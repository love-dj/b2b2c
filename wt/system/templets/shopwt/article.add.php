...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=article&t=article" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['article_index_manage'];?> - <?php echo $lang['wt_new'];?>文章</h3>
  ...
  <form id="article_form" method="post" name="articleForm">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="article_show1" class="cb-enable selected" ><?php echo $lang['wt_yes'];?></label>
            <label for="article_show0" class="cb-disable" ><?php echo $lang['wt_no'];?></label>
      ...
      <dl class="row">
        ...
        <dd class="opt">
		  <?php showEditor('article_content', $value='', $width='700px', $height='300px', $style='visibility:hidden;',$upload_state="true", $media_open=true, $type='all');?>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
...
$(document).ready(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?w=article&t=article_pic_upload',
