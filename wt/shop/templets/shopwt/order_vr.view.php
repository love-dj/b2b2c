...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="javascript:history.back(-1)" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['order_vr_manage'];?></h3>
        <h5><?php echo $lang['order_vr_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
    ...
    <div class="wtap-order-details">
      ...
      <div class="tabs-panels">
        <div class="misc-info">
          ...
          <?php if ($output['order_info']['order_state'] == ORDER_STATE_CANCEL) { ?>
          <dl>
            <dt>订单取消日志<?php echo $lang['wt_colon'];?></dt>
        ...
        <div class="addr-note">
          ...
          <dl>
            ...
            <dt>接收手机<?php echo $lang['wt_colon'];?></dt>
        ...
        <div class="contact-info">
          ...
          <dl>
            ...
            <dt>店主名称<?php echo $lang['wt_colon'];?></dt>
          ...
          <dl>
            <dt>地&#12288;&#12288;址<?php echo $lang['wt_colon'];?></dt>
          ...
          <dl>
            <dt>交通信息<?php echo $lang['wt_colon'];?></dt>
        ...
        <div class="goods-content">
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td class="w30"><div class="goods-thumb"><a href="<?php echo BASE_SITE_URL;?>/index.php?w=goods&goods_id=<?php echo $output['order_info']['goods_id'];?>" target="_blank"><img alt="<?php echo $lang['product_pic'];?>" src="<?php echo thumb($output['order_info'], 60);?>" /> </a></span></div></td>
                <td style="text-align: left;"><a href="<?php echo BASE_SITE_URL;?>/index.php?w=goods&goods_id=<?php echo $output['order_info']['goods_id'];?>" target="_blank"><?php echo $output['order_info']['goods_name'];?></a><span class="rec"><a target="_blank" href="<?php echo urlShop('vr_snapshot', 'index', array('order_id' => $output['order_info']['order_id']));?>">[交易快照]</a></span>
                <?php if ($output['order_info']['goods_spec']) { ?>
                <?php echo $output['order_info']['goods_spec'];?>
                <?php } ?>
                  <?php if ($output['order_info']['order_sale_type'] == 1) {?>
                  抢购，
                  <?php } ?>
                  ...
                  ，过期不退款
                  <?php } ?></td>
                <td class="w80"><?php echo $lang['currency'].wtPriceFormat($output['order_info']['goods_price']);?></td>
                ...
                <td class="w80"><?php echo $output['order_info']['commis_rate'] == 200 ? '' : wtPriceFormat($output['order_info']['goods_price']*$output['order_info']['commis_rate']/100);?></td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div class="tabs-panels tabs-hide">
        <div>
          ...
          <dl>
            ...
            <dt>管理员操作时间<?php echo $lang['wt_colon'];?></dt>
