...
<div class="tabmenu">
  ...
  <a title="建立模板" class="wtbtn wtbtn-mint" href="<?php echo urlShop('store_waybill', 'waybill_add');?>">添加模板</a> </div>
...
<table class="wtsc-default-table">
  <thead>
    <tr>
      ...
      <th class="w80">启用</th>
      <th class="w200"><?php echo $lang['wt_handle'];?></th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="<?php echo urlShop('store_waybill', 'waybill_design', array('waybill_id' => $value['waybill_id']));?>" class="btn-bittersweet"><i class="icon-edit"></i>
        ...
        <p>编辑</p>
        </a></span><span><a href="javascript:;" wttype="btn_del" data-waybill-id="<?php echo $value['waybill_id'];?>" class="btn-grapefruit"><i class="icon-trash"></i>
        <p>删除</p>
        </a></span></td>
    </tr>
    <?php }?>
