...
class order_snapshotModel extends Model {
    ...
    public function createSphot($rec_id,$goods_id,$snapshot_info = array()) {
        ...
        $goods_common_info = $model_goods->getGoodsCommonInfo(array('goods_commonid'=>$goods_content['goods_commonid']),'brand_name,goods_attr,goods_custom,goods_body,plateid_top,plateid_bottom');
