...
<?php if ($output['order_info']) {?>
  ...
  <form id="changeform" method="post" action="index.php?w=store_order&t=change_state&state_type=modify_price&order_id=<?php echo $output['order_info']['order_id']; ?>">
    ...
    <dl>
      <dt><?php echo '运费'.$lang['wt_colon'];?></dt>
      <dd>
