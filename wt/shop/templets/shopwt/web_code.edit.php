...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=page_config&t=page_config" title="返回<?php echo '板块区';?>列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['page_config_index'];?> - 设计“<?php echo $output['web_array']['web_name']?>”板块</h3>
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['page_config_edit_help1'];?></li>
      <li><?php echo $lang['page_config_edit_help2'];?></li>
      <li><?php echo $lang['page_config_edit_help3'];?></li>
    </ul>
  </div>
  <div class="wtap-form-all">
    <div class="title">
      <h3><?php echo $lang['page_config_style_name'];?>:<?php echo $output['style_array'][$output['web_array']['style_name']];?></h3>
      <a href="index.php?w=page_config&t=web_edit&web_id=<?php echo $output['web_array']['web_id'];?>">设置该板块色彩</a> </div>
    <dl class="row">
      <dt class="tit">
        <label><?php echo $lang['page_config_edit_html'].$lang['wt_colon'];?></label>
      </dt>
      <dd class="opt">
        <div class="home-templates-board-box style-<?php echo $output['web_array']['style_name'];?>">

          <div class="left">
            <dl id="left_tit">
              <dt>
                <h4><?php echo $lang['page_config_picture_tit'];?></h4>
                <a href="JavaScript:show_dialog('upload_tit');"><i class="fa fa-pencil-square-o"></i><?php echo $lang['wt_edit'];?></a></dt>
            ...
            <dl>
              <dt>
                <h4><?php echo $lang['page_config_picture_act'];?></h4>
                <a href="JavaScript:show_dialog('upload_act');"><i class="fa fa-picture-o"></i><?php echo $lang['wt_edit'];?></a></dt>
              <dd class="w-pic">
            ...
            <dl>
              <dt>
                <h4><?php echo $lang['page_config_edit_category'];?></h4>
                <a href="JavaScript:show_dialog('category_list');"><i class="icon-th"></i><?php echo $lang['wt_edit'];?></a></dt>
              <dd class="category-list">
                ...
                <?php }else { ?>
                <ul>
                  <li><a href="javascript:void(0);"><?php echo $lang['page_config_gc_name'];?></a></li>
                  <li><a href="javascript:void(0);"><?php echo $lang['page_config_gc_name'];?></a></li>
                  <li><a href="javascript:void(0);"><?php echo $lang['page_config_gc_name'];?></a></li>
                  <li><a href="javascript:void(0);"><?php echo $lang['page_config_gc_name'];?></a></li>
                  <li><a href="javascript:void(0);"><?php echo $lang['page_config_gc_name'];?></a></li>
          ...
          <!--
          <div class="wt-btbrand"><dl>
              <dt>
                <h4><?php echo $lang['page_config_brand_title'];?></h4>
                <a href="JavaScript:show_dialog('brand_list');"><i class="icon-ticket"></i><?php echo $lang['wt_edit'];?></a></dt>
              <dd>
                <ul class="brands">
...
-->
                            <div class="wt-topbanner">
            
            <dl>
              <dt>
                <h4><?php echo '楼层中部切换广告';?></h4>
                <a href="JavaScript:show_dialog('upload_show');"><?php echo $lang['wt_edit'];?></a></dt>
              <dd class="show-pic">
                <div id="picture_show" class="picture">
                  <?php if(is_array($output['code_show']['code_info']) && !empty($output['code_show']['code_info'])) {
					        	$show = current($output['code_show']['code_info']);
					        	?>
                  <?php if(is_array($show) && !empty($show)) { ?>
                  <img src="<?php echo UPLOAD_SITE_URL.'/'.$show['pic_img'];?>"/>
                  <?php } ?>
                  <?php } ?>
                </div>
              </dd>
            ...
            <div>
              ...
              <dl recommend_id="<?php echo $key;?>">
                <dt>
                  ...
                  <a href="JavaScript:del_recommend(<?php echo $key;?>);"><i class="fa fa-trash"></i><?php echo $lang['wt_del'];?></a> <a href="JavaScript:show_recommend_dialog(<?php echo $key;?>);"><i class="fa fa-shopping-cart"></i><?php echo '商品块';?></a> <a href="JavaScript:show_recommend_pic_dialog(<?php echo $key;?>);"><i class="icon-lightbulb"></i><?php echo '广告块';?></a> </dt>
                <dd>
  ...
  <div class="bot"><a href="index.php?w=page_config&t=web_html&web_id=<?php echo $_GET['web_id'];?>" class="wtap-btn-big wtap-btn-green" id="submitBtn"><?php echo $lang['page_config_web_html'];?></a> </div>
</div>

<!-- 标题图片 -->
<div id="upload_tit_dialog" style="display:none;">
  <div class="s-tips"><i class="fa fa-bell-o"></i><?php echo $lang['page_config_prompt_tit'];?></div>
  <form id="upload_tit_form" name="upload_tit_form" enctype="multipart/form-data" method="post" action="index.php?w=page_config&t=upload_pic" target="upload_pic">
    ...
    <div class="wtap-form-default">
      <dl class="row">
        <dt class="tit"><?php echo $lang['page_config_upload_type'].$lang['wt_colon'];?></dt>
        <dd class="opt">
          <label title="<?php echo $lang['page_config_upload_pic'];?>">
            ...
            <span><?php echo $lang['page_config_upload_pic'];?></span></label>
      ...
      <dl id="upload_tit_type_pic" class="row" <?php if($output['code_tit']['code_info']['type'] == 'txt'){ ?>style="display:none;"<?php } ?>>
        <dt class="tit"><?php echo $lang['page_config_upload_tit'].$lang['wt_colon'];?></dt>
        <dd class="opt">
          ...
          <p class="notic"><?php echo $lang['page_config_upload_tit_tips'];?></p>
        </dd>
      </dl>
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_tit_form').submit();" class="wtap-btn-big wtap-btn-green"><?php echo $lang['wt_submit'];?></a></div>
    </div>
  </form>
</div>
<!-- 推荐分类模块 -->
<div id="category_list_dialog" style="display:none;">
  <div class="s-tips"><i class="fa fa-bell-o"></i><?php echo $lang['page_config_category_tips'];?></div>
  <form id="category_list_form">
    ...
    <div class="wtap-form-all">
      ...
      <dl class="row">
        <dt class="tit"><?php echo $lang['page_config_category_title'];?></dt>
        <dd class="opt"><div class="search-bar">商品分类：
          ...
          <p class="notic"><?php echo $lang['page_config_category_note'];?></p>
        </dd>
      </dl>
    </div>
    <div class="bot"><a href="JavaScript:void(0);" onclick="update_category();" class="wtap-btn-big wtap-btn-green"><?php echo $lang['page_config_save'];?></a></div>
  </form>
</div>
<!-- 活动图片 -->
<div id="upload_act_dialog" class="upload_act_dialog" style="display:none;">
  <div class="s-tips"><i class="fa fa-bell-o"></i><?php echo $lang['page_config_prompt_act'];?></div>
  <form id="upload_act_form" name="upload_act_form" enctype="multipart/form-data" method="post" action="index.php?w=page_config&t=upload_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
    ...
    <div class="wtap-form-default" id="upload_act_type_pic" <?php if($output['code_act']['code_info']['type'] == 'show') { ?>style="display:none;"<?php } ?>>
      <dl class="row">
      ...
      <dl class="row">
        <dt class="tit">
          <label><?php echo $lang['page_config_upload_url'].$lang['wt_colon'];?></label>
        </dt>
        <dd class="opt">
          <input name="act[url]" value="<?php echo !empty($output['code_act']['code_info']['url']) ? $output['code_act']['code_info']['url']:BASE_SITE_URL;?>" class="input-txt" type="text">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <p class="notic"><?php echo $lang['page_config_upload_act_tips'];?></p>
        </dd>
      </dl>
      <!--
       <dl class="row">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input name="act[urla]" value="<?php echo !empty($output['code_act']['code_info']['urla']) ? $output['code_act']['code_info']['urla']:BASE_SITE_URL;?>" class="input-txt" type="text">
          <p class="notic"><?php echo $lang['page_config_upload_act_url'];?></p>
        </dd>
      </dl>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input name="act[urlb]" value="<?php echo !empty($output['code_act']['code_info']['urlb']) ? $output['code_act']['code_info']['urlb']:BASE_SITE_URL;?>" class="input-txt" type="text">
          <p class="notic"><?php echo $lang['page_config_upload_act_url'];?></p>
        </dd>
      </dl>
      <dl class="row">
      ...
      -->
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_act_form').submit();" class="wtap-btn-big wtap-btn-green"><?php echo $lang['wt_submit'];?></a></div>
    </div>
  </form>
</div>
<!-- 商品推荐模块 -->
...
<div id="recommend_pic_dialog" style="display:none;">
  <div class="s-tips"><i class="fa fa-bell-o"></i><?php echo '单击广告图选中对应的位置，在底部上传和修改图片信息。';?></div>
  <form id="recommend_pic_form" name="recommend_pic_form" enctype="multipart/form-data" method="post" action="index.php?w=page_config&t=recommend_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="web_id" value="<?php echo $output['code_recommend_list']['web_id'];?>">
    <input type="hidden" name="code_id" value="<?php echo $output['code_recommend_list']['code_id'];?>">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt" id="add_recommend_pic">
          ...
          <div select_recommend_pic_id="<?php echo $key;?>" class="right-floor">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input class="input-txt" type="text" name="pic_list[pic_url]" value="<?php echo BASE_SITE_URL;?>">
        </dd>
      </dl>
      <dl class="row">
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#recommend_pic_form').submit();" class="wtap-btn-big wtap-btn-green"><span><?php echo $lang['page_config_save'];?></span></a></div>
    </div>
  </form>
</div>
<!-- 品牌模块 -->
<div id="brand_list_dialog" class="brand_list_dialog" style="display:none;">
  <div class="s-tips"><i class="fa fa-bell-o"></i><?php echo $lang['page_config_brand_tips'];?></div>
  <form id="brand_list_form">
    ...
    <div class="wtap-form-all">
      ...
      <dl class="row">
        <dt class="tit"><?php echo $lang['page_config_brand_list'];?></dt>
        <dd class="opt">
          <div class="search-bar">
            ...
            <a href="JavaScript:void(0);" onclick="get_recommend_brand();" class="wtap-btn"><?php echo $lang['wt_query'];?></a> </div>
          <div id="show_brand_list"></div>
        </dd>
      </dl>
      <div class="bot"> <a href="JavaScript:void(0);" onclick="update_brand();" class="wtap-btn-big wtap-btn-green"><?php echo $lang['page_config_save'];?></a></div>
    </div>
  </form>
</div>
<!-- 切换广告图片 -->
<div id="upload_show_dialog" class="upload_show_dialog" style="display:none;">
  <div class="s-tips"><i class="fa fa-bell-o"></i><?php echo '小提示：单击图片选中修改，拖动可以排序，最少保留1个，最多可加5个，保存后生效。';?></div>
  <form id="upload_show_form" name="upload_show_form" enctype="multipart/form-data" method="post" action="index.php?w=page_config&t=slide_show" target="upload_pic">
    <input type="hidden" name="web_id" value="<?php echo $output['code_show']['web_id'];?>">
    <input type="hidden" name="code_id" value="<?php echo $output['code_show']['code_id'];?>">
    <div class="wtap-form-all">
      <dl class="row">
        <dt class="tit"><?php echo '已上传图片';?></dt>
        <dd class="opt">
          <ul class="show dialog-show-s1">
            <?php if (is_array($output['code_show']['code_info']) && !empty($output['code_show']['code_info'])) { ?>
            <?php foreach ($output['code_show']['code_info'] as $key => $val) { ?>
            <?php if (is_array($val) && !empty($val)) { ?>
            <li slide_show_id="<?php echo $val['pic_id'];?>">
              <div class="show-pic"><span class="ac-ico" onclick="del_slide_show(<?php echo $val['pic_id'];?>);"></span><img onclick="select_slide_show(<?php echo $val['pic_id'];?>);" title="<?php echo $val['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_img'];?>"/></div>
              <input name="show[<?php echo $val['pic_id'];?>][pic_id]" value="<?php echo $val['pic_id'];?>" type="hidden">
              <input name="show[<?php echo $val['pic_id'];?>][pic_name]" value="<?php echo $val['pic_name'];?>" type="hidden">
              <input name="show[<?php echo $val['pic_id'];?>][pic_url]" value="<?php echo $val['pic_url'];?>" type="hidden">
              <input name="show[<?php echo $val['pic_id'];?>][pic_surl]" value="<?php echo $val['pic_surl'];?>" type="hidden">
              <input name="show[<?php echo $val['pic_id'];?>][pic_sname]" value="<?php echo $val['pic_sname'];?>" type="hidden">
              <input name="show[<?php echo $val['pic_id'];?>][pic_simg]" value="<?php echo $val['pic_simg'];?>" type="hidden">
              <input name="show[<?php echo $val['pic_id'];?>][pic_img]" value="<?php echo $val['pic_img'];?>" type="hidden"> 
          ...
          <a class="wtap-btn" href="JavaScript:add_slide_show();"><i class="fa fa-plus"></i><?php echo '新增图片';?>&nbsp;(最多5个)</a></dd>
      </dl>
    </div>
    <div id="upload_slide_show" class="wtap-form-default" style="display:none;">
      <dl class="row">
        <dt class="tit"><?php echo '文字标题';?></dt>
        <dd class="opt">
      ...
      <dl class="row">
        <dt class="tit"><?php echo $lang['page_config_upload_show_pic'].$lang['wt_colon'];?></dt>
        <dd class="opt">
          <div class="input-file-show"><span class="type-file-box">
            <input type='text' name='textfield' id='textfield1' class='type-file-text' />
            <input type='button' name='button' id='button1' value='选择上传...' class='type-file-button' />
          ...
          <p class="notic"><?php echo $lang['page_config_upload_pic_tips'];?></p>
        </dd>
      </dl>
      <!--
            <dl class="row">
      ...
      -->
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_show_form').submit();" class="wtap-btn-big wtap-btn-green"><?php echo $lang['page_config_save'];?></a></div>
    </div>
  </form>
</div>
...
<script src="<?php echo ADMIN_STATIC_URL?>/js/web_index.js"></script>
