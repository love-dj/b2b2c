	...
	$(".i-invite-link").click(function(){
		...
		$(this).select();
		 <?} else {?>
			...
			window.location.href="<?php echo MEMBER_SITE_URL;?>/index.php?w=login&t=index&ref_url=<?php echo BASE_SITE_URL;?>/index.php?w=invite"
		    } 
	     <?php } ?>
    ...
    <div class="span-24" id="content">
      <div class="invite-bd">
        <div class="invite-form">
          ...
          <div>
            <input type="text" readonly value="<?php echo BASE_SITE_URL;?>/#WT<?php echo $member_id;?>" class="std-input i-invite-link">
        ...
        <div class="invite-share-site clearfix"> 
          <!-- Baidu Button BEGIN -->
          <p id="bdshare" class="bdshare_t bds_tools get-codes-bdshare" data="{'url':'<?php echo BASE_SITE_URL;?>/#WT<?php echo intval($_SESSION['member_id'])*1;?>'}"> <span class="bds_more">快捷邀请：</span> <a class="bds_qzone">QQ空间</a> <a class="bds_tsina">新浪微博</a> <a class="bds_tqq">腾讯微博</a> <a class="bds_taobao">我的淘宝</a> <a class="bds_renren">人人网</a> <a class="bds_douban">豆瓣</a> </p>
          <!-- Baidu Button END --> 
        </div>
      ...
      <script type="text/javascript">
    var bds_config = {'bdText':'购买这么多年，才发现，原来在【<?php echo $output['setting_config']['site_name']; ?>】购买东西这么便宜的，赶紧试试吧，一般人我不告诉他！','bdPic':'<?php echo BASE_SITE_URL;?>/system/upfiles/shop/shopwt/snsspic.png','bdDesc':'分享个我的购物省钱小窍门，我在【<?php echo $output['setting_config']['site_name']; ?>】购买的都是正品，超便宜，省钱So easy！','review':'off'};
