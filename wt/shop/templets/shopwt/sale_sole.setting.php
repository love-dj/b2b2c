...
<div class="page">
  ...
  <form id="add_form" method="post" action="<?php echo urlAdminShop('sale_sole', 'sole_setting');?>">
    <input type="hidden" id="form_submit" name="form_submit" value="ok" />
    <div class="wtap-form-default">
      <dl class="row">
        <dt class="tit">
          <label for="sale_sole_price"><em>*</em>购买单价（元/月）</label>
        </dt>
        <dd class="opt">
          <input type="text" id="sale_sole_price" name="sale_sole_price" value="<?php echo $output['setting']['sale_sole_price'];?>" class="input-txt">
          <span class="err"></span>
