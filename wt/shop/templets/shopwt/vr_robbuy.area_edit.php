...
<div class="page">
  ...
  <form id="add_form" method="post" action="index.php?w=vr_robbuy&t=area_edit">
    <div class="wtap-form-default">
      ...
      <?php } ?>
      <div class="bot"><a id="submit" href="javascript:void(0)" class="wtap-btn-big wtap-btn-green"><?php echo $lang['wt_submit'];?></a>
...
$(document).ready(function(){
    ...
    $('#add_form').validate({
        ...
        messages : {
            area_name: {
                required : '<i class="fa fa-exclamation-bbs"></i>区域名称不能为空'
            },
            area_number:{
                number:'<i class="fa fa-exclamation-bbs"></i>区号必须是数字'
            },
            post:{
                number:'<i class="fa fa-exclamation-bbs"></i>邮编必须是数字'
            }
        }
    });
});
