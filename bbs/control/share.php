...
class shareControl extends BasebbsControl{
    ...
    public function share_qqzoneWt(){
        ...
        include_once 'sns/qqzone/oauth/qq_callback.php';
        if (!$_SESSION['qqzone']){
    ...
    public function share_sinaweiboWt(){
        ...
        include_once 'api/sns/sinaweibo/callback.php';
    ...
    public function share_qqweiboWt(){
        ...
        include_once 'api/sns/qqweibo/callback.php';
        if (!$_SESSION['qqweibo']){
            echo "<script>alert('".Language::get('sharebind_bind_fail')."');</script>";
            echo "<script>window.close();</script>";
            exit;
