...
<div class="wrap">
  ...
  <div class="wtm-default-form">
    <form method="post" id="cash_form" action="<?php echo BASE_SITE_URL;?>/index.php?w=seller_predeposit_tx&t=pd_cash_add">
...
请填写详细的开户银行分行名称，虚拟账户如支付宝、财付通填写“支付宝”、“财付通”即可。</p>
      ...
      <dl>
        ...
        <p class="hint">
              ...
              <strong class="red">还未设置支付密码</strong><a href="index.php?w=member_security&t=auth&type=modify_paypwd" class="wtbtn-mini wtbtn-aqua vm ml10" target="_blank">马上设置</a>
              <?php } ?>
        </p>
          </dd>
      </dl>
      <dl class="bottom"><dt>&nbsp;</dt>
          <dd><label class="submit-border"><input type="submit"  class="submit" value="确认提现" /></label><a class="wtbtn ml10" href="javascript:history.go(-1);">取消并返回</a></dd>
      </dl>
    </form>
  </div>
</div>
