...
<div class="wrap">
  ...
  <div class="wtm-default-form">
    <dl>
      <dt><?php echo $lang['predeposit_rechargesn'].$lang['wt_colon'];?></dt>
      <dd><?php echo $output['info']['pdr_sn']; ?></dd>
    </dl>
    <dl>
      <dt><?php echo $lang['predeposit_payment'].$lang['wt_colon'];?></dt>
      <dd><?php echo $output['info']['pdr_payment_name']; ?></dd>
    </dl>
    <dl>
      <dt><?php echo $lang['predeposit_recharge_price'].$lang['wt_colon'];?></dt>
    ...
    <dl>
      <dt><?php echo $output['info']['pdr_payment_name'].$lang['predeposit_trade_no'].$lang['wt_colon'];?></dt>
