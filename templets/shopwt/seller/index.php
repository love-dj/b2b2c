    ...
    <div class="basic-info">
      <dl class="wtsc-seller-info">
        ...
        <dd class="store-validity"><?php echo $lang['store_validity'].$lang['wt_colon'];?><strong><?php echo $output['store_info']['store_end_time_text'];?>
          ...
          <a href="index.php?w=store_info&t=reopen">马上续签</a>
          <?php } ?>
          </strong> </dd>
      </dl>
  ...
  <div class="seller-cont">
    <div class="container type-a">
      ...
      <div class="content">
        <dl class="focus">
          <dt>店铺商品发布情况：</dt>
          <dd title="已发布/<?php echo $lang['store_publish_goods'];?>"><em id="wt_goodscount">0</em>&nbsp;/&nbsp;
            <?php if ($output['store_info']['grade_goodslimit'] != 0){ echo $output['store_info']['grade_goodslimit'];} else { echo '不限';} ?>
          </dd>
          <dt><?php echo $lang['store_publish_album'].$lang['wt_colon'];?></dt>
          <dd><em id="wt_imagecount">0</em>&nbsp;/&nbsp;<?php echo $output['store_info']['grade_albumlimit'] > 0 ? $output['store_info']['grade_albumlimit'] : '不限'; ?></dd>
        </dl>
        <ul>
          <li><a href="index.php?w=store_goods_online&t=index"><?php echo $lang['store_goods_selling'];?> <strong id="wt_online"></strong></a></li>
          <?php if (C('goods_verify')) {?>
          <li><a href="index.php?w=store_goods_offline&t=index&type=wait_verify&verify=10" title="<?php echo $lang['store_inform30'];?>">发布待平台审核 <strong id="wt_waitverify"></strong></a></li>
          <li><a href="index.php?w=store_goods_offline&t=index&type=wait_verify&verify=0" title="<?php echo $lang['store_inform30'];?>">平台审核失败 <strong id="wt_verifyfail"></strong></a></li>
          <?php }?>
          <li><a href="index.php?w=store_goods_offline&t=index"><?php echo $lang['store_goods_storage'];?> <strong id="wt_offline"></strong></a></li>
          <li><a href="index.php?w=store_goods_offline&t=index&type=lock_up"><?php echo $lang['store_goods_show0'];?> <strong id="wt_lockup"></strong></a></li>
          <li><a href="index.php?w=store_consult&t=consult_list&type=to_reply"><?php echo $lang['store_to_consult'];?> <strong id="wt_consult"></strong></a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="container type-a">
      ...
      <div class="content">
        <dl class="focus">
          <dt><?php echo $lang['store_order_info'].$lang['wt_colon'];?></dt>
          <dd><a href="index.php?w=store_order"><?php echo $lang['store_order_progressing'];?> <strong id="wt_progressing"></strong></a></dd>
          <dt><?php echo $lang['store_complain_info'].$lang['wt_colon'];?></dt>
          <dd><a href="index.php?w=store_complain&select_complain_state=1"><?php echo $lang['store_complain'];?> <strong id="wt_complain"></strong></a></dd>
        </dl>
        <ul>
          <li><a href="index.php?w=store_order&t=index&state_type=state_new"><?php echo $lang['store_order_pay'];?> <strong id="wt_payment"></strong></a></li>
          <li><a href="index.php?w=store_order&t=index&state_type=state_pay"><?php echo $lang['store_shipped'];?> <strong id="wt_delivery"></strong></a></li>
          <li><a href="index.php?w=store_refund&lock=2"> <?php echo '售前退款';?> <strong id="wt_refund_lock"></strong></a></li>
          <li><a href="index.php?w=store_refund&lock=1"> <?php echo '售后退款';?> <strong id="wt_refund"></strong></a></li>
          <li><a href="index.php?w=store_return&lock=2"> <?php echo '售前退货';?> <strong id="wt_return_lock"></strong></a></li>
          <li><a href="index.php?w=store_return&lock=1"> <?php echo '售后退货';?> <strong id="wt_return"></strong></a></li>
          <li><a href="index.php?w=store_bill&t=index&bill_state=1"> <?php echo '待确认账单';?> <strong id="wt_bill_confirm"></strong></a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="container type-d h500">
      ...
      <div class="content">
        <?php if (C('robbuy_allow') == 1){ ?>
        <dl class="tghd">
          <dt class="p-name"> <a href="index.php?w=store_robbuy"><?php echo $lang['store_robbuy'];?></a></dt>
          <dd class="p-ico"></dd>
          <dd class="p-hint">
          ...
          <dd class="p-info"><?php echo $lang['store_robbuy_info'];?></dd>
          <?php if (!empty($output['groupquota_info'])) {?>
          <dd class="p-point">(续费至：<?php echo date('Y-m-d', $output['groupquota_info']['end_time']);?>)</dd>
          <?php }?>
        </dl>
        <?php } ?>
        <?php if (intval(C('sale_allow')) == 1){ ?>
        <dl class="xszk">
          <dt class="p-name"><a href="index.php?w=store_sale_xianshi&t=xianshi_list"><?php echo $lang['store_xianshi'];?></a></dt>
          <dd class="p-ico"></dd>
        ...
        <dl class="mjs">
          <dt class="p-name"><a href="index.php?w=store_sale_mansong&t=mansong_list"><?php echo $lang['store_mansong'];?></a></dt>
          <dd class="p-ico"></dd>
          <dd class="p-hint"><span>
        ...
        <dl class="zhxs">
          <dt class="p-name"><a href="index.php?w=store_sale_bundling&t=bundling_list"><?php echo $lang['store_bundling'];?></a></dt>
          <dd class="p-ico"></dd>
          <dd class="p-hint"><span>
        ...
        <dl class="tjzw">
          <dt class="p-name"><a href="index.php?w=store_sale_booth&t=booth_list">推荐展位</a></dt>
          <dd class="p-ico"></dd>
          <dd class="p-hint"><span>
        ...
        <dl class="djq">
          <dt class="p-name"><a href="index.php?w=store_voucher"><?php echo $lang['store_voucher'];?></a></span></dt>
          <dd class="p-ico"></dd>
          <dd class="p-hint"><span>
...
$(function(){
    ...
    $.getJSON('index.php?w=seller_center&t=statistics&rand='+timestamp, null, function(data){
