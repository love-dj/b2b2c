...
class wxpay_h5
{
    ...
    public function __construct()
    {
        $this->config = (object) array(
            ...
            'notifyUrl' => MOBILE_SITE_URL . '/api/payment/wxpay_h5/notify_url.php',
            'finishedUrl' => WAP_SITE_URL . '/html/member/payment_result.html?_=2&attach=_attach_',
            'undoneUrl' => WAP_SITE_URL . '/html/member/payment_result_failed.html?_=2&attach=_attach_',
    ...
    public function paymentHtml($control = null) 
    {
        ...
        $mweb_url = $this->getMweb_url();
        $params = array();
		@header('Location: '.$mweb_url);die();
        return <<<EOB
<!DOCTYPE html>
<html>
<head>
...
EOB;
    ...
    public function getOpenIdThroughMultipleRequests()
    {
        if (empty($_GET['code'])) {
			...
			$backurl = BASE_SITE_URL . $_SERVER['REQUEST_URI'];
            $url = sprintf(
