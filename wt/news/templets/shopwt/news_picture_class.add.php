...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=news_picture_class&t=news_picture_class_list" title="返回图刊分类列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['wt_news_picture_class'];?> - <?php echo $lang['wt_new'];?></h3>
        <h5><?php echo $lang['wt_news_picture_class_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form id="add_form" method="post" action="index.php?w=news_picture_class&t=news_picture_class_save">
