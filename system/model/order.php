...
class orderModel extends Model {
    ...
    public function getOrderExtendInfo(& $order_info) {
        ...
        if ($order_info['order_type'] == 4) {//拼团订单
            ...
            $order_info['pingou_info'] = $_info;
            if ($order_info['if_store_send'] && $_info['lock_state'] == 1) {
