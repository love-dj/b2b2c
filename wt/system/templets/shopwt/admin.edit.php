...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=admin&t=admin" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['wt_limit_manage'];?> - <?php echo $lang['wt_edit'];?>管理员“<?php echo $output['admininfo']['admin_name'];?>”</h3>
  ...
  <form id="admin_form" method="post" action='index.php?w=admin&t=admin_edit&admin_id=<?php echo $output['admininfo']['admin_id'];?>'>
