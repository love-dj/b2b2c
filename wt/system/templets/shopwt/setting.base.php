  ...
  <form method="post" enctype="multipart/form-data" name="form1">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        ...
        <dl class="row">
            <dt class="tit"><?php echo $lang['site_imchat'];?></dt>
            <dd class="opt">
                <div class="onoff">
                    <label for="site_imchat1" class="cb-enable <?php if($output['list_setting']['site_imchat'] == '1'){ ?>selected<?php } ?>" ><?php echo $lang['open'];?></label>
                    <label for="site_imchat0" class="cb-disable <?php if($output['list_setting']['site_imchat'] == '0'){ ?>selected<?php } ?>" ><?php echo $lang['close'];?></label>
                    <input id="site_imchat1" name="site_imchat" <?php if($output['list_setting']['site_imchat'] == '1'){ ?>checked="checked"<?php } ?>  value="1" type="radio">
                    <input id="site_imchat0" name="site_imchat" <?php if($output['list_setting']['site_imchat'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio">
                </div>
                <p class="notic"><?php echo $lang['site_imchat_notice'];?></p>
            </dd>
        </dl>
        <dl class="row">
            <dt class="tit"><?php echo $lang['short_video'];?></dt>
            <dd class="opt">
                <div class="onoff">
                    <label for="short_video1" class="cb-enable <?php if($output['list_setting']['short_video'] == '1'){ ?>selected<?php } ?>" ><?php echo $lang['open'];?></label>
                    <label for="short_video0" class="cb-disable <?php if($output['list_setting']['short_video'] == '0'){ ?>selected<?php } ?>" ><?php echo $lang['close'];?></label>
                    <input id="short_video1" name="short_video" <?php if($output['list_setting']['short_video'] == '1'){ ?>checked="checked"<?php } ?>  value="1" type="radio">
                    <input id="short_video0" name="short_video" <?php if($output['list_setting']['short_video'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio">
                </div>
                <p class="notic"><?php echo $lang['short_video_notice'];?></p>
            </dd>
        </dl>
		
      <dl class="row">
        <dt class="tit"><?php echo $lang['site_area'];?></dt>
        <dd class="opt">
          <div class="onoff">
            <label for="site_area1" class="cb-enable <?php if($output['list_setting']['site_area'] == '1'){ ?>selected<?php } ?>" ><?php echo $lang['open'];?></label>
            <label for="site_area0" class="cb-disable <?php if($output['list_setting']['site_area'] == '0'){ ?>selected<?php } ?>" ><?php echo $lang['close'];?></label>
            <input id="site_area1" name="site_area" <?php if($output['list_setting']['site_area'] == '1'){ ?>checked="checked"<?php } ?>  value="1" type="radio">
            <input id="site_area0" name="site_area" <?php if($output['list_setting']['site_area'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio">
          </div>
          <p class="notic"><?php echo $lang['site_area_notice'];?></p>
        </dd>
      </dl>
