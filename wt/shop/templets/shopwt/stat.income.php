...
function update_flex(){
	$('.wtap-stat-general-single').load('index.php?w=stat_trade&t=get_plat_income&'+$("#formSearch").serialize(),
		function(){
			$('.timer').each(count);
     	});

    $("#flexigrid").flexigrid({
        url: 'index.php?w=stat_trade&t=get_income_xml&'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?w=stat_trade&t=income';
