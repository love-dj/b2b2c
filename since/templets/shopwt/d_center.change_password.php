...
<form method="post" id="change_password_form" action="<?php echo DELIVERY_SITE_URL?>/index.php?w=d_center&t=change_password">
  <input type="hidden" name="form_submit" value="ok" />
  <dl class="wtd-change-password" id="changePassword">
    <dd>
