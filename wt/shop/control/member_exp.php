...
class member_expControl extends SystemControl{
    ...
    public function expsettingWt(){
        ...
        if (chksubmit()){
            ...
            if ($result === true){
                $this->log(L('wt_edit,wt_exppoints_manage,wt_exppoints_setting'),1);
    ...
    public function member_gradeWt(){
        ...
        if (chksubmit()){
            ...
            if ($result){
                $this->log(L('wt_edit,wt_member_grade'),1);
                showDialog(L('wt_common_save_succ'),'reload','succ');
            } else {
                $this->log(L('wt_edit,wt_member_grade'),0);
