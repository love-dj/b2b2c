...
<div class="wtsc-form-default">
  <div class="alert"><strong><?php echo $lang['wt_explain'].$lang['wt_colon'];?></strong><?php echo $lang['store_callcenter_notes'];?>
    </li>
  </div>
  <form method="post" action="index.php?w=store_callcenter&t=save" id="callcenter_form" onsubmit="ajaxpost('callcenter_form','','','onerror')" class="wts-message">
    <input type="hidden" name="form_submit" value="ok" />
    <dl wttype="pre">
      <dt><?php echo $lang['store_callcenter_presales_service'].$lang['wt_colon']?></dt>
      <dd>
        <div class="wts-message-title"><span class="name"><?php echo $lang['store_callcenter_service_name'];?></span><span class="tool"><?php echo $lang['store_callcenter_service_tool'];?></span><span class="number"><?php echo $lang['store_callcenter_service_number'];?></span></div>
        <?php if(empty($output['storeinfo']['store_presales'])){?>
        <div class="wts-message-list"><span class="name tip" title="<?php echo $lang['store_callcenter_name_title'];?>">
          ...
          </span><span class="del"><a wttype="del" href="javascript:void(0);" class="wtbtn"><i class="icon-trash"></i><?php echo $lang['wt_delete'];?></a></span></div>
        <?php }else{?>
        ...
        <?php }?>
        <?php }?>
        <p><span><a href="javascript:void(0);" onclick="add_service('pre');" class="wtbtn wtbtn-aqua mt10"><i class="icon-plus"></i><?php echo $lang['store_callcenter_add_service'];?></a></span></p>
      </dd>
    </dl>
    <dl wttype="after" >
      <dt><?php echo $lang['store_callcenter_aftersales_service'].$lang['wt_colon'];?></dt>
      <dd>
        <div class="wts-message-title"><span class="name"><?php echo $lang['store_callcenter_service_name'];?></span><span class="tool"><?php echo $lang['store_callcenter_service_tool'];?></span><span class="number"><?php echo $lang['store_callcenter_service_number'];?></span></div>
        ...
        <div class="wts-message-list"><span class="name tip" title="<?php echo $lang['store_callcenter_name_title'];?>">
          ...
          </span><span><a wttype="del" href="javascript:void(0);" class="wtbtn"><i class="icon-trash"></i><?php echo $lang['wt_delete'];?></a></span> </div>
        <?php }else{?>
        ...
        <?php }?>
        <?php }?>
        <p><span><a href="javascript:void(0);" onclick="add_service('after');" class="wtbtn wtbtn-aqua mt10"><i class="icon-plus"></i><?php echo $lang['store_callcenter_add_service'];?></a></span></p>
      </dd>
    </dl>
    <dl >
      <dt><em class="pngFix"><?php echo $lang['store_callcenter_working_time'].$lang['wt_colon'];?></em></dt>
      <dd>
        <div class="wts-message-title"><span><?php echo $lang['store_callcenter_working_time_title'];?></span></div>
        <div>
    ...
    <div class="bottom">
      <label class="submit-border"><input type="submit" class="submit" value="<?php echo $lang['wt_common_button_submit'];?>" /></label>
    </div>
  </form>
</div>
...
$(function(){
	$('#callcenter_form').find('a[wttype="del"]').live('click', function(){
...
function add_service(param){
	...
	obj = $('dl[wttype="'+param+'"]').children('dd').find('p');
	len = $('dl[wttype="'+param+'"]').children('dd').find('div').length;
	key = 'k'+len+Math.floor(Math.random()*100);
	var add_html = '';
	add_html += '<div class="wts-message-list">';
	...
	add_html += '<span class="del"><a wttype="del" href="javascript:void(0);" class="wtbtn"><i class="icon-trash"></i><?php echo $lang['wt_delete'];?></a></span>';
	add_html += '</div>';
	obj.before(add_html);
	titleTip();
}
