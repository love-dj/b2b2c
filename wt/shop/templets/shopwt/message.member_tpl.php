    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="handle-s"><a class="btn blue" href="<?php echo urlAdminShop('message', 'member_tpl_edit', array('code' => $val['mmt_code']));?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['wt_edit'];?></a></td>
