...
class statistics_goodsControl extends BaseSellerControl {
    ...
    public function __construct(){
        ...
        //处理搜索时间
        if (in_array($this->search_arr['t'],array('price','hotgoods'))){
    ...
    public function goodsinfoWt(){
        ...
        //查询商品信息
        $goods_content = Model('goods')->getGoodsInfoByID($goods_id, 'goods_name');
        if (!$goods_content){
            Tpl::output('stat_msg','参数错误');
            Tpl::showpage($templatesname,'null_layout');
        }
        ...
        $stat_count['ordergamount'] = wtPriceFormat($stat_count['ordergamount']);
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'goodslist','menu_name'=>'商品详情',   'menu_url'=>'index.php?w=statistics_goods&t=goodslist'),
            2=>array('menu_key'=>'price','menu_name'=>'价格销量',   'menu_url'=>'index.php?w=statistics_goods&t=price'),
            3=>array('menu_key'=>'hotgoods','menu_name'=>'热卖商品',    'menu_url'=>'index.php?w=statistics_goods&t=hotgoods'),
        );
