...
<ul class="goods-list">
  ...
  <li>
    ...
    <a wttype="a_choose_goods" data-gid='<?php echo $val['goods_id'];?>' data-type="book" href="javascript:void(0);" class="wtbtn-mini">定金预售</a> 
    <a wttype="a_choose_goods" data-gid='<?php echo $val['goods_id'];?>' data-type="presell" href="javascript:void(0);" class="wtbtn-mini">全款预售</a>
    </li>
  <?php } ?>
</ul>
