...
<div class="wtsc-form-default">
  <dl>
    ...
    <dd>
      <form id="design_form" action="<?php echo urlShop('store_waybill', 'waybill_design_save');?>" method="post">
        ...
        <ul id="waybill_item_list" class="wtsc-form-checkbox-list">
          ...
          <li>
            ...
            <i wttype="btn_item_edit" data-item-name="<?php echo $key;?>" title="微调" class="icon-edit"></i>
  ...
  <div class="bottom"><label class="submit-border"><input id="submit"  type="submit" class="submit" value="<?php echo $lang['wt_submit'];?>"></label></div>
</div>
<div id="dialog_item_edit" class="eject_con" style="display:none;">
  ...
  <div class="bottom"><a id="btn_dialog_submit" class="wtbtn wtbtn-mint" href="javascript:;">确认</a> <a id="btn_dialog_cancel" class="wtbtn" href="javascript:;">取消</a></div> </div>
