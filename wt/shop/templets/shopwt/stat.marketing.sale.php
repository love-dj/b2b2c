...
<div class="page">
  ...
  <div class="wtap-form-all wtap-stat-general-single">
    <div class="title">
      <h3>促销情况一览</h3>
    </div>
    <dl class="row">
      <dd class="opt">
        <ul class="wt-row">
          ...
          <li title="下单金额：<?php echo wtPriceFormat($output['statcount']['orderamount']);?>元">
            <h4>下单金额</h4>
            <h2 id="count-number" class="timer" data-speed="1500" data-to="<?php echo wtPriceFormat($output['statcount']['orderamount']);?>"></h2>
            <h6>元</h6>
          </li>
        </ul>
      </dd>
  ...
  <div id="stat_tabs">
    <ul class="tab-base wt-row">
      <li><a href="#ordernum_div" wt_type="showlinelabels" data-param='{"type":"ordernum"}'>下单量</a></li>
      <li><a href="#goodsnum_div" wt_type="showlinelabels" data-param='{"type":"goodsnum"}'>下单商品数</a></li>
      <li><a href="#orderamount_div" wt_type="showlinelabels" data-param='{"type":"orderamount"}'>下单金额</a></li>
    </ul>
  ...
  <div class="wtap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      <input type="hidden" name="w" value="stat_marketing" />
...
<script type="text/javascript" src="<?php echo ADMIN_STATIC_URL?>/js/jquery.numberAnimation.js"></script>
...
$(function() {
	...
	$("[wt_type='showlinelabels']").click(function(){
...
function getLineLabels(stattype){
	...
	if(!$("#"+stattype+'_div').html()){
		$("#"+stattype+'_div').load('index.php?w=stat_marketing&t=saletrend&search_type='+search_type+'&stattype='+stattype+'&c=<?php echo $output['searchtime'];?>');
	}
}
</script>