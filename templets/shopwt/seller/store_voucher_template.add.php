<link type="text/css" rel="stylesheet" href="<?php echo STATIC_SITE_URL."/js/jquery-ui/themes/ui-lightness/jquery.ui.css";?>"/>
  ...
  <div class="tabmenu">
	...
	<div class="wtsc-form-default">
	  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?w=store_voucher&t=<?php echo $output['type']=='add'?'templateadd':'templateedit'; ?>">
	  	<input type="hidden" id="w" name="w" value="store_voucher"/>
	  	<?php if ($output['type'] == 'add'){?>
	  	<input type="hidden" id="t" name="t" value="templateadd"/>
	  	<?php }else {?>
	  	<input type="hidden" id="t" name="t" value="templateedit"/>
	  	<input type="hidden" id="tid" name="tid" value="<?php echo $output['t_info']['voucher_t_id'];?>"/>
	  	<?php }?>
	  	<input type="hidden" id="form_submit" name="form_submit" value="ok"/>
	    <dl>
	      <dt><i class="required">*</i><?php echo $lang['voucher_template_title'].$lang['wt_colon']; ?></dt>
	      <dd>
...
<?php } ?>
	    ...
	    <dl>
	      <dt><i class="required">*</i><?php echo $lang['voucher_template_total'].$lang['wt_colon']; ?></dt>
	      <dd>
	    ...
	    <dl id="eachlimit_dl">
	      <dt><i class="required">*</i><?php echo $lang['voucher_template_eachlimit'].$lang['wt_colon']; ?></dt>
	      <dd>
	      	<select name="eachlimit" class="w80">
	      		<option value="0"><?php echo $lang['voucher_template_eachlimit_item'];?></option>
	      		<?php for($i=1;$i<=intval(C('sale_voucher_buyertimes_limit'));$i++){?>
	    ...
	    <dl>
	      <dt><i class="required">*</i><?php echo $lang['voucher_template_orderpricelimit'].$lang['wt_colon']; ?></dt>
	      <dd>
	    ...
	    <dl>
	      <dt><i class="required">*</i><?php echo $lang['voucher_template_describe'].$lang['wt_colon']; ?></dt>
	      <dd>
	    ...
	    <dl>
	      <dt><i class="required">*</i><?php echo $lang['voucher_template_image'].$lang['wt_colon']; ?></dt>
	      <dd>
          <div id="customimg_preview" class="wtsc-upload-thumb voucher-pic"><p><?php if ($output['t_info']['voucher_t_customimg']){?>
          ...
          <input type="file" hidefocus="true" size="1" class="input-file" name="customimg" id="customimg" wt_type="customimg"/>
          </span>
	    ...
	    <div class="bottom">
	      ...
	      <a id='btn_add' class="submit" href="javascript:void(0);"><?php echo $lang['wt_submit'];?></a>
	      </label>
	      </div>
	  </form>
	</div>
