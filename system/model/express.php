...
class expressModel extends Model {
    ...
    function getOrderTracesByJson($e_code, $shipping_code){
		$requestData= '{"ShipperCode":"'.$e_code.'","LogisticCode":"'.$shipping_code.'"}';//改进
		...
		curl_setopt($ch, CURLOPT_URL, 'http://api.kdniao.com/Ebusiness/EbusinessOrderHandle.aspx');
