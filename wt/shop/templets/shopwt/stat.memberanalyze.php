...
<div class="page">
  ...
  <div class="wtap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      ...
      <input type="hidden" name="t" value="analyze" />
...
$(function() {
    ...
    $("#list_ordernum").flexigrid({
        url: 'index.php?w=stat_member&t=get_analyzeinfo_xml&type=ordernum&c=<?php echo $output['searchtime'];?>',
        colModel : [
    ...
    $("#list_orderamount").flexigrid({
        url: 'index.php?w=stat_member&t=get_analyzeinfo_xml&type=orderamount&c=<?php echo $output['searchtime'];?>',
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
            {display: '序号', name : 'number', width : 100, sortable : false, align: 'center'},
            {display: '会员名称', name : 'statm_membername',  width : 150, sortable : false, align: 'center'},
    ...
    $("#list_goodsnum").flexigrid({
        url: 'index.php?w=stat_member&t=get_analyzeinfo_xml&type=goodsnum&c=<?php echo $output['searchtime'];?>',
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
            {display: '序号', name : 'number', width : 100, sortable : false, align: 'center'},
            {display: '会员名称', name : 'statm_membername',  width : 150, sortable : false, align: 'center'},
...
function fg_operation_excel(stat_type,obj){
    var stat_url = 'index.php?w=stat_member&t=analyzeinfo&exporttype=excel&c=<?php echo $output['searchtime'];?>&type='+stat_type;
