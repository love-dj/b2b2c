...
<div class="wtsc-form-default">
  <form id="add_form" action="<?php echo urlShop('store_waybill', 'waybill_setting_save');?>" method="post">
    ...
    <dl>
      <dt><i class="required">*</i>左偏移<?php echo $lang['wt_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>上偏移<?php echo $lang['wt_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>显示项目<?php echo $lang['wt_colon'];?></dt>
      <dd>
        <?php if(!empty($output['store_waybill_data']) && is_array($output['store_waybill_data'])) {?>
        <ul class="wtsc-form-checkbox-list">
