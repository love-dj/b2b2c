...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=sns_member" title="返回会员标签列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
  ...
  <form id="membertag_form" method="post" enctype="multipart/form-data">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label><?php echo $lang['wt_recommend'];?></label>
        </dt>
        <dd class="opt">
          <div class="onoff">
            <label for="mtag_recommend1" class="cb-enable <?php if($output['mtag_info']['mtag_recommend'] == 1){?>selected<?php }?>"><?php echo $lang['wt_yes'];?></label>
            <label for="mtag_recommend0" class="cb-disable <?php if($output['mtag_info']['mtag_recommend'] == 0){?>selected<?php }?>"><?php echo $lang['wt_no'];?></label>
      ...
      <dl class="row">
        <dt class="tit">
          <label for="mtag_sort"><?php echo $lang['wt_sort'];?></label>
        </dt>
        <dd class="opt">
...
$(function(){
	...
	$('#membertag_form').validate({
        ...
        messages : {
        	membertag_name : {
                required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['sns_member_tag_name_null_error'];?>',
                maxlength: '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['sns_member_tag_name_max_error'];?>'
            },
            membertag_sort : {
            	digits   : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['sns_member_tag_sort_error'];?>'
            },
            membertag_desc :{
				maxlength: '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['sns_member_tag_desc_max_error'];?>'
            }
        }
    });
});
