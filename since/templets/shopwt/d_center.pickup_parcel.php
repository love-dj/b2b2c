...
<form method="post" action="<?php echo DELIVERY_SITE_URL?>/index.php?w=d_center&t=pickup_parcel" id="pickup_parcel_form">
  <input type="hidden" name="form_submit" value="ok" />
  <input type="hidden" name="order_id" value="<?php echo $_GET['order_id'];?>">
  <dl class="wtd-change-password" id="pickupParcel">
  <dd>
