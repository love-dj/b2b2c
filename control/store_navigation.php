...
class store_navigationControl extends BaseSellerControl {
    ...
    public function navigation_listWt() {
    ...
    public function navigation_saveWt() {
        $sn_info = array(
        ...
        showDialog(L('wt_common_op_succ'), urlShop('store_navigation', 'navigation_list'), 'succ');
    }
    ...
    public function navigation_delWt() {
        ...
        if($sn_id > 0) {
            ...
            showDialog(L('wt_common_op_fail'), urlShop('store_navigation', 'navigation_list'), 'error');
        }
    }
