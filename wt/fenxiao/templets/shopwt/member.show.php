...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?w=fx_member&t=get_member_xml&member_id=<?php echo intval($output['member_id']);?>',
        colModel : [
            ...
            {display: '佣金', name : 'fx_pay_amount', width : 80, sortable : true, align: 'center'}, 
            {display: '结算时间', name : 'fx_pay_time', width : 100, sortable : true, align: 'center'},
