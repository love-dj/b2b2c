$(function (){
    ...
    if(key){
       ...
       // html += '<a href="' + WapSiteUrl + '/news/index.html" class="gotop">资讯</a>' + "</div>" + '<!--<div class="copyright">' + 'Copyright&nbsp;&copy;&nbsp;2008-2019 <a href="javascript:void(0);">http://www.longbasz.com</a>版权所有' + "</div>--></div>";
        
      if (cart_count > 0) {
			  var fnav = '<div id="footnav" class="footnav clearfix"><ul>'
				  +'<li><a href="'+WapSiteUrl+'"><i class="home"></i><p>首页</p></a></li>'
				  +'<li><a href="'+WapSiteUrl+'/html/product_first_categroy.html"><i class="categroy"></i><p>分类</p></a></li>'
				  +'<li><a href="'+WapSiteUrl+'/html/search.html"><i class="search"></i><p>搜索</p></a></li>'
				  +'<li><a href="'+WapSiteUrl+'/html/cart_list.html"><span id="cart_count"><i class="cart"></i><sup>' + cart_count + '</sup></span><p>购物车</p></a></li>'
				  +'<li><a href="'+WapSiteUrl+'/html/member/member.html"><i class="member"></i><p>我的商城</p></a></li></ul>'
				  +'</div>';
      	} else {
      	var fnav = '<div id="footnav" class="footnav clearfix"><ul>'
		+'<li><a href="'+WapSiteUrl+'"><i class="home"></i><p>首页</p></a></li>'
		+'<li><a href="'+WapSiteUrl+'/html/product_first_categroy.html"><i class="categroy"></i><p>分类</p></a></li>'
		+'<li><a href="'+WapSiteUrl+'/html/search.html"><i class="search"></i><p>搜索</p></a></li>'
		+'<li><a href="'+WapSiteUrl+'/html/cart_list.html"><span id="cart_count"><i class="cart"></i></span><p>购物车</p></a></li>'
		+'<li><a href="'+WapSiteUrl+'/html/member/member.html"><i class="member"></i><p>我的商城</p></a></li></ul>'
		+'</div>';
      	}
