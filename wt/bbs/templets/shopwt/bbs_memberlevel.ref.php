  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        <li><a href="index.php?w=bbs_memberlevel"><?php echo $lang['bbs_defaultlevel'];?></a></li>
        <li><a href="JavaScript:void(0);" class="current"><?php echo $lang['bbs_memberlevelref'];?></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="flex-table">
      <thead>
        <tr>
          ...
          <th width="150" align="left"><?php echo $lang['bbs_memberlevelgroup'];?></th>
          <th width="150" align="center"><?php echo $lang['bbs_addtime'];?></th>
          <th width="150" align="center"><?php echo $lang['wt_status'];?></th>
          <th></th>
        </tr>
      </thead>
      <tbody>
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?w=bbs_memberlevel&t=ref_add';
    }
}
</script>
