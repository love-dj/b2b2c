...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['wt_goods_evaluate']; ?></h3>
        <h5><?php echo $lang['wt_goods_evaluate_subhead']; ?></h5>
      </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?w=evaluate&t=get_store_xml',
        colModel : [
...
function fg_delete(id) {
	...
	$.ajax({
        type: "GET",
        dataType: "json",
        url: "index.php?w=evaluate&t=evalstore_del",
        data: "seval_id="+id,
