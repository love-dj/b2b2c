...
function update_flex(){
	$('#container').load('index.php?w=stat_aftersale&t=get_refund_highcharts&'+$("#formSearch").serialize());
    $("#flexigrid").flexigrid({
        url: 'index.php?w=stat_aftersale&t=get_refundlist_xml&'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?w=stat_aftersale&t=refundlist';
