...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=show&t=rec_list" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['rec_position'];?> - <?php echo $lang['wt_edit'];?>“<?php echo $output['info']['title'];?>”</h3>
        <h5><?php echo $lang['rec_position_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form id="rec_form" enctype="multipart/form-data" method="post" action="index.php?w=show&t=rec_edit_save">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row" id="local_txt" style="display:none">
        ...
        <dd class="opt">
          <ul class="wtap-ajax-add" id="RemoteBoxTxt">
            <li>
              <label>
            ...
            <a id="addRemoteTxt" class="wtap-btn" href="javascript:void(0);"><i class="fa fa-plus"></i><?php echo $lang['rec_ps_addjx'];?></a>
          </ul>
        </dd>
      </dl>
      <dl class="row" id="local_pic" style="display:none">
        ...
        <dd class="opt">
          <ul class="wtap-ajax-add" id="UpFileBox">
            <li>
              <label>
              <div class="input-file-show"><span class="type-file-box">
                <input class="type-file-file" id="pic[]" name="pic[]" type="file" size="30" wt_type="change_default_goods_image"  hidefocus="true" title="点击按钮选择文件上传">
            ...
            <a id="addUpFile" href="javascript:void(0);" class="wtap-btn"><i class="fa fa-plus"></i><?php echo $lang['rec_ps_addjx'];?></a>
          </ul>
        </dd>
      </dl>
      <dl id="remote_pic" class="row" style="display:none">
        ...
        <dd class="opt">
          <ul class="wtap-ajax-add" id="RemoteBox">
            <li>
              <label>
            ...
            <a id="addRemote" class="wtap-btn"  href="javascript:void(0);"><i class="fa fa-plus"></i><?php echo $lang['rec_ps_addjx'];?></a>
          </ul>
        </dd>
      </dl>
...
$(function(){
	...
	$("#remote_pic,#local_pic").on('click','#addUpFile',function(){
		...
		$(this).remove();
   		$('#UpFileBox').append("<li><label><div class=\"input-file-show\"><span class=\"type-file-box\"><input type=\"text\" name=\"textfield\" class=\"type-file-text\"><input type=\"button\" name=\"button\" value=\"选择上传...\" class=\"type-file-button\"><input class=\"type-file-file\" type=\"file\" title=\"\" wt_type=\"change_default_goods_image\" hidefocus=\"true\" size=\"30\" name=\"pic[]\"></span></div></label><label title=\"<?php echo $lang['rec_ps_gourl'];?>\"><i class=\"fa fa-link\"></i><input type=\"text\" value=\"http://\" name=\"urlup[]\" placeholder=\"<?php echo $lang['rec_ps_gourl'];?>\" class=\"input-txt\"></label><a id=\"delUpFile\" href=\"javascript:void(0);\" class=\"wtap-btn wtap-btn-red\"><?php echo $lang['wt_del'];?></a></li><a id=\"addUpFile\" class=\"wtap-btn\" href=\"javascript:void(0);\"><i class=\"fa fa-plus\"></i><?php echo $lang['rec_ps_addjx'];?></a>");
	});
...
<script type="text/javascript">
$(function(){
	$('input[wt_type="change_default_goods_image"]').on("change", function(){
