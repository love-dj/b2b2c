...
<div class="wrap">
  <div class="tabmenu">
    ...
    <?php if($output['member_info']['fx_state'] == 2){?>
    <a class="wtbtn wtbtn-bittersweet" href="index.php?w=access_infomation&t=fx_quit"><i class="icon-shield"></i>退出分销</a>
    <?php }?>
  </div>
  ...
  <div class="wtm-default-form">
    <form id="form_company_info" action="index.php?w=access_infomation&t=save_member" method="post">
      ...
      <dl>
        ...
        <dd>
          <input type="radio" name="bill_type_code" value="bank" <?php if($output['member_info']['bill_type_code'] == 'bank'){?> checked="checked"<?php }?>><img src="<?php echo FENXIAO_TEMPLATES_URL;?>/images/fx-upay.jpg" width="auto" height="24" alt=""/>&nbsp;银行账号
            &nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="bill_type_code" value="alipay" <?php if($output['member_info']['bill_type_code'] == 'alipay'){?> checked="checked"<?php }?>><img src="<?php echo FENXIAO_TEMPLATES_URL;?>/images/fx-upay.jpg" width="auto" height="24" alt=""/>
        </dd>
      </dl>
      <dl>
      ...
      <?php }else{?>
        ...
        <dd>
          <?php if($output['member_info']['bill_type_code'] == 'bank'){?>
            <img src="<?php echo FENXIAO_TEMPLATES_URL;?>/images/fx-upay.jpg" width="auto" height="24" alt="银行账号"/>&nbsp;银行账号
          <?php }else{?>
            <img src="<?php echo FENXIAO_TEMPLATES_URL;?>/images/fx-upay.jpg" width="auto" height="24" alt="支付宝"/>支付宝
          <?php }?>  
        </dd>
      </dl>
      <dl>
      ...
      <dl class="bottom">
        <dt>&nbsp;</dt>
        <dd><label class="submit-border">
          <a id="btn_apply_company_edit" href="index.php?w=access_infomation&t=member&type=edit" class="submit">编辑</a></label>
        </dd>
      </dl>
      <?php }?>
  </form>
