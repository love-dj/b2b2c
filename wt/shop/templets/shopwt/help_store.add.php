...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=help_store&t=help_store" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3>店铺帮助 - <?php echo $lang['wt_new'];?></h3>
        <h5>商品店铺帮助类型与文章管理</h5>
      </div>
    </div>
  </div>
          ...
          <div id="thumbnails" class="wtap-thumb-list">
            ...
            <ul>
              ...
              <li id="pic_<?php echo $val['upload_id'];?>">
                ...
                <a href="javascript:del_file_upload('<?php echo $val['upload_id'];?>');" class="del" title="<?php echo $lang['wt_del'];?>">X</a><a href="javascript:insert_editor('<?php echo $val['file_name'];?>');" class="inset"><i class="fa fa-trash"></i>插入图片</a> </li>
              <?php } ?>
              <?php } ?>
            </ul>
          </div>
...
$(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?w=help_store&t=upload_pic&item_id=0',
