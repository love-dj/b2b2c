...
function get_list() {
    ...
    $.getJSON(ApiUrl + '/index.php?w=goods&t=goods_dzlist' + window.location.search.replace('?','&'), param, function(result){
    	if(!result) {
    		result = [];
    		result.datas = [];
...
function search_show() {
    $.getJSON(ApiUrl + '/index.php?w=index&t=search_show', function(result) {
    	...
    	$('#search_submit').click(function(){
    		...
    		window.location.href = WapSiteUrl + '/html/product_dazhe.html' + queryString;
    	});
