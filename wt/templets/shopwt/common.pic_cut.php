...
<form action="index.php?w=common&t=pic_cut" id="form_cut" method="post">
  ...
  <div class="pic-cut-<?php echo $_GET['x'].$_GET['type'];?>">
    ...
    <div class="work-layer">
      <p><img id="wtcropbox" src="<?php echo $_GET['url'];?>"/></p>
    </div>
    ...
    <div class="cut-btn"> <a href="JavaScript:void(0);" class="wtap-btn-big wtap-btn-green" id="pic_submit"><i class="fa fa-scissors"></i><?php echo $lang['wt_submit'];?></span></a> </div>
  </div>
</form>
...
$(function(){
    ...
    $('#pic_submit').click(function(){
		...
		$.post('<?php echo ADMIN_SITE_URL?>/index.php?w=common&t=pic_cut',d,function(data){
			call_back(data);
