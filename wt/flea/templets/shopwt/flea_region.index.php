  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['region_index_import_tip'];?>?')){location.href='index.php?w=flea_region&t=flea_import_default_area';}"><span>导入全国地区数据[三级]</span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          ...
          <th>地区名称</th>
          <th class="align-center"><?php echo $lang['wt_handle'];?></th>
        </tr>
      </thead>
      <tbody id="treet1">
        ...
        <td class="w72 align-center"><a href="javascript:void(0)" onclick='del("<?php echo $v['flea_area_id'];?>");'><?php echo $lang['wt_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php } ?>
      </tbody>
      ...
      <tfoot>
        <tr class="tfoot">
          <td colspan="15"><a href="JavaScript:void(0);" class="btn" onclick="form_list_submit();"><span><?php echo $lang['wt_submit'];?></span></a></td>
        </tr>
      </tfoot>
    </table>
  </form>
...
function refreshdistrict(parent_id,type){
	...
	location.href='index.php?w=flea_region&t=flea_region&flea_area_parent_id='+parent_id+url;
}
