...
class waybillControl extends SystemControl{
    ...
    public function get_xmlWt() {
        ...
        foreach ($waybill_list as $value) {
            ...
            $operation .= "<li><a href='index.php?w=waybill&t=waybill_design&waybill_id=".$value['waybill_id']."'>设计运单模板</a></li>";
            $operation .= "<li><a href='index.php?w=waybill&t=waybill_test&waybill_id=".$value['waybill_id']."' target=\"_blank\">测试运单模板</a></li>";
            $operation .= "<li><a href='index.php?w=waybill&t=waybill_edit&waybill_id=".$value['waybill_id']."'>编辑运单模板</a></li>";
            $operation .= "</ul></span>";
    ...
    public function waybill_saveWt() {
        ...
        if($result) {
            ...
            showMessage(L('wt_common_save_succ'), $this->url_waybill_list);
        } else {
            $this->log('保存运单模板' . '[ID:' . $result. ']', 0);
            showMessage(L('wt_common_save_fail'), $this->url_waybill_list);
        }
    }
