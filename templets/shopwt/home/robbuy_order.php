...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="wtg-buyer">
    <thead>
        <tr>
    ...
    <tbody>
        ...
        <tr>
            <td>
                <a href="index.php?w=member_snshome&mid=<?php echo $order['buyer_id'];?>" target="_blank">
                    <?php echo $order['buyer_name'] ? $order['buyer_name'] : $output['order_list'][$order['order_id']]['buyer_name']; ?>
                </a>
                </td>
            <td><?php echo $order['goods_num'];?></td>
            <td><?php echo $lang['currency'].wtPriceFormat($order['goods_price']);?></td>
...
$(document).ready(function(){
    $('#robbuy_order').find('.demo').ajaxContent({
        event:'click',
        loaderType:"img",
