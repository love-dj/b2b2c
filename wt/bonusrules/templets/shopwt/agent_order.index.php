...
<script type="text/javascript">
    $(function(){
        $("#flexigrid").flexigrid({
            url: 'index.php?w=agent_order&t=get_xml',
            colModel : [
            ...
            {display: '分佣比例分配', name : 'is_difference', width : 50, sortable : true, align: 'center'},
            {display: '分佣方式', name : 'is_average', width : 50, sortable : true, align: 'center'},
            {display: '奖金', name : 'commission_list', width : 300, sortable : true, align: 'center'},
