...
<script type="text/javascript">
    $(function(){
        $("#flexigrid").flexigrid({
            url: 'index.php?w=distribution_order&t=get_xml',
            colModel : [
            ...
            {display: '分销层数', name : 'distribution_uselevel', width : 50, sortable : true, align: 'center'},
            {display: '一级佣金', name : 'commission_one_level', width : 80, sortable : true, align: 'center'},
            {display: '二级佣金', name : 'commission_two_level', width : 80, sortable : true, align: 'center'},
            {display: '三级佣金', name : 'commission_three_level', width : 80, sortable : true, align: 'center'},
