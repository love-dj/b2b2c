...
<div class="wtsc-flow-box" id="wtscComplainFlow">
  <div class="wtsc-flow-container">
    <div class="title">
      <h3>交易投诉申诉</h3>
    </div>
    <div class="wtsc-flow-step">
    ...
    <div class="wtsc-form-default">
      ...
      <dl>
        <dt><?php echo $lang['complain_state'].$lang['wt_colon'];?></dt>
        ...
        <dd>
          <?php
                        if(empty($output['complain_info']['complain_pic1'])&&empty($output['complain_info']['complain_pic2'])&&empty($output['complain_info']['complain_pic3'])) {
                            ...
                            $pic_link = BASE_SITE_URL.'/index.php?w=show_pics&type=complain&pics=';
      ...
      <form action="index.php?w=store_complain&t=appeal_save" method="post" id="add_form" enctype="multipart/form-data">
        ...
        <dl>
          <dt><?php echo $lang['complain_appeal_evidence_upload'].$lang['wt_colon'];?></dt>
          <dd>
            <p>
        ...
        <div class="bottom">
          ...
          <label class=""><a href="javascript:history.go(-1);" class="wtbtn ml10"><i class="icon-reply"></i>返回列表</a></label>
        </div>
      </form>
    </div>
  </div>
