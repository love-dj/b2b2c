    ...
    <table class="wtsc-default-table order">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php echo wtPriceFormat($output['order_info']['goods_price']);?></td>
          <td><?php echo $output['order_info']['goods_num'];?></td>
          <td class="commis bdl bdr"><?php if ($output['order_info']['commis_rate'] != 200) { ?>
            <?php echo wtPriceFormat($output['order_info']['order_amount']);?> * <?php echo $output['order_info']['commis_rate'];?>% = <?php echo wtPriceFormat($output['order_info']['order_amount'] * $output['order_info']['commis_rate']/100);?>
            <?php } ?></td>
      ...
      <tfoot>
        ...
        <tr>
          <th colspan="20"><dl class="wtsc-store-sales">
              <?php if(!empty($output['order_info']['voucher_code'])){ ?>
