...
<div class="wtsc-form-default">
  <form method="post" id="tpl_form" name="tpl_form" action="index.php?w=store_transport&t=save">
    <input type="hidden" name="transport_id" value="<?php echo $output['transport']['id'];?>" />
    <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="type" value="<?php echo $_GET['type'];?>">
    <dl>
      <dt>
        <label for="J_TemplateTitle" class="label-like"><?php echo $lang['transport_tpl_name'].$lang['wt_colon'];?></label>
      </dt>
      <dd>
    ...
    <dl>
      <dt>
        <label class="label-like">运费承担<?php echo $lang['wt_colon'];?></label>
      </dt>
      <dd>
            <label class="mr20">
    ...
    <dl>
      <dt>
        <label class="label-like">计费规则<?php echo $lang['wt_colon'];?></label>
      </dt>
  ...
  <div id="dialog_areas" class="dialog-areas" style="display:none">
    <div class="ks-contentbox">
      ...
      <form method="post">
        ...
        <div class="bottom"> <a href="javascript:void(0);" class="J_Submit wtbtn wtbtn-mint"><?php echo $lang['transport_tpl_ok'];?></a> <a href="javascript:void(0);" class="J_Cancel wtbtn"><?php echo $lang['transport_tpl_cancel'];?></a> </div>
      </form>
    </div>
  </div>
  <div id="dialog_batch" class="dialog-batch" style="z-index: 9999; display:none">
    <div class="ks-contentbox">
      ...
      <form method="post">
        <div class="batch">运费<?php echo $lang['wt_colon'];?>
        ...
        <div class="bottom"> <a href="javascript:void(0);" class="J_SubmitPL wtbtn wtbtn-mint"><?php echo $lang['transport_tpl_ok'];?></a> <a href="javascript:void(0);" class="J_Cancel wtbtn"><?php echo $lang['transport_tpl_cancel'];?></a> </div>
      </form>
    </div>
  </div>
</div>
<script src="<?php echo STATIC_SITE_URL;?>/js/transport.js"></script>
<script>
$(function(){
