...
<div class="page">
  ...
  <div class="wtap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      ...
      <input type="hidden" name="t" value="storearea" />
...
<link rel="stylesheet" type="text/css" href="<?php echo ADMIN_STATIC_URL;?>/js/map/jquery.vector-map.css"/>
<script type="text/javascript" src="<?php echo ADMIN_STATIC_URL;?>/js/map/jquery.vector-map.js"></script>
<script type="text/javascript" src="<?php echo ADMIN_STATIC_URL;?>/js/map/china-zh.js"></script>
<script>
$(function () {
