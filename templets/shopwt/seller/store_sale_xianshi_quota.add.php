...
<div class="wtsc-form-default">
  <form id="add_form" action="index.php?w=store_sale_xianshi&t=xianshi_quota_add_save" method="post">
    <dl>
      <dt><i class="required">*</i><?php echo $lang['xianshi_quota_add_quantity'].$lang['wt_colon'];?></dt>
      <dd>
        ...
        <p class="hint"><?php echo $lang['xianshi_price_explain2'].$output['setting_config']['sale_xianshi_price'].$lang['wt_yuan'];?> ; </p>
...
$(document).ready(function(){
    ...
    $("#add_form").validate({
    	...
    	submitHandler:function(form){
            var unit_price = <?php echo $output['setting_config']['sale_xianshi_price'];?>;
            var quantity = $("#xianshi_quota_quantity").val();
            var price = unit_price * quantity;
            showDialog('<?php echo $lang['xianshi_quota_add_confirm'];?>'+price+'<?php echo $lang['wt_yuan'];?>', 'confirm', '', function(){
