...
<div class="page">
  ...
  <div id="stat_tabs" class="  ui-tabs" style="min-height:500px">
    <ul class="tab-base wt-row">
      ...
      <li><a href="#goodsnum_div" wt_type="showdata" data-param='{"type":"goodsnum"}'>下单量</a></li>
    </ul>
  ...
  <div class="wtap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      <input type="hidden" name="w" value="stat_goods" />
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('index.php?w=stat_goods&t=hotgoods_list&type='+type+'&choose_gcid='+choose_gcid+'&c=<?php echo $output['searchtime'];?>');
}
