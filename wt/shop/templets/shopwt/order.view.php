    ...
    <div class="wtap-order-details">
      ...
      <div class="tabs-panels">
        ...
        <div class="addr-note">
          ...
          <dl>
            <dt>发票信息<?php echo $lang['wt_colon'];?></dt>
            <dd>
              ...
              <ul>
                ...
                <li><strong><?php echo $key.$lang['wt_colon'];?></strong><?php echo $value;?></li>
                <?php } ?>
              </ul>
              <?php } ?>
            </dd>
          ...
          <dl>
            <dt>买家留言<?php echo $lang['wt_colon'];?></dt>
        ...
        <div class="contact-info">
          ...
          <dl>
            <dt>发货地址<?php echo $lang['wt_colon'];?></dt>
          ...
          <dl>
            <dt>发货时间<?php echo $lang['wt_colon'];?></dt>
            ...
            <dt>快递公司<?php echo $lang['wt_colon'];?></dt>
            <dd><?php echo $output['order_info']['express_info']['e_name'];?></dd>
            <dt>物流单号<?php echo $lang['wt_colon'];?></dt>
            <dd>
        ...
        <div class="goods-content">
          ...
          <table>
            ...
            <tbody>
              ...
              <?php $i++;?>
              <tr>
                <td class="w30"><div class="goods-thumb"><a href="<?php echo BASE_SITE_URL;?>/index.php?w=goods&goods_id=<?php echo $goods['goods_id'];?>" target="_blank"><img alt="<?php echo $lang['product_pic'];?>" src="<?php echo thumb($goods, 60);?>" /> </a></div></td>
                <td style="text-align: left;"><a href="<?php echo BASE_SITE_URL;?>/index.php?w=goods&goods_id=<?php echo $goods['goods_id'];?>" target="_blank"><?php echo $goods['goods_name'];?></a><span class="rec"><a target="_blank" href="<?php echo urlShop('snapshot', 'index', array('rec_id' => $goods['rec_id']));?>">[交易快照]</a></span><br/><?php echo $goods['goods_spec'];?></td>
                <td class="w80"><?php echo $lang['currency'].wtPriceFormat($goods['goods_price']);?></td>
                ...
                <td class="w80"><?php echo $goods['commis_rate'] == 200 ? '' : wtPriceFormat($goods['goods_pay_price']*$goods['commis_rate']/100);?></td>
              </tr>
                <!-- S 赠品列表 -->
                <?php if (!empty($output['order_info']['zengpin_list']) && $i == count($output['order_info']['goods_list'])) { ?>
                <tr>
                  <td>&nbsp;</td>
                  <td colspan="6"><div class="wtm-goods-gift">赠品：
        ...
        <div class="total-amount">
          ...
          <h4>(<?php echo $lang['order_total_transport'];?><?php echo $lang['wt_colon'];?><?php echo $lang['currency'].wtPriceFormat($output['order_info']['shipping_fee']);?>)</h4>
          <?php if($output['order_info']['refund_amount'] > 0) { ?>
          (<?php echo $lang['order_refund'];?><?php echo $lang['wt_colon'];?><?php echo $lang['currency'].wtPriceFormat($output['order_info']['refund_amount']);?>)
          <?php } ?>
        </div>
      </div>
      <?php if(is_array($output['refund_list']) and !empty($output['refund_list'])) { ?>
      <div class="tabs-panels tabs-hide">
        <div>
          ...
          <dl>
            <dt>退款单号<?php echo $lang['wt_colon'];?></dt>
            <dd><?php echo $val['refund_sn'];?></dd>
            <dt>退款金额<?php echo $lang['wt_colon'];?></dt>
            <dd><?php echo $lang['currency'];?><?php echo wtPriceFormat($val['refund_amount']); ?></dd>
            <dt>发生时间<?php echo $lang['wt_colon'];?></dt>
            <dd><?php echo date("Y-m-d H:i:s",$val['admin_time']); ?></dd>
            <dt>备注<?php echo $lang['wt_colon'];?></dt>
      ...
      <div class="tabs-panels tabs-hide">
        <div>
          ...
          <dl>
            <dt>退货单号<?php echo $lang['wt_colon'];?></dt>
            <dd><?php echo $val['refund_sn'];?></dd>
            <dt>退款金额<?php echo $lang['wt_colon'];?></dt>
            <dd><?php echo $lang['currency'];?><?php echo wtPriceFormat($val['refund_amount']); ?></dd>
            <dt>发生时间<?php echo $lang['wt_colon'];?></dt>
