...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="index.php?w=vr_robbuy&t=class_list" title="返回列表">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?w=vr_robbuy&t=class_edit">
    ...
    <div class="wtap-form-default">
      ...
      <div class="bot">
        ...
        <a id="submit" href="javascript:void(0)" class="wtap-btn-big wtap-btn-green"><?php echo $lang['wt_submit'];?></a></div>
    </div>
  </form>
</div>
...
$(function(){
    ...
    $('#add_form').validate({
        ...
        messages : {
            ...
            class_sort: {
                required : "<i class='fa fa-exclamation-bbs'></i>排序不能为空",
                digits: "<i class='fa fa-exclamation-bbs'></i>排序必须是数字,且数值0-255",
