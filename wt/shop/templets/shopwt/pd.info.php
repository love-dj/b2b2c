...
<div class="wtap-form-default">
  ...
  <div class="bot"><a  class="wtap-btn-big wtap-btn-green" href="index.php?w=predeposit&t=recharge_edit&id=<?php echo $output['info']['pdr_id']; ?>"><span><?php echo  $lang['admin_predeposit_payed'];?></span></a></div>
  <?php } ?>
</div>
