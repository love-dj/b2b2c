...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=bbs_class&t=class_list" title="返回分类列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['wt_bbs_classmanage'];?> - <?php echo $lang['wt_new'];?>社区分类</h3>
  ...
  <form id="class_form" method="post">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label><?php echo $lang['bbs_class_is_recommend']?></label>
        </dt>
        <dd class="opt">
          <div class="onoff">
            <label for="recommend1" class="cb-enable selected" ><?php echo $lang['wt_yes'];?></label>
            <label for="recommend0" class="cb-disable" ><?php echo $lang['wt_no'];?></label>
      ...
      <dl class="row">
        <dt class="tit">
          <label><?php echo $lang['bbs_class_status'];?></label>
        </dt>
        <dd class="opt">
          <div class="onoff">
