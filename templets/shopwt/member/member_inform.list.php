...
<div class="wrap">
  ...
  <form id="list_form" method="get">
    <table class="wtm-search-table">
      <input type="hidden" id='w' name='w' value='member_inform' />
      <input type="hidden" id='t' name='t' value='inform_list' />
      <tr>
        <td></td>
  ...
  <table class="wtm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="wtm-table-handle"><span><a href="index.php?w=member_inform&t=inform_info&inform_id=<?php echo $val['inform_id']; ?>" class="btn-bluejeans"><i class="icon-eye-open"></i>
          <p><?php echo $lang['wt_view'];?></p>
          </a></span>
          <?php if($val['inform_state']==='1') { ?>
          <span><a class="btn-bittersweet" href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['inform_cancel_confirm'];?>', 'index.php?w=member_inform&t=inform_cancel&inform_id=<?php echo $val['inform_id']; ?>');"><i class="icon-ban-bbs"></i>
          <p><?php echo $lang['wt_cancel']; ?></p>
          </a></span>
          <?php } ?></td>
      </tr>
      <?php }?>
