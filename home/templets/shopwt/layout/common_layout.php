	...
	if(strpos($agent,"comFront") || strpos($agent,"iPhone") || strpos($agent,"MIDP-2.0") || strpos($agent,"Opera Mini") || strpos($agent,"UCWEB") || strpos($agent,"Android") || strpos($agent,"Windows CE") || strpos($agent,"SymbianOS")){
        ...
        if(!empty($config['wap_site_url'])){
			...
			case 'show_store':
			  ...
			  break;
			case 'category':
			  $url .= '/product_first_categroy.html';
			  break;
			case 'brand':
			  $url .= '/product_first_categroy.html';
			  break;
...
<div class="header-box">
  <header class="wt-head wrapper">
    <h1 class="site-logo"><a title="<?php echo $output['setting_config']['site_name']; ?>" href="<?php echo BASE_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$output['setting_config']['site_logo']; ?>" class="pngFix"></a></h1>
    ...
    <div class="wt-head-search">
     ...
     <div id="search">
        ...
        <form action="<?php echo BASE_SITE_URL;?>" method="get" class="search-form" id="head_search_form">
		...
		?>
          ...
          <input type="submit" id="button" value="<?php echo $lang['wt_common_search'];?>" class="search-submit">
        </form>
    ...
    <div class="head-my-menu">
      <dl class="my-cart">
        ...
        <dd>
          ...
          <div class="checkout"> <span class="total-price">共<i><?php echo $output['cart_goods_num'];?></i><?php echo $lang['wt_kindof_goods'];?></span><a href="<?php echo BASE_SITE_URL;?>/index.php?w=cart" class="btn-cart">结算购物车中的商品</a> </div>
        </dd>
      </dl>
    </div>
  </header>
