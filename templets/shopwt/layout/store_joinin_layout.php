...
<![endif]-->
<script>
var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var SITEURL = '<?php echo BASE_SITE_URL;?>';var BASE_SITE_URL = '<?php echo BASE_SITE_URL;?>';var STATIC_SITE_URL = '<?php echo STATIC_SITE_URL;?>';var SHOP_TEMPLATES_URL = '<?php echo SHOP_TEMPLATES_URL;?>';
</script>
...
<div class="header">
  ...
  <ul class="header_menu">
	  <?php if($_GET['t'] == 'index'){?>
    <li class="<?php echo $output['show_sign']=='joinin' ? 'current':'';?>"><a href="<?php if(!($output['store_zizhi'])){?><?php echo urlShop('store_joinin', 'step0');?><?php }else { ?><?php echo urlShop('store_joininc', 'step0');?><?php } ?>" class="joinin">立即入驻</a></li>
    <li class="<?php echo $output['show_sign']=='help' ? 'current':'';?>"><a href="<?php echo urlShop('show_help', 'index');?>" class="faq">入驻指南</a></li>
	   <?php }?>
  </ul>
</div>
