...
<div class="page">
  ...
  <form id="post_form" method="post">
    ...
    <div class="wtap-form-default">
      ...
      <div class="bot"> <a href="JavaScript:void(0);" class="wtap-btn-big wtap-btn-green" id="submitBtn"><?php echo $lang['wt_submit'];?></a><a href="index.php?w=mb_app&t=mb_qr"  class="wtap-btn-big wtap-btn-orange ml10">生成二维码</a> </div>
    </div>
  </form>
</div>
<script>
