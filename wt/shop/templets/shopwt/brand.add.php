...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=brand&t=brand" title="返回品牌列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['brand_index_brand'];?> - <?php echo $lang['wt_new'];?></a></h3>
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="input-file-show"><span class="type-file-box">
            <input class="type-file-file" wttype="file-brand-pic" id="_pic" name="_pic" type="file" size="30" hidefocus="true" title="点击按钮选择文件并提交表单后上传生效">
      ...
      <dl class="row">
        ...
        <div class="input-file-show"><span class="type-file-box">
            ...
            <input class="type-file-file" wttype="file-brand-bgpic" id="brand_filebgpic" name="brand_filebgpic" type="file" size="30" hidefocus="true" title="点击前方预览图可查看大图，点击按钮选择文件并提交表单后上传生效">
            </span></div>
          <span class="err"></span>
       ...
       <dl class="row">
		...
		<dd class="opt">
          <textarea name="brand_introduction" rows="6" class="tarea"></textarea>
          <span class="err"></span>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="brand_recommend1" class="cb-enable"><?php echo $lang['wt_yes'];?></label>
            <label for="brand_recommend0" class="cb-disable selected"><?php echo $lang['wt_no'];?></label>
