...
<div class="wtc-main">
  <div class="wtc-title">
    <h3>在线支付</h3>
    <h5><a href="index.php?w=member_order_vr&t=show_order&order_id=<?php echo $output['order_info']['order_id'];?>" target="_blank">查看订单详情</a></h5>
  </div>
  <form action="index.php?w=payment&t=order_vr" method="POST" id="buy_form">
    ...
    <div class="wtc-receipt-info">
      <div class="wtc-receipt-info-title">
        <h3>下单成功，请及时付款！应付金额：<strong>￥<?php echo wtPriceFormat($output['pay']['pay_amount_online']);?></strong></h3>
      </div>
   ...
   还需在线支付 <strong id="api_pay_amount"><?php echo wtPriceFormat($output['pay']['payd_diff_amount']);?></strong>元。</dd>
    ...
    <div class="wtc-receipt-info">
      ...
      <div class="nopay"><?php echo $lang['cart_step2_paymentnull_1']; ?> <a href="<?php echo MEMBER_SITE_URL;?>/index.php?w=member_message&t=sendmsg&member_id=<?php echo $output['order']['seller_id'];?>"><?php echo $lang['cart_step2_paymentnull_2'];?></a> <?php echo $lang['cart_step2_paymentnull_3'];?></div>
      <?php } else {?>
      <div class="wtc-receipt-info-title">
        <h3>支付选择</h3>
      </div>
