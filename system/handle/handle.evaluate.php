...
class evaluateHandle {
    ...
    public function save($date, $order_info, $store_info, $order_goods, $member_id, $member_name) {
        ...
        foreach ($order_goods as $value){
            ...
            $evaluate_goods_content = array();
            $evaluate_goods_content['geval_orderid'] = $order_info['order_id'];
            $evaluate_goods_content['geval_orderno'] = $order_info['order_sn'];
            $evaluate_goods_content['geval_ordergoodsid'] = $value['rec_id'];
            $evaluate_goods_content['geval_goodsid'] = $value['goods_id'];
            $evaluate_goods_content['geval_goodsname'] = $value['goods_name'];
            $evaluate_goods_content['geval_goodsprice'] = $value['goods_price'];
            $evaluate_goods_content['geval_goodsimage'] = $value['goods_image'];
            $evaluate_goods_content['geval_scores'] = $evaluate_score;
            $evaluate_goods_content['geval_content'] = $evaluate_comment;
            $evaluate_goods_content['geval_isanonymous'] = $date['goods'][$value['rec_id']]['anony']?1:0;
            $evaluate_goods_content['geval_addtime'] = TIMESTAMP;
            $evaluate_goods_content['geval_storeid'] = $store_info['store_id'];
            $evaluate_goods_content['geval_storename'] = $store_info['store_name'];
            $evaluate_goods_content['geval_frommemberid'] = $member_id;
            $evaluate_goods_content['geval_frommembername'] = $member_name;
            $evaluate_goods_content['geval_image'] = $geval_image;
            $evaluate_goods_content['geval_content_again'] = '';
            $evaluate_goods_content['geval_image_again'] = '';
            $evaluate_goods_content['geval_explain_again'] = '';
        
            $evaluate_goods_array[] = $evaluate_goods_content;
    ...
    public function saveAgain($date, $order_info, $evaluate_goods) {
        ...
        foreach ($evaluate_goods as $value){
            ...
            $evaluate_goods_content = array();
            $evaluate_goods_content['geval_content_again'] = $evaluate_comment;
            $evaluate_goods_content['geval_addtime_again'] = TIMESTAMP;
            $evaluate_goods_content['geval_image_again'] = $geval_image;
        
            $model_evaluate_goods->editEvaluateGoods($evaluate_goods_content, array('geval_id' => $value['geval_id']));
        }
    ...
    public function saveVr($date, $order_info, $store_info, $member_id, $member_name) {
        ...
        $evaluate_goods_content['geval_orderid'] = $order_info['order_id'];
        $evaluate_goods_content['geval_orderno'] = $order_info['order_sn'];
        $evaluate_goods_content['geval_ordergoodsid'] = $order_info['order_id'];
        $evaluate_goods_content['geval_goodsid'] = $order_info['goods_id'];
        $evaluate_goods_content['geval_goodsname'] = $order_info['goods_name'];
        $evaluate_goods_content['geval_goodsprice'] = $order_info['goods_price'];
        $evaluate_goods_content['geval_goodsimage'] = $order_info['goods_image'];
        $evaluate_goods_content['geval_scores'] = $evaluate_score;
        $evaluate_goods_content['geval_content'] = $evaluate_comment;
        $evaluate_goods_content['geval_isanonymous'] = $date['goods'][$order_info['goods_id']]['anony']?1:0;
        $evaluate_goods_content['geval_addtime'] = TIMESTAMP;
        $evaluate_goods_content['geval_storeid'] = $store_info['store_id'];
        $evaluate_goods_content['geval_storename'] = $store_info['store_name'];
        $evaluate_goods_content['geval_frommemberid'] = $member_id;
