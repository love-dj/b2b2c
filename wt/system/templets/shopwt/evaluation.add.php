...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=goods" title="返回商品列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3>快速添加评论</a></h3>
   ...
   <input type="hidden" value="<?php echo $output["goods_list"]["store_name"];?>" name="storename">
    <input type="hidden" value="<?php echo $output["goods_list"]["goods_sale_price"];?>" name="goodsprice">
...
$(function(){
	...
	$("#pingjia_form").validate({
        ...
        messages : {
            member_name : {
                required : '<i class="fa fa-exclamation-bbs"></i>请填写会员名称',
               
            },
            geval_content  : {
                required   : '<i class="fa fa-exclamation-bbs"></i>请填写评价内容'
            }
        }
	});	
});
