...
<link href="<?php echo FENXIAO_TEMPLATES_URL;?>/css/member.css" rel="stylesheet" type="text/css">
...
<div class="wtm-header-nav all-nav-box">
     ...
     <div class="category-nav">
      ...
      <ul class="nav-menu">
        ...
        <li><a href="<?php echo urlFenxiao('fx_center', 'home');?>" class="current">分销中心</a> </li>
      </ul>
      <div class="notice">
        <ul class="line">
    ...
    <ul id="sidebarMenu" class="wtm-sidebar">
	  ...
	  <li class="side-menu"><a href="javascript:void(0)">
        <h3>分销市场</h3>
                ...
                <ul>
                    <li><a target="_blank" href="<?php echo urlFenxiao('search','index');?>">添加商品</a></li>
                    <li><a target="_blank" href="<?php echo urlFenxiao('store','index');?>">分销店铺</a></li>
					<li><a target="_blank" href="<?php echo FENXIAO_SITE_URL;?>">分销首页</a></li>
                  </ul>
              </li>	
    </ul>
  </div>
