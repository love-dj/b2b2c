...
<div class="wrap">
  ...
  <div class="wtm-bind">
    ...
    <div class="relieve">
      <form method="post" id="editbind_form" name="editbind_form" action="index.php?w=member_bind&t=qqunbind">
    ...
    <div class="revise wtm-default-form ">
      <form method="post" id="editpw_form" name="editpw_form" action="index.php?w=member_bind&t=qqunbind">
        <input type='hidden' id="is_editpw" name="is_editpw" value='yes'/>
        <dl>
          <dt><?php echo $lang['member_qqconnect_modpw_newpw'].$lang['wt_colon']; ?></dt>
          <dd>
        ...
        <dl>
          <dt><?php echo $lang['member_qqconnect_modpw_two_password'].$lang['wt_colon']; ?></dt>
          <dd>
    ...
    <div class="relieve pt50">
      <p class="ico"><a href="<?php echo MEMBER_SITE_URL;?>/index.php?w=connect_qq"><img src="<?php echo MEMBER_TEMPLATES_URL;?>/images/qq_bind_small.gif"></a>
