...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=show&t=rec_list" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['rec_position'];?> - <?php echo $lang['wt_new'];?></h3>
        <h5><?php echo $lang['rec_position_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form id="rec_form" enctype="multipart/form-data" method="post" action="index.php?w=show&t=rec_save">
      ...
      <dl class="row" id="local_pic" style="display:none">
        ...
        <dd class="opt">
          <ul class="wtap-ajax-add" id="UpFileBox">
            ...
            <a id="addUpFile" class="wtap-btn" href="javascript:void(0);"><i class="fa fa-plus"></i><?php echo $lang['rec_ps_addjx'];?></a>
          </ul>
        </dd>
      </dl>
...
<script type="text/javascript">
$(function(){
	$('input[wt_type="change_default_goods_image"]').live("change", function(){
