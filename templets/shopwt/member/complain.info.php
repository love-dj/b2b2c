...
<div class="wtm-flow-box" id="wtmComplainFlow">
  <div class="wtm-flow-container">
    ...
    <div class="wtm-default-form">
        ...
        <dl>
          <dt><?php echo $lang['complain_accused'].$lang['wt_colon'];?></dt>
          <dd><?php echo $output['complain_info']['accused_name'];?></dd>
          <dt><?php echo $lang['complain_subject_content'].$lang['wt_colon'];?></dt>
          <dd><?php echo $output['complain_info']['complain_subject_content'];?></dd>
          <dt><?php echo $lang['complain_datetime'].$lang['wt_colon'];?></dt>
          <dd><?php echo date('Y-m-d H:i:s',$output['complain_info']['complain_datetime']);?></dd>
          <dt><?php echo $lang['complain_content'].$lang['wt_colon'];?></dt>
          <dd><?php echo $output['complain_info']['complain_content'];?></dd>
          <dt><?php echo $lang['complain_evidence'].$lang['wt_colon'];?></dt>
          <dd>
            ...
            <ul class="wtm-evidence-pic">
              ...
              <?php if(!empty($val)){ ?>
              <li><a href="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_PATH.'/complain/'.$val;?>" wttype="nyroModal" rel="gal">
            ...
            <?php echo $lang['complain_pic_none'];?>
                <?php if((intval($output['complain_info']['complain_state']) < 99)) { ?>
                    <a class="wtbtn-mini wtbtn-bittersweet" href="javascript:void(0);" onclick="$('#post_add_pic_form').toggle();" title="<?php echo $lang['complain_add_pic'];?>"><i class="icon-cloud-upload "></i><?php echo $lang['complain_add_pic'];?></a>
                    <form style="display: none;" id="post_add_pic_form" method="post" action="index.php?w=member_complain&t=complain_add_pic&complain_id=<?php echo $output['complain_info']['complain_id']; ?>" enctype="multipart/form-data">
        ...
        <?php if ($output['complain_info']['appeal_datetime'] > 0) { ?>
            ...
            <dl>
              <dt><?php echo $lang['complain_appeal_datetime'].$lang['wt_colon'];?></dt>
              <dd><?php echo date('Y-m-d H:i:s',$output['complain_info']['appeal_datetime']);?></dd>
              <dt><?php echo $lang['complain_appeal_content'].$lang['wt_colon'];?></dt>
              <dd><?php echo $output['complain_info']['appeal_message'];?></dd>
              <dt><?php echo $lang['complain_appeal_evidence'].$lang['wt_colon'];?></dt>
              <dd>
        ...
        <dl>
          <dt><?php echo '处理意见'.$lang['wt_colon'];?></dt>
          <dd><?php echo $output['complain_info']['final_handle_message'];?></dd>
          <dt><?php echo $lang['final_handle_datetime'].$lang['wt_colon'];?></dt>
