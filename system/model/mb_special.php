...
class mb_specialModel extends Model{
    ...
    private function _initMbSpecialItemGoodsData($item_data, $item_type) {
        ...
        if(!empty($item_data['item'])) {
            ...
            $goods_list = $model_goods->getGoodsList($condition, 'goods_id,goods_name,goods_sale_price,goods_image,goods_costprice,goods_marketprice');
    ...
    private function _initMbSpecialItemGoods1Data($item_data, $item_type) {
        ...
        if(!empty($item_data['item'])) {
            ...
            $goods_list = $model_goods->getXianshiGoodsList($condition, 'goods_id,goods_name,xianshi_price,goods_image,goods_costprice,goods_marketprice');
            $goods_list = array_under_reset($goods_list, 'goods_id');
    ...
    public function getMbSpecialModuleList() {
        $module_list = array();
        $module_list['show_list'] = array('name' => 'show_list' , 'desc' => '幻灯片版块');
        $module_list['home1'] = array('name' => 'home1' , 'desc' => '广告条布局A');
		...
		$module_list['home6'] = array('name' => 'home6' , 'desc' => '版块布局F');
		$module_list['home7'] = array('name' => 'home7' , 'desc' => '导航版块G');
		$module_list['home8'] = array('name' => 'home8' , 'desc' => '版块布局H');
