...
<div class="wrap">
  ...
  <div class="wtm-default-form">
    <dl>
      <dt><?php echo '申请单号'.$lang['wt_colon']; ?></dt>
      <dd><?php echo $output['info']['tradc_sn']; ?></dd>
    </dl>
    <dl>
      <dt><?php echo '提现金额'.$lang['wt_colon']; ?></dt>
    ...
    <dl>
      <dt><?php echo '申请时间'.$lang['wt_colon'];?></dt>
      <dd><?php echo @date('Y-m-d',$output['info']['tradc_add_time']); ?></dd>
    </dl>
    <dl>
      <dt><?php echo '付款状态'.$lang['wt_colon'];?></dt>
   ...
   <?php if (intval($output['info']['tradc_payment_time'])) {?>
    <dl>
      <dt><?php echo '付款时间'.$lang['wt_colon'];?></dt>
