...
<div class="page">
  ...
  <form id="add_form" method="post" action="index.php?w=voucher&t=templateedit">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label><?php echo $lang['wt_status'];?></label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label title="<?php echo $lang['wt_yes'];?>" class="cb-enable <?php if($output['t_info']['voucher_t_recommend'] == '1'){ ?>selected<?php } ?>" for="recommend1"><?php echo $lang['wt_yes'];?></label>
            <label title="<?php echo $lang['wt_no'];?>" class="cb-disable <?php if($output['t_info']['voucher_t_recommend'] == '0'){ ?>selected<?php } ?>" for="recommend0"><?php echo $lang['wt_no'];?></label>
...
$(function(){
	...
	$("#add_form").validate({
	    ...
	    messages : {
	    	points: {
	    		required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_voucher_template_points_error'];?>',
		    	digits : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_voucher_template_points_error'];?>'
	        }
	    }
	});
