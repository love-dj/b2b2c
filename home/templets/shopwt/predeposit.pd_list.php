    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="wtm-table-handle"><?php if (!intval($val['pdr_payment_state'])){?>
          ...
          <p>支付</p>
          </a></span> <span><a class="btn-grapefruit" href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['wt_ensure_del'];?>', '<?php echo MEMBER_SITE_URL;?>/index.php?w=predeposit&t=recharge_del&id=<?php echo $val['pdr_id']; ?>');"><i class="icon-trash"></i>
          <p><?php echo $lang['wt_del'];?></p>
          </a></span>
          <?php }else{?>
          <span><a href="index.php?w=predeposit&t=recharge_show&id=<?php echo $val['pdr_id']; ?>" class="btn-bluejeans"><i class="icon-eye-open"></i>
