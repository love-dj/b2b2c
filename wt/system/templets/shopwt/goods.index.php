...
function fg_invite(ids) {
    _uri = "index.php?w=goods&t=goods_invite&id=" + ids;
...
function fg_sku(commonid) {
    CUR_DIALOG = ajax_form('login','商品"' + commonid +'"的SKU列表','index.php?w=goods&t=get_goods_sku_list&commonid=' + commonid, 580);
}
// 删除
function fg_del(id) {
