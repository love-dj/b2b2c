...
function getTrends(storeid){
	var s_type = $("#search_type").val();
	$('#stattrends').load('index.php?w=stat_store&t=storesales_trends&storeid='+storeid+'&search_type='+s_type+'&'+$("#formSearch").serialize());
}
function update_flex(){
    $('#stattrends').html('');
    $("#flexigrid").flexigrid({
        url: 'index.php?w=stat_store&t=get_storesales_xml&'+$("#formSearch").serialize(),
        colModel : [
...
$(function () {
    ...
    //店铺销售走势
    $("[wt_type='showtrends']").live('click',function(){
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?w=stat_store&t=storesales_list';
