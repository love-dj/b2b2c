$(function(){
	...
	var predepoit_=0;
	//获取团队佣金余额
	$.getJSON(ApiUrl + '/index.php?w=member_team&t=my_asset', {'key':key}, function(result){
		
		$("#allmoney").html(result.datas.team_commission);
		predepoit_=result.datas.team_commission;
	});	
	...
	$('#btn').click(function(){
		...
		if($.sValid()){
	          $.ajax({
				type:'post',
				url:ApiUrl+"/index.php?w=member_team&t=pd_cash_add",	
