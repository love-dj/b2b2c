...
<form method="get" action="index.php">
  <table class="search-form">
    <input type="hidden" name='w' value='store_complain' />
    <tr>
      <td>&nbsp;</td>
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td><?php
				...
				?></td>
      <td class="nscs-table-handle"><span><a href="index.php?w=store_complain&t=complain_show&complain_id=<?php echo $val['complain_id'];?>" class="btn-bittersweet"><i class="icon-eye-open"></i>
