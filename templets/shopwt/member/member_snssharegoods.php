...
<div class="dialog-share">
  <form method="post" action="index.php?w=member_snsindex&t=sharegoods<?php if($_GET['irefresh'] == 1){?>&irefresh=1<?php }?>" id="sharegoods_form">
    ...
    <div id="sg_seccode" class="seccode">
      ...
      <img src="" title="<?php echo $lang['wrong_checkcode_change'];?>" name="codeimage" border="0" onclick="this.src='index.php?w=vercode&type=30x92&c=' + Math.random()"/> <span><?php echo $lang['wrong_vercode'];?></span>
