...
<div class="page">
  ...
  <div class="wtap-stat-chart">
    ...
    <?php } else { ?>
    <div class="no-date"><i class="fa fa-exclamation-triangle"></i>查看分布情况前，请先设置价格区间。<a href="index.php?w=stat_general&t=setting" class="wtap-btn wtap-btn-orange">马上设置</a></div>
    <?php }?>
  </div>
  ...
  <div class="wtap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      ...
      <input type="hidden" name="t" value="pricerange" />
