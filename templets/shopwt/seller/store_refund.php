...
<form method="get" action="index.php">
  <input type="hidden" name="w" value="store_refund" />
...
<table class="wtsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line" >
        ...
        <dd><?php echo $lang['refund_order_refundsn'].$lang['wt_colon'];?><?php echo $val['refund_sn']; ?></dd></dl></td>
		    <?php } else { ?>
      ...
      <td class="nscs-table-handle"><?php if ($val['seller_state'] == 1) { ?>
    	<span><a href="index.php?w=store_refund&t=edit&refund_id=<?php echo $val['refund_id']; ?>" class="btn-bluejeans"><i class="icon-edit"></i><p>处理</p></a></span>
    	<?php } else { ?>
    	<span><a href="index.php?w=store_refund&t=view&refund_id=<?php echo $val['refund_id']; ?>" class="btn-bittersweet"><i class="icon-eye-open"></i><p><?php echo $lang['wt_view'];?></p></a></span><?php } ?>
       </td>
    </tr>
    <?php } ?>
    <?php } else { ?>
