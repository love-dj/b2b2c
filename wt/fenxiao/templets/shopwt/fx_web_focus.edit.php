...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        ...
        <li><a href="index.php?w=page_config&t=show_list"><?php echo '右侧广告图';?></a></li>-->
  ...
  <div class="homepage-focus" id="homepageFocusTab">
    ...
    <form id="upload_focus_form" class="tab-content" name="upload_screen_form" enctype="multipart/form-data" method="post" action="index.php?w=page_config&t=focus_pic" target="upload_pic">
          ...
          <dd class="opt focus-trigeminy">
              ...
              <div focus_id="<?php echo $key;?>" class="focus-trigeminy-group" title="<?php echo '可上下拖拽更改图片组显示顺序';?>">
                <div class="title">
                  ...
                  <a class="wtap-btn-mini del" href="JavaScript:edit_focus(<?php echo $key;?>);"><i class="fa fa-pencil-square-o"></i>编辑</a>
                  <a class="wtap-btn-mini del" href="JavaScript:del_focus(<?php echo $key;?>);"><i class="fa fa-trash"></i>删除</a>
                </div>
                <ul>
            ...
            <div class="mt20"> <a class="wtap-btn" href="JavaScript:add_focus('pic');"><?php echo '图片组';?></a>
            </div>
          </dd>
        </dl>
      </div>
      <div id="edit_focus" class="wtap-form-default" style="display:none;">
        <div class="title">
          <h3>选中区域编辑</h3>
        </div>
        <dl class="row">
      ...
      <div id="upload_focus" class="wtap-form-default" style="display:none;">
        <div class="title">
          <h3>新增/选中区域内容设置详情</h3>
        </div>
        <dl class="row">
      ...
      <div class="wtap-form-default">
        <div class="bot"> <a href="JavaScript:void(0);" onclick="$('#upload_focus_form').submit();" class="wtap-btn-big wtap-btn-green"><?php echo $lang['page_config_save'];?></a> <a href="index.php?w=page_config&t=html_update&web_id=<?php echo $output['code_focus_list']['web_id'];?>" class="wtap-btn-big wtap-btn-green"><?php echo $lang['page_config_web_html'];?></a> <span class="web-save-succ" style="display:none;"><?php echo $lang['wt_common_save_succ'];?></span> </div>
      </div>
    </form>
    <form id="upload_two_focus_form" class="tab-content" name="upload_screen_form" enctype="multipart/form-data" method="post" action="index.php?w=page_config&t=two_focus_pic" target="upload_pic" style="display:none;">
      <input type="hidden" name="form_submit" value="ok" />
      ...
      <div class="wtap-form-default">
        <dl class="row">
          ...
          <dd class="opt two-focus-trigeminy">
            <?php if (is_array($output['code_two_focus_list']['code_info']) && !empty($output['code_two_focus_list']['code_info'])) { ?>
              <?php foreach ($output['code_two_focus_list']['code_info'] as $key => $val) { ?>
                <div focus_id="<?php echo $key;?>" class="focus-trigeminy-group" title="<?php echo '可上下拖拽更改图片组显示顺序';?>">
                    ...
                    <a class="wtap-btn-mini del" href="JavaScript:edit_two_focus(<?php echo $key;?>);"><i class="fa fa-pencil-square-o"></i>编辑</a>
                    <a class="wtap-btn-mini del" href="JavaScript:del_two_focus(<?php echo $key;?>);"><i class="fa fa-trash"></i>删除</a></div>
                    <ul>
                      <?php foreach($val['pic_list'] as $k => $v) { ?>
            ...
            <div class="mt20"> <a class="wtap-btn" href="JavaScript:add_two_focus('pic');"><?php echo '图片组';?></a>
            </div>
          </dd>
        </dl>
      </div>
      <div id="edit_two_focus" class="wtap-form-default" style="display:none;">
        <div class="title">
          <h3>选中区域编辑</h3>
        </div>
        <dl class="row">
      ...
      <div id="upload_two_focus" class="wtap-form-default" style="display:none;">
        <div class="title">
          <h3>新增/选中区域内容设置详情</h3>
        </div>
        <dl class="row">
      ...
      <div class="wtap-form-default">
        <div class="bot"> <a href="JavaScript:void(0);" onclick="$('#upload_two_focus_form').submit();" class="wtap-btn-big wtap-btn-green"><?php echo $lang['page_config_save'];?></a> <a href="index.php?w=page_config&t=html_update&web_id=<?php echo $output['code_two_focus_list']['web_id'];?>" class="wtap-btn-big wtap-btn-green"><?php echo $lang['page_config_web_html'];?></a> <span class="web-two-save-succ" style="display:none;"><?php echo $lang['wt_common_save_succ'];?></span> </div>
      </div>
    </form>
    <form id="upload_eight_focus_form" class="tab-content" name="upload_screen_form" enctype="multipart/form-data" method="post" action="index.php?w=page_config&t=eight_focus_pic" target="upload_pic" style="display:none;">
      <input type="hidden" name="form_submit" value="ok" />
      ...
      <div class="wtap-form-default">
        <dl class="row">
          ...
          <dd class="opt eight-focus-trigeminy">
              ...
              <?php foreach ($output['code_eight_focus_list']['code_info'] as $key => $val) { ?>
                <div style="width:800px;" focus_id="<?php echo $key;?>" class="focus-trigeminy-group" title="<?php echo '可上下拖拽更改图片组显示顺序';?>">
                    <div class="title">
                      ...
                      <a class="wtap-btn-mini del" href="JavaScript:edit_eight_focus(<?php echo $key;?>);"><i class="fa fa-pencil-square-o"></i>编辑</a>
                      <a class="wtap-btn-mini del" href="JavaScript:del_eight_focus(<?php echo $key;?>);"><i class="fa fa-trash"></i>删除</a></div>
                    <ul>
                      <?php foreach($val['pic_list'] as $k => $v) { ?>
            ...
            <div class="mt20"> <a class="wtap-btn" href="JavaScript:add_eight_focus('pic');"><?php echo '图片组';?></a>
      ...
      <div id="edit_eight_focus" class="wtap-form-default" style="display:none;">
        <div class="title">
          <h3>选中区域编辑</h3>
        </div>
        <dl class="row">
      ...
      <div id="upload_eight_focus" class="wtap-form-default" style="display:none;">
        <div class="title">
          <h3>新增/选中区域内容设置详情</h3>
        </div>
        <dl class="row">
      ...
      <div class="wtap-form-default">
        <div class="bot"> <a href="JavaScript:void(0);" onclick="$('#upload_eight_focus_form').submit();" class="wtap-btn-big wtap-btn-green"><?php echo $lang['page_config_save'];?></a> <a href="index.php?w=page_config&t=html_update&web_id=<?php echo $output['code_eight_focus_list']['web_id'];?>" class="wtap-btn-big wtap-btn-green"><?php echo $lang['page_config_web_html'];?></a> <span class="web-eight-save-succ" style="display:none;"><?php echo $lang['wt_common_save_succ'];?></span> </div>
      </div>
    </form>
  </div>
</div>
