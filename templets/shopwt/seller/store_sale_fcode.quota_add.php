...
<div class="wtsc-form-default">
  <form id="add_form" action="<?php if ($output['menu_key'] == 'fcode_quota_add') {echo urlShop('store_sale_fcode', 'fcode_quota_add');} else {echo urlShop('store_sale_fcode', 'fcode_renew');}?>" method="post">
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="hint"><?php printf('每月您需要支付%d元。', intval(C('sale_fcode_price')));?></p>
...
$(document).ready(function(){
	...
	$("#add_form").validate({
		...
		submitHandler:function(form){
			var unit_price = parseInt(<?php echo intval(C('sale_fcode_price'));?>);
