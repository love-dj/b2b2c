    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <span class="err"></span>
          <p class="notic"><?php echo $lang['page_config_channel_style_tips'];?></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="show1" class="cb-enable <?php if($output['channel']['channel_show'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['wt_yes'];?>"><?php echo $lang['wt_yes'];?></label>
            <label for="show0" class="cb-disable <?php if($output['channel']['channel_show'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['wt_no'];?>"><?php echo $lang['wt_no'];?></label>
