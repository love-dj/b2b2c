...
$(function (){
  ...
  function get_detail(goods_id) {
      //渲染页面
      $.ajax({
         url:ApiUrl+"/index.php?w=pointprod&t=pinfo",
         type:"get",
         ...
         success:function(result){
            ...
            if(!data.error){
			  ...
			  $("#fixed-tab-pannel").html(data.goods_content.pgoods_body);
			//渲染模板
              ...
              $(".add").click(function (){
                 ...
                 if(buynum < data.goods_content.pgoods_storage){
                    $(".buy-num").val(parseInt(buynum+1));
                 }
              });
                  ...
                  $("#buy-now").click(function (){
                     ...
                     if(!key){
                      ...
                      if (buynum > data.goods_content.pgoods_storage) {
                        ...
                        $.ajax({
                            type:'post',
                            url:ApiUrl+'/index.php?w=pointcart&t=add',
                            data:json,
                            dataType:'json',
                            success:function(result){
                                if (result.datas.error) {
                                    ...
                                    location.href = WapSiteUrl+'/html/order/pointbuy_step1.html';//?goods_id='+goods_id+'&buynum='+buynum;
                                }
                            }
                        });
                     }
