...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a href="<?php echo urlShop('store_navigation', 'navigation_add');?>" class="wtbtn wtbtn-mint" title="添加导航">添加导航</a> </div>
  <table class="wtsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><?php if($value['sn_if_show']){echo $lang['wt_yes'];}else{echo $lang['wt_no'];}?></td>
        <td class="nscs-table-handle"><span><a href="<?php echo urlShop('store_navigation', 'navigation_edit', array('sn_id' => $value['sn_id']));?>" class="btn-bluejeans"><i class="icon-edit"></i>
          ...
          </a></span><span> <a href="javascript:;" wttype="btn_del" data-sn-id="<?php echo $value['sn_id'];?>"class="btn-grapefruit"><i class="icon-trash"></i>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('[wttype="btn_del"]').on('click', function() {
