...
<div class="page">
<div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=link" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
  ...
  <form id="link_form" enctype="multipart/form-data" method="post">
    ...
    <dl class="row">
	  ...
	  <dl class="row">
        ...
        <dd class="opt">
          <div class="input-file-show"> <span class="show"> <a class="nyroModal" href="<?php echo UPLOAD_SITE_URL."/".ATTACH_SHOW."/".$pic;?>" rel="gal"> <i class="fa fa-picture-o" onmouseout="toolTip()" onmouseover="toolTip('<img src=<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_PATH.'/common/'.$output['link_array']['link_pic']);?>>')"></i> </a> </span> <span class="type-file-box">
