$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php?w=member_evaluate&t=again', {key:key, order_id:order_id}, function(result){
        ...
        $('input[name="file"]').ajaxUploadImage({
            url : ApiUrl + "/index.php?w=sns_album&t=file_upload",
            data:{key:key},
        ...
        $('.btn-l').click(function(){
            ...
            $.ajax({//获取区域列表
                type:'post',
                url:ApiUrl+'/index.php?w=member_evaluate&t=save_again',
                data:param,
                dataType:'json',
                async:false,
