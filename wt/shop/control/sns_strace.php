...
class sns_straceControl extends SystemControl{
    ...
    public function get_xmlWt() {
        ...
        foreach ($strace_list as $value) {
            ...
            $operation .= "<li><a href='index.php?w=sns_strace&t=scomm_list&st_id=". $value['strace_id'] ."'>查看评论</a></li>";
            ...
            $param['strace_state'] = $value['strace_state'] ==  '1' ? '<span class="yes"><i class="fa fa-check-bbs"></i>是</span>' : '<span class="no"><i class="fa fa-ban"></i>否</span>';
    ...
    public function strace_infoWt() {
        ...
        if($strace_info['strace_content'] == ''){
            ...
            $strace_info['strace_content'] = str_replace("%siteurl%", BASE_SITE_URL.DS, $content);
        }
     ...
     * 输出XML数据
     */
    public function get_scomm_xmlWt() {
        ...
        foreach ($scomm_list as $value) {
            ...
            $param['scomm_state'] = $value['scomm_state'] ==  '1' ? '<span class="yes"><i class="fa fa-check-bbs"></i>是</span>' : '<span class="no"><i class="fa fa-ban"></i>否</span>';
