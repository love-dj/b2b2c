  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        <li><a href="index.php?w=pointprod&t=pointprod" ><span><?php echo $lang['admin_pointprod_list_title'];?></span></a></li>
...
<script>
$(function() {
    var flexUrl = 'index.php?w=pointprod&t=pointorder_list_xml';
