...
<div class="eject_con">
  <div class="adds">
    ...
    <div id="warning"></div>
    <form method="post" action="<?php echo MEMBER_SITE_URL;?>/index.php?w=member_address&t=delivery_add" id="address_form" target="_parent">
      ...
      <div class="wtmc-delivery" id="zt_address"></div>
      <dl>
        <dt><i class="required">*</i>收货人姓名<?php echo $lang['wt_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt><i class="required">*</i>电话号码<?php echo $lang['wt_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt><i class="required">*</i>手机<?php echo $lang['wt_colon'];?></dt>
        <dd>
      ...
      <div class="bottom">
        ...
        <a class="wtbtn ml5" href="javascript:DialogManager.close('daisou');">取消</a> </div>
    </form>
  </div>
</div>
...
$(document).ready(function(){
	var _fuc_area = function(area_id){
		$('#zt_address').load("index.php?w=member_address&t=delivery_list&dlyp_id=<?php echo $output['address_info']['dlyp_id'];?>&area_id="+area_id);
	}
	$("#region").wt_region({last_click:_fuc_area});
    ...
    $('#zt_address').load("index.php?w=member_address&t=delivery_list&dlyp_id=<?php echo $output['address_info']['dlyp_id'];?>&area_id=<?php echo $output['address_info']['area_id']?>");
    <?php } ?>
});
