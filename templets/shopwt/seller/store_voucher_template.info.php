...
<dl>
  <dt><em class="pngFix"></em><?php echo $lang['voucher_template_title'].$lang['wt_colon']; ?></dt>
...
<dl>
  <dt><em class="pngFix"></em><?php echo $lang['voucher_template_enddate'].$lang['wt_colon']; ?></dt>
  <dd><?php echo $output['t_info']['voucher_t_end_date']?@date('Y-m-d',$output['t_info']['voucher_t_end_date']):'';?></dd>
</dl>
<dl>
  <dt><?php echo $lang['voucher_template_price'].$lang['wt_colon']; ?></dt>
...
<?php } ?>
<dl>
  <dt ><em class="pngFix"></em><?php echo $lang['voucher_template_total'].$lang['wt_colon']; ?></dt>
...
<dl>
  <dt ><em class="pngFix"></em><?php echo $lang['voucher_template_eachlimit'].$lang['wt_colon']; ?></dt>
  <dd>
...
<?php } ?>
<dl>
  <dt ><em class="pngFix"></em><?php echo $lang['voucher_template_orderpricelimit'].$lang['wt_colon']; ?></dt>
...
<?php } ?>
<dl>
  <dt ><em class="pngFix"></em><?php echo $lang['voucher_template_describe'].$lang['wt_colon']; ?></dt>
  <dd>
    <textarea  name="txt_template_describe" rows="3" class="w300" readonly><?php echo $output['t_info']['voucher_t_desc'];?></textarea>
  </dd>
</dl>
<dl>
  <dt ><em class="pngFix"></em><?php echo $lang['voucher_template_image'].$lang['wt_colon']; ?></dt>
  <dd>
...
<dl>
  <dt><em class="pngFix"></em><?php echo $lang['wt_status'].$lang['wt_colon']; ?></dt>
  <dd>
...
<dl>
  <dt><em class="pngFix"></em><?php echo $lang['voucher_template_giveoutnum'].$lang['wt_colon']; ?></dt>
  <dd><?php echo $output['t_info']['voucher_t_giveout'];?>&nbsp;<?php echo $lang['voucher_template_eachlimit_unit'];?></dd>
</dl>
<dl>
  <dt><em class="pngFix"></em><?php echo $lang['voucher_template_usednum'].$lang['wt_colon']; ?></dt>
...
<dl>
  ...
  <dd>
    <input type="text" class="w340" onclick="oCopy(this)" value="<?php echo BASE_SITE_URL.DS;?>index.php?w=voucher&t=getvoucher&tid=<?php echo $output['t_info']['voucher_t_id'];?>" readonly/>
<script>
	function oCopy(obj){
      obj.select();
...
<h3>已生成代金券
  <a id="voucher_exportbtn" class="wtbtn-mini" href="javascript:void(0);" onclick="javascript:go('index.php?w=store_voucher&t=voucher_export&tid=<?php echo $output['t_info']['voucher_t_id']; ?>');" title="导出Excel" style="float: right; margin-right: 10px; display: none;">导出Excel</a>
</h3>
...
<script type="text/javascript">
  $("#voucher_list_div").load('index.php?w=store_voucher&t=voucherlist&tid=<?php echo $output['t_info']['voucher_t_id']; ?>');
</script>
<?php } ?>
<div class="bottom">
  <a href="javascript:void(0);" class="submit" onclick="window.location='index.php?w=store_voucher&t=templatelist'" > <?php echo $lang['voucher_template_backlist'];?></a>
</div>
<script type="text/javascript">
$(document).ready(function(){
	$("#build_voucher").click(function(){
		ajaxget('index.php?w=store_voucher&t=bulidvoucher&tid=<?php echo $output['t_info']['voucher_t_id'];?>');
	});
});
</script>