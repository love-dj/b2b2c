...
<div class="wtsc-form-default">
    ...
    <form id="add_form" action="index.php?w=store_sale_xianshi&t=xianshi_save" method="post">
    <?php } else { ?>
    <form id="add_form" action="index.php?w=store_sale_xianshi&t=xianshi_edit_save" method="post">
        <input type="hidden" name="xianshi_id" value="<?php echo $output['xianshi_info']['xianshi_id'];?>">
    <?php } ?>
    <dl>
      <dt><i class="required">*</i><?php echo $lang['xianshi_name'];?><?php echo $lang['wt_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>活动标题<?php echo $lang['wt_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>活动描述<?php echo $lang['wt_colon'];?></dt>
      <dd>
...
<?php } ?>
    ...
    <?php } ?>
    <dl>
      <dt><i class="required">*</i>购买下限<?php echo $lang['wt_colon'];?></dt>
      <dd>
