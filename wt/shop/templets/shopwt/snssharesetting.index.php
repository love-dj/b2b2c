...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['wt_binding_manage'];?></h3>
  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle-s">
          <a class="btn blue" href="index.php?w=sns_sharesetting&t=edit&state=1&key=<?php echo $k; ?>"><i class="fa fa-pencil-square-o"></i> <?php echo $lang['wt_edit']?></a></td>
        <td><?php echo $v['name'];?></td>
        <td><?php echo $v['url'];?></td>
        <td><?php if($v['isuse'] == '1'){ ?>
          <span class="yes"><i class="fa fa-check-bbs"></i>启用</span>
          <?php }else { ?>
