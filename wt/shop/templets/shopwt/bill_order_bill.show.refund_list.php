...
$(function(){
    $("#flexigrid").flexigrid({
        ...
        colModel : [
			...
			{display: '退还优惠券', name : 'rpt_amount', width : 70, sortable : true, align: 'left'},
...
function fg_csv(ids) {
    id = ids.join(',');
    window.location.href = $("#flexigrid").flexSimpleSearchQueryString() + '&ob_id=<?php echo $_GET['ob_id'];?>&t=export_refund_order&refund_id='+id;
}
</script>
