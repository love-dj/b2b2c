...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?w=lib_goods&t=get_xml',
        colModel : [
            ...
            {display: '商品视频', name : 'goods_video', width : 60, sortable : false, align: 'center'},//shopwt
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?w=lib_goods&t=goods_class';
    }
}
function fg_operation_del(goods_id){
    if(confirm('删除后将不能恢复，确认删除这项吗？')){
        var _url = 'index.php?w=lib_goods&t=del_goods&goods_id='+goods_id;
...
function fg_see_video(ids) {
      _uri = "index.php?w=lib_goods&t=see_video&id=" + ids;
