...
<div class="wtsc-form-default">
  <form id="add_form" action="<?php echo urlShop('store_account', 'account_save');?>" method="post">
    <dl>
      <dt><i class="required">*</i>会员帐号<?php echo $lang['wt_colon'];?></dt>
      <dd><input class="w120 text" name="member_name" type="text" id="member_name" value="" />
          <span></span>
        <p class="hint">已注册的普通会员的登录帐号</p>
      </dd>
    </dl>
    <dl>
      <dt><i class="required">*</i>登录密码<?php echo $lang['wt_colon'];?></dt>
      <dd><input class="w120 text" name="password" type="password" id="password" value="" />
          <span></span>
        <p class="hint">普通会员的登录密码</p>
      </dd>
    </dl>
    <dl>
      <dt><i class="required">*</i>商家账号<?php echo $lang['wt_colon'];?></dt>
      <dd><input class="w120 text" name="seller_name" type="text" id="seller_name" value="" />
          <span></span>
        <p class="hint">新账号登录商家中心的用户名，密码即是会员帐号的密码</p>
      </dd>
    </dl>
    <dl>
      <dt><i class="required">*</i>账号组<?php echo $lang['wt_colon'];?></dt>
    ...
    <dl>
      <dt><i class="required"></i>客户端登录<?php echo $lang['wt_colon'];?></dt>
      <dd>
