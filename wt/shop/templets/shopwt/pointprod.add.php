...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminShop('pointprod', 'index'); ?>" title="返回列表"> <i class="fa fa-arrow-bbs-o-left"></i> </a>
      <div class="subject">
        <h3><?php echo $lang['wt_pointprod'];?> - <?php echo $lang['admin_pointprod_add_title'];?></h3>
        <h5><?php echo $lang['wt_pointprod_subhead'];?></h5>
      </div>
    </div>
  </div>
...
$(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?w=pointprod&t=pointprod_pic_upload',
