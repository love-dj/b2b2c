...
<div class="eject_con">
  ...
  <form id="category_form" method="post" target="_parent" action="index.php?w=store_video&t=album_add_save">
    <input type="hidden" name="form_submit" value="ok" />
    <dl>
      <dt><i class="required">*</i><?php echo '媒体库名称'.$lang['wt_colon'];?></dt>
      <dd>
        <input class="w300 text" type="text" name="name" id="name" value="" />
      </dd>
    </dl>
    <dl>
      <dt><?php echo '描述'.$lang['wt_colon'];?></dt>
      <dd>
        <textarea class="w300 textarea" rows="3" name="description" id="description"></textarea>
      </dd>
    </dl>
    <dl>
      <dt><?php echo '排序'.$lang['wt_colon'];?></dt>
      <dd>
    ...
    $('#category_form').validate({
        ...
        rules : {
        	name : {
                ...
                maxlength	: 20,
                remote   : {
                    url :'index.php?w=store_video&t=ajax_check_class_name&column=ok',
                    type:'get',
                    data:{
                        ac_name : function(){
                            return $('#name').val();
