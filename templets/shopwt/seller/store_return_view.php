  ...
  <div class="wtsc-flow-container">
    ...
    <div id="saleRefundReturn">
      ...
      <div class="wtsc-form-default">
        ...
        <dl>
          <dt><?php echo $lang['return_buyer_message'].$lang['wt_colon'];?></dt>
        ...
        <h3>商家处理意见</h3>
        <dl>
          <dt><?php echo '处理状态'.$lang['wt_colon'];?></dt>
        ...
        <dl>
          <dt><?php echo '收货备注'.$lang['wt_colon'];?></dt>
        ...
        <?php } ?>
        <div class="bottom">
            <label class=""><a href="javascript:history.go(-1);" class="wtbtn"><i class="icon-reply"></i>返回列表</a></label>
        </div>
      </div>
    </div>
  </div>
...
$(function(){
	$.getJSON('index.php?w=seller_center&t=get_express&e_code=<?php echo $output['e_code'];?>&shipping_code=<?php echo $output['return']['invoice_no'];?>&c=<?php echo random(7);?>',function(data){
		if(data){
