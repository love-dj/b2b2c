...
<table class="search-form">
  ...
  <tr>
    ...
    <td class="tc w180">
    <label class="submit-border"><input type="submit" class="submit" value="<?php echo $lang['wt_search'];?>" /></label>
...
<table class="wtsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><?php echo wtPriceFormat($refund_info['refund_amount']);?></td>
        <td><?php echo wtPriceFormat($refund_info['commis_amount']);?></td>
        <td><?php echo wtPriceFormat($refund_info['rpt_amount']);?></td>
...
$(function(){
    $('#wtexport').click(function(){
    	$('input[name="t"]').val('export_refund_order');
    	$('#formSearch').submit();
    });
});
</script>