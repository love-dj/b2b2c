...
<div class="div-goods-select">
  <table class="search-form">
    <tbody>
      <tr>
        ...
        <td class="tc w70"><a href="index.php?w=store_sale_cou&t=cou_level_sku&level=<?php echo $output['level']; ?>" wttype="search_a" class="wts-btn"><i class="icon-search"></i><?php echo $lang['wt_search'];?></a></td>
        <td class="w10"></td>
      </tr>
    </tbody>
  </table>
  <div class="search-result" style="width:739px;">
    ...
    <ul class="goods-list" wttype="bundling_goods_add_tbody" style=" width:760px;text-align:left;">
...
?>
      <li wttype="<?php echo $val['goods_id'];?>">
        ...
        <div data-cou-level-sku-switch-enabled="<?php echo $val['goods_id']; ?>">
          <a href="javascript:;" class="wtbtn-mini wtbtn-mint" data-cou-level-sku-add-button="<?php echo $val['goods_id']; ?>" data-level="<?php echo $output['level']; ?>"><i class="icon-plus"></i>设置为换购商品</a>
        </div>
      </li>
      <?php }?>
    </ul>
