...
<script type="text/javascript">
  $(function(){
      $("#flexigrid").flexigrid({
          url: 'index.php?w=distribution_level&t=get_xml',
          colModel : [
  ...
  function fg_operation(name, bDiv) {
      if (name == 'add') {
          window.location.href = 'index.php?w=distribution_level&t=add_level';
      } else if (name == 'del') {
  ...
  function fg_delete(id) {
      ...
      location.href = 'index.php?w=distribution_level&t=del_level&del_id='+id;
  }
</script> 
