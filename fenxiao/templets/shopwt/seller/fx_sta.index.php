...
<table class="wtsc-default-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><span><?php echo $output['sta_list'][$val['goods_commonid']]['fx_num']; ?></span></td>
      <td><span><?php echo $output['sta_list'][$val['goods_commonid']]['order_num']; ?></span></td>
      <td><span><?php echo wtPriceFormat($output['sta_list'][$val['goods_commonid']]['order_goods_amount']); ?></span></td>
      <td><span><?php echo wtPriceFormat($output['sta_list'][$val['goods_commonid']]['pay_goods_amount']); ?></span></td>
      <td><span><?php echo wtPriceFormat($output['sta_list'][$val['goods_commonid']]['fx_commis_amount']); ?></span></td>
      <td><span><?php echo wtPriceFormat($output['sta_list'][$val['goods_commonid']]['order_commis_amount']); ?></span></td>
    </tr>
    <?php } ?>
    <?php } else { ?>
    <tr>
