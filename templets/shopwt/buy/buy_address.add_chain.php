...
<div class="wtc-form-default">
  <form method="POST" id="addr_form" action="index.php">
    ...
    <input type="hidden" value="add_addr" name="t">
    <input type="hidden" name="form_submit" value="ok"/>
    <dl>
      <dt><i class="required">*</i>门店<?php echo $lang['wt_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>收货人<?php echo $lang['wt_colon'];?></dt>
      <dd>
        <input type="text" class="text w100" name="true_name" maxlength="20" id="true_name" value=""/>
      </dd>
    </dl>
    <dl>
      <dt><i class="required">*</i><?php echo $lang['cart_step1_mobile_num'].$lang['wt_colon'];?></dt>
      <dd>
        <input type="text" class="text w200" name="mob_phone" id="mob_phone" maxlength="15" value=""/>
        &nbsp;&nbsp;(或)&nbsp;<?php echo $lang['cart_step1_phone_num'].$lang['wt_colon'];?>
...
$(document).ready(function(){
	var chain = function(area_id){
	    $.getJSON(SITEURL + '/index.php?w=buy&t=load_chain&area_id=' + area_id + '&store_id=' + chain_store_id + '&callback=?',function(data){
	    	$('#chain').remove();
	...
	$("#region").wt_region({last_click:chain});
