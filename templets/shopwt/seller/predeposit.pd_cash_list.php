...
<div class="wrap">
  ...
  <form method="get" action="index.php">
    <table class="wtm-search-table">
      ...
      <input type="hidden" name="t" value="pd_cash_list" />
      <tr>
      <th></th><td></td>
        <th><?php echo $lang['predeposit_paystate'].$lang['wt_colon']; ?></th>
  ...
  <table class="wtm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><p><a href="index.php?w=seller_predeposit_tx&t=pd_cash_info&id=<?php echo $val['pdc_id']; ?>"><?php echo $lang['wt_view']; ?></a></p></td>
      </tr>
      <?php } ?>
      <?php } else {?>
      <tr>
