...
<form method="get" action="index.php">
  <table class="search-form">
    <input type="hidden" name="w" value="store_lib_goods" />
    ...
    <tr>
      ...
      <td class="tc w70"><label class="submit-border"><input id="submit" type="submit" class="submit" value="<?php echo $lang['wt_search'];?>" /></label></td>
    </tr>
  </table>
</form>
<table class="wtsc-default-table">
  <thead>
    <tr wt_type="table_header">
      ...
      <th class="w80"><?php echo $lang['wt_handle'];?></th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td class="tl"><dl class="goods-name">
          ...
          <dd>商品卖点<?php echo $lang['wt_colon'];?><?php echo str_cut($val['goods_jingle'],50); ?></dd>
        </dl></td>
      ...
      <td class="nscs-table-handle">
        <span><a href="javascript:void(0)" class="btn-mint" wt_type="dialog" dialog_title="认领商品：<?php echo str_cut($val['goods_name'],50); ?>" dialog_id="map_edit" dialog_width="480" uri="index.php?w=store_lib_goods&t=edit_goods&gc_id=<?php echo $val['gc_id']; ?>&goods_id=<?php echo $val['goods_id']; ?>" href="" class="btn-bluejeans"><i class="icon-edit"></i>
        <p>认领</p>
        </a></span></td>
    </tr>
    <?php } ?>
...
<script src="<?php echo SHOP_STATIC_SITE_URL;?>/js/store_goods_list.js"></script> 
<script>
...
function gcategoryChange(){
    ...
    if (this.value > 0){
        var _self = this;
        var url = SITEURL + '/index.php?w=store_lib_goods&t=ajax_goods_class';
