...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=web_channel&t=web_channel" title="返回频道列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
  ...
  <form id="web_form" method="post" name="form1">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row wtap-channel-floor">
        <dt class="tit">
          <label>已选择中部模块</label>
        </dt>
        <dd class="opt">
          <ul id="floor_list">
            ...
            <li><div class="layout-name">模块：<?php echo $v['web_name'];?></div>
                ...
                <a href="JavaScript:void(0);" class="wtap-btn-mini wtap-btn-red" onclick="del_floor(<?php echo $v['web_id'];?>)"><i class="fa fa-trash"></i>删除</a></li>
            <?php } ?>
            <?php } ?>
            <?php } ?>
          </ul>
      ...
      <dl class="row  wtap-channel-floor-list">
        <dt class="tit">
          <label>可选择模块</label>
        </dt>
        <dd class="opt">
          ...
          <a class="wtap-btn vm" href="JavaScript:get_floor();"><i class="fa fa-search"></i></a></div>
...
function check_goods_class() {
    ...
    if (gc_id>0 && gc_id!="<?php echo $output['gc_id'];?>") {
    	var get_text = $.ajax({
    		url: 'index.php?w=web_channel&t=check_goods_class&gc_id='+gc_id,
    		async: false
    		}).responseText;
    	if(get_text!='') {
...
function get_floor() {
	...
	$("#show_floor_list").load('index.php?w=web_channel&t=get_channel_fl&'+$.param({'name':f_name }));
}
function select_floor(floor_id) {
	...
	text_append += '<a href="JavaScript:void(0);" class="wtap-btn-mini wtap-btn-red" onclick="del_floor('+floor_id+')"><i class="fa fa-trash"></i>删除</a>';
