...
<div class="wrap">
  ...
  <div class="wtm-message-send">
    <div class="wtm-message-send-form">
      <div class="wtm-default-form">
        <form method="post" id="send_form" action="<?php echo MEMBER_SITE_URL;?>/index.php?w=member_message&t=savemsg">
          <input type="hidden" name="form_submit" value="ok" />
          <dl>
            <dt><i class="required">*</i><?php echo $lang['home_message_reveiver'].$lang['wt_colon'];?></dt>
            <dd>
          ...
          <dl>
            <dt><i class="required">*</i><?php echo $lang['home_message_content'].$lang['wt_colon'];?></dt>
            <dd>
    ...
    <div class="wtm-message-send-friend">
      <h3><?php echo $lang['home_message_friend'];?></h3>
       <?php if ($output['friend_list'] != '') { ?><ul>
       
        <?php foreach ($output['friend_list'] as $val) { ?>
        <li><a href="javascript:void(0);" id="<?php echo $val['friend_tomname']; ?>" wt_type="to_member_name">
        ...
        <a href="index.php?w=member_snsfriend&t=find" class="wtbtn-mini" target="_blank">添加好友</a>
        </div>
        <?php } ?>
    </div>
  </div>
...
$(function(){
    $('a[wt_type="to_member_name"]').click(function (){
