...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=message&t=seller_tpl" title="返回用户消息模板列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['wt_message_set'];?> - <?php echo $lang['wt_edit'];?>用户消息模板“<?php echo $output['mmtpl_info']['mmt_name'];?>”</h3>
  ...
  <div class="homepage-focus" wttype="sellerTplContent">
    ...
    <form class="tab-content" method="post" name="short_name" style="display:none;">
      ...
      <div class="wtap-form-default">
        ...
        <dd class="opt">
          <input type="text" value="<?php echo $output['mmtpl_info']['apicodeid'];?>" name="apicodeid" class="input-txt">
        </dd>
      </dl>
