<?php defined('ShopWT') or exit('Access Denied By ShopWT');?>
  <div class="wtap-form-default">
    ...
    <div class="bot" id="submit-holder"> <a class="wtap-btn-big wtap-btn-green" href="javascript:if (confirm('<?php echo $lang['admin_predeposit_cash_confirm'];?>')){window.location.href='index.php?w=predeposit&t=pd_cash_pay&id=<?php echo $output['info']['pdc_id']; ?>';}else{}"><?php echo $lang['admin_predeposit_payed'];?></a></div>
  <?php } ?>
  </div>