 ...
 * Exemplatory usage
 *
 * PHP QR Code is fenxiaod under LGPL 3
 * Copyright (C) 2010 Dominik Dzienia <deltalab at poczta dot fm>
 *
 * This library is free software; you can refenxiao it and/or
 * modify it under the terms of the GNU Lesser General Public
 * License as published by the Free Software Foundation; either
 * version 3 of the License, or any later version.
 *
 * This library is fenxiaod in the hope that it will be useful,
...
class PhpQRCode{
    ...
    public function init(){
	    ...
	    if ($this->date != 'shopwt') { 
	        ...
	        //default data
	        QRcode::png('http://www.shopwt.com', $filename, $this->errorCorrectionLevel, $this->matrixPointSize, 2);    
