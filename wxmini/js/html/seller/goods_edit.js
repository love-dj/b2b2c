$(function() {
    ...
    $.ajax({
                type: "post",
                url: ApiUrl + "/index.php?w=seller_goods&t=goods_content",
                data: {
                    key: key,
    ...
    $.ajax({
                type: "post",
                url: ApiUrl + "/index.php?w=seller_goods&t=goods_image_info",
                data: {
                    key: key,
                    goods_commonid: commonid,
                },
    ...
    $('input[name="file"]').ajaxUploadImage({
            url : ApiUrl + "/index.php?w=seller_album&t=image_upload",
            data:{
                key:key,
                name:"file"
            },
    ...
    $(".btn").click(function() {
        if ($.sValid()) {
            ...
            var g_state         = $("#g_state").prop("checked") ? 1 : 0;//上架
            var g_commend       = $("#g_commend").prop("checked") ? 1 : 0;//推荐
            var g_vat           = $("#g_vat").prop("checked") ? 1 : 0;//发票
            ...
            $.ajax({
                type: "post",
                url: ApiUrl + "/index.php?w=seller_goods&t=goods_edit",
                data: {
                    key: key,
                    commonid:commonid,
                    cate_id: cate_id,
                ...
                success: function(a) {
                    if (a) {
                        window.location.href = WapSiteUrl + "/html/seller/goods_list.html";
                    } else {
                        $.sDialog({
                            skin: "red",
