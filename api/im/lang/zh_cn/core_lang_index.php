...
$lang	= array(
		 ...
		 */
				...
				'error_info' => '系统信息',
				'error_notice_operate' => '系统运行出错，给您带来的访问不便，请联系客服寻求帮助',
				'company_name' => '未来易购网上商城',

				'has_been_canceled' => '<span style>"color:#999">订单已取消</span>',
				'pending_payment' => '<span style>"color:#36C">待买家付款</span>',
				'pending_recive' => '<span style>"color:#36C">待卖家收款</span>',
				'paid' => '<span style>"color:#F30">买家已付款</span>',
				'shipped' => '<span style>"color:#F30">卖家已发货</span>',
				'completed' => '<span style>"color:#060">交易成功</span>',
				'refund_completed' => '<span style>"color:#999">交易关闭</span>',
				'to_be_confirmed' => '已提交，待确认',
				'to_be_shipped' => '已确认，待发货',
				...
				'please_check_your_system_chmod_show' => '广告位信息缓存文件不能写入，请检查文件以及文件夹权限是否正确!',
