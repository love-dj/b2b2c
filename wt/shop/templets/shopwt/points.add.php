  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        ...
        <li><a href="index.php?w=points&t=setting">规则设置</a></li>
...
function checkmember(){
	...
	$.getJSON("index.php?w=points&t=checkmember", {'name':membername}, function(data){
	        if (data)
	        {
		        $("#tr_memberinfo").show();
...
$(function(){
    ...
    $('#points_form').validate({
        ...
        messages : {
			member_name: {
				required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_points_addmembername_error'];?>'
			},
			member_id : {
				required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_points_member_error_again'];?>'
            },
            pointsnum  : {
                required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_points_points_null_error']; ?>',
                min : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_points_points_min_error']; ?>'
            }
        }
    });
});
