...
<div class="wrap">
  ...
  <div class="wtm-default-form">
    <form id="form_company_info" action="index.php?w=access_infomation&t=save_quit" method="post">
      <input type="hidden" name="form_submit" value="ok" />
      <dl>
        <dt><i class="required"></i>可提现金额：</dt>
        <dd>
          <?php echo wtPriceFormatForList($output['member_info']['available_fx_trad']); ?>
        </dd>
      </dl>
      <dl>
        <dt><i class="required"></i>冻结佣金：</dt>
        <dd>
            <?php echo wtPriceFormatForList($output['member_info']['freeze_fx_trad']); ?>
        </dd>
      </dl>
      <dl>
        <dt><i class="required"></i>总佣金：</dt>
        <dd>
          <?php echo wtPriceFormatForList($output['member_info']['available_fx_trad'] + $output['member_info']['freeze_fx_trad']);?>
        </dd>
      </dl>
      <dl class="bottom">
        <dt>&nbsp;</dt>
