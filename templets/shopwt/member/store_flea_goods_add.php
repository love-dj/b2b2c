...
<div class="wrap">
  ...
  <div class="wtm-default-form">
    <form method="post" id="goods_form" action="index.php?w=member_flea&t=<?php if ($output['goods']['goods_id']!='') echo 'edit_save_goods'; else echo 'save_goods'; ?>">
      ...
      <dl>
        <dt class="required"><em class="pngFix"></em><?php echo $lang['store_goods_index_flea_goods_class'].$lang['wt_colon'];?></dt>
        <dd id="gcategory">
          <?php if (!empty($output['goods']['gc_id'])) { ?>
          <span class="f_l"><?php echo $output['goods']['gc_name'];?></span> <a class="edit_gcategory btn" href="javascript:void(0)"><?php echo $lang['wt_edit'];?></a>
      ...
      <dl>
        <dt class="required"><em class="pngFix"></em><?php echo $lang['store_goods_index_flea_goods_name'].$lang['wt_colon'];?></dt>
        <dd>
          <p>
      ...
      <dl>
        <dt><?php echo $lang['store_goods_index_flea_goods_tag'].$lang['wt_colon'];?></dt>
        <dd>
          <p>
      ...
      <dl>
        <dt><?php echo $lang['store_goods_album_flea_goods_pic'].$lang['wt_colon'];?></dt>
        <dd>
            ...
            <div class="content">
              ...
              <div class="standard">
                ...
                <div class="small_pic" >
                  <ul id="goods_images">
                    <?php for($i=0;$i<5;$i++){?>
                    <li wt_type="handle_pic" file_id="<?php echo $output['goods_image'][$i]['upload_id']; ?>" thumbnail="<?php echo $output['goods_image'][$i]['file_thumb']; ?>" id="thumbnail_<?php echo $i;?>">
                      <input type="hidden" name="goods_file_id[]" value="<?php echo $output['goods_image'][$i]['upload_id']; ?>">
                      <div class="picture"><span class="thumb"><i></i>
                      <img id="img_<?php echo $i;?>" src="<?php echo $output['goods_image'][$i]['file_thumb'] !=''?$output['goods_image'][$i]['file_thumb']:SHOP_TEMPLATES_URL.'/images/member/default_image.png';?>" onerror="this.src='<?php echo SHOP_TEMPLATES_URL.'/images/member/default_image.png';?>'" onload="javascript:DrawImage(this,72,72);"/>
                      
                      
                      </span></div>
                      <div wt_type="handler" class="bg" id="<?php echo $i;?>">
                        <?php if($output['goods_image'][$i]['file_thumb'] !=''){?>
                        <p class="operation"><span class="cut_in" wt_type="set_cover" ecm_title="<?php echo $lang['store_goods_index_face'];?>"></span><span class="delete" wt_type="drop_image" ecm_title="<?php echo $lang['wt_del'];?>"></span></p>
                        <?php }?>
                      </div>
                      <div class="upload-btn"><a href="javascript:void(0);">
                        <iframe id="iframe_<?php echo $i;?>" width="86" scrolling="no" height="30" frameborder="0" src="index.php?w=member_flea&t=image_upload&id=<?php echo $i;?>&item_id=<?php echo $output['item_id']?>&file_id=<?php echo $output['goods_image'][$i]['upload_id']; ?>" ></iframe>
                        </a></div>
                    </li>
                    <?php } ?>
                  </ul>
      ...
      <dl>
        ...
        <dd>
          <select name="sh_quality" class="w100">
            <option value="0"<?php if($output['goods']['flea_quality']=='0'){echo ' selected="selected"';}?>><?php echo $lang['wt_please_choose'];?></option>
      ...
      <dl>
        ...
        <dd>
          <div class="select_add" id="region_flea" style="width:500px;border:1px solide red;">
            ...
            <input type="button" value="<?php echo $lang['wt_edit'];?>" class="edit_region" />
            <select style="display:none;">
      ...
      <dl>
        <dt class="required"><em class="pngFix"></em><?php echo $lang['store_goods_index_flea_goods_price'].$lang['wt_colon'];?></dt>
        <dd>
          <input name="goods_price" class="text" value="<?php echo $output['goods']['goods_price']; ?>" type="text" />
        </dd>
      </dl>
      <dl>
        <dt wt_type="no_spec" class="required"><em></em><?php echo $lang['store_goods_index_store_flea_price'].$lang['wt_colon'];?></dt>
        <dd wt_type="no_spec">
          <input name="goods_store_price" class="text" value="<?php echo $output['goods']['goods_store_price']; ?>" type="text" />
        </dd>
      </dl>
      <dl>
        <dt class="required"><em class="pngFix"></em><?php echo $lang['flea_contact_person'].$lang['wt_colon'];?></dt>
        <dd>
          <input name="flea_pname" value="<?php echo $output['goods']['flea_pname']; ?>" type="text" class="text" />
        </dd>
      </dl>
      <dl>
        <dt class="required"><em class="pngFix"></em><?php echo $lang['flea_contact_tel'].$lang['wt_colon'];?></dt>
        <dd>
          <input name="flea_pphone" value="<?php echo $output['goods']['flea_pphone']; ?>" type="text" class="text" />
        </dd>
      </dl>
      <dl>
        <dt><?php echo $lang['store_goods_index_flea_goods_seo_keywords'].$lang['wt_colon'];?></dt>
        <dd >
          <p>
      ...
      <dl>
        <dt><?php echo $lang['store_goods_index_goods_seo_description'].$lang['wt_colon'];?></dt>
        <dd>
          <p>
      ...
      <dl>
        <dt><?php echo $lang['store_goods_index_flea_goods_desc'].$lang['wt_colon'];?></dt>
        <dd>
          <p>
<?php showEditor('g_body',$output['goods']['goods_body'],'800px','480px','visibility:hidden;',"false",$output['editor_multimedia']);?>
          </p>
          <p class="info-album"><a class="des_demo" href="index.php?w=flea_album&t=pic_list&item=des&goods_id=<?php echo $_GET['goods_id']; ?>"><?php echo $lang['store_goods_album_insert_users_flea_photo'];?></a></p>
      ...
      <dl class="bottom">
        <dt>&nbsp;</dt>
        <dd>
          <input type="submit" class="submit" value="<?php echo $lang['wt_submit'];?>" />
        </dd>
      </dl>
    </form>
  </div>
...
$(document).ready(function(){
	    ...
	    $('*[wt_type="handle_pic"]').find('img:first').hover(function(){
	        $('*[wt_type="explain_layer"]').remove();
	        handle_pic = $(this).parents('*[wt_type="handle_pic"]');
	        handler = handle_pic.find('*[wt_type="handler"]');
	        ...
	        cover = handler.find('*[wt_type="set_cover"]');
	        cover.unbind('click');
	        cover.click(function(){
	            set_cover(handle_pic.attr("file_id"));
	        });

	        drop = handler.find('*[wt_type="drop_image"]');
	        drop.unbind('click');
	        drop.click(function(){
	            drop_image(handler.attr("id"));
	        });

	        insert = handler.find('*[wt_type="insert_editor"]');
	        insert.unbind('click');
...
<script src="<?php echo STATIC_SITE_URL;?>/js/flea/common_flea_select.js"></script>
...
function add_uploadedfile(file_data)
{
    ...
    if(file_data.instance == 'goods_image'){
        ...
        $('#'+id).html('<p class="operation"><span class="cut_in" wt_type="set_cover" ecm_title="<?php echo $lang['store_goods_index_face'];?>"></span><span class="delete" wt_type="drop_image" ecm_title="<?php echo $lang['wt_del'];?>"></span></p>');
        $('#iframe_'+id).attr('src','index.php?w=member_flea&t=image_upload&id='+id+'&item_id='+item_id+'&file_id='+file_data.file_id);
...
function drop_image(id){
    if (confirm('<?php echo $lang['store_goods_index_goods_del_confirm']; ?>')){
            var url = SITE_URL + '/index.php?w=member_flea&t=drop_image';
...
function set_cover(file_id){
    ...
    $('*[wt_type="handler"]').hide();
    $('#big_goods_image').attr('src',obj.attr('thumbnail'));
    obj.remove();
}
function insert_img(id,item_url){
	var url = SITE_URL + '/index.php?w=member_flea&t=insert_image';
	var j	= 0;
	var y	= 'sign';
	for (var i = 0; i < 5; i++){
	...
	if(j==5){
		...
		$.getJSON(url, {'id':id,'item_id':item_id}, function(data){
        	if (data.done){
        		...
        		$('#iframe_'+y).attr('src','index.php?w=member_flea&t=image_upload&id='+y+'&item_id='+item_id+'&file_id='+data.file_id);
        		$('#'+y).html('<p class="operation"><span class="cut_in" wt_type="set_cover" ecm_title="<?php echo $lang['store_goods_index_face'];?>"></span><span class="delete" wt_type="drop_image" ecm_title="<?php echo $lang['wt_del'];?>"></span></p>');
        		if($('#big_goods_image').attr('src') == '<?php echo SHOP_TEMPLATES_URL.'/images/member/default_image.png';?>'){
...
<?php if ($output['goods']['goods_id']=='') { ?>
            cate_id    : {
				required : true,
                remote   : {
                    url  : 'index.php?w=member_flea&t=check_class',
                    type : 'get',
                    data : {
                        cate_id : function(){
                            return $('#cate_id').val();
...
area_id: {
	required: true,
	remote   : {
        url  : 'index.php?w=index&t=flea_area&check=1',
        type : 'get',
        data : {
            region_id : function(){
                return $('#area_id').val();
