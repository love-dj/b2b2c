...
class member_chatControl extends mobileMemberControl {
     ...
     * node连接参数
     */
    public function get_node_infoWt() {
        $output_data = array('node_chat' => C('node_chat'),'node_site_url' => NODE_SITE_URL,'static_site_url' => STATIC_SITE_URL);
     ...
     *
     */
    public function get_msg_countWt(){
        $model_chat = Model('web_chat');
        $member_id = $this->member_info['member_id'];
        $condition = array();
        $condition['t_id'] = $member_id;
