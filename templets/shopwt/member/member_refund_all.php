  ...
  <div class="wtm-flow-container">
    ...
    <div id="saleRefund" show_id="1">
      ...
      <div class=" wtm-default-form">
        <div id="warning"></div>
        <form id="post_form1" enctype="multipart/form-data" method="post" action="index.php?w=member_refund&t=add_refund_all&order_id=<?php echo $output['order']['order_id']; ?>&goods_id=<?php echo $output['goods']['rec_id']; ?>">
          ...
          <dl>
            ...
            <dd><strong class="green"><?php echo wtPriceFormat($output['order']['allow_refund_amount']); ?></strong> 元</dd>
          </dl>
          <dl>
