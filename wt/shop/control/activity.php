    ...
    public function activity_xmlWt()
    {
        ...
        foreach ($list as $val) {
            ...
            if ($val['activity_state'] == 0 || $val['activity_end_date'] < time()) {
                $o .= '<a class="btn red confirm-del-on-click" href="javascript:;" data-href="index.php?w=activity&t=del&activity_id=' .
                    $val['activity_id'] .
            ...
            $o .= '<li><a href="index.php?w=activity&t=edit&activity_id=' .
                    $val['activity_id'] .
                    '">编辑活动</a></li>';

            $o .= '<li><a href="index.php?w=activity&t=detail&id=' .
                $val['activity_id'] .
                '">处理申请</a></li>';
...
EOB;
    ...
    public function newWt(){
        ...
        if($result){
            $this->log(L('wt_add,activity_index').'['.$_POST['activity_title'].']',null);
            showMessage(Language::get('wt_common_op_succ'),'index.php?w=activity&t=activity');
        }else{
    ...
    public function editWt(){
        ...
        if($result){
            ...
            $this->log(L('wt_edit,activity_index').'[ID:'.$_POST['activity_id'].']',null);
            showMessage(Language::get('wt_common_save_succ'),'index.php?w=activity&t=activity');
        }else{
            if($_FILES['activity_banner']['name']!=''){
                @unlink(BASE_UPLOAD_PATH.DS.ATTACH_ACTIVITY.DS.$upload->file_name);
            }
    ...
    public function detail_xmlWt()
    {
        ...
        foreach ($list as $val) {
            ...
            if ($val['activity_detail_state'] != 1) {
                $o .= '<li><a class="confirm-on-click" href="javascript:;" data-href="index.php?w=activity&t=deal&state=1&activity_detail_id=' .
                    $val['activity_detail_id'] .
                    '">通过</a></li>';
            }

            if ($val['activity_detail_state'] != 2) {
                $o .= '<li><a class="confirm-on-click" href="javascript:;" data-href="index.php?w=activity&t=deal&state=2&activity_detail_id=' .
                    $val['activity_detail_id'] .
                    '">拒绝</a></li>';
            }
            ...
            if ($val['activity_detail_state'] != 1) {
                $o .= '<li><a class="confirm-on-click" href="javascript:;" data-href="' .
                    'index.php?w=activity&t=del_detail&activity_detail_id=' .
                    $val['activity_detail_id'] .
                    '">删除</a></li>';
            }
