  ...
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3>计划任务</h3>
        <h5>计划触发相关设置</h5>
      </div> <ul class="tab-base wt-row">
      <li><a href="?w=task&t=list"><span><?php echo $lang['wt_list'];?></span></a></li>
      <li><a href="javascript:;" class="current"><span><?php echo $lang['wt_edit'];?></span></a></li>
      <li><a href="?w=task&t=add"><span><?php echo $lang['wt_add'];?></span></a></li>
      </ul>
	  </div>
  </div>
  ...
  <form id="edit_form" method="post" enctype="multipart/form-data">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          ...
          <td class="vatop rowform"><input name="dourl" type="text" id="dourl" class="txt" value="<?php echo $output['task']['dourl'];?>" />
            <span style="color:#999;padding:5px 0;">默认为cj_index.php，因此填写文件名即可</span></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="vatop rowform onoff"><label for="islock_enable" class="cb-enable<?php echo $output['task']['islock'] == 0?' selected':'';?>" title="<?php echo $lang['wt_yes'];?>"><span><?php echo $lang['wt_yes'];?></span></label>
            <label for="islock_disabled" class="cb-disable<?php echo $output['task']['islock'] == 1?' selected':'';?>" title="<?php echo $lang['wt_no'];?>"><span><?php echo $lang['wt_no'];?></span></label>
      ...
      <tfoot>
        <tr class="tfoot">
			<td>&nbsp;</td>
          <td><a href="javascript:;" class="wtap-btn-big wtap-btn-green" id="submitBtn"><span><?php echo $lang['wt_submit'];?></span></a><a href="javascript:;" class="wtap-btn-big ml10" id="resetBtn"><span><?php echo $lang['wt_reset'];?></span></a></td>
        </tr>
      </tfoot>
    </table>
  </form>
