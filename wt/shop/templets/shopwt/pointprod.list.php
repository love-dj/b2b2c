...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['wt_pointprod'];?></h3>
      ...
      <ul class="tab-base wt-row">
        ...
        <li><a href="index.php?w=pointprod&t=pointorder_list" ><?php echo $lang['admin_pointorder_list_title'];?></a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
...
<script>
$(function(){
    var flexUrl = 'index.php?w=pointprod&t=pointprod_xml';
        ...
        buttons: [
            {
                ...
                title: '新增积分兑换礼品',
                onpress: function() {
                    location.href = 'index.php?w=pointprod&t=prod_add';
                }
            },
            {
