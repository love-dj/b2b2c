...
.logo .link i{display:inline-block;vertical-align:middle;background:url(<?php echo FENXIAO_TEMPLATES_URL;?>/images/seller/login/dlgj.png) no-repeat;width:28px;height:26px}
...
<body>
	<div id="header">
		<div class="logo">
			...
			<a href="<?php echo FENXIAO_SITE_URL;?>/index.php?w=fx_join" class="link">
            <i></i>分销员认证申请
        </a>
		
		</div>
	</div>
	<div id="content" style="background: #B1CEF8">
	<div class="wtsc-login-layout">
			<div class="left-pic" style="background:#B1CEF8 url(<?php echo FENXIAO_TEMPLATES_URL?>/images/seller/login/login_img.png)  no-repeat scroll center center;">
				<a href="###"></a>
				...
				<div class="wtsc-login-container">
					...
					<form id="form_login" action="index.php?w=seller_login&t=login" method="post">
						...
						<div class="input">
							...
							<div class="code">
								<div class="arrow"></div>
								<div class="code-img"><a href="javascript:void(0)" wttype="btn_change_vercode"><img src="index.php?w=vercode&type=30x92" name="codeimage" border="0" id="codeimage"></a>
								</div>
