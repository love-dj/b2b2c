...
<div class="tabmenu">
  ...
  <a uri="index.php?w=store_album&t=album_add" wt_type="dialog" dialog_title="<?php echo $lang['album_class_add'];?>" class="wtbtn wtbtn-mint" style="right: 100px;"><i class="icon-folder-open "></i><?php echo $lang['album_class_add'];?></a>
  ...
  <div class="upload-con" id="uploader" style="display: none;">
    <form method="post" action="" id="fileupload" enctype="multipart/form-data">
      <div class="upload-con-div"><?php echo $lang['album_class_list_sel_img_class'].$lang['wt_colon'];?>
...
<div id="pictureIndex" class="wtsc-picture-folder">
    ...
    <tbody>
      <tr>
        ...
        <td class="w100"><form name="select_sort" id="select_sort" class="sortord">
            ...
            <input type="hidden" name="t" value="album_cate" />
  ...
  <?php if(!empty($output['aclass_info'])){?>
  <div class="wtsc-album">
    <ul>
      <?php foreach ($output['aclass_info'] as $v){?>
      <li class="hidden">
        <dl>
          <dt>
            <div class="covers"><a href="index.php?w=store_album&t=album_pic_list&id=<?php echo $v['aclass_id']?>">
            ...
            <h3 class="title"><a href="index.php?w=store_album&t=album_pic_list&id=<?php echo $v['aclass_id']?>"><?php echo $v['aclass_name'];?></a></h3>
          </dt>
          <dd class="date"><?php echo $lang['album_class_pic_altogether'];?><?php echo $v['count']?><?php echo $lang['album_class_pic_folio'];?></dd>
          <dd class="buttons"><span wt_type="dialog" dialog_title="<?php echo $lang['album_class_deit'];?>" dialog_id='album_<?php echo $v['aclass_id'];?>' dialog_width="480" uri="index.php?w=store_album&t=album_edit&id=<?php echo $v['aclass_id'];?>"><a href="JavaScript:void(0);"><i class="icon-pencil"></i><?php echo $lang['album_class_edit'];?></a></span>
            <?php if($v['is_default'] != '1'){?>
            <a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['album_class_delete_confirm_message'];?>', 'index.php?w=store_album&t=album_del&id=<?php echo $v['aclass_id'];?>');"><i class="icon-remove-sign"></i><?php echo $lang['album_class_delete'];?></a>
            <?php }?>
          </dd>
        </dl>
      </li>
...
$(function() {
    //鼠标触及区域li改变class
    $(".wtsc-album ul li").hover(function() {
        $(this).addClass("hover");
    }, function() {
        $(this).removeClass("hover");
    });
    //凸显鼠标触及区域、其余区域半透明显示
    $(".wtsc-album > ul > li").jfade({
        start_opacity:"1",
        high_opacity:"1",
        low_opacity:".5",
        timing:"200"
