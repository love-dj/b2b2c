...
<div class="sidebar">
  <div class="ad-image-date">
    ...
    <dd>
      <p id="upload_time"><b><?php echo $lang['album_pinfo_upload_time'].$lang['wt_colon'];?></b><?php echo date('Y-m-d',$output['pic_info']['upload_time']);?></p>
      <p><b><?php echo $lang['album_pinfo_class_name'].$lang['wt_colon'];?></b><?php echo $output['class_info']['ac_name'];?></p>
      
      <p id="default_spec"><b><?php echo $lang['album_pinfo_original_spec'].$lang['wt_colon'];?></b><?php echo $output['pic_info']['ap_spec'];?></p>
...
<div class="left-content">
  ...
  <div id="pictureFolder" class="album">
    <div class="intro mb20">
      <div class="covers"><span class="thumb size60"><i></i><a href="index.php?w=sns_album&t=album_pic_list&id=<?php echo $output['class_info']['ac_id']?>">
      ...
      <div class="ad-nav">
        <div class="ad-thumbs">
          <ul class="ad-thumb-list">
            ...
            <li> <a href="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$output['master_id'].DS.$v['ap_cover'];?>" value="<?php echo $v['ap_id'] ?>"> <span class="thumb"><i></i> <img wttype="thumb" title="<?php echo $v['ap_name']?>" src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$output['master_id'].DS.str_ireplace('.', '_240.', $v['ap_cover']);?>" />
...
<script type="text/javascript" src="<?php echo STATIC_SITE_URL;?>/js/jquery.ad-gallery.js"></script> 
<script type="text/javascript">
  $(function() {
	...
	$('img[wttype="thumb"]').click(function(){
	...
	$('.ad-back').live('click',function(){
		...
		$('.ad-thumb-list').load('index.php?w=sns_album&t=album_pic_scroll_ajax&id=<?php echo $_GET['id'];?>&class_id=<?php echo $_GET['class_id'];?>&mid=<?php echo $_GET['mid'];?>&curpage='+curpage);
	});
...
function ajax_change_imgmessage(url){
	...
	$.getJSON("<?php echo BASE_SITE_URL; ?>/index.php?w=sns_album&t=ajax_change_imgmessage&mid=<?php echo $output['master_id'];?>", {'url':url}, function(data){
		$("#img_name").html(data.img_name);
		$("#upload_time").html('<b><?php echo $lang['album_pinfo_upload_time'].$lang['wt_colon'];?></b>'+data.upload_time);
		$("#default_spec").html('<b><?php echo $lang['album_pinfo_original_spec'].$lang['wt_colon'];?></b>'+data.default_spec);
	});
}
</script>