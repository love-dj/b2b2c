...
<div class="theme-editor" style="display:none">
  <form method="post" id="theme_form" action="<?php echo BBS_SITE_URL;?>/index.php?w=theme&t=save_theme&c_id=<?php echo $output['c_id'];?>">
    ...
    <div class="quick-thread">
      <div class="quick-thread-box">
        ...
        <div class="bottom"> <a class="submit-btn" wttype="theme_submit" href="Javascript: void(0)"><?php echo $lang['wt_release_new_theme'];?></a> <a class="cancel-btn" wttype="theme_cancle" href="Javascript: void(0)"><?php echo $lang['wt_cancel'];?></a>
          <div id="warning"></div>
        </div>
      </div>
    </div>
...
$(function(){
	...
	// 点击取消发话题
	$('a[wttype="theme_cancle"]').click(function(){
