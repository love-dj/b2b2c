...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=admin&t=admin" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['wt_limit_manage'];?> - <?php echo $lang['wt_add'];?>管理员</h3>
	...
	$("#add_form").validate({
        ...
        rules : {
            admin_name : {
				...
				maxlength: 20,
				remote	: {
                    url :'index.php?w=admin&t=ajax&branch=check_admin_name',
                    type:'get',
                    data:{
                    	admin_name : function(){
        ...
        messages : {
            admin_name : {
                required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_add_username_null'];?>',
				minlength: '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_add_username_max'];?>',
				maxlength: '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_add_username_max'];?>',
            ...
            gid : {
                required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['admin_add_gid_null'];?>'
            }
        }
	});
});
