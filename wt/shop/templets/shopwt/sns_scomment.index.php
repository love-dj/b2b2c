...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=sns_strace" title="返回动态列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?w=sns_strace&t=get_scomm_xml&id=<?php echo $_GET['st_id'];?>',
        colModel : [
...
function fg_del(id) {
    if(confirm('删除后将不能恢复，确认删除这项吗？')){
        $.getJSON('index.php?w=sns_strace&t=scomm_del', {id:id}, function(data){
            if (data.state) {
