	...
	<form id="level_form" action="" name="form1" enctype="multipart/form-data" method="post">
		...
		<div class="wtap-form-default">			
			<dl class="row">
				...
				<dd class="opt">
					<input type="text" value="" name="level_weight" id="level_weight" maxlength="20" class="s-input-txt">
					<span class="err"></span>
					<p class="notic"></p>
				</dd>
			</dl>
			<dl class="row">
				...
				<dd class="opt">
					<input type="text" value="" name="level_name" id="level_name" class="input-txt">
					<span class="err"></span>
					<p class="notic"></p>
				</dd>
			</dl>
			<dl class="row">
				...
				<dd class="opt">
					<input type="text" value="" name="commission_layers" id="commission_layers" class="s-input-txt"> 层
					<span class="err"></span>
					<p class="notic"></p>
				</dd>
			</dl>
			<dl class="row">
				...
				<dd class="opt">
					<input type="text" value="" name="layer_rate" id="layer_rate" class="s-input-txt"> %
					<span class="err"></span>
					<p class="notic"></p>
				</dd>
			</dl>
			<dl class="row">
				...
				<dd class="opt">
					<input type="text" value="" name="same_layers" id="same_layers" class="s-input-txt"> 层
					<span class="err"></span>
					<p class="notic"></p>
				</dd>
			</dl>
			<dl class="row">
				...
				<dd class="opt">
					<input type="text" value="" name="same_layer_rate" id="same_layer_rate" class="s-input-txt"> %
					<span class="err"></span>
					<p class="notic"></p>
				</dd>
			</dl>
		      ...
		      <dl class="row">
		        ...
		        <dd class="opt">
		          <div class="onoff">
		            <label for="up_condition_1" class="cb-enable" title="与"><span>与</span></label>
		            <label for="up_condition_0" class="cb-disable" title="或"><span>或</span></label>
		            <input type="radio" id="up_condition_1" name="upgrade_value[up_condition]" value="1">
		            <input type="radio" id="up_condition_0" name="upgrade_value[up_condition]" value="0">
		          </div>
		          <p class="notic">[或]满足任意条件都可以升级<br>[与]满足所有条件才可以升级</p>
		        </dd>
		      </dl>
			<dl class="row">
				<dt class="tit">
					...
					<div class="col-xs-12 col-sm-9 col-md-10">
						<div class="input-group row" style="margin-bottom:5px;">
							<label class="radio-inline col-xs-12 col-sm-6">
								<input type="checkbox" name="upgrade_type[]" value="first_cost_count" >
								一级会员消费满&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="text" name="upgrade_value[first_cost_count]" style="width: 50px;" value="" >
								<span>&nbsp;元&nbsp;</span>
								&nbsp;订单数达到&nbsp;
								<input type="text" name="upgrade_value[first_cost_num]" style="width: 50px;" value="" >
								<span>&nbsp;个&nbsp;</span>
							</label>
							
							<label class="radio-inline  col-xs-12 col-sm-6" style="margin-left:20px;">
								<input type="checkbox" name="upgrade_type[]" value="order_count">
								&nbsp;一级会员数量满&nbsp;&nbsp;&nbsp;
								<input type="text" name="upgrade_value[team_first_member_count]" value="">
								<span>个</span>
							</label>
						</div>
						<div class="input-group row" style="margin-bottom:5px;">
							<label class="radio-inline col-xs-12 col-sm-6">
								<input type="checkbox" name="upgrade_type[]" value="first_cost_count" >
								二级会员消费满&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="text" name="upgrade_value[second_cost_count]" style="width: 50px;" value="" >
								<span>&nbsp;元&nbsp;</span>
								&nbsp;订单数数达到&nbsp;
								<input type="text" name="upgrade_value[second_cost_num]" style="width: 50px;" value="" >
								<span>&nbsp;个&nbsp;</span>
							</label>
							...
							<label class="radio-inline  col-xs-12 col-sm-6" style="margin-left:20px;">
								<input type="checkbox" name="upgrade_type[]" value="order_count">
								&nbsp;二级会员数量满&nbsp;&nbsp;&nbsp;
								<input type="text" name="upgrade_value[team_second_member_count]" value="">
								<span>个</span>
							</label>
						</div>
						<div class="input-group row" style="margin-bottom:5px;">
							<label class="radio-inline col-xs-12 col-sm-6">
								<input type="checkbox" name="upgrade_type[]" value="team_order_money">
								团队业绩金额满&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="text" name="upgrade_value[team_order_money]" value="">
								<span>&nbsp;元&nbsp;</span>
							</label>
							...
							<label class="radio-inline  col-xs-12 col-sm-6" style="margin-left:20px;">
								<input type="checkbox" name="upgrade_type[]" value="order_count">
								&nbsp;团队会员数量满&nbsp;&nbsp;&nbsp;
								<input type="text" name="upgrade_value[team_member_count]" value="">
								<span>个</span>
							</label>
						</div>
						<div class="input-group row" style="margin-bottom:5px;">
							<label class="radio-inline col-xs-12 col-sm-6">
								<input type="checkbox" name="upgrade_type[]" value="self_buy_money">
								自购订单金额满&nbsp;&nbsp;&nbsp;
							...
							<label class="radio-inline col-xs-12 col-sm-6" style="margin-left:20px;">
								<input type="checkbox" name="upgrade_type[]" value="self_buy_count">
								自购单数量满&nbsp;&nbsp;&nbsp;
						...
						<div class="input-group row">
							<label class="radio-inline col-xs-12 col-sm-6">
								<input type="checkbox" name="upgrade_type[]" value="settle_money">
								结算分红金额满&nbsp;&nbsp;&nbsp;
							...
							<label class="radio-inline  col-xs-12 col-sm-6" style="margin-left:20px;">
								<input type="checkbox" name="upgrade_type[]" value="order_count">
								&nbsp;团队具备身份的会员数量满&nbsp;&nbsp;&nbsp;
								<input type="text" name="upgrade_value[team_identity_member_count]" value="">
								<span>个</span>
							</label>							
						</div>	
						...
						<div class="input-group row">
							<label class="radio-inline col-xs-12 col-sm-6">
								<input type="checkbox" name="upgrade_type[]" id="b_o_goods" value="buy_one_goods">
								购买指定商品之一&nbsp;&nbsp;&nbsp;
							</label>							
						</div>
					</div>
		      ...
		      <dl class="row" id="search_input" style="display: none;">
		        <dt class="tit">
		      ...
		      <dl class="row" id="selected_goods_list" style="display: none;">
		      ...
		      <dl class="row" id="upgrade_event_change" style="display: none;">
		        <dt class="tit">
		          <label for="up_condition">升级事件</label>
		        </dt>
		        <dd class="opt">
		          <div class="onoff">
		            <label for="upgrade_event_1" class="cb-enable" title="订单完成后"><span>订单完成后</span></label>
		            <label for="upgrade_event_0" class="cb-disable" title="订单支付后"><span>订单支付后</span></label>
		            <input type="radio" id="upgrade_event_1" name="upgrade_value[upgrade_event]" value="1">
		            <input type="radio" id="upgrade_event_0" name="upgrade_value[upgrade_event]" value="0">
		          </div>
		          <p class="notic"></p>
		        </dd>
		      </dl>
		      <dl class="row" id="search_goodslist" style="display: none;">
