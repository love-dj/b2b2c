...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=navigation&t=navigation" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['navigation_index_nav'];?> - <?php echo $lang['wt_edit'];?>”<?php echo $output['navigation_array']['nav_title'];?>“</h3>
  ...
  <form id="navigation_form" method="post">
    ...
    <div class="wtap-form-default">
	  ...
	  <input type="radio" <?php if($output['navigation_array']['nav_location'] == '3'){ ?>checked="checked"<?php } ?> value="3" name="nav_location" id="nav_location3">
          <label for="nav_location3"><?php echo $lang['navigation_index_hidden'];?> </label>
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="nav_new_open1" class="cb-enable <?php if($output['navigation_array']['nav_new_open'] == '1'){ ?>selected<?php } ?>" ><?php echo $lang['wt_yes'];?></label>
            <label for="nav_new_open0" class="cb-disable <?php if($output['navigation_array']['nav_new_open'] == '0'){ ?>selected<?php } ?>" ><?php echo $lang['wt_no'];?></label>
      ...
      <dl class="row">
        <dt class="tit">
          <label for="nav_sort"><?php echo $lang['wt_sort'];?></label>
        </dt>
        <dd class="opt">
...
$(document).ready(function(){
	$('#navigation_form').validate({
        ...
        messages : {
            nav_title : {
                required : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['navigation_add_partner_null'];?>'
            },
            nav_sort  : {
                number   : '<i class="fa fa-exclamation-bbs"></i><?php echo $lang['navigation_add_sort_int'];?>'
            }
        }
    });
