...
<div class="page">
  ...
  <form id="live_form" method="post" enctype="multipart/form-data">
    ...
    <div class="wtap-form-default">
      ...
      <div class="bot"><a href="JavaScript:void(0);" class="wtap-btn-big wtap-btn-green" id="submitBtn"><?php echo $lang['wt_submit'];?></a> <a href="JavaScript:void(0);" class="wtap-btn-big wtap-btn-red ml10" id="clearBtn">清空数据</a></div>
    </div>
  </form>
</div>
...
$(function(){
    ...
    $('#live_form').validate({
        ...
        messages : {
            live_link1: {
                url : '<i class="fa fa-exclamation-bbs"></i>链接地址格式不正确'
            },
            live_link2:{
                url : '<i class="fa fa-exclamation-bbs"></i>链接地址格式不正确'
            },
    ...
    $('#clearBtn').click(function(){
        ...
        $.ajax({
            type:'get',
            url:'index.php?w=vr_robbuy&t=slider_clear',
            dataType:'json',
