...
<div class="wrap">
  ...
  <form method="get" action="index.php">
    <input type="hidden" name="w" value="member_refund" />
  ...
  <table class="wtm-default-table order">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="bdr"><a href="index.php?w=member_refund&t=view&refund_id=<?php echo $val['refund_id']; ?>" class="wtbtn"><?php echo $lang['wt_view'];?> </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <tfoot>
