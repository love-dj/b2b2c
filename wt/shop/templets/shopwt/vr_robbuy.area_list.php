...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        <li><a href="index.php?w=vr_robbuy&t=class_list">分类管理</a></li>
  ...
  <form id="list_form" method="post" action="index.php?w=vr_robbuy&t=area_drop">
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?w=vr_robbuy&t=area_list_xml',
        colModel: [
        ...
        buttons: [
            {
                ...
                title: '新增区域',
                onpress: function() {
                    location.href = '<?php echo urlAdminShop('vr_robbuy', 'area_add'); ?>';
                }
            },
            {
