...
<div class="page">
    ...
    <div class="item-title">
      <div class="subject">
        ...
        <ul class="tab-base nc-row">
            <li><a href="index.php?act=schema_config&op=index"><?php echo $lang['nc_schema_config'];?></a>
            <li><a href="JavaScript:void(0);" class="current"><?php echo $lang['nc_schema_settlement'];?></a>
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?act=schema_config&op=settlement">
