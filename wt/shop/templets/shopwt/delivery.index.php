  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        <li><a href="<?php echo urlAdminShop('delivery', 'index');?>" <?php if ($output['sign'] != 'verify') {?>class="current"<?php }?>><?php echo $lang['wt_manage'];?></a></li>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?w=delivery&t=index_xml&sign=<?php echo $output['sign']; ?>',
        colModel: [
