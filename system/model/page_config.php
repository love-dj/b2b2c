...
class page_configModel extends Model{
    /**
     * 读取模块内容记录
     *
     * @param
    ...
    public function updateWebHtml($web_id = 1,$web_array = array()){
        ...
        if(!empty($code_list) && is_array($code_list)) {
            ...
            switch ($web_page) {
                case 'index':
                    $style_file = BASE_DATA_PATH.DS.'static'.DS.'page_config'.DS.'default.php';
                    break;
                case 'index_pic':
                    $style_file = BASE_DATA_PATH.DS.'static'.DS.'page_config'.DS.'focus.php';
                    break;
                case 'index_sale':
                    $style_file = BASE_DATA_PATH.DS.'static'.DS.'page_config'.DS.'sale_goods.php';
                    break;
                case 'channel_tp':
                    $style_file = BASE_DATA_PATH.DS.'static'.DS.'page_config'.DS.'channel_top.php';
                    break;
                case 'channel_fl':
                    $style_file = BASE_DATA_PATH.DS.'static'.DS.'page_config'.DS.'channel_floor.php';
                    break;
                case 'index_fl':
                    $style_file = BASE_DATA_PATH.DS.'static'.DS.'page_config'.DS.'index_fl.php';
                    break;
                default:
                    $style_file = BASE_DATA_PATH.DS.'static'.DS.'page_config'.DS.'default.php';
                    break;
