...
(function($) {
    $.fn.what_form_show = function(options) {
 ...
 */
(function($) {
    $.fn.what_publish = function(options,submit_function) {
        var settings = $.extend({}, {max: 140,button_item:'#btn_publish_comment',allow_null:'false'}, options);
        $(this).after('<span id="_comment_count" wt_type="commend_count" class="commend_count"></div>');
        settings.message_item = $(this).next("[wt_type='commend_count']");
 ...
 */
(function($) {
    $.fn.what_count = function(options) {
...
(function($) {
    $.fn.what_like = function(options) {
        ...
        function submit_like() {
            var item = $(this);
            $.getJSON("index.php?w=like&t=like_save", { type: settings.type, like_id: item.attr("like_id") }, function(json){
                if(json.result == "true") {
                    if(settings.count_target == '') {
                        item.find("em").what_count({type:"+"});
                    } else {
                        settings.count_target.what_count({type:"+"});
                    }
                }
                $(".like_tooltips").hide();
...
(function($) {
    $.fn.smilies = function(options) {
        ...
        var STATICURL = 'static/js/smilies/';
