<div class="eject_con" style="overflow: visible;">
  <form id="add_form" action="index.php?w=member_order_vr&t=resend" method="post"  onsubmit="ajaxpost('add_form','','','onerror')">
    ...
    <div class="bottom">
        ...
        <a class="wtbtn ml5" href="javascript:DialogManager.close('vr_code_resend');">取消</a>
    </div>
  </form>
</div>
