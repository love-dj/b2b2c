...
<div class="wrap">
  ...
  <div class="wtm-default-form">
    <form method="post" id="cash_form" action="<?php echo BASE_SITE_URL;?>/index.php?w=predeposit&t=pd_cash_add">
...
请填写详细的开户银行分行名称，虚拟账户如支付宝、财付通填写“支付宝”、“财付通”即可。</p>
      ...
      <dl>
        ...
        <p class="hint">
              ...
              <strong class="red">还未设置支付密码</strong><a href="<?php echo BASE_SITE_URL;?>/index.php?w=member_security&t=auth&type=modify_paypwd" class="wtm-btn-mini wtm-btn-acidblue vm ml10" target="_blank">马上设置</a>
              <?php } ?>
        </p>
          </dd>
      </dl>
