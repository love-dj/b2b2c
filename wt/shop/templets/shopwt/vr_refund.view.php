...
<div class="page">
  ...
  <div class="wtap-form-default">
    ...
    <dl class="row">
      ...
      <dd class="opt"><?php echo wtPriceFormat($output['refund']['refund_amount']); ?></dd>
    </dl>
    <dl class="row">
    ...
    <dl class="row">
      ...
      <dd class="opt"><?php echo wtPriceFormat($output['detail_array']['pay_amount']); ?> </dd>
    </dl>
    <dl class="row">
      <dt class="tit">预存款金额</dt>
      <dd class="opt"><?php echo wtPriceFormat($output['detail_array']['pd_amount']); ?> </dd>
    </dl>
    <dl class="row">
      <dt class="tit">充值卡金额</dt>
      <dd class="opt"><?php echo wtPriceFormat($output['detail_array']['rcb_amount']); ?> </dd>
    </dl>
    <?php } ?>
    <?php } ?>
  </div>
