...
K.options = {
	...
	htmlTags : {
		...
		video : ['id', 'class', 'src', 'width', 'height', 'type', 'controls', 'source', 'data-ke-src', '.width', '.height', 'align', 'autoplay'],
...
function _mediaImg(blankPath, attrs) {
	...
	if (attrs.src.indexOf(".mp4")!=-1 || attrs.src.indexOf("avi")!=-1 || attrs.src.indexOf(".mp3")!=-1) {
            var html = '<video controls="" autoplay="" class="' + _mediaClass(type) + '" src="' + attrs.src + '" ';
			if (style !== '') {
                html += 'style="' + style + '" ';
            }
			html += 'data-ke-tag="' + escape(srcTag) + '" />';
            html += '</video>';
            return html;
        }
        else {
